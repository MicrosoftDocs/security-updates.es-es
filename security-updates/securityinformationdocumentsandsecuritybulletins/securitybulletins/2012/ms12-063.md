---
TOCTitle: 'MS12-063'
Title: 'Boletín de seguridad de Microsoft MS12-063 - Crítica'
ms:assetid: 'ms12-063'
ms:contentKeyID: 61226377
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-063(v=Security.10)'
---
...
Publicado: viernes, 21 de septiembre de 2012
...
Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2757760](http://technet.microsoft.com/es-es/security/advisory/2757760).
...
<td style="border:1px solid black;">
KB2722913 en [MS12-052](http://technet.microsoft.com/es-es/security/bulletin/ms12-052) se reemplaza por KB2744842
</td>
</tr>
...
<td style="border:1px solid black;">
KB2722913 en [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327) se reemplaza por KB2744842
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**Si apliqué la solución Microsoft Fixit automatizada para Internet Explorer del documento informativo sobre seguridad de Microsoft 2757760, ¿debo deshacer la solución provisional antes de aplicar esta actualización?**  
Los clientes que implementaron la **solución Microsoft Fixit** "Evitar los daños en memoria a través de ExecCommand en Internet Explorer" del [documento informativo sobre seguridad de Microsoft 2757760](http://technet.microsoft.com/es-es/security/advisory/2757760), no necesitan deshacer la **solución Microsoft Fixit** antes de aplicar esta actualización.

**¿Dónde están los detalles de información de archivos?**  
Consulte en las tablas de referencia de la sección **Implementación de la actualización de seguridad** la ubicación de los detalles de información de archivo.

**¿Dónde están los valores hash de las actualizaciones de seguridad?**  
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2744842 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2744842).
...
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de OnMove después de la liberación (CVE-2012-1529)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de la escucha de eventos después de la liberación (CVE-2012-2546)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso del diseño después de la liberación (CVE-2012-2548)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de cloneNode después de la liberación (CVE-2012-2557)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a un objeto en memoria que no se ha inicializado correctamente o se ha eliminado. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario actual.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1529).

#### Factores atenuantes para la vulnerabilidad en el uso de OnMove después de la liberación (CVE-2012-1529)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En el caso de un ataque basado en web, el intruso podría hospedar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. El atacante también podría aprovechar los sitios web vulnerables y los sitios web que aceptan u hospedan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.
...
#### Soluciones provisionales para la vulnerabilidad en el uso de OnMove después de la liberación (CVE-2012-1529)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de OnMove después de la liberación (CVE-2012-1529)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código en el contexto del usuario actual.

**¿Cuál es la causa de esta vulnerabilidad?**  
Cuando Internet Explorer intenta obtener acceso a un objeto en memoria que no se ha inicializado o se ha eliminado, se puede dañar la memoria de tal manera que un atacante podría ejecutar código arbitrario en el contexto del usuario actual.
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a un objeto en memoria que se ha eliminado. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario actual.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2546).

#### Factores atenuantes para la vulnerabilidad en el uso de la escucha de eventos después de la liberación (CVE-2012-2546)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de la escucha de eventos después de la liberación (CVE-2012-2546)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de la escucha de eventos después de la liberación (CVE-2012-2546)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2548](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2548).

#### Factores atenuantes para la vulnerabilidad en el uso del diseño después de la liberación (CVE-2012-2548)
...
#### Soluciones provisionales para la vulnerabilidad en el uso del diseño después de la liberación (CVE-2012-2548)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso del diseño después de la liberación (CVE-2012-2548)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2557).

#### Factores atenuantes para la vulnerabilidad en el uso de cloneNode después de la liberación (CVE-2012-2557)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de cloneNode después de la liberación (CVE-2012-2557)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de cloneNode después de la liberación (CVE-2012-2557)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4969](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969).

#### Factores atenuantes para la vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Aplicar la solución Microsoft Fixit "Evitar los daños en memoria a través de ExecCommand en Internet Explorer", que impide que se aproveche esta vulnerabilidad**

    Vea el [artículo 2744842 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2744842) para usar la solución **Microsoft Fixit** automática para habilitar o deshabilitar esta solución provisional.
...
-   **Implementar Enhanced Mitigation Experience Toolkit**
    ...
    **Configurar EMET para Internet Explorer desde una línea de comandos**
    ...
    -   Si ha completado esta operación correctamente, se muestra el siguiente mensaje: `"Thechangesyouhavemademayrequirerestartingoneor more applications" (Los cambios que ha realizado pueden requerir el reinicio de una o varias aplicaciones)`
    -   Si la aplicación ya se ha agregado a EMET, se muestra el mensaje siguiente:`:Error: "c:\Archivos de programa (x86)\Internet Explorer\iexplore.exe" conflictswithexistingentryfor "C:\Archivos de programa (x86)\Internet Explorer\iexplore.exe" (Error: "c:\Archivos de programa (x86)\Internet Explorer\iexplore.exe" está en conflicto con la entrada existente para "C:\Archivos de programa (x86)\Internet Explorer\iexplore.exe"`
    -   Para obtener más información acerca de la ejecución de EMET_Conf.exe, vea la ayuda de la línea de comandos ejecutando lo siguiente desde un símbolo del sistema.En sistemas de 32 bits: `"C:\Archivos de programa\EMET\EMET_Conf.exe" /?En sistemas de 64 bits: "C:\Archivos de programa (x86)\EMET\EMET_Conf.exe" /?`
 ...
 **Configurar EMET para Internet Explorer mediante directiva de grupo**
    ...
    **Nota** Para obtener más información acerca de la directiva de grupo, vea [Colección de directivas de grupo](http://go.microsoft.com/fwlink/?linkid=215719).
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)
...
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Tiene asignado el número de vulnerabilidad y exposición común [CVE-2012-4969](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969). Esta vulnerabilidad se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2757760](http://technet.microsoft.com/es-es/security/advisory/2757760).
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2744842-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2744842-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2744842">artículo 2744842 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2744842$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad en el uso de OnMove después de la liberación (CVE-2012-1529)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola)  
-   , por informar de la vulnerabilidad en la escucha de eventos después de la liberación (CVE-2012-2546)  
-   Stephen Fewer, de [Harmony Security](http://www.harmonysecurity.com/), en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), por informar de la vulnerabilidad en el uso del diseño después de la liberación (CVE-2012-2548)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), por informar de la vulnerabilidad en el uso de cloneNode después de la liberación (CVE-2012-2557)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), por informar de la vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)  
-   [Mitre](http://www.mitre.org/)  
-   , por colaborar con nosotros en la vulnerabilidad en el uso de execCommand después de la liberación (CVE-2012-4969)
...
-   V1.0 (21 de septiembre de 2012): Publicación del boletín.
