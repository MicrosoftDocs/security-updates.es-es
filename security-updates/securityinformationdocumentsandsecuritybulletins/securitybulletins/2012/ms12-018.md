---
TOCTitle: 'MS12-018'
Title: 'Boletín de seguridad de Microsoft MS12-018 - Importante'
ms:assetid: 'ms12-018'
ms:contentKeyID: 61226329
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-018(v=Security.10)'
---
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el controlador en modo kernel de Windows trata los mensajes de ventana. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2922411c-9755-461b-9904-f6940322af19)                                                                                          | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e72b6b1f-68f5-4e1a-878e-290a5f03ca30)                                                                 | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=599e5db1-3bf1-4d44-bc7c-81bc545c58ec)                                                                                 | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=482c2890-8d4c-4e13-820f-d5ff256b6a3a)                                                                     | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ccd0f116-73c2-4471-a6d9-e07d1dbdd406)                                                              | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f4e73a92-583b-4352-b19d-7a8e3ef162b7)                                                                                       | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ead9d29b-becf-448e-bff4-d5bb12d02c64)                                                                           | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dd547364-f6bb-453c-9e4d-6b80dfc47fbb)\*                                                      | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=%205ff65fc2-5969-4d7e-9c72-9a2096dafdcf)\*                                                          | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eeb5385c-fb81-4d33-af2a-986e6cf14ee2)                                                       | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=75fd93ff-5be5-42b5-ab00-3378e545c271)                             | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=71ffba4c-d816-45a9-abef-131915885bc8)                                           | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=22d6a234-6447-4854-8119-4fddd3c6e1bb)\*               | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cb5ac981-e8e5-4df7-84bb-7a2a916d0ce9) | Elevación de privilegios        | Importante                          | [MS12-008](http://technet.microsoft.com/es-es/security/bulletin/ms12-008) |
...
<th style="border:1px solid black;" >Vulnerabilidad de la función PostMessage (CVE-2012-0157)</th>
...
Vulnerabilidad de la función PostMessage (CVE-2012-0157)  
--------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en la forma en que el controlador en modo kernel de Windows administra la función PostMessage. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0157](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0157).
  
#### Factores atenuantes para la vulnerabilidad de la función PostMessage (CVE-2012-0157)
...
#### Soluciones provisionales para la vulnerabilidad de la función PostMessage (CVE-2012-0157)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de la función PostMessage (CVE-2012-0157)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que el controlador en modo kernel de Windows trata incorrectamente la entrada pasada a través de la función PostMessage.
...
La actualización corrige la vulnerabilidad al modificar la forma en que el controlador en modo kernel de Windows trata los mensajes de ventana.
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2641653$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2641653">artículo 2641653 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   , por informar de la vulnerabilidad de la función PostMessage (CVE-2012-0157)
