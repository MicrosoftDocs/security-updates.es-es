...
-   **Restringir el acceso a ORMELEMS.DLL**
    ...
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
    ...
    ```
    takeown /f "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll"
    cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone
    ```
    ...
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
    ...
    ```
    takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll"
    cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone
    ```
...
-   **Restringir el acceso a ELEMENTS.DLL**
    ...
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
    ...
    ```
    Takeown /f "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll"cacls
    "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone
    ```
    ...
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
    ...
    ```
    Takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll"cacls
    "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone
    ```
