---
TOCTitle: 'MS09-039'
Title: 'Boletín de seguridad de Microsoft MS09-039 - Crítica'
ms:assetid: 'ms09-039'
ms:contentKeyID: 61225561
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-039(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-039 - Crítica
====================================================

Vulnerabilidades en WINS podrían permitir la ejecución remota de código (969883)
--------------------------------------------------------------------------------
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Microsoft Windows 2000 Server Service Pack 4 y Windows Server 2003. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la manera en que el servicio WINS calcula la longitud del búfer y al incluir validaciones de datos correctas en los paquetes recibidos en el servidor WINS. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=96c3f496-7b2f-4dbc-b484-216c9943c2b1">Windows Server 2003 con SP2 para sistemas con Itanium</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=139821">MS09-008</a><br />
(KB961064 únicamente)</td>
...
La actualización sólo se puede instalar si WINS está habilitado en los sistemas operativos enumerados en la tabla Software afectado. De forma predeterminada, WINS no está habilitado en estos sistemas operativos, por lo que la actualización no se ofrecerá a menos que se haya habilitado.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)</th>
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en el servicio de nombres Internet de Windows (WINS) debido a un desbordamiento del búfer provocado por un cálculo incorrecto de la longitud del búfer al procesar los paquetes de red de WINS especialmente diseñados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1923](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1923).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, WINS no se instala en ninguna versión de sistema operativo afectada. Sólo los clientes que instalen manualmente este componente están afectados por este problema.  
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   Bloquear TCP y UDP en el puerto 42 en el firewall.
  
    Estos puertos se utilizan para iniciar una conexión con un servidor WINS remoto. Al bloquear estos puertos en el servidor de seguridad, evitará que los sistemas situados detrás de dicho servidor de seguridad sean atacados en un intento de aprovechar la vulnerabilidad. Puede que también se usen otros puertos para aprovechar esta vulnerabilidad. Los puertos que se enumeran son los vectores de ataque más comunes. Le recomendamos bloquear toda comunicación entrante no solicitada de Internet.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)
...
La vulnerabilidad es el resultado de la manera en que WINS calcula una longitud de búfer al procesar paquetes de red de WINS especialmente diseñados.
  
**¿Qué es WINS?**    
WINS es un protocolo que se diseñó específicamente para admitir NetBIOS a través de TCP/IP (NetBT). WINS se necesita para cualquier entorno en el que los usuarios obtengan acceso a recursos que tengan nombres NetBIOS. Si no usa WINS en una red de ese tipo, no podrá conectarse al recurso de red remoto con su nombre NetBIOS a menos que use archivos Lmhosts y tal vez no pueda establecer las conexiones para compartir archivos e impresión. Para obtener más información, vea el artículo de TechNet acerca de [WINS](http://technet.microsoft.com/en-us/library/cc784180.aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría obtener el control completo del sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante podría aprovechar esta vulnerabilidad mediante el envío de un paquete de replicación de WINS especialmente diseñado a un sistema afectado que ejecuta el servicio WINS. No es necesario que un sistema WINS tenga habilitada la replicación para que se produzca este ataque.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los servidores WINS de Windows están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el servicio WINS calcula la longitud del búfer.
...
Vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la configuración predeterminada del servicio de nombres Internet de Windows (WINS) debido a una validación insuficiente de las estructuras de datos dentro de paquetes de red WINS especialmente diseñados recibidos de un asociado de replicación WINS de confianza.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1924](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1924).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   En la configuración predeterminada, este ataque sólo se puede llevar a cabo desde un asociado de replicación WINS de confianza. No obstante, si la clave del Registro "HKLM\\System\\CCS\\Services\\WINS\\Parameteres\\RplOnlyWCnfPnrs" se establece en 0, cualquier usuario de la red puede aprovechar esta vulnerabilidad. Vea [KB251067](http://support.microsoft.com/kb/251067) para obtener una descripción completa de esta clave del Registro y su uso.  
-   De forma predeterminada, WINS no se instala en ninguna versión de sistema operativo afectada. Sólo los clientes que lo instalen manualmente están afectados por este problema.  
-   Si se siguen las prácticas recomendadas relativas al uso de servidores de seguridad y se implementan las configuraciones de servidores de seguridad predeterminadas estándar, puede contribuirse a proteger una red de los ataques que se originen fuera del ámbito de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos.  
-   Este problema sólo afecta a WINS con Windows 2000 Server Service Pack 4.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
El problema se debe a que WINS valida y restringe incorrectamente las longitudes de búfer pasadas al montón.
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante con confianza para la replicación de WINS podría intentar aprovechar la vulnerabilidad si envía paquetes de red especialmente diseñados a un sistema afectado.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los servidores WINS de Windows que se ejecuten en Windows 2000 Server están expuestos a la vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al incluir validaciones de datos correctas en los paquetes recibidos en el servidor WINS.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-kb969883-x86-enu /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-kb969883-x86-enu /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | kb969883.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB969883$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 969883 de Microsoft Knowledge Base](http://support.microsoft.com/kb/969883).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969883\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB969883$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969883">artículo 969883 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de desbordamiento del montón en WINS (CVE-2009-1923)
-   LiGen, de [National University of Defense Technology](http://english.nudt.edu.cn/), por informar de la vulnerabilidad de desbordamiento de enteros en WINS (CVE-2009-1924)
...
-   V1.1 (12 de agosto de 2009): Se ha actualizado la tabla Software afectado para indicar KB961064 como el único artículo de KB reemplazado por esta actualización en el boletín de seguridad de Microsoft MS09-008.
