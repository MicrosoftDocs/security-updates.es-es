---
TOCTitle: 'MS10-097'
Title: 'Boletín de seguridad de Microsoft MS10-097 - Importante'
ms:assetid: 'ms10-097'
ms:contentKeyID: 61225971
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-097(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-097 - Importante
=======================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el asistente de suscripción de la conexión a Internet carga las bibliotecas externas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fa9a1aac-b9c5-4d4e-9083-a080ad4ccc6f)                             | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6dabc306-c858-46b1-815c-cd8d011ff62e)    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fa2cfa4-a01d-4910-b69f-736aeb585bab)                    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17b0b340-73b2-42a7-9d86-1297c63dcc2b)        | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=04a178cc-1afd-4e47-8cab-05e402e5a568) | Ejecución remota de código      | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)</th>
...
Vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)  
-----------------------------------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el asistente de suscripción de la conexión a Internet, un componente de Microsoft Windows, trata la carga de archivos DLL. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
  
#### Factores atenuantes para la vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)
...
#### Soluciones provisionales para la vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Esta vulnerabilidad se debe a que el asistente de suscripción de la conexión a Internet restringe incorrectamente la ruta de acceso empleada para cargar bibliotecas externas.
  
**¿Qué es el asistente de suscripción de la conexión a Internet?**  
El asistente de suscripción de la conexión a Internet permite a los usuarios configurar una conexión en un nuevo equipo o bien usar una cuenta de servicio de Internet existente que tuvieran en un equipo anterior. El asistente también ayuda a los usuarios cuya configuración de Internet se haya dañado. La configuración de configuración automática restaura la configuración y el usuario sólo debe proporcionar el identificador de usuario, la contraseña y el nombre del servidor de punto de presencia (POP).
...
Un atacante podría convencer a un usuario de que abra un archivo .ins o .isp legítimo que se encuentre en el mismo directorio de red que un archivo de biblioteca de vínculos dinámicos (DLL) especialmente diseñado. Después, al abrir el archivo, el asistente de suscripción de la conexión a Internet puede intentar cargar el archivo DLL y ejecutar el código que contiene.
  
En un ataque por correo electrónico, el atacante puede aprovechar la vulnerabilidad mediante el envío de un archivo .ins o .isp legítimo como datos adjuntos a un usuario y convencerle de que guarde los datos adjuntos en un directorio que contiene un archivo DLL especialmente diseñado y de que abra el archivo .ins o .isp. Después, al abrir el archivo .ins o .isp, el asistente de suscripción de la conexión a Internet puede intentar cargar el archivo DLL y ejecutar el código que contiene.
  
En un escenario de red, un atacante podría guardar un archivo .ins o .isp legítimo y una DLL especialmente diseñada en una ubicación UNC o WebDAV y convencer al usuario de que abra el archivo legítimo. Un atacante también podría hospedar un sitio web y consultar el archivo legítimo desde este sitio web, lo que provoca que la vulnerabilidad se active a través de un explorador web.
...
La actualización corrige esta vulnerabilidad al modificar la manera en que el asistente de suscripción de la conexión a Internet carga las bibliotecas externas.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2443105$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2443105">artículo 2443105 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Muhaimin Dzulfakar, de [NGS Software](http://www.ngssoftware.com/), por informar de la vulnerabilidad en la carga de bibliotecas no seguras en el asistente de suscripción de la conexión a Internet (CVE-2010-3144)
