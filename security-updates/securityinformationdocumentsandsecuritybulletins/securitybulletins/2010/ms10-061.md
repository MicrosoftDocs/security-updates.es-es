---
TOCTitle: 'MS10-061'
Title: 'Boletín de seguridad de Microsoft MS10-061 - Crítica'
ms:assetid: 'ms10-061'
ms:contentKeyID: 61225835
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-061(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-061 - Crítica
====================================================
...
Publicado: martes, 14 de septiembre de 2010 | Actualizado: miércoles, 29 de septiembre de 2010
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el servicio de administrador de trabajos de impresión valida los permisos de usuario. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2347290 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2347290) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=93faba6b-0a85-4acc-b527-a012bbf56b13)                                                                                    | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f7f3737-056d-44bd-b644-51093b5b501b)                                                           | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d79680b-c071-462f-9cea-551fbd42edf0)                                                                           | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=073b3305-4a81-4ef8-b6aa-e53b31a936b4)                                                               | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ca35a520-c4da-41bb-abcc-d5bc534ff19a)                                                        | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=028977fd-0f39-42d4-9fee-0d90a2931cfd)                                                  | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c68b9337-883d-4e98-ba0a-90b5cad46184)                          | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e2e788de-8400-4bf6-b96b-a915154aa20a)\* | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08d4f49-5a13-4e1d-b0a7-27b314c2edb5)\*               | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=098537d5-bf6e-4e04-ad33-1cde697e062f) | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=34619e9e-1f00-40e4-be6f-5bbf5e3c801b)                                                                           | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=dbb747a5-658d-44cf-bd49-425d1700157f)                                                                                  | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=11e20088-1be2-4166-9c97-234b7e9f1c4f)\*                                                                   | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d8c635f8-8978-44bf-b457-e07368f08ef4)                                                             | Elevación de privilegios        | Importante                          | Ninguna                                       |
...
**¿Por qué esta vulnerabilidad tiene una gravedad más alta en los sistemas Windows XP?**  
En Windows XP, la cuenta de invitado está habilitada de forma predeterminada, lo que permite a los usuarios anónimos obtener acceso a los recursos compartidos de impresora. En Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2, el atacante debe estar autenticado para aprovechar esta vulnerabilidad, a menos que esté deshabilitado el uso compartido con contraseña. Si se ha deshabilitado el uso compartido con contraseña, los atacantes pueden atacar estos sistemas sin autenticación.
...
<th style="border:1px solid black;" >Vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)</th>
...
Vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)  
-----------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en el servicio de administrador de trabajos de impresión de Windows que podría permitir a un atacante remoto y sin autenticar ejecutar arbitrario en un sistema Windows XP afectado. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas. Se trata de una vulnerabilidad de elevación de privilegios en todos los demás sistemas Microsoft Windows compatibles.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
  
#### Factores atenuantes para la vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, las impresoras no se comparten en ninguno de los sistemas operativos Windows compatibles.  
-   Los sistemas sólo son vulnerables al ataque remoto cuando se comparte una impresora y el atacante remoto puede obtener acceso al recurso compartido de impresora.  
...
#### Soluciones provisionales para la vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)
...
-   **Deshabilitar el uso compartido de impresora**
  
    Para deshabilitar el uso compartido de impresora, realice las siguientes acciones:
  
    En sistemas Windows XP y Windows 2003
  
    1.  Haga clic en **Inicio** y, a continuación, en **Impresoras y faxes**.  
    2.  Haga clic con el botón secundario en el icono de impresora y seleccione **Compartir**.  
    3.  Seleccione **No compartir esta impresora** y, a continuación, haga clic en **Aceptar**.  
    4.  Repita este proceso para cada impresora compartida del sistema.
  
    En todos los sistemas operativos Windows posteriores:
  
    1.  Haga clic en **Inicio** y, a continuación, en **Dispositivos e impresoras**.  
    2.  Haga clic con el botón secundario en el icono de impresora y seleccione **Propiedades de impresora**.  
    3.  Seleccione la ficha **Compartir**.  
    4.  Asegúrese de que no está seleccionada la opción **Compartir esta impresora** y, a continuación, haga clic en **Aceptar**.  
    5.  Repita este proceso para cada impresora compartida del sistema.
  
    **Consecuencias de la solución provisional.** Al deshabilitar esta característica, los usuarios remotos no podrán imprimir en la impresora afectada.
    ...
    **Cómo deshacer la solución provisional:**
    ...
    1.  Haga clic en **Inicio** y, a continuación, en **Impresoras y faxes**.  
    2.  Haga clic con el botón secundario en el icono de impresora y seleccione **Compartir**.  
    3.  Seleccione **Compartir esta impresora** y, a continuación, haga clic en **Aceptar**.  
    4.  Repita este proceso para cada impresora compartida del sistema.
    ...
    2.  Haga clic con el botón secundario en el icono de impresora y seleccione **Propiedades de impresora**.  
    3.  Seleccione la ficha **Compartir**.  
    4.  Seleccione la opción **Compartir esta impresora** y, a continuación, haga clic en **Aceptar**.  
    5.  Repita este proceso para cada impresora compartida del sistema.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)
...
Esta vulnerabilidad se debe a que el administrador de trabajos de impresión de Windows no restringe de forma suficiente los permisos para obtener acceso a los administradores de trabajos de impresión.
...
Un atacante podría aprovechar esta vulnerabilidad si diseña y envía una solicitud de impresión malintencionada a un sistema vulnerable que tenga una interfaz de administrador de trabajos de impresión expuesta a través de RPC. El sistema de destino no valida correctamente si el usuario remoto tiene permisos suficientes y permite que el atacante remoto cree un archivo en un directorio de sistema de Windows. Si se almacenan en determinadas ubicaciones, el sistema puede ejecutar automáticamente estos archivos.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Las estaciones de trabajo y los servidores de Terminal Server que compartan una impresora o los servidores de impresión son los sistemas más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el servicio de administrador de trabajos de impresión valida los permisos de usuario para obtener acceso a los administradores de trabajos de impresión.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2347290$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2347290">artículo 2347290 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin y Alexey Monastyrsky, de [Kaspersky Lab](http://www.kaspersky.com), y Vitaly Kiktenko y Alexander Saprykin, de [Design and Test Lab](http://www.dnt-lab.com), por informar de la vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)  
-   Liam O Morchu, de [Symantec](http://www.symantec.com/index.jsp), por informar de la vulnerabilidad de suplantación del servicio de administrador de trabajos de impresión (CVE-2010-2729)
...
-   V1.1 (29 de septiembre de 2010): Se ha agregado un vínculo al artículo 2347290 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
