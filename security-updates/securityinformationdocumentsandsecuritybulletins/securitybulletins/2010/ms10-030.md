---
TOCTitle: 'MS10-030'
Title: 'Boletín de seguridad de Microsoft MS10-030 - Crítica'
ms:assetid: 'ms10-030'
ms:contentKeyID: 61225804
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-030(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-030 - Crítica
====================================================
...
**¿Por qué esta vulnerabilidad se considera importante en Windows 7 y Windows Server 2008 R2?**    
En Windows 7 y Windows Server 2008 R2, Windows Live Mail es un componente inmediato que no se instala de forma predeterminada. Un usuario tendría que instalar la aplicación para que esté afectado por este problema. No obstante, el código vulnerable se encuentra en el equipo en el archivo inetcomm.dll en la instalación predeterminada y al instalar esta actualización se corregirá la vulnerabilidad independientemente de que exista la vía de ataque.
  
**Ejecuto Windows 7 o Windows Server 2008 R2 sin que esté instalado Windows Live. ¿Por qué se me ofrece esta actualización de seguridad?**    
Esta vulnerabilidad se encuentra en inetcomm.dll, que es un componente principal del sistema operativo. No obstante, la única vía de ataque es mediante el uso de Windows Live Mail. Se sigue ofreciendo esta actualización de seguridad como una actualización defensiva y para corregir por completo la vulnerabilidad del sistema.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de enteros en Outlook Express y Windows Mail (CVE-2010-0816)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 5.5 Service Pack 2 en Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook Express 6 Service Pack 1 cuando está instalado en Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 en Windows XP Service Pack 2 y Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows XP Service Pack 2 y Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 en Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 en Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook Express 6 en Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Outlook Express 6 en Windows Server 2003 con SP2 para sistemas con Itanium</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail en Windows Vista Service Pack 1 y Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Vista Service Pack 1 y Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail en Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2\*\*</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2\*\*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Mail en Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows 7 para sistemas de 32 bits</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows 7 para sistemas x64</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Server 2008 R2 para sistemas x64\*\*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Live Mail cuando está instalado en Windows Server 2008 R2 para sistemas con Itanium</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilidad de desbordamiento de enteros en Outlook Express y Windows Mail (CVE-2010-0816)  
---------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código sin autenticación en la forma en que el cliente de Windows Mail trata las respuestas de correo especialmente diseñadas. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo que un atacante podría enviar una respuesta especialmente diseñada a un cliente que inicie una conexión a un servidor bajo su control mediante los protocolos de correo habituales POP3 e IMAP.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0816](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0816).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en Outlook Express y Windows Mail (CVE-2010-0816)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.  
-   Un atacante no puede enviar un correo electrónico malintencionado para activar esta vulnerabilidad.  
-   Los clientes que utilizan cifrado SSL sobre los protocolos POP3 o IMAP ya no son vulnerables a los ataques de tipo "Man in the middle" que aprovechen esta vulnerabilidad y sólo estarían afectados si se convence al cliente para que se conecte a un servidor de correo electrónico malintencionado o vulnerable.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en Outlook Express y Windows Mail (CVE-2010-0816)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Usar correo electrónico basado en web cuando sea posible**
  
    Si se encuentra disponible, use el correo electrónico basado en web en vez de IMAP o POP3 para comprobar el correo electrónico.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en Outlook Express y Windows Mail (CVE-2010-0816)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que una biblioteca común que usan Outlook Express y Windows Mail valida de forma insuficiente los datos de red antes de usarlos para calcular el tamaño necesario de un búfer.
  
**¿Qué es Windows Mail?**    
Windows Mail (anteriormente Outlook Express) es una herramienta de comunicación en línea que se usa con Windows.
  
**¿Qué son los protocolos de correo POP3 e IMAP?**    
Los servidores POP3 (Protocolo de oficina de correos 3) almacenan los mensajes de correo electrónico entrantes hasta que se comprueba el correo, momento en el que se transfieren al equipo. POP3 es el tipo de cuenta más habitual para el correo electrónico personal. Al comprobar el correo electrónico, los mensajes normalmente se eliminan del servidor. IMAP4 (Protocolo de acceso a mensajes de Internet 4) es un protocolo para leer correo y obtener acceso a carpetas públicas en servidores remotos. Los clientes pueden iniciar sesión en un servidor de correo y usar IMAP4 para descargar los encabezados de los mensajes y, después, leerlos individualmente mientras están conectados.
...
Un atacante podría aprovechar esta vulnerabilidad si configura un servidor de correo electrónico malintencionado y convence al cliente para que se conecte a este equipo. A continuación, podría responder con una respuesta POP3 o IMAP especialmente diseñada, lo que provocaría que el cliente activara la vulnerabilidad. Por otro lado, con un ataque de tipo "Man in the middle" se podrían editar las respuestas de servidor específicas y provocar que se activara esta vulnerabilidad.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los sistemas de escritorio que se utilizan para almacenar y leer el correo electrónico están más expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al validar correctamente las respuestas que devuelve el servidor de correo electrónico antes de su procesamiento.
...
<td style="border:1px solid black;">Para Microsoft Outlook Express 5.5 Service Pack 2 en Microsoft Windows 2000 Service Pack 4:<br />
OE5.5sp2-KB978542-Windows2000-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Outlook Express 6 Service Pack 1 cuando está instalado en Microsoft Windows 2000 Service Pack 4:<br />
...
<td style="border:1px solid black;">Para Microsoft Outlook Express 5.5 Service Pack 2 en Microsoft Windows 2000 Service Pack 4:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB978542-OE55SP2-20100202.120000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Outlook Express 6 Service Pack 1 cuando está instalado en Microsoft Windows 2000 Service Pack 4:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB978542-OE6SP1-20100202.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/978542">artículo 978542 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB978542$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/978542">artículo 978542 de Microsoft Knowledge Base</a>.</td>
...
-   Francis Provencher, de Protek Research Lab, por informar de la vulnerabilidad de desbordamiento de enteros en el cliente de Windows Mail (CVE-2010-0816)
...
-   V1.1 (12 de mayo de 2010): Se han corregido los requisitos de inicio para Microsoft Windows 2000, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2. También se ha corregido la clave de Registro de comprobación para Microsoft Outlook Express 6 Service Pack 1 cuando está instalado en Microsoft Windows 2000 Service Pack 4.  
-   V1.2 (19 de mayo de 2010): Se han quitado las referencias erróneas a Windows Mail en Windows 7 y Windows Server 2008 R2. También se ha corregido la información de reemplazo de boletín para los paquetes de actualización de Windows XP, Windows Server 2003 y Windows Vista. Se trata únicamente de un cambio informativo. Los clientes que ya han instalado correctamente la actualización no tienen que volver a instalarla.
