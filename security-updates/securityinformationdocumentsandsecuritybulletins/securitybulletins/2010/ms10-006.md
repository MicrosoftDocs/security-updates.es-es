---
TOCTitle: 'MS10-006'
Title: 'Boletín de seguridad de Microsoft MS10-006 - Crítica'
ms:assetid: 'ms10-006'
ms:contentKeyID: 61225780
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-006(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-006 - Crítica
====================================================
...
Esta actualización de seguridad se considera crítica para Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows 7 y Windows Server 2008 R2, e importante para todas las ediciones compatibles de Windows Vista y Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado** en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la manera en que el cliente SMB valida las respuestas. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=80b49bab-6c2f-48a8-a901-ca3f76e4fe6b)                                | Ejecución remota de código      | Crítica                             | [MS06-030](http://go.microsoft.com/fwlink/?linkid=62073)            |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f6c4472e-385c-4412-bda9-c2e615e50713)                | Ejecución remota de código      | Crítica                             | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63e15ff0-73b3-46c9-96f8-c18977d35a10)                   | Ejecución remota de código      | Crítica                             | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=feb8c145-7c30-45fa-a6f0-8b6453ddd521)                                   | Ejecución remota de código      | Crítica                             | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36d88c1b-814c-4371-9ed2-d4576f419fc3)                       | Ejecución remota de código      | Crítica                             | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=622442b0-cffe-4fc2-94a8-edff9d71ecd3)                | Ejecución remota de código      | Crítica                             | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista y Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                         | Elevación de privilegios        | Importante                          | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                                         | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Vista x64 Edition y Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da) | Elevación de privilegios        | Importante                          | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da)                             | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*                       | Elevación de privilegios        | Importante                          | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*        | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*                              | Elevación de privilegios        | Importante                          | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*               | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)                        | Elevación de privilegios        | Importante                          | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)         | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=a589431a-93dc-42cd-a74e-d9c1e3452fef)                                   | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=3c1edcf8-d304-45c4-9818-1cd86383b3fe)                                          | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=ecb06350-47a7-48eb-825f-3e8f89c5ca8e)\*                           | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=badd6cab-7738-4401-a68c-c15414388601)                     | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
...
**¿Esta actualización de seguridad está relacionada con MS10-012, publicada el 9 de febrero de 2010?**  
No. En el boletín de seguridad de Microsoft [MS10-012](http://technet.microsoft.com/security/bulletin/ms09-034), "Vulnerabilidades en SMB podrían permitir la ejecución remota de código", se tratan diferentes componentes de SMB. Esta actualización de seguridad se puede aplicar independientemente de cualquier otra actualización.

**Si tengo instalada la actualización MS10-012, ¿también necesito instalar esta actualización?**
Sí. Esta actualización del boletín de seguridad corrige vulnerabilidades en los componentes del cliente SMB de Windows, mientras que [MS10-012](http://technet.microsoft.com/security/bulletin/ms09-034) corrige vulnerabilidades en los componentes del servidor SMB de Windows.
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016)</th>
<th style="border:1px solid black;" >Vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)</th>
...
Vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016)  
-------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0016).
  
#### Factores atenuantes para la vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Se trata de una vulnerabilidad de cliente SMB. Para aprovechar esta vulnerabilidad, un atacante debe convencer a un usuario para que inicie una conexión SMB con un servidor SMB malintencionado. Si se siguen las prácticas recomendadas relativas al uso de servidores de seguridad y se implementan las configuraciones de servidores de seguridad predeterminadas estándar, puede contribuirse a proteger una red de los ataques que se originen fuera del ámbito de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos. En este caso, los puertos SMB deben bloquearse desde Internet.
  
#### Soluciones provisionales para la vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la implementación del cliente del bloque de mensajes del servidor (SMB) de Microsoft valida incorrectamente los campos de la respuesta de SMB. Esto podría provocar un problema de daños en el grupo que conllevar la ejecución de código con privilegios de nivel de sistema.
  
**¿Qué es el protocolo del bloque de mensajes del servidor (SMB) de Microsoft?**  
El protocolo del bloque de mensajes del servidor (SMB) de Microsoft es un protocolo de uso compartido de archivos de la red de Microsoft utilizado en Microsoft Windows. Para obtener más información acerca de SMB, vea [Descripción general del protocolo SMB y el protocolo CIFS de Microsoft](http://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx).
...
Un atacante podría hospedar un servidor SMB malintencionado que esté diseñado para aprovechar esta vulnerabilidad y, a continuación, convencer a un usuario para que iniciara una conexión SMB con él. Adicionalmente, un atacante en la red local podría realizar un ataque del tipo "Man in the middle" para responder a una solicitud SMB legítima con una respuesta SMB con formato incorrecto.
...
No. Sin embargo, este problema se puede aprovechar mediante transacciones web, independientemente del tipo de explorador. En el caso de un ataque basado en Web, el atacante tendría que hospedar una página web que contuviera un URI especialmente diseñado. El usuario que ha explorado ese sitio web forzaría una conexión SMB a un servidor SMB controlado por el atacante, que enviaría una respuesta con formato incorrecto al usuario. Esta respuesta tendría como resultado la ejecución de código en el sistema del usuario. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido proporcionado por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. El atacante no podría obligar a los usuarios a visitar un sitio web especialmente diseñado. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio del atacante.
...
La actualización corrige la vulnerabilidad al modificar la forma en la que se validan los campos en la respuesta SMB.
...
Vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)  
---------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código sin autenticación en la forma en que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft trata los paquetes SMB especialmente diseñados. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo que un atacante podría enviar una respuesta SMB especialmente diseñada a una solicitud SMB iniciada por el cliente. Un atacante que aprovechara esta vulnerabilidad podría obtener el control completo del sistema.
  
En Windows Vista y Windows Server 2008, esta vulnerabilidad podría dar como resultado una vulnerabilidad de elevación de privilegios debido al modo en que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft trata las respuestas de negociación SMB especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario con privilegios de nivel de sistema. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Para elevar los privilegios de esta manera, un atacante debe tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
Esta vulnerabilidad también podría dar como resultado una denegación de servicio. El intento para aprovechar la vulnerabilidad de esta manera no requiere autenticación, por lo que un atacante podría enviar una respuesta SMB especialmente diseñada a una solicitud SMB iniciada por el cliente. Un atacante que aprovechara esta vulnerabilidad podría provocar que el equipo dejara de responder hasta que se reiniciara.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0017](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0017).
  
#### Factores atenuantes para la vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para elevar los privilegios en Windows Vista y Windows Server 2008, un atacante debe tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local para aprovechar esta vulnerabilidad. La vulnerabilidad de elevación de privilegios no se puede aprovechar de forma remota o por usuarios anónimos en esas plataformas. Si se siguen las prácticas recomendadas relativas al uso de servidores de seguridad y se implementan las configuraciones de servidores de seguridad predeterminadas estándar, puede contribuirse a proteger una red de los ataques que se originen fuera del ámbito de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos.
  
#### Soluciones provisionales para la vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
En Windows 7 y Windows Server 2008 R2, se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
En Windows Vista y Windows Server 2008, se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para todas las plataformas afectadas, esta vulnerabilidad también podría dar como resultado una denegación de servicio. En este caso, un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado dejara de responder hasta que se reiniciara manualmente. Es importante mencionar que la vulnerabilidad de denegación de servicio no permitiría a los atacantes ejecutar código o elevar sus derechos de usuario, pero podría provocar que el sistema afectado dejara de aceptar solicitudes.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la implementación del cliente del bloque de mensajes del servidor (SMB) de Microsoft trata incorrectamente una condición de carrera que se puede producir cuando se procesan respuesta de negociación.
  
**¿Qué es el protocolo del bloque de mensajes del servidor (SMB) de Microsoft?**  
El protocolo del bloque de mensajes del servidor (SMB) de Microsoft es un protocolo de uso compartido de archivos de la red de Microsoft utilizado en Microsoft Windows. Para obtener más información acerca de SMB, vea [Descripción general del protocolo SMB y el protocolo CIFS de Microsoft](http://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. En Windows Vista y Windows Server 2008, un atacante que aprovechara correctamente esta vulnerabilidad podría ejecutar código arbitrario con privilegios de nivel del sistema. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Un atacante que aprovechara esta vulnerabilidad, lo cual conllevara una denegación de servicio, podría provocar que el sistema de un usuario dejara de responder hasta que se reiniciara manualmente.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Para aprovechar esta vulnerabilidad para provocar la ejecución remota de código o una denegación de servicio, un atacante podría hospedar un servidor SMB diseñado para aprovechar esta vulnerabilidad y, a continuación, convencer a un usuario para que iniciara una conexión SMB con él. Adicionalmente, un atacante en la red local podría realizar un ataque del tipo "Man in the middle" para responder a una solicitud SMB legítima con una respuesta SMB con formato incorrecto.
  
Antes de aprovechar esta vulnerabilidad para elevar los privilegios, el atacante debería iniciar sesión en el sistema. Seguidamente, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo del sistema afectado.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el cliente SMB trata la condición de carrera que se puede producir al tratar las respuestas de negociación de SMB.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB978251-x86-enu /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB978251-x86-enu /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | KB978251.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB978251$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 978251 de Microsoft Knowledge Base](http://support.microsoft.com/kb/978251).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978251\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB978251$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/978251">artículo 978251 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Laurent Gaffié, de [stratsec](http://www.stratsec.net/), por informar de la vulnerabilidad de daños en el grupo de clientes SMB (CVE-2010-0016) y la vulnerabilidad de condición de carrera de cliente SMB (CVE-2010-0017)
...
-   V1.1 (10 de febrero de 2010): Se han cambiado entradas en la tabla de **Systems Management Server** para SMS 2003 con ITMU para Windows 7 y Windows Server 2008 R2. Se trata únicamente de un cambio informativo. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.
