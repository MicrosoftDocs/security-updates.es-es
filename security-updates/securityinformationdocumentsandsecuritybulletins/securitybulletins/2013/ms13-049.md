---
TOCTitle: 'MS13-049'
Title: 'Boletín de seguridad de Microsoft MS13-049 - Importante'
ms:assetid: 'ms13-049'
ms:contentKeyID: 61226446
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-049(v=Security.10)'
---

Boletín de seguridad de Microsoft MS13-049 - Importante
=======================================================

Una vulnerabilidad en los controladores modo kernel podría permitir la denegación de servicio (2845690)
-------------------------------------------------------------------------------------------------------
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows 8, Windows Server 2012 y Windows RT, y moderada para todas las ediciones compatibles de Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2. Para obtener más información, vea la subsección, **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el controlador TCP/IP de Windows administra paquetes especialmente diseñados. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
| Artículo de Knowledge Base | [2845690](https://support.microsoft.com/kb/2845690) |
|----------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2790655 en [MS13-018](http://go.microsoft.com/fwlink/?linkid=278912)
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=47062f6c-3eaa-47ce-987c-c145d8187466)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0042d190-04b1-4633-bf3e-c6bcf1532e14)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4ce94666-91c6-4eb6-b90a-245b37ab2073)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f320a41f-db24-4d36-9569-308c0dbb7ef5)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=06041fdb-0e80-4738-bdb6-86c162b84420)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=90ef15f2-b2f6-4125-9188-9d296c0769c2)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6f0d6f4a-06e7-4466-bfd8-87fd61e843fd)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=a6eae62a-6d23-425f-9bf5-1fd1efa1bea7)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows 8 para sistemas de 64 bits](http://www.microsoft.com/downloads/details.aspx?familyid=79ed4e26-354e-471c-8112-85e78409956d)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=47062f6c-3eaa-47ce-987c-c145d8187466) (instalación Server Core)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0042d190-04b1-4633-bf3e-c6bcf1532e14) (instalación Server Core)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=90ef15f2-b2f6-4125-9188-9d296c0769c2) (instalación Server Core)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=f2f59e32-0852-4d50-87e6-762552039a49) (instalación Server Core)  
(2845690)
</td>
<td style="border:1px solid black;">
Denegación de servicio
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento de enteros en TCP/IP (CVE-2013-3138)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de denegación de servicio debida a que el controlador de TCP/IP de Windows administra incorrectamente los paquetes durante la conexión TCP. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema de destino dejara de responder.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3138).
...
La vulnerabilidad se debe a que el controlador de TCP/IP administra incorrectamente los paquetes durante la conexión TCP.
...
Un atacante podría intentar aprovechar esta vulnerabilidad si envía paquetes especialmente diseñados al servidor.
...
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador TCP/IP de Windows administra paquetes especialmente diseñados.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2845690">artículo 2845690 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
| **Informaciónsobrearchivos**                | Vea el [artículo 2845690 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2845690)                                                                                                                                    |
