...
ms:contentKeyID: 21741373
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Dd939865(v=WS.10)'
---
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939865.Important(WS.10).gif" />Importante</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939865.note(WS.10).gif" />Nota</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
Set up and configure the WSUS servers in the different subnets. See [Install the WSUS 3.0 SP2 Server](https://technet.microsoft.com/2cd2d2ac-47e8-461f-99bd-db6bd3af1dfc) for details.
