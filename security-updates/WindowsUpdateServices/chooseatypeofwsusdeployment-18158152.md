...
ms:contentKeyID: 18158152
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc720448(v=WS.10)'
---
...
| ![](images/Cc720448.note(WS.10).gif)Nota                                           |
|-----------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720448.Important(WS.10).gif)Importante                                                                                                                                                                                                                                                                                                                                          |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
