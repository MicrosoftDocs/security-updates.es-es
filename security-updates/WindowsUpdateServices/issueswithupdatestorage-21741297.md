...
ms:contentKeyID: 21741297
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Dd939816(v=WS.10)'
---
...
<thead>
<tr class="header">
<th><img src="images/Dd939816.note(WS.10).gif" />Nota</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">For more information about using the WSUSUtil utility, see <a href="https://technet.microsoft.com/4d4b90e9-bbb2-429a-92c9-1e5388240416">Managing WSUS 3.0 SP2 from the Command Line</a>.
<p></p></td>
</tr>
</tbody>
</table>
