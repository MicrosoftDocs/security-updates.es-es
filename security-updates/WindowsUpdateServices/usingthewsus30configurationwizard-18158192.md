...
ms:contentKeyID: 18158192
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)Nota                           |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)Importante |
|----------------------------------------------------------------------------------|
