...
ms:contentKeyID: 18158627
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc708574(v=WS.10)'
---
...
| ![](images/Cc708574.note(WS.10).gif)Nota                                                            |
|----------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708574.Important(WS.10).gif)Importante                                                                                                                                                                                                                                                                            |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
