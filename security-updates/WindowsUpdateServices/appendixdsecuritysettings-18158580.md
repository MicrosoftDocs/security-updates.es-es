...
ms:contentKeyID: 18158580
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc708591(v=WS.10)'
---
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Delete the following stored procedure by using the following command:<br/><br/>
