...
ms:contentKeyID: 18158470
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)Importante |
|----------------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)Nota                                                                                                                                                                                                                                                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
