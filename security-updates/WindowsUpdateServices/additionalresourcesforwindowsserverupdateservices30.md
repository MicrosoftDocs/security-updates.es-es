...
ms:contentKeyID: 18158405
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc708482(v=WS.10)'
---
...
-   For step-by-step guidance for getting started, including installing WSUS, setting up a client computer, and deploying your first set of updates, see [Guía paso a paso para una introducción a Microsoft Windows Server Update Services 3.0](https://technet.microsoft.com/a68a19d2-630e-45d6-b596-d24dac987b64)(http://go.microsoft.com/fwlink/?LinkID=41774).
