...
ms:contentKeyID: 18158668
ms:mtpsurl: 'https://technet.microsoft.com/es-es/library/Cc708595(v=WS.10)'
---
...
| ![](images/Cc708595.note(WS.10).gif)Nota                                                                                 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708595.Important(WS.10).gif)Importante  |
|-----------------------------------------------------------------------------------|
