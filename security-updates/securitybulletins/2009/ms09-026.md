---
TOCTitle: 'MS09-026'
Title: 'Boletín de seguridad de Microsoft MS09-026 - Importante'
ms:assetid: 'ms09-026'
ms:contentKeyID: 61225537
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-026(v=Security.10)'
---
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac)                                                                        | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                    | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                    | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                           | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5)                                                                           | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56)                                                               | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                        | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                                                                | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                  | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                                                                    | Elevación de privilegios        | Importante                          | [MS07-058](http://technet.microsoft.com/security/bulletin/ms07-058) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                          | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca)\* | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e)\*               | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337) | Elevación de privilegios        | Importante                          | Ninguna                                                             |
...
<th style="border:1px solid black;" >Vulnerabilidad en el motor de cálculo de referencias de RPC (CVE-2009-0568)</th>
...
Vulnerabilidad en el motor de cálculo de referencias de RPC (CVE-2009-0568)  
---------------------------------------------------------------------------
  
Existe vulnerabilidad de elevación de privilegios en la función de llamada a procedimiento remoto (RPC) de Windows, donde el motor de cálculo de referencias de RPC no actualiza su estado interno de forma adecuada. El hecho de no actualizar su estado interno puede provocar que un puntero se lea desde una ubicación incorrecta. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568).
  
#### Factores atenuantes para la vulnerabilidad en el motor de cálculo de referencias de RPC (CVE-2009-0568)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Las ediciones compatibles de Microsoft Windows no se proporcionan con servidores o clientes de RPC que estén expuestos a esta vulnerabilidad. En una configuración predeterminada, no se puede atacar a los usuarios mediante esta vulnerabilidad. No obstante, la vulnerabilidad existe en el módulo de tiempo de ejecución de RPC de Microsoft Windows y podría afectar a aplicaciones RPC de terceros.
  
#### Soluciones provisionales para la vulnerabilidad en el motor de cálculo de referencias de RPC (CVE-2009-0568)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad en el motor de cálculo de referencias de RPC (CVE-2009-0568)
...
La vulnerabilidad se debe a que el motor de cálculo de referencias de llamada a procedimiento remoto (RPC) no actualiza su estado interno de una forma adecuada. El hecho de no actualizar puede provocar que un puntero se lea desde una ubicación incorrecta. Sólo las interfaces que usen el IDL (lenguaje de definición de interfaz) que contiene un matriz variable no compatible pueden estar afectadas por este problema.
  
**¿Qué aplicaciones de RPC pueden estar afectadas por esta vulnerabilidad?**    
Para determinar si una aplicación está afectada por este problema, los usuarios deben tener acceso al archivo IDL que se usó para compilar la aplicación de cliente o servidor. Las aplicaciones RPC pueden estar expuestas a esta vulnerabilidad si la agrupación resultante contiene FC\_SMVARRAY o FC\_LGVARRAY seguido de FC\_VARIABLE REPEAT y FC\_VARIABLE\_OFFSET.
...
**¿Qué es el motor de cálculo de referencias de RPC?**    
El motor de cálculo de referencias de RPC, también denominado NDR, proporciona una interfaz RPC común entre los clientes y los servidores RPC. NDR20 se usa en una arquitectura de 32 bits y NDR64 está optimizado para una arquitectura de 64 bits. El mismo motor de cálculo de referencias de RPC se usa en el cliente y en el servidor, independientemente de la arquitectura del programa. El cliente y el servidor negocian el motor de cálculo de referencias que se usa para la comunicación.
  
**¿Qué son los archivos de lenguaje de definición de interfaz (IDL) y los archivos de configuración de aplicación (ACF)?**    
El archivo de lenguaje de definición de interfaz (IDL) contiene una descripción de la interfaz entre los programas cliente y servidor. Las aplicaciones RPC usan el archivo de configuración de aplicación (ACF) para describir las características de la interfaz que son específicas al hardware y el sistema operativo que componen un determinado entorno operativo. La finalidad de dividir esta información en dos archivos es mantener la interfaz de servidor separada de las características que sólo afectan al entorno operativo.
  
El archivo IDL especifica un contrato de red para lo que se transmite entre el cliente y el servidor. Al mantener esta información diferenciada de la información acerca del entorno operativo el archivo IDL se puede portar a otros entornos. El archivo IDL consta de dos partes: un [encabezado de interfaz](http://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx) y un [cuerpo de interfaz](http://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx).
  
El ACF especifica los atributos que afectan sólo al rendimiento local y no al contrato de red. Microsoft RPC permite combinar los atributos de ACF e IDL en un solo archivo IDL. También puede combinar varias interfaces en un solo archivo IDL (y su ACF). Para obtener más información, vea el artículo de MSDN [Los archivos IDL y ACF](http://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx).
  
**¿Qué son las comunicaciones entre procesos (IPC)?**    
El sistema operativo Microsoft Windows proporciona mecanismos para facilitar las comunicaciones y el uso compartido de datos entre aplicaciones. De forma colectiva, las actividades habilitadas por estos mecanismos se denominan comunicaciones entre procesos (IPC). Algunas formas de IPC facilitan la división del trabajo entre varios procesos especializados. Otras formas de IPC facilitan la división del trabajo entre los equipos de una red. Para obtener más información, vea el artículo de MSDN [Comunicaciones entre procesos](http://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx).
...
Un atacante podría intentar aprovechar la vulnerabilidad creando un mensaje RPC especialmente diseñado y enviándolo a un sistema afectado a través de un puerto TCP o UDP afectado. El mensaje podría permitir al cliente escribir datos arbitrarios en la memoria en el espacio de direcciones de servidor RPC. Sólo las interfaces IDL que contienen un matriz variable no compatible están afectadas por este problema.
...
La actualización corrige la vulnerabilidad al modificar la forma en que el motor de cálculo de referencias de RPC actualiza su estado interno.
  
**En el momento de publicar este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568).
...
**Nota para WindowsVi sta y Windows Server 2008** Microsoft Systems Management Server 2003 con Service Pack 3 incluye compatibilidad con la capacidad de administración de Windows Vista y Windows Server 2008.
...
<td style="border:1px solid black;">Para Microsoft Windows 2000 Service Pack 4:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/970238">artículo 970238 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/??????">artículo 970238 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
