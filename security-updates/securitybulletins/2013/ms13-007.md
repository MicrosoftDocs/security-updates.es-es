---
TOCTitle: 'MS13-007'
Title: 'Boletín de seguridad de Microsoft MS13-007 - Importante'
ms:assetid: 'ms13-007'
ms:contentKeyID: 61226404
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-007(v=Security.10)'
---

Boletín de seguridad de Microsoft MS13-007 - Importante
=======================================================

Una vulnerabilidad en el protocolo Open Data podría provocar la denegación de servicio (2769327)
------------------------------------------------------------------------------------------------

Publicado: martes, 8 de enero de 2013 | Actualizado: miércoles, 3 de abril de 2013
...
Esta actualización de seguridad se considera importante para Microsoft .NET Framework 3.5, Microsoft .NET Framework 3.5 Service Pack 1, Microsoft .NET Framework 3.5.1 y Microsoft .NET Framework 4.0. También se considera importante para Extensión IIS Management OData cuando se instala en Microsoft Windows Server 2012. Para obtener más información, vea la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al desactivar la función de reemplazo de WCF de forma predeterminada. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2769327 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2769327) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2769327 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2769327).
...
<th style="border:1px solid black;" >
Vulnerabilidad de denegación de servicio en el reemplazo (CVE-2013-0005)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<tr>
<th colspan="3" style="border:1px solid black;">
Extensión IIS Management OData
</th>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
Extensión IIS Management OData cuando está instalado en Windows Server 2012
</td>
<td style="border:1px solid black;">
**Importante**   
Denegación de servicio
...
<tr>
<td style="border:1px solid black;">
Extensión IIS Management OData cuando está instalado en Windows Server 2012 (instalación Server Core)
</td>
<td style="border:1px solid black;">
**Importante**   
Denegación de servicio
...
Existe una vulnerabilidad de denegación de servicio en la especificación OData que podría permitir la denegación de servicio. La vulnerabilidad podría provocar que el servidor o el servicio dejara de responder y se reiniciara.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-0005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005).

#### Factores atenuantes para la vulnerabilidad de denegación de servicio en el reemplazo (CVE-2013-0005)
...
-   Los sistemas que ejecutan Windows Server 2012 en su configuración predeterminada no están expuestos a esta vulnerabilidad ya que la extensión IIS Management OData no está habilitada de forma predeterminada. Solo los sistemas Windows Server 2012 en los que se ha habilitado la extensión IIS Management OData son vulnerables.

#### Soluciones provisionales para la vulnerabilidad de denegación de servicio en el reemplazo (CVE-2013-0005)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Bloquear los puertos de aplicación web de** **OData** **en el firewall**

    Los puertos de OData normalmente se hospedan en los puertos TCP 80 y 443, pero también se podrían hospedar en otros puertos no estándar. La evaluación del entorno y el bloqueo de las conexiones entrantes y salientes en todos los puertos donde está hospedado un servicio OData en el firewall empresarial protegerán los sistemas frente a los intentos de aprovechar esta vulnerabilidad. Le recomendamos bloquear toda la comunicación entrante no solicitada de Internet para ayudar a impedir ataques que puedan usar otros puertos. Para obtener más información acerca de los puertos, vea el artículo de TechNet [Asignación de puertos TCP y UDP](http://go.microsoft.com/fwlink/?linkid=21312).

-   **Requerir autenticación para los clientes que se conectan a IIS**

    Puede habilitar la autenticación en IIS para impedir que los atacantes no autenticados aprovechen esta vulnerabilidad. Para obtener información sobre cómo implementar la autenticación en su entorno, consulte la documentación de TechNet de su versión de IIS.
    Para IIS 7, vea [Configuración de la autenticación en IIS 7](http://technet.microsoft.com/en-us/library/cc733010(v=ws.10).aspx)

    Para IIS 6.0, vea [Autenticación de Windows integrada en IIS 6.0](http://technet.microsoft.com/en-us/library/cc738016(v=ws.10).aspx)

#### Preguntas más frecuentes sobre la vulnerabilidad de denegación de servicio en el reemplazo (CVE-2013-0005)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de denegación de servicio.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que la función de reemplazo de WCF realiza un saneamiento incorrecto de los valores especialmente diseñados, lo que permite la replicación de datos y el agotamiento de los recursos del sistema.

**¿Qué es** **OData?**  
El protocolo Open Data (OData) es un protocolo web para consultar y actualizar datos que proporciona una forma de liberar los datos de los silos que existen en las aplicaciones en la actualidad. OData lleva a cabo esta operación al aplicar y basarse en tecnologías web, como [HTTP](http://www.w3.org/protocols/), [Protocolo de publicación Atom](http://www.ietf.org/rfc/rfc4287.txt) (AtomPub) y [JSON](http://json.org/), para ofrecer acceso a la información desde diferentes aplicaciones, servicios y almacenes. El protocolo surgió a partir de las experiencias en la implementación de clientes y servidores AtomPub en diferentes productos en años anteriores. OData se usa para exponer y obtener acceso a la información de varias fuentes, entre las que se incluyen bases de datos relacionales, sistemas de archivos, sistemas de administración de contenido y sitios web tradicionales. Para obtener más información acerca de la especificación OData, visite el [sitio web del protocolo Open Data](http://www.odata.org/).

**¿Qué es el servicio web Extensión IIS Management OData?**  
Extensión IIS Management es un marco para exponer fácilmente cmdlets de Windows PowerShell a través de un servicio web basado en OData que se ejecuta en IIS. Para obtener más información, vea [Crear un servicio web Extensión IIS Management OData](http://msdn.microsoft.com/en-us/library/windows/desktop/hh880865(v=vs.85).aspx).
...
Un atacante podría usar esta vulnerabilidad para provocar un ataque de denegación de servicio e interrumpir la disponibilidad de los sitios que usan servicios WCF de .NET.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante no autenticado podría enviar un número reducido de solicitudes HTTP especialmente diseñadas a un sitio afectado, lo que provoca una condición de denegación de servicio.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los sistemas con acceso a Internet con .NET Framework y WCF instalados están más expuestos a esta vulnerabilidad. Los sistemas Windows Server 2012 que ejecutan IIS con Extensión IIS Management OData también están expuestos a esta vulnerabilidad.

**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al desactivar la función de reemplazo de WCF de forma predeterminada.
...
KB2736428\_\*\_\*-Microsoft .NET Framework 4 Client Profile-MSP0.txt<br />
KB2736428\_\*\_\*.html</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2736416">artículo 2736416 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2736428">artículo 2736428 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5 Service Pack 1 cuando está instalado en Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP35SP1-KB2736416-x64.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4.0 cuando está instalado en Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP40-KB2736428-x64.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5 Service Pack 1 cuando está instalado en Windows Server 2003 con SP2 para sistemas con Itanium:<br />
NDP35SP1-KB2736416-IA64.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4.0 cuando está instalado en Windows Server 2003 con SP2 para sistemas con Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones x64 y con Itanium de Windows Server 2003:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2736428<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Información adicional</td>
<td style="border:1px solid black;">Vea la subsección <strong>Herramientas y consejos de detección</strong> <strong>e implementación</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Requisito</strong> <strong>de</strong> <strong>reinicio</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2736418">artículo 2736418 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2736422">artículo 2736422 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2736428">artículo 2736428 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
Las actualizaciones de seguridad para Microsoft .NET Framework 4.0 admiten los siguientes parámetros de instalación.
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2736693">artículo 2736693 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Extensión IIS Management OData cuando está instalado en Windows Server 2012:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2736693">artículo 2736693 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2753596">artículo 2753596 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 3.5:<br />
...
-   V1.1 (3 de abril de 2013): se ha agregado un factor atenuante a CVE-2013-0005 para los sistemas que ejecutan Windows Server 2012.
