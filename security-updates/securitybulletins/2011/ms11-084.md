---
TOCTitle: 'MS11-084'
Title: 'Boletín de seguridad de Microsoft MS11-084 - Moderada'
ms:assetid: 'ms11-084'
ms:contentKeyID: 61226259
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-084(v=Security.10)'
---

Boletín de seguridad de Microsoft MS11-084 - Moderada
=====================================================
...
Es una actualización de seguridad moderada para todas las ediciones compatibles de Windows 7 y Windows 2008 R2. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al garantizar que los controladores del modo kernel de Windows validan correctamente los índices de matriz al cargar los archivos de fuente TrueType. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=156c1bd9-55bc-482c-874b-61998d1ef153)                             | Denegación de servicio          | Moderada                            | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5c7db930-5495-43f0-928c-d586ac9e80d0)                                           | Denegación de servicio          | Moderada                            | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5d810dae-5c52-4155-b5c2-163d27be6e78)\*\*\*           | Denegación de servicio          | Moderada                            | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=395819e2-1028-44b7-ace4-ca754b1a7543) | Denegación de servicio          | Moderada                            | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
...
<th style="border:1px solid black;" >Vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)</th>
...
Vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)  
--------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-2004](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2004).
  
#### Factores atenuantes para la vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para que se lleve a cabo un ataque, un usuario debe visitar una ubicación de sistema de archivo o recurso compartido WebDAV remoto que no sea de confianza que contenga el archivo de fuente TrueType especialmente diseñado o abra el archivo como datos adjuntos de correo electrónico. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a realizar estas acciones. Por lo tanto, tendría que atraerlos; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger.  
...
#### Soluciones provisionales para la vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que los controladores del modo kernel de Windows no realizan una validación suficiente en un índice matriz al cargar un archivo de fuente TrueType.
...
Un atacante podría hospedar una fuente TrueType especialmente diseñada en un recurso de red y cuando el usuario tenga acceso a dicho recurso en el Explorador de Windows, la ruta de acceso de control afectada se activa mediante los paneles Detalles y Vista previa. La fuente TrueType especialmente diseñada podría aprovechar la vulnerabilidad y provocar que el sistema dejara de responder.
...
La actualización corrige esta vulnerabilidad al garantizar que los controladores del modo kernel de Windows validan correctamente los índices de matriz al cargar los archivos de fuente TrueType.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2617657">artículo 2617657 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Will Dorman, de [CERT/CC](http://www.cert.org/), por informar de la vulnerabilidad de análisis de fuentes TrueType (CVE-2011-2004)
