---
TOCTitle: 'MS07-060'
Title: 'Boletín de seguridad de Microsoft MS07-060 - Crítica'
ms:assetid: 'ms07-060'
ms:contentKeyID: 61225337
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms07-060(v=Security.10)'
---

Boletín de seguridad de Microsoft MS07-060 - Crítica
====================================================
...
Es una actualización de seguridad crítica para ediciones compatibles de Microsoft Office 2000, Microsoft Office XP y Microsoft Office 2004 para Mac. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
| Conjunto de programas de Office                                               | Componente                                                                                                                          | Repercusión de seguridad máxima | Clasificación de gravedad acumulada | Boletines reemplazados por esta actualización                       |
|-------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| Microsoft Office 2000 Service Pack 3                                          | [Microsoft Word 2000 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8b3072fb-5933-47f7-a498-13a93e268e57) | Ejecución remota de código      | Crítica                             | [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) |
| Microsoft Office XP Service Pack 3                                            | [Microsoft Word 2002 Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=d6b787bb-03ff-4f67-8b69-6011fb18ba75) | Ejecución remota de código      | Importante                          | [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) |
| [Microsoft Office 2004 para Mac](http://www.microsoft.com/mac/downloads.aspx) |                                                                                                                                     | Ejecución remota de código      | Importante                          | [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) |
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899)</th>
...
Vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899)  
--------------------------------------------------------------------------
  

Existe una vulnerabilidad de ejecución remota de código en la manera en que Word trata los archivos de Word especialmente diseñados. Esta vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de Word especialmente diseñado que contenga una cadena con formato incorrecto. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2007-3899](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   La vulnerabilidad no se puede aprovechar en 2007 Microsoft Office system.  
-   La vulnerabilidad no se puede aprovechar en Microsoft Office 2003 como una ejecución remota de código. Sin embargo, Microsoft Office 2003 podría cerrarse inesperadamente.  
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría ejecutar código arbitrario con los mismos privilegios que el usuario que ha iniciado la sesión. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
...
La actualización elimina la vulnerabilidad al modificar la manera en que Microsoft Word abre los archivos especialmente diseñados para que Word no se cierre de un modo que pudiera permitir la ejecución de código arbitrario. Después que aplicar esta actualización, Word todavía puede cerrarse inesperadamente si los usuarios intentan abrir archivos especialmente diseñados. Sin embargo, la vulnerabilidad se elimina con esta actualización.
  
**¿Qué se hará para solucionar los problemas de estabilidad que todavía existen??**  
Microsoft usará los datos de este problema de estabilidad del servicio de Informe de errores de Windows para determinar el mecanismo de entrega adecuado al establecer prioridades en problemas de estabilidad similares.
...
Sí. En el momento de emitir el boletín de seguridad, Microsoft había recibido información que indicara que se estaba usando esta vulnerabilidad.
...
|------------------------------------|------------|------------|  
| Microsoft Word 2000 Service Pack 3 | Sí         | No         |  
| Microsoft Word 2002 Service Pack 3 | Sí         | Sí         |  
...
|------------------------------------|---------|----------|  
| Microsoft Word 2000 Service Pack 3 | Sí      | Sí       |  
| Microsoft Word 2002 Service Pack 3 | Sí      | Sí       |  
| Microsoft Office 2004 para Mac     | No      | No       |
...
-   La [actualización de Microsoft Office 2004 para Mac 11.3.7](http://www.microsoft.com/downloads/details.aspx?familyid=f151bc90-e985-4cdf-aea7-285920693f26) debe estar instalada en el equipo.  
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2004 para Mac 11.3.8 del [sitio web de Microsoft Mactopia](http://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1138.xml&secid=4&ssid=35&flgnosysreq=true).
...
-   Liu Kun-Hao, de Information and Communication Security Technology Center, por informar de la vulnerabilidad de daños en la memoria relacionada con Word (CVE-2007-3899).
...
-   V1.1 (10 de octubre de 2007): Actualización del boletín: Actualización del hipervínculo del sitio web de Microsoft Mactopia a la ubicación de descarga correcta de la actualización 11.3.8 en la sección "Información sobre la implementación".  
-   V1.2 (17 de octubre de 2007): Actualización del boletín: Actualización de las preguntas más frecuentes de vulnerabilidad para explicar la naturaleza de la actualización y los planes para corregir problemas de estabilidad similares.
