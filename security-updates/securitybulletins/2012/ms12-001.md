---
TOCTitle: 'MS12-001'
Title: 'Boletín de seguridad de Microsoft MS12-001 - Importante'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61226299
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-001(v=Security.10)'
---

Boletín de seguridad de Microsoft MS12-001 - Importante
=======================================================

Una vulnerabilidad en el kernel de Windows podría permitir la omisión de característica de seguridad (2644615)
--------------------------------------------------------------------------------------------------------------

Publicado: martes, 10 de enero de 2012 | Actualizado: miércoles, 22 de febrero de 2012
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el kernel de Windows carga las tablas de control de excepciones estructuradas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2644615 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2644615) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                 | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                 | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                     | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                              | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                       | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                           | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                      | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                             | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                       | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                             | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                           | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*               | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Omisión de característica de seguridad | Importante                          | Ninguna                                       |
...
Gravedad e identific adores de vulnerabilidad
---------------------------------------------
...
<th style="border:1px solid black;" >Vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)</th>
...
Vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de omisión de característica de seguridad en Windows debida a la forma en que el kernel carga las tablas de control de excepciones estructuradas. Un atacante que aprovechara esta vulnerabilidad podría omitir el mecanismo de defensa en profundidad de SafeSEH para facilitar el aprovechamiento de otras vulnerabilidades.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
  
#### Factores atenuantes para la vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Solo las aplicaciones de software que se compilaron con Microsoft Visual C++ .NET 2003 se pueden usar para aprovechar esta vulnerabilidad. **Nota**
  
#### Soluciones provisionales para la vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Volver a compilar el**  
-   **software**  
-   **con**  
...
-   **C++**
    ...
    Solo las aplicaciones de software que se compilaron con Microsoft Visual C++ .NET 2003 se pueden usar para aprovechar esta vulnerabilidad. Para solucionar de forma provisional este problema, vuelva a compilar el modelo con Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 o Microsoft Visual C++ 2010.
  
-   **Habilitar la**  
-   **protección contra sobrescritura del control de excepciones estructuradas (**  
-   **SEHOP**  
-   **)**
  
    Para los sistemas Windows Vista, Windows 7, Windows Server 2008 y Windows Server 2008 R2, vea [Cómo habilitar la protección contra sobrescritura del control de excepciones estructuradas (SEHOP) en sistemas operativos Windows](http://support.microsoft.com/kb/956607) para obtener instrucciones acerca de cómo habilitar SEHOP en las aplicaciones existentes.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Es una vulnerabilidad de omisión de característica de seguridad. Un atacante que aprovechara esta vulnerabilidad podría omitir la característica de seguridad SafeSEH para facilitar el aprovechamiento de otras vulnerabilidades.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que el kernel de Windows carga una tabla de control de excepciones estructuradas en el encabezado de PE "Cargar configuración" durante la ejecución binaria.
...
Ntdll.dll es el componente afectado por la vulnerabilidad.
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**   
Un atacante que aprovechara esta vulnerabilidad podría omitir la característica de seguridad SafeSEH en una aplicación de software. Un atacante podría usar otras vulnerabilidades para aprovechar el controlador de excepciones estructuradas para ejecutar código arbitrario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**   
Para usar esta vulnerabilidad a fin de ejecutar código arbitrario, un atacante primero debería omitir la característica de seguridad SafeSEH y, a continuación, aprovechar esta condición de omisión de seguridad para aprovechar otra vulnerabilidad con el fin de ejecutar código arbitrario.
  
**¿Qué es el controlador de excepciones estructuradas?**   
El controlador de excepciones estructuradas (SEH) es un mecanismo de una aplicación de software para controlar las excepciones de hardware y de software. SEH permite a los programadores tener un control completo sobre el tratamiento de las excepciones, proporciona asistencia a los depuradores y se puede usar en todos los lenguajes de programación y equipos.
  
**¿Qué es SafeSEH?**   
SafeSEH es una característica de seguridad que protege al controlador de excepciones estructuradas frente a daños y secuestros si se produce un desbordamiento del búfer.
  
**¿Qué sistemas están más expuestos** **a esta vulnerabilidad?**   
Tanto las estaciones de trabajo como los servidores están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**   
La actualización corrige la vulnerabilidad al modificar la forma en que el kernel de Windows carga las tablas de control de excepciones estructuradas.
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2644615">artículo 2644615 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2644615-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2644615-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2644615-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2644615-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2644615.log</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2644615\Filelist</td>
</tr>
</tbody>
</table>
...
-   Joshua J. Drake, de [Accuvant LABS](http://www.accuvant.com/), por informar de la vulnerabilidad de omisión de SafeSEH en el kernel de Windows (CVE-2012-0001)
...
-   V1.1 (22 de febrero de 2012): Se ha agregado un vínculo al artículo 2644615 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
