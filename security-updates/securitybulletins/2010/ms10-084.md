---
TOCTitle: 'MS10-084'
Title: 'Boletín de seguridad de Microsoft MS10-084 - Importante'
ms:assetid: 'ms10-084'
ms:contentKeyID: 61225958
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-084(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-084 - Importante
=======================================================

Una vulnerabilidad en la llamada a procedimiento remoto de Windows podría provocar la elevación de privilegios (2360937)
------------------------------------------------------------------------------------------------------------------------

Publicado: martes, 5 de octubre de 2010
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que los mensajes de puerto LRPC se tratan en el subsistema RPC. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                             | Elevación de privilegios        | Importante                          | [MS10-066](http://technet.microsoft.com/security/bulletin/ms10-066) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d)    | Elevación de privilegios        | Importante                          | [MS10-066](http://technet.microsoft.com/security/bulletin/ms10-066) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                    | Elevación de privilegios        | Importante                          | [MS10-066](http://technet.microsoft.com/security/bulletin/ms10-066) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)        | Elevación de privilegios        | Importante                          | [MS10-066](http://technet.microsoft.com/security/bulletin/ms10-066) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | Elevación de privilegios        | Importante                          | [MS10-066](http://technet.microsoft.com/security/bulletin/ms10-066) |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer de mensajes LPC (CVE-2010-3222)</th>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 con SP2 para sistemas con Itanium</a></td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Elevación de privilegios</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilidad de desbordamiento del búfer de mensajes LPC (CVE-2010-3222)  
--------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en el subsistema de llamada a procedimiento remoto (RPCSS) que se ejecuta en el contexto de la cuenta NetworkService, por la que una aplicación local puede usar LPC para solicitar que el servidor LPC se vuelva a conectar con el cliente mediante LRPC. Esta solicitud podría contener datos especialmente diseñados para provocar un desbordamiento de búfer basado en pila, lo que permite que un usuario autenticado obtenga acceso a los recursos que se ejecutan en el contexto de la cuenta NetworkService.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer de mensajes LPC (CVE-2010-3222)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer de mensajes LPC (CVE-2010-3222)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer de mensajes LPC (CVE-2010-3222)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código en el contexto de la cuenta NetworkService.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Esta vulnerabilidad se debe a un desbordamiento del búfer basado en pila en el intercambio de mensajes de puerto entre LPC y el servidor LRPC (asignador de extremos RPC) incluido en RPCSS.
  
**¿Cuál es el componente afectado por esta vulnerabilidad?**    
El componente afectado por la vulnerabilidad es LPC (llamada a procedimiento local) de Microsoft, un componente de RPC (llamada a procedimiento remoto).
  
**¿Qué es LPC?**  
La llamada a procedimiento local (LPC) es un servicio de transmisión de mensajes incluido en Windows. Este servicio permite a los subprocesos y procesos comunicarse entre sí. Cuando un proceso cliente debe solicitar un servicio de un proceso del servidor, tiene que haber un medio para que los dos procesos puedan comunicarse entre sí. Debe existir un mecanismo para que el proceso cliente pueda realizar las solicitudes al servidor, para que el servidor envíe las respuestas al cliente y para que ambos puedan determinar su estado. Cuando los procesos cliente y servidor se encuentran en sistemas distintos, se utiliza RPC (Llamada a procedimiento remoto). Cuando se encuentran en el mismo sistema, puede utilizarse LPC .
...
**¿Qué es LRPC?**  
RPC local (LRPC) hace referencia a la comunicación RPC que se produce en un sistema local.
  
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría ejecutar código especialmente diseñado en el contexto de la cuenta NetworkService, lo que le permitiría obtener acceso a los recursos que se ejecutan como NetworkService. Algunos de estos procesos pueden tener la capacidad de elevar sus privilegios a LocalSystem, lo que permite que cualquier proceso de NetworkService eleve también sus privilegios a LocalSystem. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante que haya iniciado sesión localmente con credenciales válidas podría aprovechar la vulnerabilidad al ejecutar código especialmente diseñado que envíe un mensaje LPC al servidor LRPC local. El mensaje podría permitir a un usuario autenticado ejecutar código en el contexto de la cuenta NetworkService.
...
La actualización corrige la vulnerabilidad al modificar la manera en que los mensajes de puerto LPC se tratan en RPCSS.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2360937$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2360937">artículo 2360937 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
