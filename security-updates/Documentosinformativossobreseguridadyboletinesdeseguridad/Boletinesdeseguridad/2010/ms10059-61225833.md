---
TOCTitle: 'MS10-059'
Title: 'Boletín de seguridad de Microsoft MS10-059 - Importante'
ms:assetid: 'ms10-059'
ms:contentKeyID: 61225833
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-059(v=Security.10)'
---
...
La actualización de seguridad corrige las vulnerabilidades al modificar la manera en la que se obtienen los símbolos (token) y se calcula la longitud de una cadena leída del Registro. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfb31aa2-7457-4581-9e28-7984a360edf4)                                                  | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=110f932f-d13c-4486-a295-e6068d5d8d7a)                          | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c9b3e60-e166-40c9-8938-3cba0a399c47)\* | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fa84e547-2190-402f-9467-2450deeff565)\*               | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84f89dca-108c-4956-9aa2-866e17a872fc) | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ce6233f3-2ee5-4329-908d-ba9b28ecc553)                                                                           | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=146270fa-cd6f-440a-aa3e-e93af0bff447)                                                                                  | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=333fb6e4-f867-4dcb-beb3-2d88e428ca2e)\*                                                                   | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=62034ecb-a6bd-46c5-a03d-9642880bc2d6)                                                             | Elevación de privilegios        | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)</th>
...
Vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)  
--------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios cuando Windows coloca listas de control de acceso (ACL) incorrectas en las claves del Registro para la característica de seguimiento para servicios. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
  
#### Factores atenuantes para la vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)
...
#### Soluciones provisionales para la vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)
...
La vulnerabilidad se produce cuando Windows coloca listas de control de acceso (ACL) incorrectas en las claves del Registro para la característica de seguimiento para servicios. De este modo resulta posible que un atacante modifique el directorio de seguimiento por una canalización con nombre y cree una escucha de canalización con nombre en él. Una vez creada la canalización con nombre, el atacante puede suplantarla para obtener los símbolos (token) del servicio que ha creado la canalización con nombre. Si el creador se crea en el contexto del sistema local (por ejemplo, el servicio IpHlpSvc), el atacante puede obtener y usar los símbolos del sistema local.
  
**¿Qué es una lista de control de acceso (ACL)?**    
Una lista de control de acceso (ACL) es una lista de protecciones de seguridad que se aplica a un objeto. Un objeto puede ser un archivo, un proceso, un evento o cualquier entidad que tenga un descriptor de seguridad. Una entrada en una ACL es una entrada de control de acceso (ACE). Hay dos tipos de lista de control de acceso: discrecional y sistema. Cada ACE de una ACL identifica los derechos de acceso permitidos, denegados o auditados para el elemento de confianza. Para obtener información adicional, vea el artículo de MSDN [Listas de control de acceso](http://msdn.microsoft.com/en-us/library/aa374872(vs.85).aspx).
  
**¿Qué es una canalización con nombre?**    
Se trata de una canalización unidireccional o dúplex con nombre para la comunicación entre el servidor de canalización y uno o varios clientes de canalización. Todas las instancias de una canalización con nombre comparten el mismo nombre de canalización, pero cada instancia tiene sus propios búferes e identificadores, y proporciona un conducto independiente para la comunicación cliente-servidor. El uso de instancias permite que varios clientes de canalización usen la misma canalización con nombre simultáneamente. Cualquier proceso puede tener acceso a las canalizaciones con nombre, sujeto a las comprobaciones de seguridad, con lo que las canalizaciones con nombre resultan una forma sencilla de comunicación entre procesos relacionados o no relacionados. Para obtener más información, vea el artículo de MSDN [Canalizaciones con nombre](http://msdn.microsoft.com/en-us/library/aa365590(vs.85).aspx).
  
**¿Qué es el componente de utilidades de enrutamiento (rtutils.dll)?**    
El componente de utilidades de enrutamiento (rtutils.dll) es un módulo que contiene las funciones que se usan para el seguimiento, que proporciona un mecanismo uniforme para generar salida de diagnóstico para los distintos componentes de servicio. Cuando un componente usa el mecanismo de seguimiento de Rtutils, la configuración de seguimiento específica del componente almacenada en la clave del Registro en la clave HKLM\\Software\\Microsoft\\Tracing\\ para almacenar los datos de seguimiento.
...
La actualización corrige la vulnerabilidad al modificar la manera en la que los símbolos (token) se obtienen mediante suplantación.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-2554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2554).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes.
  
Vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)  
------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que la característica de seguimiento para servicios asigna memoria al procesar cadenas largas especialmente diseñadas del Registro. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario con privilegios de nivel de sistema. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2555](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2555).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se produce cuando la característica de seguimiento para servicios calcula incorrectamente la longitud de determinadas cadenas del Registro.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que las características de seguimiento para servicios calculan la longitud de una cadena leída del Registro.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/982799">artículo 982799 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo, de [Argeniss](http://www.argeniss.com/), por informar de la vulnerabilidad de la ACL del Registro de seguimiento (CVE-2010-2554)  
-   Cesar Cerrudo, de [Argeniss](http://www.argeniss.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con el seguimiento (CVE-2010-2555)
