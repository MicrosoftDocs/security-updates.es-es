---
TOCTitle: 'MS10-083'
Title: 'Boletín de seguridad de Microsoft MS10-083 - Importante'
ms:assetid: 'ms10-083'
ms:contentKeyID: 61225957
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-083(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-083 - Importante
=======================================================
...
Publicado: martes, 12 de octubre de 2010 | Actualizado: martes, 14 de diciembre de 2010
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el shell de Windows y WordPad validan los objetos COM. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En los documentos [2405882 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2405882) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<tr>
<th colspan="4">
Actualizaciones para el shell de Windows
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[1]</sup>En el caso de que ambos paquetes de actualización de seguridad para WordPad (KB979687) y el shell de Windows (KB979688) estén disponibles para el mismo sistema operativo, los clientes deben instalar ambas para estar protegidos frente a las vulnerabilidades descritas en este boletín.

Preguntas más frecuentes (P+F) relacionadas con esta actualización de seguridad
-------------------------------------------------------------------------------

<span></span>
**¿Por qué se ha vuelto a publicar este boletín el 14 de diciembre de 2010?**  
Microsoft ha vuelto a publicar este boletín para ofrecer una actualización adicional para Windows Vista Service Pack 2 (KB979688) para los usuarios que instalaron Windows Search 4.0 en Windows Vista Service Pack 1, después instalaron la actualización de seguridad ofrecida en el [artículo 2405882 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2405882) y, por último, migraron a Windows Vista Service Pack 2. Los clientes en este escenario deberán instalar la nueva actualización ofrecida en el [artículo 2405882 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2405882) para protegerse de las vulnerabilidades descritas en este boletín. A los clientes en este escenario con las actualizaciones automáticas habilitadas se les ofrecerá esta actualización para sus sistemas. Para información adicional, vea el [artículo 2405882 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2405882).
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en el modo en que el shell de Windows y WordPad validan la ejecución de objetos COM. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
...
-   La vulnerabilidad no se podría aprovechar automáticamente mediante el correo electrónico. Un usuario debe abrir un archivo adjunto a un mensaje de correo electrónico para que un ataque tenga éxito. Al usuario se le pedirá si desea abrir el archivo o no, a menos que haya desactivado anteriormente la opción "Preguntar siempre antes de abrir este tipo de archivos".
...
-   **No usar WordPad para abrir documentos de fuentes que no sean de confianza**

    No use WordPad para abrir documentos que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.
...
El shell de Windows y WordPad validan inadecuadamente los objetos COM cuando se ejecutan.
...
**¿Qué es WordPad?**  
WordPad es un procesador de textos básico que se incluye en Microsoft Windows. Un procesador de textos es un programa informático que puede usar para crear, editar, ver e imprimir documentos de texto. Con WordPad, puede escribir cartas, informes de libro y otros documentos sencillos. También puede cambiar el aspecto del texto, mover frases y párrafos rápidamente, y copiar y pegar texto en el mismo documento y de un documento a otro. Para obtener más información acerca de WordPad, vea [Uso de WordPad](http://windows.microsoft.com/en-us/windows-vista/using-wordpad).
...
El vector de ataque de WordPad requiere que un usuario abra un archivo de WordPad especialmente diseñado dentro de una versión afectada de Microsoft Windows.

En el supuesto de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía al usuario un archivo de WordPad especialmente diseñado y lo convence de que lo abra.

En el caso de un ataque a través de web, el atacante tendría que hospedar un sitio web que contuviera un archivo de WordPad especialmente diseñado destinado a intentar aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido proporcionado por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. El atacante no podría obligar a los usuarios a visitar un sitio web especialmente diseñado. Por lo tanto, tendría que atraerlos al sitio web; para ello debería, por ejemplo, incitarles a hacer clic en un vínculo que les llevara al sitio web del atacante.

La vía de ataque del shell de Windows usa las capacidades de búsqueda y requiere que un usuario abra o seleccione un archivo de accesos directos que se encuentre en un recurso compartido de red o de WebDAV. El atacante no podría obligar a los usuarios a visitar un recurso compartido de WebDAV o de red especialmente diseñado. Por lo tanto, tendría que atraerlos al recurso compartido; para ello debería, por ejemplo, incitarles a hacer clic en un vínculo que les llevara al sitio controlado por el atacante.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Todos los sistemas operativos enumerados en la tabla de software afectado están expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.

**¿Cómo funciona esta actualización?**  
La actualización corrige la forma en que el shell de Windows y WordPad validan los objetos COM que se ejecutarán.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB979687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/979687">artículo 979687 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones de 32 bits compatibles de Windows Vista:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones de 32 bits compatibles de Windows Vista:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones x64 compatibles de Windows Vista:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones x64 compatibles de Windows Vista:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para WordPad, <a href="http://support.microsoft.com/kb/979687">artículo 979687 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows, vea el <a href="http://support.microsoft.com/kb/979688">artículo 979688 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones de 32 bits compatibles de Windows Server 2008:<br />
Windows6.0-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones de 32 bits compatibles de Windows Server 2008:<br />
Windows6.0-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones x64 compatibles de Windows Server 2008:<br />
Windows6.0-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones x64 compatibles de Windows Server 2008:<br />
Windows6.0-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones con Itanium compatibles de Windows Server 2008:<br />
Windows6.0-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones con Itanium compatibles de Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para WordPad, vea el <a href="http://support.microsoft.com/kb/979687">artículo 979687 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows, vea el <a href="http://support.microsoft.com/kb/979688">artículo 979688 de Microsoft Knowledge Base</a>.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones de 32 bits compatibles de Windows 7:<br />
Windows6.1-KB979687-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones de 32 bits compatibles de Windows 7:<br />
Windows6.1-KB979688-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones x64 compatibles de Windows 7:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones x64 compatibles de Windows 7:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones x64 compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB979687-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones x64 compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB979688-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para WordPad en todas las ediciones con Itanium compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB979687-ia64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para el shell de Windows en todas las ediciones con Itanium compatibles de Windows Server 2008 R2:<br />
...
-   HD Moore, [Rapid7](http://www.rapid7.com/), por informar de la vulnerabilidad de validación COM (CVE-2010-1263)  
...
-   V2.0 (14 de diciembre de 2010): Se ha agregado una pregunta más frecuente de actualización para anunciar una actualización adicional para Windows Vista Service Pack 2 (KB979688) para los usuarios que instalaron Windows Search 4.0 en Windows Vista Service Pack 1, después instalaron la actualización de seguridad ofrecida en KB2405882 y, por último, migraron a Windows Vista Service Pack 2. Los clientes en este escenario deberán instalar la nueva actualización ofrecida en KB2405882 para protegerse de las vulnerabilidades descritas en este boletín.
