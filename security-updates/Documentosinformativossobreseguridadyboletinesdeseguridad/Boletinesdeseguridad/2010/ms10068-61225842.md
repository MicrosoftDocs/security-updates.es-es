---
TOCTitle: 'MS10-068'
Title: 'Boletín de seguridad de Microsoft MS10-068 - Importante'
ms:assetid: 'ms10-068'
ms:contentKeyID: 61225842
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-068(v=Security.10)'
---
...
Esta actualización de seguridad resuelve una vulnerabilidad de la que se ha informado de forma privada en Active Directory, Active Directory Application Mode (ADAM) y servicio de directorio ligero de Active Directory (AD LDS). La vulnerabilidad podría permitir la elevación de privilegios si un atacante autenticado enviara mensajes de protocolo ligero de acceso a directorios (LDAP) especialmente diseñados a un servidor LSASS de escucha. Para aprovechar esta vulnerabilidad, el atacante debe tener una cuenta de miembro en el dominio de Windows de destino. No obstante, el atacante no necesita tener una estación de trabajo unida a un dominio de Windows.

Esta actualización de seguridad se considera importante para Active Directory, ADAM y AD LDS cuando está instalado en las ediciones compatibles de Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2. Para obtener más información, vea la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el servicio de subsistema de autoridad de seguridad local (LSASS) trata determinados mensajes LDAP. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=853a71f3-fb0d-43af-a2b8-45bf8ca1a588">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=566f468b-22b6-400a-a656-ae64cfcb52df">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1452befe-b7b8-4131-b36f-dded2bd16d5e">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=38eb875f-1869-401b-b7d3-9f18f4ba4f24">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-066">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=454fc025-bfa2-4552-9522-3585f523ecb2">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b15ad533-3cf1-4dcf-847c-05ebffb84e26">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54f36389-8be4-4a0c-9640-dc32addac9d7">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
...
| Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2<sup>[1]</sup> |  
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento del montón en LSASS (CVE-2010-0820)  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Existe una vulnerabilidad de elevación de privilegios autenticada en Microsoft Windows debida a que el servicio de subsistema de autoridad de seguridad local (LSASS) trata incorrectamente determinados mensajes del protocolo ligero de acceso a directorios (LDAP). La vulnerabilidad existe en las implementaciones de Active Directory, Active Directory Application Mode (ADAM) y servicio de directorio ligero de Active Directory (AD LDS). Un atacante debe haberse autenticado previamente con el servidor LSASS antes de aprovechar este problema. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0820](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón en LSASS (CVE-2010-0820)
...
-   Para aprovechar esta vulnerabilidad, el atacante debe ser una cuenta de miembro en el dominio de Windows de destino. No obstante, el atacante no necesita tener una estación de trabajo unida a un dominio de Windows.

#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón en LSASS (CVE-2010-0820)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **Bloquear el puerto TCP 389 en el firewall**

    Bloquee el puerto TCP 389 en el firewall. Este puerto se utiliza para iniciar una conexión con el componente afectado.

    Microsoft le recomienda bloquear toda la comunicación entrante no solicitada de Internet para ayudar a impedir ataques que puedan utilizar otros puertos. Para obtener más información acerca de puertos, vea [asignaciones de puertos TCP y UDP](http://technet.microsoft.com/es-es/library/cc977599(en-us).aspx). Para obtener más información acerca de Firewall de Windows, consulte [Cómo configurar Firewall de Windows en un único equipo](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón en LSASS (CVE-2010-0820)
...
La vulnerabilidad se debe a que la implementación LSASS de Windows no trata correctamente determinados paquetes con formato incorrecto en los mensajes LDAP.

**¿Qué es LSASS?**  
El servicio de subsistema de autoridad de seguridad local (LSASS) ofrece una interfaz para administrar la seguridad local, la autenticación de dominios y los procesos del servicio Active Directory. LSASS controla la autenticación para el cliente y para el servidor. LSASS también contiene características para admitir utilidades de Active Directory.
...
Un atacante podría aprovechar esta vulnerabilidad mediante el envío de mensajes LDAP especialmente diseñados a un servidor LSASS de escucha. Un atacante debe haberse autenticado previamente con el servidor LSASS antes de aprovechar este problema.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Todos los sistemas que ejecuten un sistema operativo afectado con los servicios de Active Directory instalados están afectados por esta vulnerabilidad. Esta vulnerabilidad no afecta directamente a los sistemas solo cliente.

**¿Cómo funciona esta actualización?**  
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que LSASS trata determinados mensajes LDAP.
...
| Windows Vista Service Pack 2                                                                               | No      | No                | Sí                | Sí                         |
| Windows Vista x64 Edition Service Pack 2                                                                   | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/982000">artículo 982000 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB981550$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM), use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Active Directory en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/981550">artículo 981550 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM) en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/982000">artículo 982000 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/981550">artículo 981550 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
