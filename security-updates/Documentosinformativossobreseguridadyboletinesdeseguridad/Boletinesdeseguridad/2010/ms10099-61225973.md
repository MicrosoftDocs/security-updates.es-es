---
TOCTitle: 'MS10-099'
Title: 'Boletín de seguridad de Microsoft MS10-099 - Importante'
ms:assetid: 'ms10-099'
ms:contentKeyID: 61225973
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-099(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-099 - Importante
=======================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la validación en el componente Enrutamiento y acceso remoto. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                             | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50)    | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                    | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)        | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0) | Elevación de privilegios        | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)</th>
...
Vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)  
----------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios en el componente NDProxy de Enrutamiento y acceso remoto del kernel de Windows debida a una validación incorrecta de los datos que se pasan del modo de usuario al kernel. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante local que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, el atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)
...
El componente NDProxy de Enrutamiento y acceso remoto no valida correctamente los datos suministrados por el usuario cuando se envían datos desde el modo de usuario al kernel.
  
**¿Qué es RRAS?**    
RRAS permite el funcionamiento de un equipo como enrutador de red. Además, RRAS proporciona la funcionalidad de servidor de próxima generación para el servicio de acceso remoto (RAS, Remote Access Service) de Windows. La funcionalidad del servidor RRAS toma como base y desarrolla el RAS incluido en sistemas operativos anteriores.
  
RAS permite a los usuarios conectar a un equipo remoto a través de líneas telefónicas, de forma que pueden trabajar como si su sistema estuviera conectado físicamente a la red remota. Gracias a estos servicios, los usuarios remotos pueden realizar operaciones como enviar y recibir correo electrónico, enviar documentos por fax, recuperar archivos e imprimir documentos en una impresora de la oficina.
  
RAS es un servicio nativo en Windows XP y Windows Server 2003.
  
**¿Qué es NDProxy?**    
NDPROXY es un controlador proporcionado por el sistema que interactúa con los controladores de minipuerto WAV, administradores de llamadas y administradores de llamadas de minipuerto a los servicios de interfaz de programación de aplicaciones de telefonía (TAPI). Para obtener información adicional, vea el artículo de MSDN [Descripción general de NDPROXY](http://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx).
...
La actualización corrige la vulnerabilidad al validar correctamente los datos enviados al kernel de Windows desde el modo de usuario a través del componente Enrutamiento y acceso remoto.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2440591$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2440591">artículo 2440591 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Honggang Ren, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com/), por informar de la vulnerabilidad de desbordamiento del búfer de NDProxy en el kernel (CVE-2010-3963)
