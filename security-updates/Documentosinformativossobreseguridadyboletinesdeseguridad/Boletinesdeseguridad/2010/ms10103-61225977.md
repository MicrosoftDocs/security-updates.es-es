---
TOCTitle: 'MS10-103'
Title: 'Boletín de seguridad de Microsoft MS10-103 - Importante'
ms:assetid: 'ms10-103'
ms:contentKeyID: 61225977
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-103(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-103 - Importante
=======================================================
...
Esta actualización de seguridad se considera importante para las ediciones compatibles de Microsoft Publisher 2002, Microsoft Publisher 2003, Microsoft Publisher 2007 y Microsoft Publisher 2010. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2010 (ediciones de 32 bits)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2">Microsoft Publisher 2010 (ediciones de 32 bits)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 (ediciones de 64 bits)</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966">Microsoft Publisher 2010 (ediciones de 64 bits)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)</th>
<th style="border:1px solid black;" >Vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2010 (ediciones de 32 bits)</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2010 (ediciones de 64 bits)</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;">No aplicable</td>
...
Vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)  
--------------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2569](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569).
  
#### Factores atenuantes para la vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)
...
#### Soluciones provisionales para la vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 32 bits de Windows XP y Windows Server 2003:**
    ...
    `cacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /E /P everyone:N`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    **Para ediciones de 64 bits de Windows XP y Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /E /P everyone:N`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    **Para ediciones de 32 bits de Windows** **Vista, Windows Server 2008 y Windows 7:**
  
    `takeown /f "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll"icacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone(F)`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    **Para ediciones de 64 bits de Windows** **Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:**
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll"icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone (F)`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    **Consecuencias de la solución provisional.** Los usuarios que han deshabilitado la dll del convertidor de Publisher no podrán abrir los archivos de Publisher creados en versiones anteriores a Microsoft Publisher 2007.
    ...
    **Cómo deshacer la solución provisional:**
    ...
    `cacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    Para ediciones de 64 bits de Windows XP y Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    Para ediciones de 32 bits de Windows Vista, Windows Server 2008 y Windows 7:
  
    `icacls "c:\archivos de programa\Microsoft Office\<versión de Office>\" /restore %TEMP%\PUBCONV_ACL.TXT`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 y "Office12" para Microsoft Publisher 2007. Para comprobar la versión, abra este componente de Microsoft Office y haga clic en **Ayuda**.
  
    Para ediciones de 64 bits de Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
  
    `icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\" /restore %TEMP%\PUBCONV_ACL.TXT`
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a la forma en que Microsoft Publisher analiza los archivos de Publisher especialmente diseñados.
  
**¿Qué es pubconv.dll?**    
Microsoft Publisher usa la dll del convertidor de Publisher para abrir los archivos de Publisher creados en versiones anteriores a Microsoft Publisher 2007.
...
Vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)  
---------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código debida a la forma en que Microsoft Publisher analiza los archivos de Publisher. Un atacante podría aprovechar la vulnerabilidad si crea un archivo de Publisher especialmente diseñado que se podría incluir como datos adjuntos de correo electrónico u hospedarse en un sitio web especialmente diseñado o vulnerable, y convencer al usuario para que abra el archivo de Publisher especialmente diseñado. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2570](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570).
  
#### Factores atenuantes para la vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)
...
#### Soluciones provisionales para la vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Nota** Use la versión del software de Microsoft Office correspondiente a su sistema, como "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003, "Office12" para Microsoft Publisher 2007 y "Office14" para Microsoft Publisher 2010.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Esta vulnerabilidad requiere que un usuario abra un archivo de Publisher especialmente diseñado con Microsoft Publisher.
...
Vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)  
---------------------------------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código debida a la forma en que Microsoft Publisher abre los archivos de Publisher. Un atacante podría aprovechar la vulnerabilidad si crea un archivo de Publisher especialmente diseñado que se podría incluir como datos adjuntos de correo electrónico u hospedarse en un sitio web especialmente diseñado o vulnerable, y convencer al usuario para que abra el archivo de Publisher especialmente diseñado. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2571](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 64 bits de Windows** **Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:**
    ...
    `takeown /f "<RUTA_DE_ACCESO_64_BITS_Y_NOMBRE_DE_ARCHIVO>"icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone (F)`
    ...
    **Nota** Use la versión del software de Microsoft Office correspondiente a su sistema, como "Office10" para Microsoft Publisher 2002 y "Office11" para Microsoft Publisher 2003.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a la forma en que Microsoft Publisher analiza los archivos con formato de Publisher 97.
...
**¿Cómo funciona esta actualización?**    
Esta actualización corrige la vulnerabilidad al modificar la manera en que Microsoft Publisher convierte los archivos con formato de Publisher 97.
...
Vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)  
-----------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código debida a la forma en que Microsoft Publisher abre los archivos de Publisher. Un atacante podría aprovechar la vulnerabilidad si crea un archivo de Publisher especialmente diseñado que se podría incluir como datos adjuntos de correo electrónico u hospedarse en un sitio web especialmente diseñado o vulnerable, y convencer al usuario para que abra el archivo de Publisher especialmente diseñado. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)
...
Vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)  
-----------------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código debida a la forma en que Microsoft Publisher abre los archivos de Publisher. Un atacante podría aprovechar la vulnerabilidad si crea un archivo de Publisher especialmente diseñado que se podría incluir como datos adjuntos de correo electrónico u hospedarse en un sitio web especialmente diseñado o vulnerable, y convencer al usuario para que abra el archivo de Publisher especialmente diseñado. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3955](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 32 bits de Windows XP y Windows Server 2003:**
    ...
    `cacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /E /P everyone:N`
    ...
    **Para ediciones de 32 bits de Windows** **Vista, Windows Server 2008 y Windows 7:**
    ...
    `takeown /f "c:\archivos de programa\Microsoft Office\office10\pubconv.dll"icacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /deny everyone(F)`
  
    **Para ediciones de 64 bits de Windows** **Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:**
  
    `takeown /f "<RUTA_DE_ACCESO_64_BITS_Y_NOMBRE_DE_ARCHIVO>"icacls "%ProgramFiles(86)%\Microsoft Office\office10\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\office10\pubconv.dll" /deny everyone (F)`
    ...
    **Cómo deshacer la solución provisional:**
    ...
    `cacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /E /R everyone`
  
    Para ediciones de 64 bits de Windows XP y Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\office10\pubconv.dll" /E /R everyone`
  
    Para ediciones de 32 bits de Windows Vista, Windows Server 2008 y Windows 7, ejecute el siguiente comando en el símbolo del sistema con privilegios elevados:
  
    `icacls "c:\archivos de programa\Microsoft Office\office10\" /restore %TEMP%\PUBCONV_ACL.TXT`
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2284692">artículo 2284692 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2284695">artículo 2284695 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2284697">artículo 2284697 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Publisher 2010 (todas las ediciones)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2409055">artículo 2409055 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Chaouki Bekrar, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en el montón de valor de tamaño en pubconv.dll (CVE-2010-2569)  
-   Chaouki Bekrar, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de saturación de montón en pubconv.dll (CVE-2010-2570)  
-   Chaouki Bekrar, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria debido a un índice incorrecto en la matriz en Pubconv.dll (CVE-2010-2571)  
-   Chaouki Bekrar, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con Microsoft Publisher (CVE-2010-3954)  
-   Chaouki Bekrar, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2010-3955)
