---
TOCTitle: 'MS10-045'
Title: 'Boletín de seguridad de Microsoft MS10-045 - Importante'
ms:assetid: 'ms10-045'
ms:contentKeyID: 61225819
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-045(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-045 - Importante
=======================================================
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Microsoft Office Outlook 2002, Microsoft Office Outlook 2003 y Microsoft Office Outlook 2007. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización corrige la vulnerabilidad al modificar la manera en que Microsoft Office Outlook comprueba los datos adjuntos de un mensaje de correo electrónico especialmente diseñado. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.

**Recomendación.** Microsoft recomienda que los clientes instalen la actualización lo antes posible.

**Problemas conocidos.** En el [artículo 978212 de Microsoft Knowledge Base](http://support.microsoft.com/kb/978212) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4e2e7c49-6665-4135-adbb-8e831a91d0fe">Microsoft Office Outlook 2007 Service Pack 1 y Microsoft Office Outlook 2007 Service Pack 2</a><br />
(KB980376)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-060">MS09-060</a></td>
...
|------------------------------------------------------|  
| Microsoft Office Outlook 2010 (ediciones de 32 bits) |  
| Microsoft Office Outlook 2010 (ediciones de 64 bits) |
...
Sí. Además de los cambios enumerados en la sección Información sobre la vulnerabilidad de este boletín, esta actualización incluye un cambio para bloquear los datos adjuntos de correo electrónico mediante el valor ATTACH\_BY\_REFERENCE de la propiedad PR\_ATTACH\_METHOD. Para obtener detalles, vea el [artículo 2271150 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2271150).
  
**¿Están Outlook Express, Windows Mail o Windows Live Mail afectados por la vulnerabilidad descrita en este boletín?**    
No, Outlook Express, Windows Mail y Windows Live Mail no están afectados por la vulnerabilidad descrita en este boletín. Estas herramientas de comunicación en línea para usarlas con Windows no están relacionadas con Microsoft Office Outlook.
...
<th>Vulnerabilidad de datos adjuntos de SMB en Microsoft Outlook (CVE-2010-0266)</th>  
<th>Clasificación de gravedad acumulada</th>  
</tr>  
</thead>  
<tbody>  
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Outlook 2007 Service Pack 1 y Microsoft Office Outlook 2007 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>  
...
Vulnerabilidad de datos adjuntos de SMB en Microsoft Outlook (CVE-2010-0266)  
----------------------------------------------------------------------------
  
<span></span>  
Existe una vulnerabilidad de ejecución remota de código en la manera en que Microsoft Office Outlook comprueba los datos adjuntos de un mensaje de correo electrónico especialmente diseñado. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266).
  
#### Factores atenuantes para la vulnerabilidad de datos adjuntos de SMB en Microsoft Outlook (CVE-2010-0266)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de datos adjuntos de SMB en Microsoft Outlook (CVE-2010-0266)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que Microsoft Office Outlook no comprueba correctamente los datos adjuntos mediante el valor ATTACH\_BY\_REFERENCE de la propiedad PR\_ATTACH\_METHOD en un mensaje de correo electrónico especialmente diseñado.
...
Para aprovechar esta vulnerabilidad es necesario que un usuario abra los datos adjuntos de un mensaje de correo electrónico especialmente diseñado con una versión afectada de Microsoft Office Outlook.
  
En el supuesto de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía al usuario un mensaje de correo electrónico especialmente diseñado con datos adjuntos y lo convence de que lo abra. Cuando el usuario intenta abrir los datos adjuntos, se podría ejecutar un archivo ejecutable malintencionado especificado por el atacante.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los sistemas como las estaciones de trabajo o los servidores de Terminal Server donde se usa Microsoft Outlook están más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/980371">artículo 980371 de Microsoft Knowledge Base</a>.</td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/980373">artículo 980373 de Microsoft Knowledge Base</a>.</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/980376">artículo 980376 de Microsoft Knowledge Base</a>.</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Yorick Koster, en colaboración con el programa [SSD/SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), por informar de la vulnerabilidad de datos adjuntos de SMB en Microsoft Outlook (CVE-2010-0266)
...
-   V1.1 (14 de julio de 2010): Se ha agregado un vínculo al artículo 978212 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
