---
TOCTitle: 'MS10-064'
Title: 'Boletín de seguridad de Microsoft MS10-064 - Crítica'
ms:assetid: 'ms10-064'
ms:contentKeyID: 61225838
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-064(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-064 - Crítica
====================================================

Una vulnerabilidad en Microsoft Outlook podría permitir la ejecución remota de código (2315011)
-----------------------------------------------------------------------------------------------

Publicado: martes, 14 de septiembre de 2010 | Actualizado: miércoles, 22 de septiembre de 2010
...
|-----------------------------------------------|  
| Microsoft Outlook 2010 (ediciones de 32 bits) |  
| Microsoft Outlook 2010 (ediciones de 64 bits) |
...
**¿Están Outlook Express, Windows Mail o Windows Live Mail afectados por la vulnerabilidad descrita en este boletín?**     
No, Outlook Express, Windows Mail y Windows Live Mail no están afectados por la vulnerabilidad descrita en este boletín. Estas herramientas de comunicación en línea para usarlas con Windows no están relacionadas con Microsoft Outlook.
  
**¿Por qué esta actualización de seguridad se considera crítica para Outlook 2002 pero importante para Outlook 2003 y Outlook 2007?**     
Esta vulnerabilidad afecta a Microsoft Outlook cuando está conectado a un servidor de Exchange con el modo en línea; no obstante, de forma predeterminada, Microsoft Outlook 2003 y Microsoft Outlook 2007 se conectan a un servidor de Exchange con el modo caché de Exchange. Este factor atenuante reduce la vulnerabilidad de crítica a importante para Outlook 2003 y Outlook 2007 porque estas versiones no están afectadas en una configuración predeterminada. El modo caché de Exchange no está disponible en Microsoft Outlook 2002.
  
**Me conecto a múltiples servidores de correo. ¿La vulnerabilidad afecta a mi configuración de Outlook?**     
La vulnerabilidad sólo afecta a las configuraciones que se conectan a un servidor de Exchange con el modo en línea. Las configuraciones en las que Outlook usa servidores de correo POP o IMAP únicamente no están afectadas por la vulnerabilidad. En la tabla siguiente se resumen estas configuraciones afectadas.
  
**Configuraciones afectadas **
  
|                                       | Modo en línea de Exchange | Modo caché de Exchange | POP              | IMAP             |  
|---------------------------------------|---------------------------|------------------------|------------------|------------------|  
| Microsoft Outlook 2002 Service Pack 3 | Afectado                  | No aplicable           | No está afectada | No está afectada |  
| Microsoft Outlook 2003 Service Pack 3 | Afectado                  | No está afectada       | No está afectada | No está afectada |  
| Microsoft Outlook 2007 Service Pack 2 | Afectado                  | No está afectada       | No está afectada | No está afectada |
  
**Ejecuto Outlook es una configuración que no está afectada. ¿Se me ofrecerá la actualización?**     
Sí. Independientemente de la configuración, si ejecuta una versión afectada de Microsoft Outlook, se ofrecerá la actualización.
  
**¿Cómo afecta esta vulnerabilidad a los programas independientes de Microsoft Office?**     
Los programas independientes de Microsoft Office están afectados con la misma clasificación de gravedad que el componente correspondiente en un conjunto de programas de Microsoft Office. Por ejemplo, una instalación independiente de Microsoft Outlook está afectada con la misma clasificación de gravedad que una instalación de Microsoft Outlook suministrada con un conjunto de programas de Microsoft Office.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)  
--------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la manera en que Microsoft Outlook analiza el contenido de un mensaje de correo electrónico especialmente diseñado. Esta vulnerabilidad sólo existe en las configuraciones en las que Outlook se conecta a un servidor de Exchange en el modo en línea. Las configuraciones en las que Outlook se conecta a un servidor de Exchange en el modo caché de Exchange no están afectadas. Además, las configuraciones en las que Outlook usa servidores de correo POP o IMAP únicamente no están afectadas por la vulnerabilidad. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2728](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2728) .
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.  
-   De forma predeterminada, Microsoft Outlook 2003 y Microsoft Outlook 2007 se conectan a un servidor de Exchange con el modo caché de Exchange. Outlook no está afectado por la vulnerabilidad cuando recupera datos de un servidor de Exchange con el modo caché de Exchange. El modo caché de Exchange no está disponible en Microsoft Outlook 2002.  
-   Un cliente de Microsoft Outlook no está afectado por la vulnerabilidad cuando no se conecta a un servidor de Exchange, por ejemplo, cuando se conecta a un servidor POP o IMAP únicamente.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)
...
-   **Leer los correos electrónicos en texto sin formato**
    ...
    Los usuarios de Microsoft Outlook 2002 que han aplicado Microsoft Office XP Service Pack 1 o una versión posterior, pueden habilitar una característica para ver en texto sin formato sólo los mensajes de correo electrónico que no estén firmados digitalmente o que no estén cifrados.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)
  
**¿Cuál es el alcance de esta vulnerabilidad?**     
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**     
Microsoft Outlook no analiza correctamente un mensaje de correo electrónico especialmente diseñado.
...
Para aprovechar esta vulnerabilidad es necesario que un usuario abra u obtenga una vista preliminar de un mensaje de correo electrónico especialmente diseñado con una versión afectada de Microsoft Outlook que esté conectada a un servidor de Exchange en el modo en línea.
...
Los sistemas como las estaciones de trabajo y los servidores de Terminal Server donde se usa Microsoft Outlook para conectarse a un servidor de Exchange en el modo en línea están más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**     
La actualización corrige la vulnerabilidad al modificar la manera en que Microsoft Outlook analiza el contenido de un mensaje de correo electrónico especialmente diseñado.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2293422">artículo 2293422 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2293428">artículo 2293428 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2288953">artículo 2288953 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Dyon Balding, de [Secunia](http://secunia.com/) , por informar de la vulnerabilidad de desbordamiento del búfer basado en montón en Outlook (CVE-2010-2728)
...
-   V1.1 (22 de septiembre de 2010): RElimina referencias erróneas al entorno de trabajo de Outlook Express 6 basado en un desbordamiento del búfer por una vulnerabilidad de Outlook - CVE-2010-2728.
