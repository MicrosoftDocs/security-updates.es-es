---
TOCTitle: 'MS10-091'
Title: 'Boletín de seguridad de Microsoft MS10-091 - Crítica'
ms:assetid: 'ms10-091'
ms:contentKeyID: 61225965
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-091(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-091 - Crítica
====================================================
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que el controlador de fuentes OpenType (OTF) indiza las matrices al analizar estas fuentes, restablece los punteros al liberar memoria y analiza la tabla CMAP al representar las fuentes OpenType. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65)                                                                                    | Elevación de privilegios        | Importante                          | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                           | Elevación de privilegios        | Importante                          | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4)                                                                           | Elevación de privilegios        | Importante                          | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f)                                                               | Elevación de privilegios        | Importante                          | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                        | Elevación de privilegios        | Importante                          | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f)                                                  | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30)                          | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e)\* | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00)\*               | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b) | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5)                                                                           | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92)                                                                                  | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01)\*                                                                   | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                             | Ejecución remota de código      | Crítica                             | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
...
<th style="border:1px solid black;" >Vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)</th>
<th style="border:1px solid black;" >Vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)</th>
<th style="border:1px solid black;" >Vulnerabilidad de la tabla CMAP de OpenType (CVE-2010-3959)</th>
...
Vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)  
----------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el controlador de fuentes OpenType (OTF) analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3956](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956).
  
#### Factores atenuantes para la vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)
...
#### Soluciones provisionales para la vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)
...
-   **Deshabilitar el panel de vista previa y el panel de detalles en el Explorador de Windows**
    ...
    Al deshabilitar el panel de vista previa y el panel de detalles en el Explorador de Windows se impide que las fuentes OpenType se muestren en el Explorador de Windows. Aunque esto impide que se muestren archivos malintencionados en el Explorador de Windows, no impide que un usuario local no autenticado ejecute un programa especialmente diseñado para aprovechar esta vulnerabilidad. Para deshabilitar estos paneles en Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2, realice los pasos siguientes:
    ...
    **Cómo deshacer la solución provisional.**
    ...
    Para volver a habilitar los paneles de vista previa y de detalles del Explorador de Windows en Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
  
    1.  Abra el Explorador de Windows, haga clic en **Organizar** y, a continuación, en **Diseño**.  
    2.  Active las opciones de menú **Panel de detalles** y **Panel de vista previa**.  
    3.  Cierre todas las instancias abiertas del Explorador de Windows para que el cambio surta efecto.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)
...
La vulnerabilidad se debe a que el controlador de fuentes OpenType (OTF) no indiza correctamente un matriz al analizar dichas fuentes.
  
**¿Que es el formato de fuentes OpenType?**    
...
En los sistemas Windows XP y Windows Server 2003, para aprovechar esta vulnerabilidad, en primer lugar, el intruso debe iniciar sesión en el sistema. A continuación, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo de un sistema afectado.
  
**¿Los exploradores web de terceros están afectados por esta vulnerabilidad?**    
Sí. Los exploradores web de terceros están afectados por esta vulnerabilidad si representan las fuentes OpenType de forma nativa. Para estas aplicaciones, esta vulnerabilidad puede permitir la ejecución remota de código en el contexto del usuario que ha iniciado la sesión si se usa para visitar un sitio web con una fuente OpenType insertada especialmente diseñada. De forma predeterminada, Internet Explorer no está afectado por este problema.
...
No. En estos sistemas no se obtiene una vista previa automáticamente de las fuentes OpenType en el Explorador de Windows. Para aprovechar esta vulnerabilidad en estos sistemas, el atacante primero tendría que iniciar sesión en el sistema local. A continuación, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo de un sistema afectado.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador de fuentes OpenType (OTF) indiza una matriz al analizar dichas fuentes.
...
Vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)  
----------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el controlador de fuentes OpenType (OTF) analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3957](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957).
  
#### Factores atenuantes para la vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.
  
#### Soluciones provisionales para la vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que el controlador de fuentes OpenType (OTF) no restablece correctamente un puntero al liberar memoria. Esto tiene como resultado una condición de "doble liberación".
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador de fuentes OpenType (OTF) restablece los punteros al liberar memoria.
...
Vulnerabilidad de la tabla CMAP de OpenType (CVE-2010-3959)  
-----------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el controlador de fuentes OpenType (OTF) analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3959](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959).
  
#### Factores atenuantes para la vulnerabilidad de la tabla CMAP de OpenType (CVE-2010-3959)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.
  
#### Soluciones provisionales para la vulnerabilidad de la tabla CMAP de OpenType (CVE-2010-3959)
...
**¿Los exploradores web de terceros están afectados por esta vulnerabilidad?**    
Sí. Los exploradores web de terceros están afectados por esta vulnerabilidad si representan las fuentes OpenType de forma nativa. Para estas aplicaciones, esta vulnerabilidad podría permitir una denegación de servicio remota si un usuario explora un sitio web con una fuente OpenType insertada especialmente diseñada. De forma predeterminada, Internet Explorer no está afectado por este problema.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador de fuentes OpenType (OTF) analiza la tabla CMAP al representar dichas fuentes.
  
**¿Qué es una tabla CMAP?**    
Esta tabla define la asignación de los códigos de carácter a los valores de índice de glifo usados en la fuente. Puede contener varias tablas secundarias para admitir varios esquemas de codificación de caracteres. El encabezado de la tabla indica las codificaciones de caracteres para los que hay tablas secundarias. Cada tabla secundaria es uno de los siete formatos posibles y empieza por un código de formato que indica el formato usado. Para obtener más información, vea el artículo titulado [Tabla de asignación de índice de carácter a glifo](http://www.microsoft.com/typography/otspec/cmap.htm).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2296199$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2296199">artículo 2296199 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Marc Schoenefeld, del [equipo de respuesta de seguridad de Red Hat](https://www.redhat.com/security/team/) en colaboración con [Opera Security Team](http://www.opera.com/security/), por informar de la vulnerabilidad de indización de fuentes OpenType (CVE-2010-3956)  
-   Marc Schoenefeld, del [equipo de respuesta de seguridad de Red Hat](https://www.redhat.com/security/team/), por informar de la vulnerabilidad de doble liberación de fuentes OpenType (CVE-2010-3957)  
-   Paul-Kenji Cahier Furuya, por informar de la vulnerabilidad de la tabla CMAP de OpenType (CVE-2010-3959)
