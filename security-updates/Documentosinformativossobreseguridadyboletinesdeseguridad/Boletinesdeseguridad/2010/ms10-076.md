---
TOCTitle: 'MS10-076'
Title: 'Boletín de seguridad de Microsoft MS10-076 - Crítica'
ms:assetid: 'ms10-076'
ms:contentKeyID: 61225950
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-076(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-076 - Crítica
====================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el motor de fuentes OpenType insertadas analiza los archivos y el contenido que incluyen fuentes insertadas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c3799399-ca72-4dec-a2a2-3571ad0b2f63)                                                                                      | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=860ff738-205d-430e-b223-b333813fc590)                                                             | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b240b65-f3ca-465c-a606-b561999c1977)                                                                             | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70c9e826-b80b-4a20-82d2-8e52e5cca839)                                                                 | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bd5878bb-f565-4303-afed-4e17b44a02f2)                                                          | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29c4afb1-227d-4572-b136-a78ef7e1df77)                                                    | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=880ad9a0-6ddd-41f4-a608-171d59a31b6a)                            | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50386655-982e-4126-8261-2c972d695bbd)\*\* | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6b2ae1d-9225-4495-8560-97860f87d7b4)\*\*               | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a4e38a77-3835-47b3-bd86-6c039169abf5)   | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=f6cae091-e9f1-48e9-a035-4346b9c6fec6)                                                                             | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=35882477-4e0a-4783-a4b4-0f1ea3398360)                                                                                    | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=b060c516-233a-4e1e-9237-698420e97b2f)\*\*                                                                   | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0ead2ed9-8b2f-496e-b7d1-3ad2b04be5cc)                                                               | Ejecución remota de código      | Crítica                             | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)</th>
...
Vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)  
----------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que la tecnología de fuentes OpenType insertadas (EOT) de Microsoft Windows analiza determinadas tablas en fuentes insertadas especialmente diseñadas. Si un usuario inicia sesión con derechos de usuario administrativos, un intruso que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1883](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1883).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)
...
-   **Deshabilitar la compatibilidad para analizar fuentes incrustadas en Internet Explorer**
    ...
    **Con el método interactivo:**
    ...
    2.  En **Opciones de Internet**, haga clic en la ficha **Seguridad**, seleccione la zona **Internet** y, a continuación, en **Nivel personalizado…**  
    3.  En **Configuración de seguridad - Zona Internet**, desplácese a **Descargas** en el panel **Configuración** y seleccione **Pedir datos** o **Deshabilitar** para la configuración de **Descarga de fuentes**.  
    4.  Haga clic en **Aceptar** para guardar la selección; a continuación, haga clic en **Aceptar** de nuevo para volver a Internet Explorer.
  
    **Con la directiva de grupo:**
  
    **Nota** El complemento de MMC Directiva de grupo se puede usar para establecer la directiva de un sistema, una unidad organizativa o un dominio completo. Para obtener más información acerca de directivas de grupo, consulte los siguientes sitios web de Microsoft:
    ...
    -   [¿Qué](http://technet2.microsoft.com/windowsserver/en/library/47ba1311-6cca-414f-98c9-2d7f99fca8a31033.mspx?mfr=true) es el editor de objetos de directiva de grupo?  
    ...
    Para usar Directiva de grupo, realice los pasos siguientes:
  
    1.  Abra la consola de administración de la directiva de grupo y configúrela para trabajar con el objeto de directiva de grupo adecuado (como, por ejemplo, equipo local, unidad organizativa o GPO de dominio).  
    2.  Haga clic en **Configuración de usuario**, **Configuración de Windows**, **Mantenimiento de Internet Explorer** y **Seguridad**.  
    3.  Haga doble clic en **Zonas de seguridad y clasificación de contenido**, seleccione **Importar la configuración actual de las zonas de seguridad y privacidad** y, a continuación, haga clic en **Modificar configuración**.
  
    **Nota** De este modo se crea una directiva de grupo para Internet Explorer según la configuración del usuario que ha iniciado la sesión actualmente y se abre Propiedades de Internet.
  
    1.  En Propiedades de Internet, haga clic en la ficha **Seguridad**, asegúrese de que está seleccionada la zona **Internet** y, a continuación, haga clic en **Nivel personalizado…**  
    2.  En **Configuración de seguridad - Zona Internet**, desplácese a **Descargas** en el panel **Configuración** y seleccione **Pedir datos** o **Deshabilitar** para la configuración de **Descarga de fuentes**.  
    3.  Haga clic en **Aceptar** para volver a **Propiedades de Internet**.  
    4.  Repita los pasos 4 a 6 para la zona **Intranet local**.  
    5.  Haga clic en **Aceptar** tres veces para volver a la consola de administración de la directiva de grupo.  
    6.  Actualice la directiva de grupo en todos los sistemas o espere al próximo intervalo de actualización programada de directiva de grupo para que la nueva configuración surta efecto.
  
    **Con una secuencia de comandos administrada:**
  
    Esta configuración de seguridad se puede especificar manualmente en el Registro mediante la creación de una secuencia de comandos del Registro y la importación mediante doble clic en ella o ejecutando regedit.exe como parte de una secuencia de comandos de inicio de sesión o de inicio de equipo. Para las implementaciones administradas, se puede usar regedit.exe para importar la secuencia de comandos de forma silenciosa con el parámetro "-s". Para obtener más información acerca de los parámetros de la línea de comandos, vea el artículo 82821 de Microsoft Knowledge Base: Parámetros de la línea de comandos del editor de información de registro (REGEDIT).
    ...
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no le garantiza que pueda resolver los problemas provocados por el uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
    ...
    ; dword:00000001 establece la directiva para pedir datos[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\1]"1604"=dword:00000001
    ; Zona 3 es la zona Internet[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3]"1604"=dword:00000001
    ```
    ...
    "1604"=dword:00000003; Zona 3 es la zona Internet[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Zones\3]"1604"=dword:00000003
    ```
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a un desbordamiento de enteros cuando un componente de Microsoft Windows, Motor de fuentes OpenType insertadas, analiza determinadas tablas en archivos y contenido especialmente diseñados que incluyen fuentes insertadas.
...
Esta vulnerabilidad requiere que un usuario visualice contenido que tenga insertada una fuente EOT especialmente diseñada.
  
En un ataque por correo electrónico, el atacante puede aprovechar la vulnerabilidad si envía un mensaje de correo electrónico con un archivo adjunto de Microsoft Word o PowerPoint que contenga una fuente EOT especialmente diseñada y lo convence de que vea u obtenga una vista previa del archivo.
...
La actualización corrige la vulnerabilidad al modificar la manera en que el motor de fuentes OpenType insertadas analiza los archivos y el contenido que incluyen fuentes insertadas.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB982132$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/982132">artículo 982132 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Sebastian Apelt, en colaboración con [Tipping Point](http://www.tippingpoint.com) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)  
-   Ivan Fratric, a través de [iSIGHT Partners Global Vulnerability Partnership](https://gvp.isightpartners.com), por informar de la vulnerabilidad de desbordamiento de enteros en las fuentes OpenType insertadas (CVE-2010-1883)
