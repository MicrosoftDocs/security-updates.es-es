---
TOCTitle: 'MS10-098'
Title: 'Boletín de seguridad de Microsoft MS10-098 - Importante'
ms:assetid: 'ms10-098'
ms:contentKeyID: 61225972
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-098(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-098 - Importante
=======================================================
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que los controladores de modo kernel asignan memoria, liberan objetos que ya no están en uso, administran los objetos de controlador en modo kernel y validan los datos pasados del modo usuario. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=bb9d1657-5beb-4372-b74c-a612a6fff5a8)                                                                                    | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1f277ae4-4f85-4c8a-bfc5-dcdc8afed133)                                                           | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa39f59-2177-459f-9b8a-9543330d48ec)                                                                           | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bca61d61-d5cf-49a4-ab99-b61e50e8f619)                                                               | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4fce129d-2b4e-4a66-af27-bbbde1e65ba1)                                                        | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b824d3b9-2ce1-4abc-ae06-68aef1250be9)                                                  | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f4c42cfe-b7f2-4436-919e-4bd305a3439a)                          | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e2f572a-4169-47f2-a872-5466997122ed)\* | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09a4b646-989d-43ef-a3e8-64af8b380a14)\*               | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46522323-837e-4a74-9cf0-45f69343e776) | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=aa7de2e4-ba48-4d58-b034-05349f0eb920)                                                                           | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=b21db627-91c2-4ebf-b7c0-38ac58ae5b6c)                                                                                  | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=d417ebce-7841-4bbb-8abc-b15ef5f4b733)\*                                                                   | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7eeac1bb-9f86-4ea5-b30f-980d52be5044)                                                             | Elevación de privilegios        | Importante                          | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer en Win32k (CVE-2010-3939)</th>
<th style="border:1px solid black;" >Vulnerabilidad de doble liberación de punteros PFE en Win32k (CVE-2010-3940)</th>
<th style="border:1px solid black;" >Vulnerabilidad de doble liberación en Win32k (CVE-2010-3941)</th>
<th style="border:1px solid black;" >Vulnerabilidad de WriteAV en Win32k (CVE-2010-3942)</th>
<th style="border:1px solid black;" >Vulnerabilidad de vinculación de cursor en Win32k (CVE-2010-3943)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2010-3944)</th>
...
Vulnerabilidad de desbordamiento del búfer en Win32k (CVE-2010-3939)  
--------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows asignan incorrectamente la memoria al copiar datos desde el modo usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3939](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en Win32k (CVE-2010-3939)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en Win32k (CVE-2010-3939)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en Win32k (CVE-2010-3939)
...
La vulnerabilidad se debe a que los controladores en modo kernel de Windows no asignan correctamente la memoria al copiar datos desde el modo usuario.
...
La actualización corrige la vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows asignan la memoria.
  
**En el momento de publicar este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3939](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba usando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes.
  
Vulnerabilidad de doble liberación de punteros PFE en Win32k (CVE-2010-3940)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows liberan los objetos que ya no están en uso. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3940](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3940).
  
#### Factores atenuantes para la vulnerabilidad de doble liberación de punteros PFE en Win32k (CVE-2010-3940)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de doble liberación de punteros PFE en Win32k (CVE-2010-3940)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de doble liberación de punteros PFE en Win32k (CVE-2010-3940)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a una condición de "doble liberación" en la que interviene un puntero a un objeto de controlador en modo kernel.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar la forma en que los controladores en modo kernel de Windows liberan los objetos que ya no están en uso.
...
Vulnerabilidad de doble liberación en Win32k (CVE-2010-3941)  
------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows liberan los objetos que ya no están en uso. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3941](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3941).
  
#### Factores atenuantes para la vulnerabilidad de doble liberación en Win32k (CVE-2010-3941)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.  
-   Un sistema afectado debe poder ejecutar programas de 16 bits para que un atacante pueda aprovechar esta vulnerabilidad. La vulnerabilidad no se puede aprovechar en servidores de 64 bits porque no pueden ejecutar programas de 16 bits.
  
#### Soluciones provisionales para la vulnerabilidad de doble liberación en Win32k (CVE-2010-3941)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Deshabilitar el subsistema NTVDM mediante la edición de la directiva de grupo**
  
    Los usuarios que no requieran el modo DOS virtual de NT (NTVDM), pueden impedir que se aproveche esta vulnerabilidad si deshabilitan el subsistema NTVDM.
  
    Para deshabilitar el subsistema NTVDM en sistemas Windows XP:
  
    1.  Después de haber iniciado sesión con privilegios de administrador, haga clic en **Inicio**, haga clic en **Ejecutar**, escriba **gpedit.msc** y, a continuación, haga clic en **Aceptar**.  
    2.  En el panel del editor de Directiva de grupo, haga doble clic en **Plantillas administrativas**, haga doble clic en **Componentes de Windows** y, a continuación, haga clic en **Compatibilidad de aplicaciones**.  
    3.  En el panel Compatibilidad de aplicaciones, haga doble clic en **Impedir el acceso a aplicaciones de 16 bits**, cambie la selección en la pestaña Configuración a **Habilitado**, haga clic en **Aceptar** y, a continuación, salga del editor de Directiva de grupo.
  
    Para los sistemas Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2, esta configuración se puede implementar mediante la directiva de grupo con la misma plantilla que se emplea para los sistemas Windows XP.
  
    Para los sistemas Windows NT 4.0, vea el artículo de Microsoft Knowledge Base [Deshabilitar los subsistemas MSDOS y WOWEXEC en Terminal Server](http://support.microsoft.com/kb/220159).
  
    **Consecuencias de la solución provisional.**  Se deshabilitará el acceso a las aplicaciones de 16 bits.
  
    **Cómo deshacer la solución provisional.**
  
    Para volver a habilitar el subsistema NTVDM en sistemas Windows XP:
  
    1.  Después de haber iniciado sesión con privilegios de administrador, haga clic en **Inicio**, haga clic en **Ejecutar**, escriba **gpedit.msc** y, a continuación, haga clic en **Aceptar**.  
    2.  En el panel del editor de Directiva de grupo, haga doble clic en **Plantillas administrativas**, haga doble clic en **Componentes de Windows** y, a continuación, haga clic en **Compatibilidad de aplicaciones**.  
    3.  En el panel Compatibilidad de aplicaciones, haga doble clic en **Impedir el acceso a aplicaciones de 16 bits**, cambie la selección en la pestaña Configuración a **No configurado**, haga clic en **Aceptar** y, a continuación, salga del editor de Directiva de grupo.
  
    Para los sistemas Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2, esta configuración se puede implementar mediante la directiva de grupo con la misma plantilla que se emplea para los sistemas Windows XP.
  
    Para los sistemas Windows NT 4.0, vea el artículo de Microsoft Knowledge Base [Deshabilitar los subsistemas MSDOS y WOWEXEC en Terminal Server](http://support.microsoft.com/kb/220159).
  
-   **Deshabilitar el subsistema NTVDM mediante la edición del Registro del sistema**
    ...
    **Nota** Es conveniente realizar una copia de seguridad del Registro antes de modificarlo.
    ...
    Para deshabilitar el subsistema NTVDM mediante la edición del Registro del sistema, realice los siguientes pasos:
  
    1.  Haga clic en **Inicio**, en **Ejecutar**, escriba **regedit** y, a continuación, haga clic en **Aceptar**.  
    2.  Busque la siguiente clave en el Registro del sistema:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  Agregue una entrada DWORD denominada **DisallowedPolicyDefault** y establezca su valor en **1** (de este modo se deshabilita NTVDM).  
    ...
    **Cómo deshacer la solución provisional.**
    ...
    Para volver a habilitar el subsistema NTVDM mediante la edición del Registro del sistema, siga estos pasos:
  
    1.  Haga clic en **Inicio**, en **Ejecutar**, escriba **regedit** y, a continuación, haga clic en **Aceptar**.  
    2.  Busque la siguiente clave en el Registro del sistema:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  Cambie el valor de **DisallowedPolicyDefault** a **0** (de este modo se vuelve a habilitar NTVDM).  
    4.  Cierre el Editor del Registro.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de doble liberación en Win32k (CVE-2010-3941)
...
Vulnerabilidad de WriteAV en Win32k (CVE-2010-3942)  
---------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows asignan incorrectamente la memoria al copiar datos desde el modo usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3942).
  
#### Factores atenuantes para la vulnerabilidad de WriteAV en Win32k (CVE-2010-3942)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de WriteAV en Win32k (CVE-2010-3942)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de WriteAV en Win32k (CVE-2010-3942)
...
Vulnerabilidad de vinculación de cursor en Win32k (CVE-2010-3943)  
-----------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3943](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3943).
  
#### Factores atenuantes para la vulnerabilidad de vinculación de cursor en Win32k (CVE-2010-3943)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de vinculación de cursor en Win32k (CVE-2010-3943)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de vinculación de cursor en Win32k (CVE-2010-3943)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a un error de lógica que se produce al vincular los objetos de controlador en modo kernel, lo que produce una lista vinculada dañada.
...
Vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2010-3944)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan incorrectamente los datos pasados desde el modo usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3944](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3944).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2010-3944)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2010-3944)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2010-3944)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que los controladores en modo kernel de Windows no validan correctamente los datos pasados desde el modo usuario.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2436673$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2436673">artículo 2436673 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb2436673">artículo 2436673 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
-   Tarjei Mandt, de [Norman](http://www.norman.com), por informar de la vulnerabilidad de doble liberación en el kernel de Windows (CVE-2010-3941)  
-   Tarjei Mandt, de [Norman](http://www.norman.com), por informar de la vulnerabilidad de WriteAV en el kernel de Windows (CVE-2010-3942)  
-   Tarjei Mandt, de [Norman](http://www.norman.com), por informar de la vulnerabilidad de vinculación de cursor en el kernel de Windows (CVE-2010-3943)  
-   Tarjei Mandt, de [Norman](http://www.norman.com), por informar de la vulnerabilidad de daños en la memoria relacionada con el kernel de Windows (CVE-2010-3944)  
-   Stéfan Le Berre, de [Sysdream](http://www.sysdream.com), por informar de la vulnerabilidad de daños en la memoria relacionada con el kernel de Windows (CVE-2010-3944)
