---
TOCTitle: 'MS10-078'
Title: 'Boletín de seguridad de Microsoft MS10-078 - Importante'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61225952
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-078(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-078 - Importante
=======================================================
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que el controlador de formato de fuentes OpenType (OTF) asigna la memoria y realiza cálculos de enteros al procesar las fuentes OpenType. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc)                             | Elevación de privilegios        | Importante                          | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b)    | Elevación de privilegios        | Importante                          | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d)                    | Elevación de privilegios        | Importante                          | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963)        | Elevación de privilegios        | Importante                          | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa) | Elevación de privilegios        | Importante                          | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
...
<th style="border:1px solid black;" >Vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)</th>
...
Vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)  
--------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en la forma en que el controlador del formato de fuentes OpenType (OTF) de Windows analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2740](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740).
  
#### Factores atenuantes para la vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)
...
#### Soluciones provisionales para la vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)
...
La vulnerabilidad se debe a que el controlador de formato de fuentes OpenType (OTF) no asigna correctamente la memoria al analizar una fuente especialmente diseñada.
  
**¿Que es el formato de fuentes OpenType?**    
OpenType es un formato de fuente desarrollado conjuntamente por Microsoft y Adobe como una extensión del formato de fuente TrueType de Apple. Un archivo de fuente OpenType contiene datos, en formato de tabla, que incluyen una fuente TrueType o una fuente de contorno PostScript. Los rasterizadores usan combinaciones de datos de las tablas que se incluyen en la fuente para representar los contornos de glifo TrueType o PostScript. Parte de estos datos de compatibilidad se utilizan independientemente del formato de contorno que se use; algunos de estos datos de compatibilidad son específicos de TrueType o PostScript. Para obtener más información, vea [Preguntas más frecuentes acerca de la tipografía OpenType de Microsoft](http://www.microsoft.com/typography/opentypefaq.mspx).
...
Sí. Los exploradores web de terceros están afectados por esta vulnerabilidad si representan las fuentes OpenType (OTF) de forma nativa. Para estas aplicaciones, esta vulnerabilidad puede permitir la ejecución remota de código en el contexto del usuario que ha iniciado la sesión si se utiliza para visitar un sitio web con una fuente insertada especialmente diseñada. De forma predeterminada, Internet Explorer no está afectado por este problema.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador de formato de fuentes OpenType (OTF) asigna la memoria al analizar una fuente.
...
Vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)  
----------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en la forma en que el controlador del formato de fuentes OpenType (OTF) de Windows analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2741](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741).
  
#### Factores atenuantes para la vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que el controlador de formato de fuentes OpenType (OTF) no realiza correctamente un cálculo de enteros al procesar fuentes OpenType especialmente diseñadas.
...
**¿Los exploradores web de terceros están afectados por esta vulnerabilidad?**  
Sí. Los exploradores web de terceros están afectados por esta vulnerabilidad si representan las fuentes OpenType (OTF) de forma nativa. Para estas aplicaciones, esta vulnerabilidad puede permitir la ejecución remota de código en el contexto del usuario que ha iniciado la sesión si se utiliza para visitar un sitio web con una fuente insertada especialmente diseñada.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar la manera en que el controlador de formato de fuentes OpenType (OTF) realiza los cálculos de enteros al procesar fuentes OpenType.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2279986$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2279986">artículo 2279986 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Sebastian Apelt, de [Siberas](http://www.siberas.de/), por informar de la vulnerabilidad de análisis de fuentes OpenType (CVE-2010-2740)
-   Diego Juárez, de [Core Security Technologies](http://www.coresecurity.com), por informar de la vulnerabilidad de validación de fuentes OpenType (CVE-2010-2741)
