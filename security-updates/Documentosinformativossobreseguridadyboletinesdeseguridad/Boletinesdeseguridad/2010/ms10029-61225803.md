---
TOCTitle: 'MS10-029'
Title: 'Boletín de seguridad de Microsoft MS10-029 - Moderada'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61225803
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-029(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-029 - Moderada
=====================================================
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                          | Suplantación                    | Moderada                            | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                             | Suplantación                    | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                             | Suplantación                    | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                 | Suplantación                    | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                          | Suplantación                    | Moderada                            | Ninguna                                                             |
| [Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                     | Suplantación                    | Moderada                            | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36) | Suplantación                    | Moderada                            | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*   | Suplantación                    | Moderada                            | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*                 | Suplantación                    | Moderada                            | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)   | Suplantación                    | Moderada                            | [MS10-009](http://technet.microsoft.com/security/bulletin/ms10-009) |

**\*La instalación de Server Core está afectada.** Esta actualización se aplica, con la misma clasificación de gravedad, a las ediciones compatibles de Windows Server 2008 tal como se indica, independientemente de si se ha instalado con la opción de instalación Server Core. Para obtener más información acerca de esta opción de instalación, vea el artículo de MSDN, [Server Core](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx). Tenga en cuenta que la opción de instalación Server Core no se aplica a determinadas ediciones de Windows Server 2008; vea [Comparar opciones de instalación de Server Core](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
Esta actualización de seguridad implementa dos nuevas características de seguridad:

-   **Lista de posibles enrutadores en clientes ISATAP:** La lista de posibles enrutadores permite que los clientes realicen la comprobación de dirección de origen de los paquetes de túnel ISATAP entrantes. La lista de posibles enrutadores se habilita de forma predeterminada tras instalar esta actualización de seguridad y ayuda a corregir la vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP descrita en CVE-2010-0812. En el [artículo 978338 de Microsoft Knowledge Base](http://support.microsoft.com/kb/978338) se encuentra más información acerca de la lista de posibles enrutadores.
-   **Detección de inaccesibilidad de vecino en las interfaces ISATAP:** La detección de inaccesibilidad de vecino se usa para validar si un vecino es accesible o no lo es. Los nodos ISATAP realizan la detección de inaccesibilidad de vecino antes de enviar los paquetes ISATAP. La detección de inaccesibilidad de vecino no está habilitada de forma predeterminada y los administradores de red deben configurarla manualmente. En el [artículo 978338 de Microsoft Knowledge Base](http://support.microsoft.com/kb/978338) se puede encontrar más información acerca de la detección de inaccesibilidad de vecino y cómo habilitarla.

**¿Por qué Microsoft Windows 2000 no está afectado por esta vulnerabilidad?**  
Microsoft Windows 2000 no incluye compatibilidad con IPv6 y, por lo tanto, este sistema operativo no es vulnerable.

**¿Por qué Windows 7 y Windows Server 2008 R2 no están afectados por esta vulnerabilidad?**  
Las características implementadas por esta actualización de seguridad, la lista de posibles enrutadores y la detección de inaccesibilidad de vecino, ya se encuentran en Windows 7 y Windows Server 2008 R2.

**Nota** Aunque la lista de posibles enrutadores está habilitada de forma predeterminada en estas plataformas, la detección de inaccesibilidad de vecino no lo está y la debe configurar manualmente el administrador de red. Consulte el [artículo 978338 de Microsoft Knowledge Base](http://support.microsoft.com/kb/978338) para obtener información adicional acerca de esta característica.

**¿Esta actualización se ofrecerá aunque no tenga habilitado IPv6?**  
Sí, esta actualización de seguridad se ofrecerá a través de Actualizaciones automáticas porque el código vulnerable existe en estos sistemas. Se recomienda a los clientes que instalen la actualización de seguridad si piensan implementar IPv6 en el futuro.
...
<th style="border:1px solid black;" >Vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)</th>
...
Vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)  
------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de suplantación de identidad en la pila IPv6 de Microsoft Windows debida a la forma en que Windows comprueba la dirección de origen IPv6 del paquete interno en un paquete ISATAP de túnel. Un atacante que aprovechara esta vulnerabilidad podría suplantar una dirección para pasar por alto los firewalls perimetrales o de host. Además, la información se podría divulgar cuando el equipo objetivo responda al mensaje con la dirección IPv6 de origen que el atacante ha especificado.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812).
  
#### Factores atenuantes para la vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Esta vulnerabilidad sólo afecta a los sistemas Windows que tienen configurada la interfaz ISATAP.
  
#### Soluciones provisionales para la vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)
...
-   **Deshabilitar la interfaz IPv6 de ISATAP**
  
    Para deshabilitar la interfaz IPv6 de ISATAP, ejecute el comando siguiente en el símbolo del sistema con privilegios elevados:
    ...
    **Consecuencias de la solución provisional.** Al deshabilitar la interfaz ISATAP se impedirá que el sistema use ISATAP como mecanismo de túnel IPv6.
  
    **Cómo deshacer la solución provisional.**
  
    Para volver a habilitar la interfaz IPv6 de ISATAP, ejecute el comando siguiente en el símbolo del sistema con privilegios elevados:
...
#### Preguntas más frecuentes sobre la vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de suplantación. Esta vulnerabilidad podría permitir que un atacante suplantara una dirección IPv4 para pasar por alto los dispositivos de filtrado que se basan en la dirección IPv4 de origen.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la pila TCP/IP de Windows no comprueba correctamente la dirección IPv6 de origen en un paquete ISATAP de túnel.
  
**¿Qué es ISATAP?**    
El protocolo de direccionamiento de túnel automático en el sitio (ISATAP) proporciona conectividad IPv6 en una intranet IPv4. Para obtener información acerca de ISATAP, vea [RFC5214: Protocolo de direccionamiento de túnel automático en el sitio (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante puede suplantar a otro usuario o sistema, lo que podría permitir pasar por alto los filtros de dirección de origen de dirección de origen, como los firewalls perimetrales o de host.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante podría intentar aprovechar la vulnerabilidad mediante el envío de paquetes de red especialmente diseñados con una dirección de origen IPv6 especialmente diseñada en una conexión ISATAP que no coincida con la dirección de origen IPv4 correspondiente.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Todos los sistemas operativos con las características ISATAP de IPv6 habilitadas están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al cambiar la manera en que la pila TCP/IP de Windows comprueba la dirección IPv6 de origen en un paquete ISATAP de túnel.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB978338$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/978338">artículo 978338 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
Gabi Nakibly, de National EW Research & Simulation Center (en Rafael), por informar de la vulnerabilidad de suplantación de identidad de origen IPv6 en ISATAP (CVE-2010-0812)
...
-   V1.1 (21 de abril de 2010): Se ha corregido la información de reemplazo de boletín para todos los paquetes de actualización de Windows Vista y Windows Server 2008.
