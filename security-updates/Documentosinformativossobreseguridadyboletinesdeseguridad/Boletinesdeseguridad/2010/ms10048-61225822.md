---
TOCTitle: 'MS10-048'
Title: 'Boletín de seguridad de Microsoft MS10-048 - Importante'
ms:assetid: 'ms10-048'
ms:contentKeyID: 61225822
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-048(v=Security.10)'
---
...
La actualización de seguridad corrige las vulnerabilidades al modificar la manera en que los controladores en modo kernel de Windows tratan las excepciones, asignan memoria y validan los argumentos de llamada, la entrada de modo usuario y los nuevos parámetros de devolución de llamada de ventana. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=deeac521-d3a2-4019-8176-c9228e733cf4)                                                                                    | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d6c5455e-bc31-4842-aef4-ebff92324323)                                                           | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=59395f00-90f4-4b68-8dd3-03ff611c1bc8)                                                                           | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9ef1c600-bb93-4800-81b8-8c64b369c194)                                                               | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f96b8154-9976-41b0-b9d7-d79887fe9364)                                                        | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c9345207-7242-4b71-bf80-b52031e08f8c)                                                  | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1620e7ac-3913-478d-8120-e9f46d98f453)                          | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8b1a3f7-7147-494e-bfc0-b1979b9578e6)\* | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c1c25cb7-7e82-4c14-9666-aff52dd308b4)\*               | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=45fe5135-aa89-4f60-8cdb-ec0edc9a7e77) | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=68bddf4b-b597-477e-80e4-9293d7160496)                                                                           | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=5ff09e03-d662-4b23-ab26-d25ca2ba58df)                                                                                  | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=6bbc9cb1-0b59-4473-adf9-2ce2f0f94c0a)\*                                                                   | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2543191a-09cb-4417-bbb2-aac4d9a2a756)                                                             | Elevación de privilegios        | Importante                          | [MS10-032](http://technet.microsoft.com/security/bulletin/ms10-032) |
...
Sí. Además de los cambios que se enumeran en la sección "Detalles de la vulnerabilidad", esta actualización también incluye medidas defensivas que corrigen los posibles desbordamientos de enteros en situaciones poco realistas debido a las restricciones de memoria. Estos cambios de defensa sólo se aplican a los sistemas de 64 bits. Aunque no hay ninguna forma real de que un atacante cumpla las condiciones necesarias para aprovechar estos problemas, Microsoft está corrigiendo el código para garantizar que no se identifican problemas futuros en estas áreas específicas.
...
<th style="border:1px solid black;" >Vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)</th>
<th style="border:1px solid black;" >Vulnerabilidad de control de excepciones en Win32k (CVE-2010-1894)</th>
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)</th>
<th style="border:1px solid black;" >Vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)</th>
...
Vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en los controladores en modo kernel de Windows debida a la validación incorrecta de un argumento pasado a una llamada del sistema. Un atacante puede aprovechar esta vulnerabilidad si ejecuta una aplicación especialmente diseñada que provoque que el sistema deje de responder y se reinicie automáticamente.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1887](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1887).
  
#### Factores atenuantes para la vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)
...
#### Soluciones provisionales para la vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)
...
Los controladores en modo kernel de Windows no validan correctamente un argumento pasado a una llamada del sistema.
...
La actualización corrige esta vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows validan el argumento pasado a la llamada del sistema.
...
Vulnerabilidad de control de excepciones en Win32k (CVE-2010-1894)  
------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows tratan determinadas excepciones. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894).
  
#### Factores atenuantes para la vulnerabilidad de control de excepciones en Win32k (CVE-2010-1894)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de control de excepciones en Win32k (CVE-2010-1894)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de control de excepciones en Win32k (CVE-2010-1894)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores en modo kernel de Windows no tratan correctamente determinadas excepciones.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al garantizar que los controladores en modo kernel de Windows tratan la excepción correctamente.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1894).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes.
  
Vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a que los controladores en modo kernel de Windows no asignan correctamente la memoria al realizar una copia desde el modo usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1895](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1895).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores en modo kernel de Windows no asignan correctamente la memoria al copiar datos desde el modo usuario.
...
Vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en los controladores en modo kernel de Windows debida a una validación incorrecta de la entrada pasada desde el modo de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1896](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1896).
  
#### Factores atenuantes para la vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores en modo kernel de Windows no validan correctamente la entrada pasada desde el modo usuario.
...
Vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)  
----------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1897).
  
#### Factores atenuantes para la vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores en modo kernel de Windows no validan correctamente los pseudo identificadores en los parámetros de devolución de llamada al crear una nueva ventana.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows validan los pseudo identificadores en los parámetros de devolución de llamada al crear una nueva ventana.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2160329$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2160329">artículo 2160329 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Tavis Ormandy, de [Google Inc.](http://www.google.com/), por informar de la vulnerabilidad de comprobación de límites en Win32k (CVE-2010-1887)  
-   Matthieu Suiche, de [MoonSols](http://moonsols.com/), por informar de la vulnerabilidad de desbordamiento de grupo en Win32k (CVE-2010-1895)  
-   Matthieu Suiche, de [MoonSols](http://moonsols.com/), por informar de la vulnerabilidad de validación de entrada de usuario en Win32k (CVE-2010-1896)  
-   Matthieu Suiche, de [MoonSols](http://moonsols.com/), por colaborar con nosotros en los cambios de defensa tratados en este boletín  
-   Nicolas Economou, de [Core Security Technologies](http://www.coresecurity.com/), por informar de la vulnerabilidad de creación de ventanas en Win32k (CVE-2010-1897)
