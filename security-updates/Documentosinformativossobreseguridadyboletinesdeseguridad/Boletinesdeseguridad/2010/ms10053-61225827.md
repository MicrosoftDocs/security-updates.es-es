---
TOCTitle: 'MS10-053'
Title: 'Boletín de seguridad de Microsoft MS10-053 - Crítica'
ms:assetid: 'ms10-053'
ms:contentKeyID: 61225827
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-053(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-053 - Crítica
====================================================
...
Esta actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Internet Explorer aplica las comprobaciones de seguridad y trata los objetos en memoria. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
Esta actualización incluye una actualización de defensa en profundidad para el filtro XSS de Internet Explorer 8.
...
<th>
Vulnerabilidad entre dominios por controlador de eventos (CVE-2010-1258)
</th>
<th>
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2556)
</th>
<th>
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2557)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con la condición de ejecución (CVE-2010-2558)
</th>
<th>
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2559)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el diseño HTML (CVE-2010-2560)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer que podría permitir a una secuencia de comandos obtener acceso a una ventana de explorador en otro dominio o zona de Internet Explorer. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada que logre la divulgación de información si un usuario visita la página web y, a continuación, interactúa con la ventana del explorador mediante el mouse.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1258).

#### Factores atenuantes para la vulnerabilidad entre dominios por controlador de eventos (CVE-2010-1258)
...
#### Soluciones provisionales para la vulnerabilidad entre dominios por controlador de eventos (CVE-2010-1258)
...
#### Preguntas más frecuentes sobre la vulnerabilidad entre dominios por controlador de eventos (CVE-2010-1258)
...
Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar una secuencia de comandos en el contexto del usuario que consulta la página web, lo que podría permitir la divulgación de la información de usuario al atacante.
...
La actualización modifica Internet Explorer para aplicar comprobaciones de seguridad al comprobar el origen de la secuencia de comandos.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2556).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2556)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2556)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2556)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2557).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2557)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2557)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2557)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2558).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la condición de ejecución (CVE-2010-2558)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la condición de ejecución (CVE-2010-2558)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la condición de ejecución (CVE-2010-2558)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2559).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2559)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2559)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2559)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2560).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el diseño HTML (CVE-2010-2560)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el diseño HTML (CVE-2010-2560)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el diseño HTML (CVE-2010-2560)
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2183461$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2183461-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2183461-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2183461">artículo 2183461 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2183461$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   David Bloom, de [Google Inc.](http://www.google.com/), por informar de la vulnerabilidad entre dominios por controlador de eventos (CVE-2010-1258)  
-   Nicolas Joly, de [VUPEN Vulnerability Research Team](http://www.vupen.com), por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2556)  
-   Nicolas Joly, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2557)  
-   Nicolas Joly, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con la condición de ejecución (CVE-2010-2558)  
-   Gambino ZaDarkSide, por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2010-2559)  
-   Nicolas Joly, de [VUPEN Vulnerability Research Team](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con el diseño HTML (CVE-2010-2560)
