---
TOCTitle: 'MS10-073'
Title: 'Boletín de seguridad de Microsoft MS10-073 - Importante'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61225947
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-073(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-073 - Importante
=======================================================
...
La actualización de seguridad corrige las vulnerabilidades al modificar la manera en que los controladores en modo kernel de Windows mantienen el recuento de referencias para un objeto, indizan una tabla de punteros de función al cargar una distribución de teclado del disco y validan los datos de clase de ventana. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215)                                                                                    | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                           | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1)                                                                           | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745)                                                               | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                        | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f)                                                  | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db)                          | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763)\* | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e)\*               | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd) | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602)                                                                           | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad)                                                                                  | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5)\*                                                                   | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                             | Elevación de privilegios        | Importante                          | [MS10-048](http://technet.microsoft.com/security/bulletin/ms10-048) |
...
<th style="border:1px solid black;" >Vulnerabilidad de recuento de referencias en Win32k (CVE-2010-2549)</th>
<th style="border:1px solid black;" >Vulnerabilidad de distribución de teclado en Win32k (CVE-2010-2743)</th>
<th style="border:1px solid black;" >Vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)</th>
...
Vulnerabilidad de recuento de referencias en Win32k (CVE-2010-2549)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows mantienen el recuento de referencias de un objeto. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549).
  
#### Factores atenuantes para la vulnerabilidad de recuento de referencias en Win32k (CVE-2010-2549)
...
#### Soluciones provisionales para la vulnerabilidad de recuento de referencias en Win32k (CVE-2010-2549)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de recuento de referencias en Win32k (CVE-2010-2549)
...
La vulnerabilidad se debe a que los controladores en modo kernel de Windows no mantienen correctamente el recuento de referencias de un objeto.
...
**¿Qué es un recuento de referencias?**    
Un recuento de referencias es el registro del administrador de objetos de la cantidad de punteros de objeto que se han suministrado a los procesos del sistema operativo. El administrador de objetos aumenta un recuento de referencias de un objeto cada vez que le envía un puntero al mismo; cuando los componentes en modo kernel terminan de usar el puntero, llaman al administrador de objetos para reducir el recuento de referencias del objeto.
...
La actualización corrige esta vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows mantienen el recuento de referencias de un objeto.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes y no tenía constancia de que se hubiera publicado código demostrativo.
  
Vulnerabilidad de distribución de teclado en Win32k (CVE-2010-2743)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows cargan determinadas distribuciones de teclado. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743).
  
#### Factores atenuantes para la vulnerabilidad de distribución de teclado en Win32k (CVE-2010-2743)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de distribución de teclado en Win32k (CVE-2010-2743)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de distribución de teclado en Win32k (CVE-2010-2743)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que los controladores en modo kernel de Windows no indizan correctamente una tabla de punteros de función al cargar una distribución de teclado del disco.
  
**¿Por qué esta vulnerabilidad tiene una clasificación de gravedad baja para todas las ediciones compatibles de Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2?**    
En estas versiones de Windows, existe el código que pertenece a esta vulnerabilidad, pero no hay forma conocida de que el atacante obtenga acceso a dicho código. No obstante, esta actualización corrige este código como una medida defensiva en el caso de que se encuentre una forma de aprovechar este código para la elevación de privilegios.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar la manera en la que los controladores en modo kernel de Windows indizan una tabla de punteros de función al cargar una distribución de teclado del disco.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**    
Sí. En el momento de publicar este boletín, diferentes tipos de malware estaban aprovechando esta vulnerabilidad a escala limitada.
  
Vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)  
------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a que los controladores en modo kernel de Windows no validan correctamente los datos de clase de ventana. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744).
  
#### Factores atenuantes para la vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Esta vulnerabilidad se debe a que los controladores en modo kernel de Windows no administran correctamente una clase de ventana.
...
**¿Qué es una clase de ventana?**    
Una clase de ventana es un conjunto de atributos que el sistema usa como plantilla para crear una ventana. Cada ventana es miembro de una clase de ventana. Todas las clases de ventana son específicas del proceso. Hay tres tipos de clases de ventana. Una clase del sistema es una clase de ventana registrada por el sistema. Muchas clases del sistema están disponibles para que las usen todos los procesos, mientras que otras sólo las usa internamente el sistema. Debido a que el sistema registra estas clases, un proceso no las puede destruir. Una clase global de aplicación es una clase de ventana registrada por un archivo ejecutable o DLL que está disponible para todos los demás módulos del proceso. Una clase local de aplicación es cualquier clase de ventana que un archivo ejecutable o DLL registra para su uso exclusivo. Aunque puede registrar cualquier número de clases locales, lo habitual es registrar sólo una. Esta clase de ventana admite el procedimiento de la ventana principal de la aplicación. Para obtener más información acerca de las clases de ventana, vea el artículo de MSDN [Clases de ventana](http://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx).
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows validan los datos de clase de ventana.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB981957$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/981957">artículo 981957 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin y Alexey Monastyrsky, de [Kaspersky Lab](http://www.kaspersky.com), y Vitaly Kiktenko y Alexander Saprykin, de [Design and Test Lab](http://www.dnt-lab.com), por informar de la vulnerabilidad de distribución de teclado en Win32K (CVE-2010-2743)  
-   Eric Chien, de [Symantec](http://www.symantec.com/index.jsp), por informar de la vulnerabilidad de distribución de teclado en Win32K (CVE-2010-2743)  
-   Tarjei Mandt, de [Norman](http://www.norman.com), por colaborar con nosotros en la vulnerabilidad de clase de ventana en Win32k (CVE-2010-2744)
