...
-   **Habilitar SSLAlwaysNegoClientCert en IIS 6 y posterior**
    ...
    **Para IIS 7:**
    ...
    `var vdirObj=GetObject("IIS://localhost/W3svc/1");// reemplace el número 1 de esta línea por el número de sitio web que desee configurarWScript.Echo("Valor de SSLAlwaysNegoClientCert antes: " + vdirObj.SSLAlwaysNegoClientCert);vdirObj.Put("SSLAlwaysNegoClientCert", true);vdirObj.SetInfo();WScript.Echo("Valor de SSLAlwaysNegoClientCert después: " + vdirObj.SSLAlwaysNegoClientCert);`
