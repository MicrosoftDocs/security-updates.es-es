---
TOCTitle: 'MS10-100'
Title: 'Boletín de seguridad de Microsoft MS10-100 - Importante'
ms:assetid: 'ms10-100'
ms:contentKeyID: 61225974
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-100(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-100 - Importante
=======================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que la interfaz de usuario de consentimiento procesa los valores leídos del Registro. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664)                                                    | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348)                            | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a)\*\* | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f)\*\*               | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164)   | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401)                                                                             | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384)                                                                                    | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a)\*\*                                                                   | Elevación de privilegios        | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90)                                                               | Elevación de privilegios        | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)</th>
...
Vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)  
------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en la forma en que la interfaz de usuario de consentimiento procesa incorrectamente los valores especiales leídos del Registro. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3961](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961).
  
#### Factores atenuantes para la vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)
...
-   Para conseguir aprovechar esta vulnerabilidad, el atacante debe tener SeImpersonatePrivilege. Los siguientes componentes también tienen este derecho de usuario:  
    - Servicios que se inician mediante el Administrador de control de servicios  
    - Servicios COM (modelo de objeto componente) que se inician mediante la infraestructura COM y se configuran para ejecutarse en una cuenta específica  
    - Servicios IIS cuando están configurados para ejecutarse como un usuario normal
  
#### Soluciones provisionales para la vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)
...
La vulnerabilidad se debe a que la interfaz de usuario de consentimiento no procesa correctamente una clave de Registro que se ha configurado en un valor específico.
  
**¿Qué es la interfaz de usuario de consentimiento?**    
La interfaz de usuario de consentimiento es una parte del Control de cuentas de usuario (UAC). Si UAC se ha habilitado de forma completa, los administradores interactivos normalmente tienen menos privilegios de usuario, pero pueden elevarlos automáticamente para llevar a cabo tareas administrativas al proporcionarse consentimiento explícito con la interfaz de usuario de consentimiento. Dichas tareas administrativas incluyen la instalación de software y controladores, el cambio de la configuración en todo el sistema, la consulta o modificación de otras cuentas de usuario y la ejecución de herramientas administrativas. Para obtener más información, vea el artículo de MSDN [Control de cuentas de usuario](http://msdn.microsoft.com/en-us/library/aa511445.aspx).
  
**¿Qué es SeImpersonatePrivilege?**    
SeImpersonatePrivilege, o el derecho de usuario "Suplantar a un cliente después de la autenticación", es una configuración de seguridad que se presentó por primera vez en Microsoft Windows 2000 Service Pack 4. De forma predeterminada, este derecho de usuario se asigna a los miembros del grupo Administradores local del dispositivo y a la cuenta LocalService del dispositivo. La configuración SeImpersonatePrivilege se describe en el [artículo 821546 de Microsoft Knowledge Base](http://support.microsoft.com/kb/821546).
...
Solo las cuentas de usuario a las que se ha concedido SeImpersonatePrivilege pueden llevar a cabo este ataque. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código especialmente diseñado con el privilegio LocalSystem. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
...
La actualización corrige la vulnerabilidad al modificar la manera en que la interfaz de usuario de consentimiento procesa los valores leídos del Registro.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2442962">artículo 2442962 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo, de [Argeniss](http://www.argeniss.com/), por informar de la vulnerabilidad de suplantación de la interfaz de usuario de consentimiento (CVE-2010-3961)
