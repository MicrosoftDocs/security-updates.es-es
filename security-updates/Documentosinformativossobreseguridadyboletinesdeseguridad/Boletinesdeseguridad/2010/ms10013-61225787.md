---
TOCTitle: 'MS10-013'
Title: 'Boletín de seguridad de Microsoft MS10-013 - Crítica'
ms:assetid: 'ms10-013'
ms:contentKeyID: 61225787
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-013(v=Security.10)'
---

Boletín de seguridad de Microsoft MS10-013 - Crítica
====================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que DirectShow abre los archivos AVI. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**¿Por qué se aplican dos actualizaciones al mismo sistema operativo afectado en varios casos?**  
Este boletín corrige una vulnerabilidad que está presente en dos componentes distintos. Hay disponibles dos paquetes de actualización con diferentes números KB, uno para cada componente afectado. KB977914 trata la vulnerabilidad en el filtro de AVI. KB975560 trata la vulnerabilidad en DirectX. En los sistemas operativos afectados donde se encuentran ambos componentes, es necesario instalar las dos actualizaciones.

En las ediciones compatible de Microsoft Windows 2000, Windows XP y Windows Server 2003, los clientes deben aplicar los dos paquetes de actualización KB977914 y KB975560, ya que ambos se aplican a su entorno. En otros sistemas operativos afectados, los clientes sólo deben aplicar el paquete de actualización de seguridad KB975560.
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento del montón en DirectShow (CVE-2010-0250)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<tr>
<td style="border:1px solid black;">
Filtro de AVI en Microsoft Windows 2000 Service Pack 4
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Filtro de AVI en Windows XP Service Pack 2 y Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Filtro de AVI en Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Filtro de AVI en Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Filtro de AVI Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Filtro de AVI en Windows Server 2003 con SP2 para sistemas con Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Microsoft Windows 2000 Service Pack 4
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows XP Service Pack 2 y Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows Server 2003 con SP2 para sistemas con Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**  
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows 7 para sistemas de 32 bits
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows 7 para sistemas x64
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Quartz en Windows Server 2008 R2 para sistemas x64
</td>
<td style="border:1px solid black;">
**Crítica**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Quartz en Windows Server 2008 R2 para sistemas con Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0250).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón en DirectShow (CVE-2010-0250)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón en DirectShow (CVE-2010-0250)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón en DirectShow (CVE-2010-0250)
...
El componente Microsoft DirectShow no trata correctamente los archivos AVI especialmente diseñados.
...
La actualización corrige el problema al modificar la forma en que DirectShow abre los archivos AVI.
...
|----------------------------------------------------------------------------------------------------------------|---------|-------------------|-------------------|----------------------------|
| Microsoft Windows 2000 Service Pack 4 (Filtro de AVI)                                                          | Sí      | Sí                | Sí                | Sí                         |
| Microsoft Windows 2000 Service Pack 4 (Quartz)                                                                 | No      | No                | Sí                | Sí                         |
| Windows XP Service Pack 2 y Windows XP Service Pack 3 (Filtro de AVI)                                          | Sí      | Sí                | Sí                | Sí                         |
| Windows XP Service Pack 2 y Windows XP Service Pack 3 (Quartz)                                                 | No      | No                | Sí                | Sí                         |
| Windows XP Professional x64 Edition Service Pack 2                                                             | No      | No                | Sí                | Sí                         |
| Windows Server 2003 Service Pack 2 (Filtro de AVI)                                                             | Sí      | Sí                | Sí                | Sí                         |
| Windows Server 2003 Service Pack 2 (Quartz)                                                                    | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Para el filtro de AVI en Microsoft Windows 2000:<br />
Windows2000-KB977914-x86-ENU /quiet<br />
<br />
Además, para Quartz en uno de los sistemas operativos:<br />
<br />
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en las carpetas %Windir%\\$NTUninstallKB977914$\Spuninst y %Windir%\\$NTUninstallKB975560$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Consulte los artículos <a href="http://support.microsoft.com/kb/977914">977914</a> y <a href="http://support.microsoft.com/kb/975560">975560</a> de Microsoft Knowledge Base</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Windows XP Service Pack 2 y Windows XP Service Pack 3 se aplican ambos:<br />
- Para Filtro de AVI:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows XP Professional x64 Edition Service Pack 2 se aplican ambos:<br />
- Para Filtro de AVI:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003 se aplican ambos:<br />
- Para Filtro de AVI:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003 se aplican ambos:<br />
- Para Filtro de AVI:<br />
WindowsServer2003.WindowsXP-KB977914-x64-ENU /quiet<br />
- Para Quartz:<br />
WindowsServer2003.WindowsXP-KB975560-x64-ENU /quiet</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003 se aplican ambos:<br />
- Para Filtro de AVI:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/975560">artículo 975560 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Windows Server 2008 R2 para sistemas x64:<br />
Windows6.1-KB975560-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Server 2008 R2 para sistemas con Itanium:<br />
...
-   Un investigador anónimo, en colaboración con [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de desbordamiento del montón en DirectShow (CVE-2010-0250)
...
-   V1.1 (10 de febrero de 2010): Se ha corregido el reemplazado de boletín para el paquete de actualización de Quartz (KB975560). Se han corregido los requisitos de reinicio para la actualización en todas las plataformas, excepto Microsoft Windows 2000 y Windows Server 2008. Se han cambiado las entradas de la tabla de **Systems Management Server** para SMS 2003 con ITMU para Windows 7 y Windows Server 2008 R2. Por último, se ha corregido la clave del Registro de comprobación para todas las ediciones x64 compatibles de Windows XP. Sólo son cambios informativos. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.
