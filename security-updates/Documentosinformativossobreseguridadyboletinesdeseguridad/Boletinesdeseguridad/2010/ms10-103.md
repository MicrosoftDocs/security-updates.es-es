...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 32 bits de Windows** **Vista, Windows Server 2008 y Windows 7:**
    ...
    ```
    takeown /f "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll"
    icacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXT
    icacls "c:\archivos de programa\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone(F)
    ```
    ...
    **Para ediciones de 64 bits de Windows** **Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:**
    ...
    ```
    takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll"
    icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXT
    icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone (F)
    ```
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 64 bits de Windows** **Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:**
    ...
    ```
    takeown /f "<RUTA_DE_ACCESO_64_BITS_Y_NOMBRE_DE_ARCHIVO>"
    icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXT
    icacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\pubconv.dll" /deny everyone (F)
    ```
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Para ediciones de 32 bits de Windows** **Vista, Windows Server 2008 y Windows 7:**
    ...
    ```
    takeown /f "c:\archivos de programa\Microsoft Office\office10\pubconv.dll"
    icacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXT
    icacls "c:\archivos de programa\Microsoft Office\office10\pubconv.dll" /deny everyone(F)
    ```
