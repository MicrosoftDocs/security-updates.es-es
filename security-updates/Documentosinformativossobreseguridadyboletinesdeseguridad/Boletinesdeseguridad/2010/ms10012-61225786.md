---
TOCTitle: 'MS10-012'
Title: 'Boletín de seguridad de Microsoft MS10-012 - Importante'
ms:assetid: 'ms10-012'
ms:contentKeyID: 61225786
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-012(v=Security.10)'
---
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714)                                                                          | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31)                                                          | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                             | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff)                                                                             | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6)                                                                 | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                          | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0)                                     | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c) | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a)\*   | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670)\*                 | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102)   | Ejecución remota de código      | Importante                          | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=122fc003-0651-4ad2-a5c8-a21536defad8)                                                                             | Ejecución remota de código      | Importante                          | Ninguna                                                             |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=3e096468-db6c-45c6-bee5-eaeaa63500b5)                                                                                    | Ejecución remota de código      | Importante                          | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=dc757b6d-f0f8-4e71-ab6f-1417233eedf9)\*                                                                     | Ejecución remota de código      | Importante                          | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d5b0b1eb-24f3-47ec-aba1-c1b95400189e)                                                               | Ejecución remota de código      | Importante                          | Ninguna                                                             |
...
**¿Esta actualización de seguridad está relacionada con MS10-006, publicada el 9 de febrero de 2010?**  
No. En el boletín de seguridad de Microsoft [MS10-006](http://go.microsoft.com/fwlink/?linkid=178850), "Vulnerabilidades en el cliente SMB podrían permitir la ejecución remota de código", se tratan diferentes componentes de SMB. Esta actualización de seguridad se puede aplicar independientemente de cualquier otra actualización.

**Si tengo instalada la actualización MS10-006, ¿también necesito instalar esta actualización?**
Sí. Esta actualización del boletín de seguridad corrige vulnerabilidades en los componentes del servidor SMB de Windows, mientras que [MS10-006](http://go.microsoft.com/fwlink/?linkid=178850) corrige vulnerabilidades en los componentes del cliente SMB de Windows.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del nombre de ruta en SMB (CVE-2010-0020)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con SMB (CVE-2010-0021)</th>
<th style="border:1px solid black;" >Vulnerabilidad de puntero nulo en SMB (CVE-2010-0022)</th>
<th style="border:1px solid black;" >Vulnerabilidad de falta de entropía en la autenticación NTLM en SMB (CVE-2010-0231)</th>
...
Existe una vulnerabilidad de ejecución remota de código autenticado en la forma en que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft trata los paquetes SMB especialmente diseñados. Un atacante podría aprovechar la vulnerabilidad al enviar un mensaje de red especialmente diseñado a un equipo que ejecuta el servicio de servidor como usuario autenticado. Aunque un atacante que aprovechara con éxito esta vulnerabilidad podría obtener el control completo del sistema afectado, lo más probable es que los intentos de aprovechar esta vulnerabilidad tengan como consecuencia la denegación de servicio.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del nombre de ruta en SMB (CVE-2010-0020)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del nombre de ruta en SMB (CVE-2010-0020)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del nombre de ruta en SMB (CVE-2010-0020)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la implementación del bloque de mensajes del servidor (SMB) de Microsoft valida incorrectamente los campos de una solicitud SMB con formato incorrecto.
...
La actualización corrige la vulnerabilidad al modificar la forma en que SMB valida los campos en una solicitud SMB con formato incorrecto.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con SMB (CVE-2010-0021)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con SMB (CVE-2010-0021)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con SMB (CVE-2010-0021)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft trata incorrectamente una condición de carrera que se puede producir al analizar los paquetes SMB durante la fase de negociación. Esta vulnerabilidad afecta a SMB versiones 1 y 2.
...
**¿Cómo funciona esta actualización?**    
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que SMB analiza los paquetes SMB especialmente diseñados.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022).
  
#### Factores atenuantes para la vulnerabilidad de puntero nulo en SMB (CVE-2010-0022)
...
#### Soluciones provisionales para la vulnerabilidad de puntero nulo en SMB (CVE-2010-0022)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de puntero nulo en SMB (CVE-2010-0022)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de denegación de servicio. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado dejara de responder hasta que se reiniciara manualmente. Es importante mencionar que la vulnerabilidad de denegación de servicio no permitiría a los atacantes ejecutar código o elevar sus derechos de usuario, pero podría provocar que el sistema afectado dejara de aceptar solicitudes.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft comprueba incorrectamente los campos de recurso compartido y de nombre de servidor en los paquetes SMB con formato incorrecto.
...
**¿Cómo funciona esta actualización?**    
La actualización de seguridad corrige la vulnerabilidad al validar correctamente los campos que contienen los paquetes SMB.
...
Existe una vulnerabilidad de elevación de privilegios sin autenticación en la forma en que el software del protocolo del bloque de mensajes del servidor (SMB) de Microsoft trata los intentos de autenticación. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo que un atacante podría enviar grandes cantidades de solicitudes de autenticación al servidor SMB. Un atacante que consiguiera aprovechar esta vulnerabilidad podría obtener acceso al servicio SMB en el usuario de destino con las credenciales de un usuario autorizado.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231).
  
#### Factores atenuantes para la vulnerabilidad de falta de entropía en la autenticación NTLM en SMB (CVE-2010-0231)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Si se siguen las prácticas recomendadas relativas al uso de servidores de seguridad y se implementan las configuraciones de servidores de seguridad predeterminadas estándar, puede contribuirse a proteger una red de los ataques que se originen fuera del ámbito de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos. En este caso, los puertos SMB deben bloquearse desde Internet.
  
#### Soluciones provisionales para la vulnerabilidad de falta de entropía en la autenticación NTLM en SMB (CVE-2010-0231)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de falta de entropía en la autenticación NTLM en SMB (CVE-2010-0231)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechara esta vulnerabilidad podría autenticar se correctamente en un sistema de destino sin requerir credenciales de autenticación precisas. De este modo, el atacante podría cargar y descargar archivos, así como obtener acceso a los recursos de red SMB disponibles para dicho usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Esta vulnerabilidad se debe a la falta de entropía de cifrado cuando el servidor SMB genera desafíos y los presenta al cliente que se está conectando. Esto podría provocar que un atacante intentara continuamente autenticarse en el servidor SMB y, posteriormente, provocar que el servidor genere valores duplicados.
  
**¿Qué es el protocolo del bloque de mensajes del servidor (SMB) de Microsoft?**    
El protocolo del bloque de mensajes del servidor (SMB) de Microsoft es un protocolo de uso compartido de archivos de la red de Microsoft utilizado en Microsoft Windows. Para obtener más información sobre SMB consulte [Descripción general del protocolo SMB y el protocolo CIFS de Microsoft](http://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que consiguiera aprovechar esta vulnerabilidad podría cargar y descargar archivos, así como obtener acceso a los recursos de red SMB disponibles para el usuario a cuya cuenta tiene acceso el atacante.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante podría intentar aprovechar la vulnerabilidad si intenta continuamente autenticarse en un servidor y reutiliza la información de esas conexiones erróneas para suplantar un token de autenticación válido.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Todos los sistemas con el servicio Servidor SMB están afectados por esta vulnerabilidad. Los controles de dominio están más expuestos a que se aproveche esta vulnerabilidad, ya que estos sistemas tienen recursos compartidos de red abiertos a todos los usuarios del dominio de forma predeterminada.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al garantizar que el servidor SMB usa un proveedor de criptografía con suficientes garantías de entropía.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB971468-x86-enu /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB971468-x86-enu /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | KB971468.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB971468$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 971468 de Microsoft Knowledge Base](http://support.microsoft.com/kb/971468).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971468\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB971468$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/971468">artículo 971468 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Joshua Morin, de [Codenomicon](http://www.codenomicon.com/), por informar de la vulnerabilidad de desbordamiento del nombre de ruta en SMB (CVE-2010-0020)  
-   Florian Rienhardt, de [BSI](http://www.bsi.bund.de/), por informar de la vulnerabilidad de daños en la memoria relacionada con SMB (CVE-2010-0021)  
-   Hernan Ochoa (consultor/investigador de seguridad de información independiente), por informar de la vulnerabilidad de falta de entropía en la autenticación NTLM en SMB (CVE-2010-0231)
...
-   V1.1 (10 de febrero de 2010): Se han corregido las **Preguntas más frecuentes sobre la vulnerabilidad de puntero nulo en SMB (CVE-2010-0022)** para reflejar que la vulnerabilidad se divulgó de forma responsable. Se han cambiado las entradas de la tabla de **Systems Management Server** para SMS 2003 con ITMU para Windows 7 y Windows Server 2008 R2. Se ha corregido la clave del Registro de comprobación para todas las ediciones x64 compatibles de Windows XP. Sólo son cambios informativos. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.
