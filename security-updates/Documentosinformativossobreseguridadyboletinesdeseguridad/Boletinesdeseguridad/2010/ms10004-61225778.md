---
TOCTitle: 'MS10-004'
Title: 'Boletín de seguridad de Microsoft MS10-004 - Importante'
ms:assetid: 'ms10-004'
ms:contentKeyID: 61225778
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-004(v=Security.10)'
---
...
En el [artículo 975416 de Microsoft Knowledge Base](http://support.microsoft.com/kb/975416) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.

**¿Por qué no se ofrece un paquete de actualización a Microsoft Office PowerPoint Viewer 2003?**  
En las preguntas más frecuentes sobre la vulnerabilidad para CVE-2010-0033 se indica que esta actualización corrige la vulnerabilidad al cambiar la forma en que Microsoft Office PowerPoint Viewer analiza los archivos de PowerPoint especialmente diseñados; no obstante, no se ofrece ningún paquete de actualización para la versión independiente de PowerPoint Viewer 2003.

Esto se debe que las instalaciones independientes de PowerPoint Viewer 2003 ya han [pasado su ciclo de vida del soporte técnico](http://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx) y no se les ofrecerá esta actualización. En su lugar, esta actualización se está ofreciendo a los clientes de Microsoft Office PowerPoint 2003, por lo que pueden enviar la versión actualizada de sus presentaciones creadas con la [característica de empaquetar una presentación para CD](http://support.microsoft.com/kb/828504) en PowerPoint que usa PowerPoint Viewer 2003.

Los clientes que tengan las instalaciones independientes de PowerPoint Viewer 2003 deben plantearse la migración a versiones con soporte técnico para evitar la exposición a vulnerabilidades. PowerPoint Viewer 2007 no está afectado por las vulnerabilidades descritas en este boletín y está disponible en el [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en).

**MS10-003 también describe una vulnerabilidad en Microsoft Office 2004 para Mac. ¿Cómo se relaciona MS10-003 con este boletín (MS10-004)?**  
Como parte del modelo de servicio acumulativo para Microsoft Office 2004 para Mac, esta actualización de seguridad para Microsoft Office 2004 para Mac (KB979674) también corrige la vulnerabilidad descrita en MS10-003. Los usuarios con Microsoft Office 2004 para Mac instalado tendrán que instalar esta actualización de seguridad, pero sólo deberán instalarla una vez.
...
<th>
Vulnerabilidad de desbordamiento del búfer en tratamiento de rutas de acceso de archivo en PowerPoint (CVE-2010-0029)
</th>
<th>
Vulnerabilidad de desbordamiento del montón de LinkedSlideAtom en PowerPoint (CVE-2010-0030)
</th>
<th>
Vulnerabilidad de indización de matriz no válida 'placementId' de OEPlaceholderAtom en PowerPoint (CVE-2010-0031)
</th>
<th>
Vulnerabilidad de uso de OEPlaceholderAtom después de liberación en PowerPoint (CVE-2010-0032)
</th>
<th>
Vulnerabilidad de desbordamiento de la pila de registros de TextBytesAtom en PowerPoint Viewer (CVE-2010-0033)
</th>
<th>
Vulnerabilidad de desbordamiento de la pila de registros de TextCharsAtom en Office PowerPoint Viewer (CVE-2010-0034)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en tratamiento de rutas de acceso de archivo en PowerPoint (CVE-2010-0029)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en tratamiento de rutas de acceso de archivo en PowerPoint (CVE-2010-0029)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en tratamiento de rutas de acceso de archivo en PowerPoint (CVE-2010-0029)
...
La vulnerabilidad se debe a la forma en que Microsoft Office PowerPoint analiza el formato de archivo de PowerPoint al abrir un archivo de PowerPoint especialmente diseñado.
...
Para aprovechar esta vulnerabilidad es necesario que un usuario abra un archivo de PowerPoint especialmente diseñado con una versión afectada de Microsoft Office PowerPoint.
...
Los sistemas donde se usa Microsoft Office PowerPoint, incluidas las estaciones de trabajo y los servidores de Terminal Server, están más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.

**¿Cómo funciona esta actualización?**  
Esta actualización corrige la vulnerabilidad al modificar la forma en que Microsoft Office PowerPoint analiza los archivos de PowerPoint especialmente diseñados.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón de LinkedSlideAtom en PowerPoint (CVE-2010-0030)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón de LinkedSlideAtom en PowerPoint (CVE-2010-0030)
...
-   **Use la directiva Bloqueo de archivos de Microsoft Office para bloquear la apertura de documentos de Office 2003 y anteriores de fuentes y lugares desconocidos o que no sean de confianza**
    ...
    **Consecuencias de la solución provisional.** Los usuarios que han configurado la directiva Bloqueo de archivos y no han configurado un "directorio de exención" especial, como se describe en el [artículo 922847 de Microsoft Knowledge Base](http://support.microsoft.com/kb/922847), no podrán abrir archivos de Office 2003 o de versiones anteriores en Office 2003.
...
-   **Use el Entorno aislado de conversión de Microsoft Office (MOICE) al abrir archivos de fuentes desconocidas o que no sean de confianza**
    ...
    [http://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=en-us](http://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=es)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón de LinkedSlideAtom en PowerPoint (CVE-2010-0030)
...
**Cuando este boletín de seguridad se publicó, ¿se había hecho pública esta vulnerabilidad? Cuando este boletín de seguridad se publicó, ¿se había hecho pública esta vulnerabilidad?**  
No. Microsoft recibió información acerca de esta vulnerabilidad a través de una fuente responsable.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031).

#### Factores atenuantes para la vulnerabilidad de indización de matriz no válida 'placementId' de OEPlaceholderAtom en PowerPoint (CVE-2010-0031)
...
#### Soluciones provisionales para la vulnerabilidad de indización de matriz no válida 'placementId' de OEPlaceholderAtom en PowerPoint (CVE-2010-0031)
...
-   **Use el Entorno aislado de conversión de Microsoft Office (MOICE) al abrir archivos de fuentes desconocidas o que no sean de confianza**
    ...
    [http://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=en-us](http://update.microsoft.com/microsoftupdate/v6/default.aspx?ln=es-es)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de indización de matriz no válida 'placementId' de OEPlaceholderAtom en PowerPoint (CVE-2010-0031)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0032](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032).

#### Factores atenuantes para la vulnerabilidad de uso de OEPlaceholderAtom después de liberación en PowerPoint (CVE-2010-0032)
...
#### Soluciones provisionales para la vulnerabilidad de uso de OEPlaceholderAtom después de liberación en PowerPoint (CVE-2010-0032)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de uso de OEPlaceholderAtom después de liberación en PowerPoint (CVE-2010-0032)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Office PowerPoint Viewer trata los archivos de PowerPoint especialmente diseñados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0033](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de la pila de registros de TextBytesAtom en PowerPoint Viewer (CVE-2010-0033)
...
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. En su lugar, el atacante tendría que persuadir a los usuarios para que visitaran el sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante y para que abran el archivo de PowerPoint especialmente diseñado.
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
-   Microsoft Office PowerPoint Viewer 2007 no está afectado por esta vulnerabilidad. Los usuarios pueden instalar Microsoft Office PowerPoint Viewer 2007 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en).

#### Soluciones provisionales para la vulnerabilidad de desbordamiento de la pila de registros de TextBytesAtom en PowerPoint Viewer (CVE-2010-0033)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de la pila de registros de TextBytesAtom en PowerPoint Viewer (CVE-2010-0033)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a la forma en que Microsoft Office PowerPoint Viewer analiza el formato de archivo de PowerPoint al abrir un archivo de PowerPoint especialmente diseñado.

**¿Para qué puede usar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría ejecutar código arbitrario como el usuario que ha iniciado la sesión. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante podría lograr el control completo del sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Para aprovechar esta vulnerabilidad es necesario que un usuario abra un archivo de PowerPoint especialmente diseñado con una versión afectada de Microsoft Office PowerPoint Viewer.
...
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los sistemas donde se usa Microsoft Office PowerPoint Viewer, incluidas las estaciones de trabajo y los servidores de Terminal Server, están más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.

**¿Cómo funciona esta actualización?**  
Esta actualización corrige la vulnerabilidad al modificar la forma en que Microsoft Office PowerPoint Viewer analiza los archivos de PowerPoint especialmente diseñados.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0034](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de la pila de registros de TextCharsAtom en Office PowerPoint Viewer (CVE-2010-0034)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de la pila de registros de TextCharsAtom en Office PowerPoint Viewer (CVE-2010-0034)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de la pila de registros de TextCharsAtom en Office PowerPoint Viewer (CVE-2010-0034)
...
|-------------------------------------------------|---------|-------------------|-------------------|----------------------------|
| Microsoft Office PowerPoint 2002 Service Pack 3 | No      | No                | Sí                | Sí                         |
| Microsoft Office PowerPoint 2003 Service Pack 3 | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/973143">artículo 973143 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/976881">artículo 976881 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Carsten Eiram, de [Secunia](http://secunia.com/), por informar de la vulnerabilidad de desbordamiento del búfer en tratamiento de rutas de acceso de archivo en PowerPoint (CVE-2010-0029)  
-   Sean Larsson, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de desbordamiento del montón de LinkedSlideAtom en PowerPoint (CVE-2010-0030)  
-   Sean Larsson, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de indización de matriz no válida 'placementId' de OEPlaceholderAtom en PowerPoint (CVE-2010-0031)  
-   Sean Larsson, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de uso de OEPlaceholderAtom después de liberación en PowerPoint (CVE-2010-0032)  
-   SkD, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/), por informar de la vulnerabilidad de desbordamiento de la pila de registros de TextBytesAtom en PowerPoint Viewer (CVE-2010-0033)  
-   Cody Pierce, de [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/), por informar de la vulnerabilidad de desbordamiento de la pila de registros de TextCharsAtom en Office PowerPoint Viewer (CVE-2010-0034)
