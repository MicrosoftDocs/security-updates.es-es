---
TOCTitle: 'MS10-082'
Title: 'Boletín de seguridad de Microsoft MS10-082 - Importante'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61225956
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-082(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-082 - Importante
=======================================================
...
Esta actualización de seguridad se considera importante para Reproductor de Windows Media 9 Series, Reproductor de Windows Media 10, Reproductor de Windows Media 11 y Reproductor de Windows Media 12 cuando está instalado en las versiones compatibles de Microsoft Windows excepto para Windows Server 2008 y Windows Server 2008 R2. Para Reproductor de Windows Media 11 y Reproductor de Windows Media 12 cuando está instalado en ediciones compatibles de Windows Server 2008 y Windows Server 2008 R2, esta actualización de seguridad se considera moderada. Las ediciones con Itanium compatibles de Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2 no están afectadas por la vulnerabilidad. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que Reproductor de Windows Media desasigna los objetos durante una operación de nueva carga. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Reproductor de Windows Media Serie 9</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Reproductor de Windows Media 10</a><br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Reproductor de Windows Media 11</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0663e0e8-c5d1-4cd2-b6d3-ff78fb56bba1">Reproductor de Windows Media 10</a><br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=474b5618-dfe6-40de-b59b-1fd61a05749e">Reproductor de Windows Media 11</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5479fd20-50d1-447a-8555-a98ce0723f71">Reproductor de Windows Media 10</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a9515e69-c147-4810-8c5a-6cb94c398a95">Reproductor de Windows Media 10</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=95e24a63-d21a-4756-a16e-17a977595396">Reproductor de Windows Media 11</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=277151a2-b74f-4da6-8203-e774af75e44c">Reproductor de Windows Media 11</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=67eb3a70-9ca7-4184-b9fe-cc3e66b1bf36">Reproductor de Windows Media 11</a>**</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=33a06f0e-81ab-445a-bc89-14350ebfe688">Reproductor de Windows Media 11</a>**</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Moderada</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=59a2ef36-9c32-488b-b5b1-30b5bcd83358">Reproductor de Windows Media 12</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=00176d56-8a93-4780-96fc-a7ab715e7291">Reproductor de Windows Media 12</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4cf0e3b1-4b72-4f99-b716-2489ea42ed72">Reproductor de Windows Media 12</a>**</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Moderada</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
|--------------------------------------------------------------------------------------------------------------|----------------------------------|  
| Windows XP Service Pack 3                                                                                    | Reproductor de Windows Media 6.4 |  
| Windows XP Professional x64 Edition Service Pack 2                                                           | Reproductor de Windows Media 6.4 |  
| Windows Server 2003 Service Pack 2                                                                           | Reproductor de Windows Media 6.4 |  
| Windows Server 2003 x64 Edition Service Pack 2                                                               | Reproductor de Windows Media 6.4 |  
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria relacionada con Reproductor de Windows Media (CVE-2010-2745)  
</th>
<th style="border:1px solid black;" >
...
Reproductor de Windows Media 9 en Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
...
<td style="border:1px solid black;">
Reproductor de Windows Media 10 en Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 10 en Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 10 en Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 10 en Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows Vista Service Pack 1 y Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Moderada**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 11 en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Moderada**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 12 en Windows 7 para sistemas de 32 bits
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Reproductor de Windows Media 12 en Windows 7 para sistemas x64
</td>
<td style="border:1px solid black;">
**Importante**   
Ejecución remota de código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Reproductor de Windows Media 12 en Windows Server 2008 R2 para sistemas x64\*\*
</td>
<td style="border:1px solid black;">
**Moderada**   
Ejecución remota de código
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Reproductor de Windows Media desasigna objetos durante una operación de nueva carga a través de un explorador web. Esta vulnerabilidad podría permitir la ejecución de código si un usuario visita una página web especialmente diseñada. Si un usuario inicia sesión con derechos de usuario administrativos, un intruso que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-2745](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Reproductor de Windows Media (CVE-2010-2745)
...
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
-   Las ediciones compatibles de Windows Server 2008 y Windows Server 2008 R2 no están afectadas por este problema a menos que esté instalada la característica Experiencia de escritorio. De forma predeterminada, estas plataformas no cargan el componente Reproductor de Windows Media afectado. Para obtener más información acerca de la característica Experiencia de Escritorio, vea el artículo de TechNet, [Información general acerca de Experiencia de escritorio](http://technet.microsoft.com/en-us/library/cc772567.aspx).

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Reproductor de Windows Media (CVE-2010-2745)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **Cancelar el registro de wmp.dll**

    Para cancelar el registro de esta DLL, ejecute los comandos siguientes en el símbolo del sistema con privilegios elevados.
    ...
    **Consecuencias de la solución provisional.** Reproductor de Windows Media no podrá reproducir los formatos de archivo compatibles.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Reproductor de Windows Media (CVE-2010-2745)
...
Reproductor de Windows Media desasigna incorrectamente los objetos durante una operación de nueva carga a través de un explorador web.
...
Sí. Para que el ataque se pueda llevar a cabo, el usuario debe hacer clic en uno o varios cuadros de diálogo emergentes al explorar una página web. Esta vulnerabilidad no se puede aprovechar automáticamente al visitar una página web especialmente diseñada.
...
La actualización corrige el problema al modificar la manera en que Reproductor de Windows Media desasigna los objetos durante una operación de nueva carga.
...
<td style="border:1px solid black;">Para Reproductor de Windows Media 9, Reproductor de Windows Media 10 y Reproductor de Windows Media 11 en Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 10 en Windows XP Professional x64 Edition Service Pack 2:<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 11 en Windows XP Professional x64 Edition Service Pack 2:<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 9 en Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 10 y Reproductor de Windows Media 11 en Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en las siguientes ubicaciones:<br />
<br />
Para Reproductor de Windows Media 9, Reproductor de Windows Media 10 y Reproductor de Windows Media 11 en Windows XP Service Pack 3:<br />
Carpeta %Windir%\$NTUninstallKB2378111_WM9$\Spuninst<br />
<br />
Para Reproductor de Windows Media 10 en Windows XP Professional x64 Edition Service Pack 2:<br />
Carpeta %Windir%\$NTUninstallKB2378111$\Spuninst<br />
<br />
Para Reproductor de Windows Media 11 en Windows XP Professional x64 Edition Service Pack 2:<br />
Carpeta %Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2378111">artículo 2378111 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 9, Reproductor de Windows Media 10 y Reproductor de Windows Media 11 en las ediciones de 32 bits compatibles de Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Reproductor de Windows Media 10 en todas las ediciones x64 compatibles de Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2378111$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2378111">artículo 2378111 de Microsoft Knowledge Base</a>.</td>
...
-   SkyLined, [Google Inc.](http://www.google.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con Reproductor de Windows Media (CVE-2010-2745)
...
-   V1.1 (13 de octubre de 2010): Se ha corregido el vínculo de descarga en la tabla **Software afectado** para Reproductor de Windows Media 11 en Windows XP Professional x64 Edition Service Pack 2. Los clientes que hayan instalado el paquete específico mediante las actualizaciones automáticas no necesitan realizar ninguna acción. Los clientes que hayan realizado la instalación manualmente desde el Centro de descarga de Microsoft deben instalar este nuevo paquete manualmente.
