---
TOCTitle: 'MS10-005'
Title: 'Boletín de seguridad de Microsoft MS10-005 - Moderada'
ms:assetid: 'ms10-005'
ms:contentKeyID: 61225779
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms10-005(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS10-005 - Moderada
=====================================================
...
Esta actualización de seguridad se considera moderada para Microsoft Windows 2000, Windows XP y Windows Server 2003. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que Microsoft Paint descodifica los archivos de imagen JPEG. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134)                 | Ejecución remota de código      | Moderada                            | Ninguna                                       |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f) | Ejecución remota de código      | Moderada                            | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155)    | Ejecución remota de código      | Moderada                            | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec)                    | Ejecución remota de código      | Moderada                            | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a)        | Ejecución remota de código      | Moderada                            | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ee603435-26af-4ab9-9f22-92734346dc0a) | Ejecución remota de código      | Moderada                            | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de enteros en MS Paint (CVE-2010-0028)</th>
...
Vulnerabilidad de desbordamiento de enteros en MS Paint (CVE-2010-0028)  
-----------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Paint descodifica las imágenes JPEG. La vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de imagen JPEG especialmente diseñado en Microsoft Paint. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en MS Paint (CVE-2010-0028)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, cuando un usuario hace doble clic en un archivo JPEG, éste se abre en el Visor de imágenes y fax de Windows. Para aprovechar la vulnerabilidad, un atacante debe convencer al usuario para que abra el archivo especialmente diseñado en Microsoft Paint.  
-   Un atacante podría enviar el archivo especialmente diseñado como datos adjuntos de correo electrónico, pero el atacante tendría que convencer al usuario para que abriera los datos adjuntos en Microsoft Paint a fin de aprovechar la vulnerabilidad.  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en MS Paint (CVE-2010-0028)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Deshabilitar Microsoft Paint**
  
    Para Windows de 32 bits, ejecute el comando siguiente en el símbolo del sistema:
  
    `cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N`
  
    Para Windows de 64 bits, ejecute el comando siguiente en el símbolo del sistema:
  
    `cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N`
  
    **Consecuencias de la solución provisional.**Los usuarios no podrán ejecutar Microsoft Paint.
...
-   **En Windows XP y Windows Server 2003, quitar Microsoft Paint**
  
    1.  En el **Panel de control**, seleccione **Agregar o quitar programas**.  
    2.  Haga clic en **Agregar o quitar componentes de Windows**.  
    3.  En el **Asistente para componentes de Windows**, seleccione **Accesorios y utilidades** y, a continuación, haga clic en **Detalles**.  
    4.  Seleccione **Accesorios** y, a continuación, haga clic en **Detalles**.  
    5.  Desactive la casilla **Paint** y, a continuación, haga clic en **Aceptar** dos veces.  
    6.  En el **Asistente para componentes de Windows**, asegúrese de que la casilla **Accesorios y utilidades** está atenuada y, a continuación, haga clic en **Siguiente**.  
    7.  Cuando se complete la eliminación de los archivos, haga clic en **Finalizar** para salir del asistente.
  
    **Consecuencias de la solución provisional.** Los usuarios no podrán ejecutar Microsoft Paint.
  
    **Cómo deshacer la solución provisional.** Reinstale Microsoft Paint mediante el Asistente para componentes de Windows en Agregar o quitar programas.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en MS Paint (CVE-2010-0028)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Esta vulnerabilidad se debe a daños en la memoria a descodificar imágenes JPEG procesadas por Microsoft Paint.
  
**¿Qué es Microsoft Paint?**    
Microsoft Paint es una herramienta que se usa para crear dibujos simples o elaborados. Además, Microsoft Paint se puede usar para ver y evitar fotos digitalizadas.
  
**¿Qué son las imágenes JPEG?**    
JPEG es un formato de imagen independiente de la plataforma que admite un alto grado de compresión. JPEG es un estándar muy usado en Internet desarrollado por el Joint Photographic Experts Group.
...
Esta vulnerabilidad requiere que un usuario abra o visualice un archivo de imagen especialmente diseñado. Un atacante tendría que enviar un archivo de imagen JPEG especialmente diseñado al usuario y convencerle de que abra el archivo con Microsoft Paint.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que un usuario haya iniciado la sesión y esté usando Microsoft Paint para editar o ver imágenes JPEG. Por lo tanto, cualquier sistema en el que se lean los mensajes de correo electrónico, se utilice Internet Explorer de forma habitual o los usuarios tengan acceso a recursos compartidos de red (como estaciones de trabajo y servidores de Terminal Server) está expuesto a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al modificar la forma en que Microsoft Paint descodifica los archivos de imagen JPEG.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB978706$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/978706">artículo 978706 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Tielei Wang, de ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Universidad de Pekín/China) en colaboración con [Secunia](http://secunia.com/), por informar de la vulnerabilidad de desbordamiento de enteros en MSPaint (CVE-2010-0028)
...
-   V1.1 (10 de febrero de 2010): Se han corregido las subsecciones de **Implementación de la actualización de seguridad** para indicar que, en algunos casos, la actualización no requiere reiniciar el sistema. Se ha corregido la clave del Registro de comprobación para todas las ediciones x64 compatibles de Windows XP. Sólo son cambios informativos. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.
