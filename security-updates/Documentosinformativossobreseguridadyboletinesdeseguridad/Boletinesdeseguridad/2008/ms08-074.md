---
TOCTitle: 'MS08-074'
Title: 'Boletín de seguridad de Microsoft MS08-074 - Crítica'
ms:assetid: 'ms08-074'
ms:contentKeyID: 61225507
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms08-074(v=Security.10)'
---

Boletín de seguridad de Microsoft MS08-074 - Crítica
====================================================

Vulnerabilidades en Microsoft Office Excel podrían permitir la ejecución remota de código (959070)
--------------------------------------------------------------------------------------------------

Publicado: martes, 9 de diciembre de 2008 | Actualizado: miércoles, 28 de enero de 2009
...
**Problemas conocidos.** En el [artículo 959070 de Microsoft Knowledge Base](http://support.microsoft.com/kb/959070) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
**¿Por qué se ha revisado este boletín el 28 de enero de 2009?**  
Microsoft ha revisado este boletín para comunicar que para las versiones compatibles de Microsoft Office Excel 2007, además del paquete de actualización de seguridad KB958437, los clientes también deben instalar la actualización de seguridad para [Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f) (KB958439) con el fin de protegerse de las vulnerabilidades descritas en este boletín. Los clientes que ya han instalado correctamente los paquetes de actualización de seguridad KB958437 y KB958439 no tienen que reinstalarlos.

**¿Por qué se requiere la actualización KB958439 para Excel 2007?**  
Las versiones compatibles de Microsoft Office Excel 2007 contienen el componente de convertidor de Excel vulnerable que se actualiza con la actualización para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 (KB958439).. La actualización para Microsoft Office Excel 2007 y Microsoft Office Excel 2007 Service Pack 1 (KB958437) no actualiza el componente de convertidor de Excel.

**¿Dónde están los detalles de información de archivos?**  
Los detalles de información de archivos se pueden encontrar en el [artículo 959070 de Microsoft Knowledge Base](http://support.microsoft.com/kb/959070).

**En MS08-072 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. ¿Cómo se relaciona MS08-072 con este boletín (MS08-074)?**  
Esta actualización de seguridad para Microsoft Office 2004 para Mac (960402), Microsoft Office 2008 para Mac (960401) y Convertidor de archivos con formatos XML abiertos para Mac (960403) también corrige las vulnerabilidades descritas en MS08-072. Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac o Convertidor de archivos con formatos XML abiertos para Mac instalado tendrán que instalar esta actualización de seguridad, pero sólo deberán hacerlo una vez.
...
<th style="border:1px solid black;" >Vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)</th>
<th style="border:1px solid black;" >Vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)</th>
...
Vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)  
-----------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-4265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265).
  
#### Factores atenuantes para la vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)
...
#### Soluciones provisionales para la vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)
...
Existe una vulnerabilidad en Microsoft Office Excel que permite a un atacante ejecutar código cuando un usuario de una versión afectada de Excel abre una hoja de cálculo de Excel especialmente diseñada que haya proporcionado el atacante. La vulnerabilidad específica se encuentra en la forma en que Microsoft Office Excel analiza el formato de archivo de hoja de cálculo de Excel.
...
Esta actualización elimina la vulnerabilidad al cambiar la manera en que Microsoft Office Excel trata la apertura de los archivos de Excel especialmente diseñados
...
Vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)  
-----------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-4264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264).
  
#### Factores atenuantes para la vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)
...
#### Soluciones provisionales para la vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Existe una vulnerabilidad en Microsoft Office Excel que podría permitir a un atacante ejecutar código cuando un usuario de una versión afectada de Excel abre una hoja de cálculo de Excel especialmente diseñada que haya proporcionado el atacante. La vulnerabilidad específica se encuentra en la forma en que Microsoft Office Excel analiza el formato de archivo de hoja de cálculo de Excel.
...
Vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)  
----------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en Microsoft Office Excel como resultado de daños en la pila al cargar registros de Excel. La vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de Excel especialmente diseñado que incluya un objeto con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-4266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   No abra ni guarde los archivos de Microsoft Office que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/959070">artículo 959070 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Joshua J. Drake, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de análisis del formato de archivo (CVE-2008-4265)  
-   Claes M Nyberg, de [signedness.org](http://www.signedness.org/), por informar de la vulnerabilidad de análisis del formato de archivo (CVE-2008-4264)  
-   Dyon Balding, de [Secunia](http://secunia.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con las matrices globales en Excel (CVE-2008-4266)
