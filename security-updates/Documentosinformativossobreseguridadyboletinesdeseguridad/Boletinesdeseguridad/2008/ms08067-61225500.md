...
-   **En Windows** **Vista** **y Windows Server 2008, filtre el identificador de RPC afectado**
    ...
    `Mostrando una lista de todos los filtros RPC.---------------------------------filterKey: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxxdisplayData.name: RPCFilterdisplayData.description: RPC FilterfilterId: 0x12f79layerKey: umweight: Escriba: FWP_EMPTY Value: Emptyaction.type: blocknumFilterConditions: 1`
