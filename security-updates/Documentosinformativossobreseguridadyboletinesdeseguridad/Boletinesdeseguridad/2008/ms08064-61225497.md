---
TOCTitle: 'MS08-064'
Title: 'Boletín de seguridad de Microsoft MS08-064 - Importante'
ms:assetid: 'ms08-064'
ms:contentKeyID: 61225497
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms08-064(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS08-064 - Importante
=======================================================
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows XP, Windows Server 2003, Windows Vista y Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el descriptor de direcciones virtuales trata las variables de asignación de memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-------------------------------------------------------------------------------------------------------|
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                     | Elevación de privilegios        | Importante                          | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022)                                   |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                     | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows XP Professional x64 Edition y Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50fae854-0bde-46f8-9444-b9e0d9bfecad)                      | Elevación de privilegios        | Importante                          | [Documento informativo sobre seguridad de Microsoft (932596)](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 Service Pack 1 y Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667)                                       | Elevación de privilegios        | Importante                          | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022)                                   |
| [Windows Server 2003 x64 Edition y Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2e754f9-086a-494c-bc19-5feed7df8b65)                              | Elevación de privilegios        | Importante                          | [Documento informativo sobre seguridad de Microsoft (932596)](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 con SP1 para sistemas con Itanium y Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=5a3832ec-3f8f-42c1-a603-b1330d527547) | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                                 | Elevación de privilegios        | Importante                          | [MS07-066](http://technet.microsoft.com/security/bulletin/ms07-066)                                   |
| [Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                  | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                     | Elevación de privilegios        | Importante                          | [MS07-066](http://technet.microsoft.com/security/bulletin/ms07-066)                                   |
| [Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                      | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4)\*                                                                | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows Server 2008 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca)\*                                                                       | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
| [Windows Server 2008 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0af72663-4945-4916-8c55-090ba4d82793)                                                                 | Elevación de privilegios        | Importante                          | Ninguna                                                                                               |
...
Los detalles de información de archivos se pueden encontrar en el [artículo 956841 de Microsoft Knowledge Base](http://support.microsoft.com/kb/956841).
...
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)</th>
...
<span></span>
Existe una vulnerabilidad de elevación de privilegios en la forma en que el administrador de memoria trata la asignación de memoria y los descriptores de direcciones virtuales (VAD). La vulnerabilidad podría permitir la elevación de privilegios si un atacante autenticado ejecuta un programa especialmente diseñado en un sistema afectado. Un atacante que aprovechase esta vulnerabilidad podría obtener elevación de privilegios en un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-4036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036).
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)
...
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechase esta vulnerabilidad podría obtener elevación de privilegios en un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El administrador de memoria no trata correctamente un desbordamiento de enteros al disminuir una variable, lo que provoca un error de asignación de memoria.
  
**¿Qué es un descriptor de direcciones virtuales (VAD)?**    
VAD es una forma de memoria virtual para las aplicaciones que permite que cada aplicación tenga su propio espacio de direcciones privadas. Para obtener más información acerca de VAD, consulte los artículos [Administrador de memoria virtual en Windows NT](http://msdn.microsoft.com/en-us/library/ms810616.aspx) y [Administración de la memoria virtual en Win32](http://msdn.microsoft.com/en-us/library/ms810627.aspx) de MSDN.
...
Un atacante autenticado podría ejecutar un programa especialmente diseñado que podría provocar un desbordamiento de enteros, con lo que la memoria se dañaría de modo que permitiera la ejecución de código.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Windows XP, Windows Server 2003, Windows Vista y Windows Server 2008 están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La vulnerabilidad se debe a un desbordamiento de enteros. La actualización elimina la vulnerabilidad al agregar validación adicional en los parámetros de VAD.
...
<td style="border:1px solid black;">Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/956841">artículo 956841 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/956841">artículo 956841 de Microsoft Knowledge Base</a></td>
...
-   Alex Ionescu (<http://www.alex-ionescu.com/>) por informar de la vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)
...
-   V1.1 (15 de octubre de 2008): Se ha corregido en **P+F** el vínculo a un artículo de referencia de MSDN **sobre la vulnerabilidad de elevación de privilegios en el descriptor de direcciones virtuales (CVE-2008-4036)**.
