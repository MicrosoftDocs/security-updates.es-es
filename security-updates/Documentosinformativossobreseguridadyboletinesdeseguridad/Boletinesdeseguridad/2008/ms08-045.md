---
TOCTitle: 'MS08-045'
Title: 'Boletín de seguridad de Microsoft MS08-045 - Crítica'
ms:assetid: 'ms08-045'
ms:contentKeyID: 61225478
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms08-045(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS08-045 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (953838)
----------------------------------------------------------------------

Publicado: martes, 12 de agosto de 2008 | Actualizado: miércoles, 20 de agosto de 2008
...
Esta actualización de seguridad se considera crítica para todas las versiones compatibles de Internet Explorer. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
Los detalles de información de archivos se pueden encontrar en el [artículo 953838 de Microsoft Knowledge Base](http://support.microsoft.com/kb/953838).
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2255)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2258)</th>
<th style="border:1px solid black;" >Vulnerabilidad en el tratamiento de componentes HTML (CVE-2008-2259)</th>
...
Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254)  
--------------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-2254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2254).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254)
...
-   **Lea los mensajes de correo electrónico como texto sin formato si usa Microsoft Outlook 2002 o una versión posterior, o bien Outlook Express 6 SP1 o una versión posterior, para protegerse del tipo de ataque mediante correo electrónico HTML.**
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254)
...
Esta actualización elimina la vulnerabilidad al modificar la manera en que Internet Explorer procesa el error que da lugar a la situación vulnerable.
...
Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2255)  
--------------------------------------------------------------------------------------
  

Existe una vulnerabilidad de ejecución remota de código en Internet Explorer debido a los intentos de obtener acceso a la memoria sin inicializar en determinadas situaciones. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-2255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2255).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2255)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2255)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2255)
...
**En el momento de publicar este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común CVE-2008-2255.
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba usando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes y no tenía constancia de que se hubiera publicado código demostrativo.
  
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256)  
---------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-2256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2256).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256)
  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256)
  
-   Ninguna
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256)
...
Vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257 y CVE-2008-2258)  
------------------------------------------------------------------------------------------------------
  

Existe una vulnerabilidad de ejecución remota de código en Internet Explorer debido a los intentos de obtener acceso a la memoria sin inicializar en determinadas situaciones. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-2257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2257) y [CVE-2008-2258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2258).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257 y CVE-2008-2258)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257 y CVE-2008-2258)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257 y CVE-2008-2258)
...
Vulnerabilidad en el tratamiento de componentes HTML (CVE-2008-2259)  
--------------------------------------------------------------------
  

Existe una vulnerabilidad de ejecución remota de código en la manera en que Internet Explorer trata la validación de argumentos en el tratamiento de la vista preliminar. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos que el usuario que ha iniciado sesión.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-2259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2259).
  
#### Factores atenuantes para la vulnerabilidad en el tratamiento de componentes HTML (CVE-2008-2259)
  
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.  
-   De forma predeterminada, Internet Explorer en Windows Server 2003 y Windows Server 2008 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo establece el nivel de seguridad para la zona Internet en Alto. Esto constituye un factor atenuante para sitios web que no ha agregado a la zona de sitios de confianza de Internet Explorer. Vea la subsección P+F correspondiente a esta sección de vulnerabilidad para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer.
  
#### Soluciones provisionales para la vulnerabilidad en el tratamiento de componentes HTML (CVE-2008-2259)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el tratamiento de componentes HTML (CVE-2008-2259)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
En determinadas circunstancias del procesamiento de vistas preliminares, Internet Explorer trata incorrectamente la validación de argumentos. Como resultado, se podría mostrar una página web especialmente diseñada de modo que un atacante podría ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
...
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al modificar el modo en que Internet Explorer trata los argumentos pasados a la generación de la vista preliminar.
...
\* SMS 2.0 y SMS 2003 con SUSFP admiten todas las versiones afectadas de Internet Explorer excepto para IE7. Para obtener más información, vea el [artículo 924178 de Microsoft Knowledge Base](http://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Para Internet Explorer 5.01 Service Pack 4 en todas las ediciones compatibles de Windows 2000:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB953838-IE501SP4- 20080620.120000 $\Spuninst<br />
<br />
Para Internet Explorer 6 Service Pack 1 cuando está instalado en todas las ediciones compatibles de Windows 2000:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB953838-IE6SP1- 20080620.120000 $\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/953838">artículo 953838 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstal\KB953838$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para Windows XP:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB953838-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">Vea el artículo 953838 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB953838$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   Yamata Li, de [Palo Alto Networks](http://www.paloaltonetworks.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2254).  
-   Tavis Ormandy, de [Google Security Team](http://www.google.com/), por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2008-2256).  
-   Sam Thomas, en colaboración con [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2257).  
-   [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos HTML (CVE-2008-2258).
...
-   V1.1 (20 de agosto de 2008): Se ha corregido una entrada de comprobación de clave del Registro para Windows XP y se ha agregado un factor atenuante para CVE-2008-2256.
