---
TOCTitle: 'MS08-019'
Title: 'Boletín de seguridad de Microsoft MS08-019 - Importante'
ms:assetid: 'ms08-019'
ms:contentKeyID: 61225365
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms08-019(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS08-019 - Importante
=======================================================

Vulnerabilidades en Microsoft Visio podrían permitir la ejecución remota de código (949032)
-------------------------------------------------------------------------------------------
...
**¿Por qué revisó Microsoft este boletín el 18 de abril de 2008?**    
Este boletín se ha revisado para corregir los problemas de detección e instalación que habían afectado a los usuarios los componentes de Microsoft Office 2007. La actualización anteriormente ofrecía e instalaba la versión de Visio 2007 para los usuarios que no tenían instalado Visio 2007 en sus sistemas. Microsoft ha corregido el problema y ha actualizado este boletín para hacer referencia al cambio. Fue un cambio de detección únicamente que no afecta a los archivos que se incluyen en la actualización inicial. A los sistemas con Visio 2007 que ya tienen aplicada la actualización no se les vuelve a ofrecer y los usuarios que ya la han instalado no deben volver a aplicarla a sus sistemas.
  
**¿Cuál es la repercusión de seguridad de la instalación de esta actualización si no tengo instalado Visio 2007 en mi sistema? ¿Qué debo hacer?**    
Ninguna. Si esta actualización se ha instalado incorrectamente en un sistema que no tiene instalado Visio 2007, no se incrementará el riesgo de seguridad en dicho sistema. Los usuarios pueden desinstalar la actualización si ya se ha aplicado. Sin embargo, no es obligatoria la desinstalación, ya que no afectará negativamente a la seguridad ni al rendimiento de un sistema.
...
Los detalles de información de archivos se pueden encontrar en el [artículo 949032 de Microsoft Knowledge Base](http://support.microsoft.com/kb/949032).
...
<th style="border:1px solid black;" >Vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de la memoria en Visio (CVE-2008-1090)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089)  
---------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Visio valida los datos de encabezado de objeto en archivos especialmente diseñados. Un atacante podría aprovechar la vulnerabilidad si envía un archivo con formato incorrecto que se podría incluir como dato adjunto de correo electrónico o alojado en un sitio Web especialmente diseñado o vulnerable.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones habituales, consulte [CVE-2008-1089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089).
  
#### Factores atenuantes para la vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089)
...
#### Soluciones provisionales para la vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   Use Microsoft Visio 2003 Viewer o Microsoft Visio 2007 Viewer para abrir y ver los archivos de Visio. Microsoft Visio 2003 Viewer y Microsoft Visio 2007 Viewer no están afectados por el problema.  
-   No abra ni guarde los archivos de Visio que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089)
...
Microsoft Visio no valida los datos correctamente los datos de encabezado de objeto al abrir archivos de Visio.
...
Esta vulnerabilidad requiere que un usuario abra un archivo de Visio con formato incorrecto de una versión afectada de Microsoft Visio.
  
En el caso de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía al usuario un archivo de Visio con formato incorrecto y le convence para que lo abra.
...
Los sistemas donde se usa Microsoft Visio son los más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al realizar la validación cuando se asigna espacio para los datos de encabezado de objeto al abrir archivos de Visio.
...
Vulnerabilidad de validación de la memoria en Visio (CVE-2008-1090)  
-------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Visio valida las asignaciones de memoria al cargar archivos .DXF especialmente diseñados del disco en la memoria. Un atacante podría aprovechar la vulnerabilidad si envía un archivo con formato incorrecto que se podría incluir como dato adjunto de correo electrónico o alojado en un sitio Web especialmente diseñado o vulnerable.
  
Si un usuario inicia sesión con derechos de usuario administrativos, un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones habituales, consulte [CVE-2008-1090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090).
  
#### Factores atenuantes para la vulnerabilidad de validación de la memoria en Visio (CVE-2008-1090)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, Visio no registra los archivos de dibujo de AutoCAD (extensión de archivo .DXF) ni abrirá un archivo .DXF especialmente diseñado si se hace doble clic en él. Un atacante tendría que convencer a un usuario para que abriera un archivo .DXF; para ello, tendría que iniciar Visio, seleccionar Abrir y, a continuación, cambiar el tipo de archivo predeterminado de "Todos los archivos de Visio" a "Dibujo de AutoCAD".  
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.  
-   La vulnerabilidad no puede aprovecharse automáticamente mediante el correo electrónico. Un usuario debe abrir un archivo adjunto a un mensaje de correo electrónico para que un ataque tenga éxito.
  
#### Soluciones provisionales para la vulnerabilidad de validación de la memoria en Visio (CVE-2008-1090)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Impedir que Visio abra los archivos .DXF con la restricción del acceso a DWGDP.DLL.**  
    Para restringir el acceso a DWGDP.DLL, escriba lo siguiente en el símbolo del sistema:  
    **Nota** Para Vista, se requiere una cuenta con privilegios de administrador con el fin de implementar esta solución provisional.  
    **Para Windows XP**  
    ...
    **Consecuencias de la solución provisional:** La consecuencia de la implementación de esta solución provisional es que Visio ya no abrirá los archivos de dibujo de AutoCAD (.DXF). Si no tiene que abrir archivos de dibujo de AutoCAD, esta solución provisional no debe afectar a la funcionalidad del sistema.  
...
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de la memoria en Visio (CVE-2008-1090)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Microsoft Visio no valida correctamente las asignaciones de memoria al cargar archivos .DXF especialmente diseñados del disco en la memoria.
  
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría ejecutar código arbitrario como el usuario que ha iniciado la sesión. Si un usuario inicia sesión con derechos de usuario administrativos, un atacante podría lograr el control completo del sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Esta vulnerabilidad requiere que un usuario abra un archivo .DXF con formato incorrecto de una versión afectada de Microsoft Visio.
...
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al realizar una validación correcta de las asignaciones de memoria al cargar archivos de Visio del disco en la memoria.
...
| Software                            | MBSA 2.0.1 |  
|-------------------------------------|------------|  
| Microsoft Visio 2002 Service Pack 2 | Sí         |  
| Microsoft Visio 2003 Service Pack 2 | Sí         |  
| Microsoft Visio 2003 Service Pack 3 | Sí         |  
| Microsoft Visio 2007                | Sí         |  
| Microsoft Visio 2007 Service Pack 1 | Sí         |
...
**Nota** Para los clientes que usen software heredado incompatible con MBSA 2.0.1, Microsoft Update y Windows Server Update Services: visite Microsoft Baseline Security Analyzer y consulte en la sección acerca del soporte técnico de productos heredados el modo de crear una detección de actualizaciones de seguridad exhaustiva con herramientas heredadas.
...
|-------------------------------------|---------|--------------------|-------------------|-----------|  
| Microsoft Visio 2002 Service Pack 2 | Sí      | Sí                 | Sí                | Sí        |  
| Microsoft Visio 2003 Service Pack 2 | Sí      | Sí                 | Sí                | Sí        |  
| Microsoft Visio 2003 Service Pack 3 | Sí      | Sí                 | Sí                | Sí        |  
| Microsoft Visio 2007                | No      | No                 | Sí                | Sí        |  
| Microsoft Visio 2007 Service Pack 1 | No      | No                 | Sí                | Sí        |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/949032">artículo 949032 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
**Nota** Puesto que existen varias versiones y ediciones de Microsoft Windows, los pasos que se indican a continuación pueden ser diferentes en su sistema. En tal caso, consulte la documentación del producto para ejecutar los pasos necesarios.
...
-   Un investigador anónimo por informar de la vulnerabilidad de encabezado de objeto en Visio (CVE-2008-1089).  
-   Un investigador anónimo por informar de la vulnerabilidad de validación de memoria en Visio (CVE-2008-1090).
...
-   V1.1 (9 de abril de 2008): Actualización de Problemas conocidos.  
-   V1.2 (11 de abril de 2008): Actualización del boletín. Se ha agregado una entrada de preguntas más frecuentes acerca de un problema conocido relacionado con un problema de detección de Visio 2007.  
-   V1.3 (16 de abril de 2008): Actualización del boletín: Entrada agregada a las preguntas más frecuentes de la actualización para describir las características de seguridad adicionales incluidas para Microsoft Office 2003 Service Pack 2. Aclaración de la tabla de software afectado.  
-   V1.4 (18 de abril de 2008): Se ha actualizado una entrada de preguntas más frecuentes acerca de un problema conocido relacionado con un problema de detección de Visio 2007.  
-   V1.5 (23 de abril de 2008): Aclaración de la entrada de las preguntas más frecuentes de la actualización acerca de la última revisión, con fecha de 18 de abril. Se trata de un cambio de detección que no afecta a los archivos que contiene la actualización inicial.
