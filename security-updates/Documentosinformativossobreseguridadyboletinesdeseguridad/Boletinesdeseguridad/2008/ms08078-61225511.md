...
-   **Restringir el uso de OLEDB32.dll por parte de Internet Explorer con una ACL de nivel de integridad**
    ...
    **Para sistemas de 64 bits**
    ...
    `La tarea se ha completado correctamente.Consultar el registro %windir%\security\logs\scesrv.log para obtener información detallada.`
