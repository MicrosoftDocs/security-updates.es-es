...
<th>Vulnerabilidad de desbordamiento de enteros en el servicio IPP - CVE-2008-1446</th>
...
<p><strong>Nota:</strong> se puede evitar el reinicio del sistema en Windows Server 2003 si se detiene el servicio de IIS, se instala la actualización y, a continuación, se reinicia el servicio de IIS. Si el servicio de IIS no se detiene antes de instalar la actualización, será necesario reiniciar el sistema.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
