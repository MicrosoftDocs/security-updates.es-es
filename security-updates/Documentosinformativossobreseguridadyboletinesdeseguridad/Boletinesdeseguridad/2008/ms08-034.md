---
TOCTitle: 'MS08-034'
Title: 'Boletín de seguridad de Microsoft MS08-034 - Importante'
ms:assetid: 'ms08-034'
ms:contentKeyID: 61225467
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms08-034(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS08-034 - Importante
=======================================================

Una vulnerabilidad en WINS podría permitir la elevación de privilegios (948745)
-------------------------------------------------------------------------------
...
La actualización elimina la vulnerabilidad al validar las estructuras de datos de los paquetes de red procesados por WINS. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=aa8aa79f-c2cc-440c-9e5c-089143e6f814)                                                                  | Elevación de privilegios        | Importante                          | [MS04-045](http://www.microsoft.com/spain/technet/seguridad/boletines/ms04-045-it.mspx) |
| [Windows Server 2003 Service Pack 1 y Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08fc90d5-23aa-4327-8aef-16bc5170769d)                                       | Elevación de privilegios        | Importante                          | Ninguna                                                                                 |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                                                                               | Elevación de privilegios        | Importante                          | [MS04-045](http://www.microsoft.com/spain/technet/seguridad/boletines/ms04-045-it.mspx) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                                                                | Elevación de privilegios        | Importante                          | Ninguna                                                                                 |
| [Windows Server 2003 con SP1 para sistemas con Itanium y Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=87affdc9-d9fe-413c-af30-f3d3b671ec72) | Elevación de privilegios        | Importante                          | Ninguna                                                                                 |
...
Los detalles de información de archivos se pueden encontrar en el [artículo 948745 de Microsoft Knowledge Base](http://support.microsoft.com/kb/948745).

**La descripción de la vulnerabilidad parece indicar ejecución remota de código. ¿Por qué es una vulnerabilidad de elevación de privilegios locales?**  
Para aprovechar esta vulnerabilidad, un atacante debe iniciar sesión en el servidor WINS afectado con credenciales válidas, ejecutar una aplicación que elabore paquetes SDP malintencionados y, a continuación, envíe dichos paquetes al servicio WINS que se ejecuta localmente. El servicio WINS no acepta paquetes SDP de una ubicación remota y sólo puede aceptar estos paquetes del host local. Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
...
<th style="border:1px solid black;"  >Vulnerabilidad de sobrescritura de la memoria (CVE-2008-1451)</th>
...
Vulnerabilidad de sobrescritura de la memoria (CVE-2008-1451)  
-------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en WINS (servicio de nombres Internet de Windows) debida a que WINS no valida suficientemente las estructuras de datos que se encuentran en paquetes de red WINS especialmente diseñados. La vulnerabilidad podría permitir a un atacante local ejecutar código con privilegios elevados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas. Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2008-1451](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1451).
  
#### Factores atenuantes para la vulnerabilidad de sobrescritura de la memoria (CVE-2008-1451)
...
#### Soluciones provisionales para la vulnerabilidad de sobrescritura de la memoria (CVE-2008-1451)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de sobrescritura de la memoria (CVE-2008-1451)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Existe una vulnerabilidad de elevación de privilegios en WINS. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código con privilegios elevados. A continuación, podría lograr el control completo de un sistema afectado. Vea el artículo de [WINS](http://technet2.microsoft.com/windowsserver/en/library/ea41036e-5cbf-427b-a34f-9e4d1d1519581033.mspx?mfr=true) de Technet para obtener más información.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
WINS no valida correctamente las estructuras de datos que se encuentran en paquetes de red WINS especialmente diseñados.
  
**¿Qué es WINS?**  
WINS es un servicio que convierte los nombres NetBIOS en direcciones en una red TCP/IP. Aunque NetBIOS y los nombres NetBIOS se pueden usar con otros protocolos distintos de TCP/IP, WINS (servicio de nombres Internet de Windows) se diseñó específicamente para admitir NetBIOS sobre TCP/IP (NetBT). WINS se necesita para cualquier entorno en el que los usuarios obtengan acceso a recursos que tengan nombres NetBIOS. Si no usa WINS en una red de ese tipo, no podrá conectarse al recurso de red remoto con su nombre NetBIOS a menos que cada sistema incluya sus propios archivos Lmhosts y puede establecer las conexiones para compartir archivos e impresión.
...
Para aprovechar esta vulnerabilidad un atacante local tendría que enviar un paquete específicamente diseñado al servicio WINS afectado.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los servidores WINS de Windows están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**  
La actualización elimina la vulnerabilidad al validar las estructuras de datos de los paquetes de red procesados por WINS.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server Service Pack 4:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB948745$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/948745">artículo 948745 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB948745$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/948745">artículo 948745 de Microsoft Knowledge Base</a></td>
...
-   V1.1 (11 de junio de 2008): Se ha agregado una entrada en las preguntas más frecuentes de la actualización para explicar por qué no se trata de una vulnerabilidad de ejecución remota de código. También se ha agregado una entrada en las preguntas más frecuentes de la actualización para explicar por qué la actualización no se ofrecerá a menos que se haya habilitado WINS en el sistema.
