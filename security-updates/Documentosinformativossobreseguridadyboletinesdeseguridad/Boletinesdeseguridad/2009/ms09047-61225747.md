...
<td style="border:1px solid black;">
[Módulo de tiempo de ejecución de Windows Media Format 9.0, módulo de tiempo de ejecución de Windows Media Format 9.5 y módulo de tiempo de ejecución de Windows Media Format 11](http://www.microsoft.com/downloads/details.aspx?familyid=6ffc081e-f892-4818-acb9-6d79e15d473c)  
(KB968816)
</td>
<td style="border:1px solid black;">
Ejecución remota de código
...
**Restringir el acceso a wmvcore.dll**
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la reproducción de Windows Media (CVE-2009-2499)
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para el módulo de tiempo de ejecución de Windows Media Format 11 y Microsoft Media Foundation en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2:<br />
Windows6.0-KB968816-x86 /quiet<br />
<br />
Para el módulo de tiempo de ejecución de Windows Media Format 11 y Microsoft Media Foundation en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para el módulo de tiempo de ejecución de Windows Media Format y Microsoft Media Foundation:<br />
Vea el <a href="http://support.microsoft.com/kb/968816">artículo 968816 de Microsoft Knowledge Base</a><br />
<br />
Para Servicios de Windows Media:<br />
Vea el <a href="http://support.microsoft.com/kb/972554">artículo 972554 de Microsoft Knowledge Base</a></td>
...
-   Peter Winter-Smith, de [NGS Software](http://www.ngssoftware.com/), por informar de la vulnerabilidad de liberación no válida en el análisis de encabezados de Windows Media (CVE-2009-2498)  
-   Hiroshi Noguchi, del club de admiradores de Alice Carroll, por informar de la vulnerabilidad de daños en la memoria relacionada con la reproducción de Windows Media (CVE-2009-2499)
...
-   V1.1 (September 16, 2009): Se ha corregido la lista de los boletines sustituida por la actualización para Windows Media Format Runtime, en Microsoft Windows 2000, Windows XP y Windows Server 2003.
