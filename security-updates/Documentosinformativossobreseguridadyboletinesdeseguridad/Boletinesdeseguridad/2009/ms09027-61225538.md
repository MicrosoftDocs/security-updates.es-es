---
TOCTitle: 'MS09-027'
Title: 'Boletín de seguridad de Microsoft MS09-027 - Crítica'
ms:assetid: 'ms09-027'
ms:contentKeyID: 61225538
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-027(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-027 - Crítica
====================================================
...
<tr>
<td style="border:1px solid black;">
[Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
No aplicable
...
En el [artículo 969514 de Microsoft Knowledge Base](http://support.microsoft.com/kb/969514) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas. Cuando los problemas conocidos y las soluciones recomendadas corresponden sólo a versiones específicas de este software, este artículo proporciona vínculos a más artículos.

**En MS09-017 y MS09-021 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. ¿Cómo se relacionan MS09-017 y MS09-021 con este boletín (MS09-027)?**  
 Los paquetes de actualización de seguridad de este boletín, MS09-027, para Microsoft Office 2004 para Mac (KB969661), Microsoft Office 2008 para Mac (KB971822) y Convertidor de archivos con formatos XML abiertos para Mac (KB971824) también corrigen las vulnerabilidades descritas en [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017) y [MS09-021](http://technet.microsoft.com/security/bulletin/ms09-021). Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac o Convertidor de archivos con formatos XML abiertos para Mac instalado sólo deberán instalar una vez los paquetes de actualización.
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0563)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0565)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0563)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0563)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0563)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0565](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0565)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0565)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0565)
...
| Microsoft Office Word 2007 Service Pack 1 y Microsoft Office Word 2007 Service Pack 2                                                                                                                                                           | Sí       |
...
| Microsoft Office Word Viewer 2003 Service Pack 3                                                                                                                                                                                                | Sí       |
...
| Microsoft Office Word 2007 Service Pack 1 y Microsoft Office Excel 2007 Service Pack 2                                                                                                                                                          | No      | No                 | Sí                | Sí                         |
...
| Microsoft Office Word Viewer 2003 Service Pack 3                                                                                                                                                                                                | Sí      | Sí                 | Sí                | Sí                         |
| Microsoft Office Word Viewer                                                                                                                                                                                                                    | Sí      | Sí                 | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969600">artículo 969600 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969602">artículo 969602 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Word 2003 (todas las ediciones), Word Viewer 2003 y Word Viewer
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Word 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/969603">artículo 969603 de Microsoft Knowledge Base</a>.<br />
<br />
Para Word Viewer 2003 y Word Viewer:<br />
Vea el <a href="http://support.microsoft.com/kb/969614">artículo 969614 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Word 2007 (todas las ediciones) y Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Word 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/969604">artículo 969604 de Microsoft Knowledge Base</a>.<br />
<br />
Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/969613">artículo 969613 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Wushi, de [team509](http://www.team509.com/), en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0563)  
-   Nicolas Joly, de [VUPEN Security](http://www.vupen.com/), por informar de la vulnerabilidad de desbordamiento del búfer en Word (CVE-2009-0565)
