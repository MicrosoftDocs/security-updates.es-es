---
TOCTitle: 'MS09-018'
Title: 'Boletín de seguridad de Microsoft MS09-018 - Crítica'
ms:assetid: 'ms09-018'
ms:contentKeyID: 61225529
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-018(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS09-018 - Crítica
====================================================
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Microsoft Windows 2000 Server e importante para las versiones compatibles de Windows XP Professional y Windows Server 2003. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el servicio LDAP asigna y libera memoria al procesar solicitudes LDAP o LDAPS especialmente diseñadas.
...
<br />
Servicio de directorio ligero de Active Directory (AD LDS)</td>
</tr>
<tr class="odd">
...
<th style="border:1px solid black;" >Vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)</th>
<th style="border:1px solid black;" >Vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Active Directory Application Mode (ADAM) cuando está instalado en Windows XP Professional Service Pack 2 y Windows XP Professional Service Pack 3</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
...
<tr class="odd">
<td style="border:1px solid black;">Active Directory Application Mode (ADAM) cuando está instalado en Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
<tr class="even">
<td style="border:1px solid black;">Active Directory en Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Active Directory Application Mode (ADAM) cuando está instalado en Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
<tr class="even">
<td style="border:1px solid black;">Active Directory en Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Active Directory Application Mode (ADAM) cuando está instalado en Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
<tr class="even">
<td style="border:1px solid black;">Active Directory en Windows Server 2003 con SP2 para sistemas con Itanium</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Denegación de servicio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
...
Vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)  
--------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en implementaciones de Active Directory en Microsoft Windows 2000 Server. La vulnerabilidad se debe a que la memoria se libera incorrectamente cuando se procesan solicitudes LDAP o LDAPS especialmente diseñadas. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138).
  
#### Factores atenuantes para la vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)
...
#### Soluciones provisionales para la vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Bloquear los puertos TCP 389, 636, 3268 y 3269 en el firewall**
  
    Bloquee lo siguiente en el servidor de seguridad:
  
    Puertos TCP 389, 636, 3268 y 3269
  
    Estos puertos se utilizan para iniciar una conexión con el componente afectado. Al bloquearlos en el servidor de seguridad de la empresa, para el tráfico entrante y saliente, ayudará a proteger los sistemas situados detrás de dicho servidor de seguridad de intentos de aprovechar esta vulnerabilidad. Los puertos 389 y 636 proporcionan servicios LDAP y LDAP seguro, respectivamente, mientras que los puertos 3268 y 3269 los usa el servidor de catálogo global, que también procesa solicitudes de LDAP.
  
    Microsoft le recomienda bloquear toda la comunicación entrante no solicitada de Internet para ayudar a impedir ataques que puedan utilizar otros puertos. Para obtener más información acerca de puertos, vea [asignaciones de puertos TCP y UDP](http://go.microsoft.com/fwlink/?linkid=21312). Para obtener más información acerca de Firewall de Windows, consulte [Cómo configurar Firewall de Windows en un único equipo](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
-   **Deshabilitar el acceso LDAP anónimo en los servidores Microsoft Windows 2000**
  
    Al deshabilitar el acceso LDAP anónimo en los servidores Microsoft Windows 2000 se limita la capacidad de aprovechar esta vulnerabilidad sólo a los usuarios autenticados. Para obtener más información acerca de las conexiones de base NULL (anónimas) de LDAP, incluida una descripción de la repercusión al deshabilitarlas, vea el [artículo 837964 de Microsoft Knowledge Base](http://support.microsoft.com/kb/837964).
  
#### Preguntas más frecuentes sobre la vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El servicio LDAP libera incorrectamente la memoria después de tratar solicitudes LDAP o LDAPS especialmente diseñadas.
...
De forma predeterminada, el tráfico LDAP no se transmite de forma segura. No obstante, se puede hacer que el tráfico LDAP sea confidencial y protegerlo contra su modificación si se usa la tecnología Capa de sockets seguros (SSL) / Seguridad de la capa de transporte (TLS). Los administradores pueden habilitar LDAP sobre SSL (LDAPS) si instalan un certificado con formato correcto de una entidad de certificación (CA) de Microsoft o una CA que no sea de Microsoft. Para obtener más información, vea el [artículo 321051 de Microsoft Knowledge Base](http://support.microsoft.com/kb/321051).
...
**¿Cómo puedo confirmar si mi servidor ejecuta el servicio LDAP**?    
Para confirmar si un servidor escucha consultas LDAP o LDAPS, ejecute el siguiente comando desde un símbolo del sistema con privilegios de administrador y compruebe si escucha en el puerto LDAP (389) o LDAPS (636), o bien en cualquiera de los puertos del servicio de catálogo global (3268 o 3269):  
netstat –a  
LDAP está habilitado si los resultados contienen cualquier elemento de los siguientes:  
Protocolo Dirección local Dirección externa Estado  
TCP 0.0.0.0:389 0.0.0.0:0 ESCUCHANDO  
TCP 0.0.0.0:636 0.0.0.0:0 ESCUCHANDO  
TCP 0.0.0.0:3268 0.0.0.0:0 ESCUCHANDO  
TCP 0.0.0.0:3269 0.0.0.0:0 ESCUCHANDO
...
Un atacante podría aprovechar la vulnerabilidad si envía un paquete LDAP o LDAPS especialmente diseñado a un controlador de dominio con Microsoft Windows 2000. Cualquier usuario anónimo con acceso a la red de destino podría entregar un paquete de red especialmente diseñado al sistema afectado para aprovechar esta vulnerabilidad.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
LDAP es un requisito para Active Directory. Cualquier servidor con Microsoft Windows 2000 Server en función de servidor de Active Directory está afectado por esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la forma en que el servicio LDAP libera memoria al procesar solicitudes LDAP o LDAPS de cliente especialmente diseñadas.
...
Vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)  
------------------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en implementaciones de Active Directory en Microsoft Windows 2000 Server y Windows Server 2003. La vulnerabilidad también existe en implementaciones de Active Directory Application Mode (ADAM) cuando está instalado en Windows XP Professional y Windows Server 2003. La vulnerabilidad se debe a la administración incorrecta de la memoria durante la ejecución de determinados tipos de solicitudes LDAP o LDAPS. Un atacante que aprovechara esta vulnerabilidad podría provocar que el servidor afectado dejara de responder.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1139](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139).
  
#### Factores atenuantes para la vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Si se siguen las prácticas recomendadas relativas al uso de servidores de seguridad y se implementan las configuraciones de servidores de seguridad predeterminadas estándar, puede contribuirse a proteger una red de los ataques que se originen fuera del ámbito de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos.
  
#### Soluciones provisionales para la vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
El servicio LDAP administra incorrectamente la memoria mientras ejecuta solicitudes LDAP o LDAPS que contienen filtros OID específicos.
...
**¿Qué son los filtros OID?**    
Un OID, o identificador de objeto, se usa para asignar un nombre a un objeto LDAP. Una consulta LDAP puede contener un filtro para seleccionar los datos de un espacio de nombres LDAP que coincida únicamente con un OID específico.
  
**¿Qué es Active Directory Application Mode (ADAM)?**    
ADAM es un servicio de directorio LDAP (protocolo ligero de acceso a directorios) que se ejecuta como un servicio de usuario, en vez de hacerlo como un servicio de sistema. Para obtener más información, vea el artículo de TechNet [Conceptos de ADAM](http://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true).
  
**¿El servicio de directorio ligero de Active Directory (AD LDS) está afectado por esta vulnerabilidad?**    
Los servicios de directorio ligero de Active Directory son un modo independiente de Active Directory que proporciona servicios de directorio dedicado para las aplicaciones. AD LDS sólo está disponible actualmente para el sistema operativo Microsoft Windows Server 2008, y no está afectado por esta vulnerabilidad.
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría provocar que un sistema afectado dejara de responder y se reiniciara.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante podría intentar aprovechar la vulnerabilidad mediante el envío de un paquete LDAP o LDAPS especialmente diseñado al servidor Active Directory o ADAM. Para Microsoft Windows 2000 Server, cualquier usuario anónimo con acceso a la red de destino que pudiera enviar un paquete de red especialmente diseñado al sistema afectado podría aprovechar esta vulnerabilidad. En Windows Server 2003 o sistemas con ADAM instalado, el atacante debe tener credenciales de autenticación válidas para aprovechar esta vulnerabilidad.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
El protocolo ligero de acceso a directorios (LDAP) es un requisito para Active Directory y ADAM. Por lo tanto, cualquier sistema que se ejecute como un servidor Active Directory o ADAM está afectado por esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la forma en que el servicio LDAP asigna memoria al procesar solicitudes LDAP o LDAPS especialmente diseñadas.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB969805-x86-ENU /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB969805-x86-ENU /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | kb969805.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB969805$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 969805 de Microsoft Knowledge Base](http://support.microsoft.com/kb/969805).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969805\\Filelist                                                                                  |
...
#### Windows XP Professional (todas las ediciones) con Active Directory Application Mode (ADAM)
...
<td style="border:1px solid black;">Para Windows XP Professional Service Pack 2 con ADAM y Windows XP Professional Service Pack 3 con ADAM:<br />
WindowsXP-KB970437-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows XP Professional x64 Edition Service Pack 2 con ADAM:<br />
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB970437$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/970437">artículo 970437 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para Todas las ediciones de 32 bits compatibles de Windows XP con ADAM:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB970437\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows XP con ADAM:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB969805$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969805">artículo 969805 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
#### Windows Server 2003 (todas las ediciones) con Active Directory Application Mode (ADAM)
...
-   Joshua J. Drake, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de liberación no válida en Active Directory (CVE-2009-1138)
-   Justin Wyatt, de [Beaverton School District](http://www.beaverton.k12.or.us/home/), por informar de la vulnerabilidad de pérdida de memoria en Active Directory (CVE-2009-1139)
...
-   V1.1 (17 de junio de 2009): Se han enumerado Microsoft Windows 2000 Professional Service Pack 4, todas las ediciones compatibles de Windows Vista y todas las versiones compatibles de Windows Server 2008 para sistemas con Itanium como software no afectado. También se indican los puertos que usa el servidor de catálogo global en la solución provisional Bloquear los puertos TCP para CVE-2009-1139. Se trata únicamente de un cambio informativo.
