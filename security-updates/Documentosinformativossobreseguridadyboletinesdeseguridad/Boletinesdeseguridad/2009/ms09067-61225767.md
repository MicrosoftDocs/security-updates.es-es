---
TOCTitle: 'MS09-067'
Title: 'Boletín de seguridad de Microsoft MS09-067 - Importante'
ms:assetid: 'ms09-067'
ms:contentKeyID: 61225767
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-067(v=Security.10)'
---
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1 y Microsoft Office Excel 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693)\*  
(KB973593)
</td>
<td style="border:1px solid black;">
Ejecución remota de código
...
<p> </p>
\*Para Microsoft Office Excel 2007 Service Pack 1 y Microsoft Office PowerPoint 2007 Service Pack 2, además del paquete de actualización de seguridad KB973593, los clientes también deben instalar la actualización de seguridad para [Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 1 y Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) (KB973704) con el fin de protegerse de las vulnerabilidades descritas en este boletín.
...
En el [artículo 972652 de Microsoft Knowledge Base](http://support.microsoft.com/kb/972652) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.

**¿Contiene esta actualización algún cambio en relación con la seguridad en su funcionalidad?**  
Sí. Después de instalar esta actualización de seguridad, si un usuario abre un archivo de Excel especialmente diseñado, Excel puede cerrarse inesperadamente pero no se podrán aprovechar las vulnerabilidades tratadas en esta actualización.
...
**En MS09-068 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. ¿Cómo se relaciona MS09-068 con este boletín (MS09-067)?**  
Los paquetes de actualización de seguridad de este boletín, MS09-067, para Microsoft Office 2004 para Mac (KB976830), Microsoft Office 2008 para Mac (KB976828) y Convertidor de archivos con formatos XML abiertos para Mac (KB976831) también corrigen las vulnerabilidades descritas en MS09-068. Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac o Convertidor de archivos con formatos XML abiertos para Mac instalado sólo deberán instalar una vez los paquetes de actualización.
...
<th>
Vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con SxView de Excel (CVE-2009-3128)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con Fatheader de Excel (CVE-2009-3129)
</th>
<th>
Vulnerabilidad de desbordamiento del montón al analizar documentos de Excel (CVE-2009-3130)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el análisis de fórmulas de Excel (CVE-2009-3131)
</th>
<th>
Vulnerabilidad de análisis de índices en Excel (CVE-2009-3132)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el análisis de documentos de Excel (CVE-2009-3133)
</th>
<th>
Vulnerabilidad de saneamiento de campos de Excel (CVE-2009-3134)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)
...
-   A los usuarios de Office XP y versiones posteriores de Office se les mostrará un mensaje de confirmación para abrir, guardar o cancelar un documento.

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)
...
La vulnerabilidad se debe a la forma en que Microsoft Office Excel analiza el formato de hoja de cálculo de Excel al abrir una hoja de cálculo de Excel especialmente diseñada.
...
Para aprovechar esta vulnerabilidad es necesario que un usuario abra una hoja de cálculo de Excel especialmente diseñada de una versión afectada de Microsoft Office Excel.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Office Excel trata los archivos de Excel especialmente diseñados que incluyen un objeto de registro con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3128](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con SxView de Excel (CVE-2009-3128)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con SxView de Excel (CVE-2009-3128)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con SxView de Excel (CVE-2009-3128)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3129](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Fatheader de Excel (CVE-2009-3129)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Fatheader de Excel (CVE-2009-3129)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Fatheader de Excel (CVE-2009-3129)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Office Excel trata los archivos de Excel con registros BIFF con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3130](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón al analizar documentos de Excel (CVE-2009-3130)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón al analizar documentos de Excel (CVE-2009-3130)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón al analizar documentos de Excel (CVE-2009-3130)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Excel no trata correctamente los archivos de Excel con registros BIFF (formato de archivo binario) con formato incorrecto, que podría alterar la memoria de forma tal que un atacante podría ejecutar código arbitrario.
...
**¿Cómo funciona esta actualización?**  
La actualización elimina la vulnerabilidad al modificar el modo en que Excel trata los registros BIFF con formato incorrecto.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Office Excel analiza los documentos que contienen una fórmula especialmente diseñada incrustada en una celda. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario en el contexto del usuario que ha iniciado la sesión actualmente.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3131](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el análisis de fórmulas de Excel (CVE-2009-3131)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el análisis de fórmulas de Excel (CVE-2009-3131)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el análisis de fórmulas de Excel (CVE-2009-3131)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a la forma en que Microsoft Office Excel analiza una hoja de cálculo de Excel que contiene una fórmula especialmente diseñada.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en Microsoft Office Excel como resultado de daños en el puntero al cargar fórmulas de Excel. La vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de Excel especialmente diseñado que incluya una fórmula con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132).

#### Factores atenuantes para la vulnerabilidad de análisis de índices en Excel (CVE-2009-3132)
...
#### Soluciones provisionales para la vulnerabilidad de análisis de índices en Excel (CVE-2009-3132)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de índices en Excel (CVE-2009-3132)
...
**¿Cómo funciona esta actualización?**  
Esta actualización corrige la vulnerabilidad al cambiar la manera en que Microsoft Office Excel trata la apertura de los archivos de Excel especialmente diseñados.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en Microsoft Office Excel como resultado de daños en la memoria al cargar registros de Excel. La vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de Excel especialmente diseñado que incluya un objeto con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3133](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el análisis de documentos de Excel (CVE-2009-3133)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el análisis de documentos de Excel (CVE-2009-3133)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el análisis de documentos de Excel (CVE-2009-3133)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en Microsoft Office Excel que podría permitir la ejecución remota de código si un usuario abre un archivo de Excel especialmente diseñado que incluya un objeto de registro con formato incorrecto. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134).

#### Factores atenuantes para la vulnerabilidad de saneamiento de campos de Excel (CVE-2009-3134)
...
#### Soluciones provisionales para la vulnerabilidad de saneamiento de campos de Excel (CVE-2009-3134)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de saneamiento de campos de Excel (CVE-2009-3134)
...
| Software                                                                                                                                                                                                                                        | MBSA 2.1.1 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                                                                                      | Sí         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                                                                                      | Sí         |
| Microsoft Office Excel 2007 Service Pack 1 y Microsoft Office Excel 2007 Service Pack 2                                                                                                                                                         | Sí         |
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|-------------------|-------------------|----------------------------|
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                                                                                      | No      | No                | Sí                | Sí                         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                                                                                      | No      | No                | Sí                | Sí                         |
| Microsoft Office Excel 2007 Service Pack 1 y Microsoft Office Excel 2007 Service Pack 2                                                                                                                                                         | No      | No                | Sí                | Sí                         |
| Office 2004 para Mac                                                                                                                                                                                                                            | No      | No                | No                | No                         |
| Office 2008 para Mac                                                                                                                                                                                                                            | No      | No                | No                | No                         |
| Convertidor de archivos con formatos XML abiertos para Mac                                                                                                                                                                                      | No      | No                | No                | No                         |
| Microsoft Office Excel Viewer 2003 Service Pack 3                                                                                                                                                                                               | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/973471">artículo 973471 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
#### Excel 2003 (todas las ediciones) y Excel Viewer 2003
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Excel 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/973475">artículo 973475 de Microsoft Knowledge Base</a>.<br />
<br />
Para Excel Viewer 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/973484">artículo 973484 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Excel 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/973593">artículo 973593 de Microsoft Knowledge Base</a>.<br />
<br />
Para Excel Viewer:<br />
Vea el <a href="http://support.microsoft.com/kb/973707">artículo 973707 de Microsoft Knowledge Base</a>.<br />
<br />
Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/973704">artículo 973704 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2004 para Mac 11.5.6 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e).
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office 2004 para Mac 11.5.6. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office 2004 para Mac 11.5.6, haga doble clic en la aplicación Actualización de Microsoft Office 2004 para Mac 11.5.6 y siga las instrucciones en pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado “Comprobación de la instalación de la actualización” siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office 2004 para Mac 11.5.6 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **11.5.6**, significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2008 para Mac 12.2.3 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928).
  
-   Cierre todas las aplicaciones en ejecución, incluidos los programas antivirus, todas las aplicaciones de Microsoft Office, Microsoft Messenger para Mac y Office Notifications, ya que podrían interferir con la instalación.  
-   Abra en el escritorio el volumen de actualización de Microsoft Office 2008 para Mac 12.2.3. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office 2008 para Mac 12.2.3, haga doble clic en la aplicación Actualización de Microsoft Office 2008 para Mac 12.2.3 y siga las instrucciones en pantalla.  
...
Si el número de versión es **12.2.3**, significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.1.3 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6).
  
-   Cierre todas las aplicaciones en ejecución, incluidos los programas antivirus, todas las aplicaciones de Microsoft Office, Microsoft Messenger para Mac y Office Notifications, ya que podrían interferir con la instalación.  
-   Abra en el escritorio el volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.1.3. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.1.3, haga doble clic en la aplicación de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.1.3 y siga las instrucciones que aparecen en la pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado “Comprobación de la instalación de la actualización” siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.1.3 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **1.1.3**, significa que la actualización se ha instalado correctamente.
...
-   Bing Liu, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com), por informar de la vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)  
-   [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en la memoria caché de Excel (CVE-2009-3127)  
-   Bing Liu, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com), por informar de la vulnerabilidad de daños en la memoria relacionada con SxView de Excel (CVE-2009-3128)  
-   Sean Larsson, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con Fatheader de Excel (CVE-2009-3129)  
-   Nicolas Joly, de [VUPEN Security](http://www.vupen.com/), por informar de la vulnerabilidad de desbordamiento del montón al analizar documentos de Excel (CVE-2009-3130)  
-   Nicolas Joly, de [VUPEN Security](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con el análisis de fórmulas de Excel (CVE-2009-3131)  
-   Nicolas Joly, de [VUPEN Security](http://www.vupen.com/), por informar de la vulnerabilidad de análisis de índices en Excel (CVE-2009-3132)  
-   Nicolas Joly, de [VUPEN Security](http://www.vupen.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con el análisis de documentos de Excel (CVE-2009-3133)  
-   Bing Liu, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com), por informar de la vulnerabilidad de saneamiento de campos de Excel (CVE-2009-3134)
