...
<th>Vulnerabilidad de anulación de referencia de puntero (CVE-2009-0566)</th>
<th>Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
-   **Deshabilitar la DLL del convertidor de Publisher**
    ...
    **Nota** Use las rutas de acceso de Windows adecuadas para su sistema, como “%ProgramFiles(86)%” o “%windir%\\SysWOW64”.
    ...
    `takeown /f “c:\archivos de programa\microsoft office\office12\pubconv.dll”icacls “c:\archivos de programa\microsoft office\office12\pubconv.dll” /save %TEMP%\ PUBCONV ACL.TXTicacls “c:\archivos de programa\microsoft office\office12\pubconv.dll” /deny everyone(F)`
    ...
    `takeown /f <RUTA_DE_ACCESO_Y_NOMBRE_DE_ARCHIVO_DE_64_BITS>icacls <RUTA_DE_ACCESO_Y_NOMBRE_DE_ARCHIVO_DE_64_BITS> /save %TEMP%\ FILENAME_ACL.TXTicacls <RUTA_DE_ACCESO_Y_NOMBRE_DE_ARCHIVO_DE_64_BITS> /deny everyone (F)`
