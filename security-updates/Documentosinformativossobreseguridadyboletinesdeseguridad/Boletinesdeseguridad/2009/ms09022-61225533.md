---
TOCTitle: 'MS09-022'
Title: 'Boletín de seguridad de Microsoft MS09-022 - Crítica'
ms:assetid: 'ms09-022'
ms:contentKeyID: 61225533
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-022(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS09-022 - Crítica
====================================================
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Microsoft Windows 2000, moderada para todas las ediciones compatibles de Windows XP y Windows Server 2003, e importante para todas las ediciones compatibles de Windows Vista y Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado** en esta sección.

La actualización corrige las vulnerabilidades al cambiar la forma en que el administrador de trabajos de impresión analiza determinadas estructuras de datos de impresión, al limitar la ubicación de donde el servicio de impresión de Windows pueden leer las páginas de separación o los archivos incrustados y al restringir las rutas de acceso desde las que el administrador de trabajos de impresión puede cargar una DLL. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.**  En el [artículo 961501 de Microsoft Knowledge Base](http://support.microsoft.com/kb/961501) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=86378753-db24-44c2-a27d-cc0239f40ab8)                                                                          | Ejecución remota de código      | Crítica                             | [MS07-021](http://technet.microsoft.com/security/bulletin/ms07-021) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f2119aca-a98e-4810-be52-f38241443baf)                                                          | Elevación de privilegios        | Moderada                            | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=22699d09-1e68-456a-8733-bfad6667ebf5)                                                             | Elevación de privilegios        | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=865414f8-3f77-4fee-acc6-6684a3dc0aa4)                                                                             | Elevación de privilegios        | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=197a6cc7-4ba3-4d2e-b621-0ef3da645ef2)                                                                 | Elevación de privilegios        | Moderada                            | Ninguna                                                             |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=719efd62-fb33-447d-b6dd-2aaafbbad881)                                                          | Elevación de privilegios        | Moderada                            | Ninguna                                                             |
| [Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3ad8f037-2434-4dea-bfc3-9d3b4008b828)                                     | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85c317cd-2a14-4747-9f50-3af3ddd3ae1b) | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f18356d-9f09-4d24-8361-970c0d1ccac4)\*   | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d0a6e8d-a31d-4f3d-a7d7-e61215bfebed)\*                 | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bbac3deb-6c93-45aa-832c-02b915ac7f44)   | Elevación de privilegios        | Importante                          | Ninguna                                                             |
...
Sí. Aparte de los cambios enumerados en la sección Información sobre la vulnerabilidad de este boletín, esta actualización de seguridad también restringe las rutas de acceso donde se deben encontrar los archivos de separación y los archivos incrustados @F*nombre de ruta de acceso*. Antes de instalar la actualización, los usuarios podían aplicar páginas de separación con archivos incrustados desde cualquier ubicación. Después de instalar esta actualización, sólo se imprimirán las páginas de separación con el archivo incrustado en una ubicación restringida. Para obtener más información acerca de las ubicaciones adecuadas para estos archivos, vea el [artículo 102712 de Microsoft Knowledge Base](http://support.microsoft.com/kb/102712).
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)</th>
<th style="border:1px solid black;" >Vulnerabilidad de lectura de archivos en el administrador de trabajos de impresión (CVE-2009-0229)</th>
<th style="border:1px solid black;" >Vulnerabilidad de carga de bibliotecas en el administrador de trabajos de impresión (CVE-2009-0230)</th>
...
Vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)  
-------------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en el administrador de trabajos de impresión de Windows que podrían permitir a un atacante remoto y sin autenticar ejecutar arbitrario en un sistema afectado. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0228](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0228).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)
...
-   **Deshabilite el servicio de cola de impresión**
    ...
    **Cómo deshacer la solución provisional.**
    ...
    Para habilitar el servicio de administrador de trabajos de impresión, siga estos pasos:
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)
...
El administrador de trabajos de impresión de Windows contiene un desbordamiento de búfer debido al análisis incorrecto de determinadas estructuras de datos de impresión.
  
**¿Qué es el servicio de administrador de trabajos de impresión?**    
El servicio de de administrador de trabajos de impresión es un archivo ejecutable instalado como servicio. La cola se carga durante el inicio del sistema operativo y continúa ejecutándose hasta que se cierra el sistema. Este servicio administra el proceso de impresión, que incluye tareas como la recuperación de la ubicación del controlador de impresora correcto, la carga de dicho controlador, la colocación en la cola de un trabajo de impresión de las llamadas de función de alto nivel y la programación de trabajos de impresión. Una vez completadas las tareas de un trabajo de impresión particular, el servicio de cola de impresión transfiere el trabajo al enrutador de impresión. Para obtener más información, vea el artículo de TechNet, [Cómo funciona la impresión en red](http://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true).
...
Para que se produzca la ejecución remota de código, el atacante primero necesita configurar un servidor de impresión malintencionado al que se pueda obtener acceso mediante un sistema afectado. Después, el atacante puede enviar una solicitud RPC especialmente diseñada al sistema afectado que provocaría que analizara incorrectamente el nombre de recurso compartido en el servidor de impresión del atacante durante la enumeración. Esto permitiría al atacante realizar la ejecución remota de código en el sistema afectado con privilegios de nivel de sistema.
...
La actualización corrige la vulnerabilidad al cambiar la forma en que el administrador de trabajos de impresión analiza determinadas estructuras de datos.
...
Vulnerabilidad de lectura de archivos en el administrador de trabajos de impresión (CVE-2009-0229)  
--------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de divulgación de información autenticada y local en el servicio de impresión de Windows que podría permitir a un usuario leer o imprimir cualquier archivo del sistema. Esta acción se puede realizar incluso si el usuario no tiene acceso administrativo. No obstante, los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0229](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0229).
  
#### Factores atenuantes para la vulnerabilidad de lectura de archivos en el administrador de trabajos de impresión (CVE-2009-0229)
...
#### Soluciones provisionales para la vulnerabilidad de lectura de archivos en el administrador de trabajos de impresión (CVE-2009-0229)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de lectura de archivos en el administrador de trabajos de impresión (CVE-2009-0229)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que consiga aprovechar esta vulnerabilidad podría leer o imprimir cualquier archivo del sistema. Esta acción se puede realizar incluso si el usuario no tiene acceso administrativo.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El servicio de impresión de Windows no comprueba correctamente los archivos que se pueden incluir con las páginas de separación.
  
**¿Qué es el servicio de administrador de trabajos de impresión?**    
El servicio de de administrador de trabajos de impresión es un archivo ejecutable instalado como servicio. La cola se carga durante el inicio del sistema operativo y continúa ejecutándose hasta que se cierra el sistema. Este servicio administra el proceso de impresión, que incluye tareas como la recuperación de la ubicación del controlador de impresora correcto, la carga de dicho controlador, la colocación en la cola de un trabajo de impresión de las llamadas de función de alto nivel y la programación de trabajos de impresión. Una vez completadas las tareas de un trabajo de impresión particular, el servicio de cola de impresión transfiere el trabajo al enrutador de impresión. Para obtener más información, vea el artículo de TechNet, [Cómo funciona la impresión en red](http://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true).
  
**¿Qué es una página de separación?**    
Una página de separación o de titular normalmente indica quién ha enviado el documento a la impresora y ofrece la fecha y la hora de impresión. Puede utilizar una de las páginas de separación estándar o crear una personalizada. Windows proporciona tres archivos de página de separación, que se encuentran en la carpeta %systemroot%\\System32. Para obtener más información, vea el artículo de TechNet, [Usar páginas de separación](http://technet.microsoft.com/en-us/library/cc737357.aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que consiga aprovechar esta vulnerabilidad podría leer o imprimir cualquier archivo de un sistema afectado. El atacante no tendría la capacidad de cambiar el contenido de un archivo.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Para aprovechar esta vulnerabilidad, el atacante debería iniciar sesión en el sistema. Después, podría crear una página de separación especialmente diseñada que incluyera cualquier archivo del sistema que deseara incluir en la solicitud de impresión.
  
En todas las versiones de Microsoft Windows, el atacante necesita el privilegio "Administrar impresora" para aprovechar este problema. En Windows Vista y Windows Server 2008, al usuario local se le asigna automáticamente este permiso si instala una impresora local. Esto se puede realizar sin privilegios administrativos si el controlador de impresora está incluido de forma predeterminada.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los sistemas con más riesgo de sufrir un ataque son las estaciones de trabajo y los servidores de Servicios de Terminal Server. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al limitar la ubicación en las que el servicio de impresión de Windows puede leer las páginas de separación y los archivos incrustados.
...
Vulnerabilidad de carga de bibliotecas en el administrador de trabajos de impresión (CVE-2009-0230)  
---------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios de forma remota y autenticada en el administrador de trabajos de impresión de Windows que podría permitir la carga de una biblioteca de vínculos dinámicos (DLL) arbitraria, por parte del administrador de trabajos de impresión. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario con privilegios elevados. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0230](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0230).
  
#### Factores atenuantes para la vulnerabilidad de carga de bibliotecas en el administrador de trabajos de impresión (CVE-2009-0230)
...
-   En todas las versiones de Microsoft Windows, el atacante necesita el privilegio "Administrar impresora" para aprovechar esta vulnerabilidad. En Microsoft Windows Vista y Windows Server 2008, al usuario local se le asigna automáticamente este permiso cuando instala una impresora local. Esto se puede realizar sin privilegios administrativos si el controlador de impresora está incluido de forma predeterminada.
  
#### Soluciones provisionales para la vulnerabilidad de carga de bibliotecas en el administrador de trabajos de impresión (CVE-2009-0230)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de carga de bibliotecas en el administrador de trabajos de impresión (CVE-2009-0230)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
El administrador de trabajos de impresión de Windows no valida correctamente las rutas de acceso desde las que se puede cargar una DLL.
  
**¿Qué es el servicio de administrador de trabajos de impresión?**    
El servicio de de administrador de trabajos de impresión es un archivo ejecutable instalado como servicio. La cola se carga durante el inicio del sistema operativo y continúa ejecutándose hasta que se cierra el sistema. Este servicio administra el proceso de impresión, que incluye tareas como la recuperación de la ubicación del controlador de impresora correcto, la carga de dicho controlador, la colocación en la cola de un trabajo de impresión de las llamadas de función de alto nivel y la programación de trabajos de impresión. Una vez completadas las tareas de un trabajo de impresión particular, el servicio de cola de impresión transfiere el trabajo al enrutador de impresión. Para obtener más información, vea el artículo de TechNet, [Cómo funciona la impresión en red](http://technet2.microsoft.com/windowsserver/en/library/d58ce7b9-49cf-4f5e-95e9-1ade005c13e01033.mspx?mfr=true).
  
**¿Qué es una DLL?**    
Una biblioteca de vínculos dinámicos (DLL) es un módulo que contiene funciones y datos que puede usar otro módulo (aplicación o DLL). Una DLL puede definir dos clases de funciones: exportadas e internas. Las funciones exportadas están diseñadas para ser llamadas por otros módulos, así como desde dentro del archivo DLL en el que se definen. Las funciones internas suelen estar diseñadas para ser llamadas únicamente desde el archivo DLL en el que se definen. Aunque un archivo DLL puede exportar datos, éstos sólo suelen ser utilizados por sus funciones. Sin embargo, nada impide que otro módulo lea o escriba esa dirección. Los archivos DLL proporcionan un medio de modularizar las aplicaciones para que sus funciones se puedan actualizar y reutilizar más fácilmente. Los archivos DLL también ayudan a reducir la sobrecarga de memoria cuando varias aplicaciones usan las mismas funciones simultáneamente, porque aunque cada aplicación reciba su propia copia de los datos de DLL, las aplicaciones comparten el código de DLL. Para obtener más información, vea el artículo de MSDN, [Bibliotecas de vínculos dinámicos](http://msdn.microsoft.com/en-us/library/ms682589.aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría ejecutar código arbitrario con los mismos privilegios que el administrador de trabajos de impresión de Windows. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Para aprovechar esta vulnerabilidad, el atacante tendría que almacenar una DLL malintencionada en una ubicación que esté accesible para el administrador de trabajos de impresión. Después, el l atacante crearía un mensaje RPC especialmente diseñado y lo enviaría a un sistema afectado. El mensaje provocaría que el administrador de trabajos de impresión cargara la DLL malintencionada y ejecutara código con privilegios elevados.
  
En todas las versiones de Microsoft Windows, el atacante necesita el privilegio "Administrar impresora" para aprovechar este problema. En Windows Vista y Windows Server 2008, al usuario local se le asigna automáticamente este permiso cuando instala una impresora local. Esto se puede realizar sin privilegios administrativos si el controlador de impresora está incluido de forma predeterminada.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los sistemas configurados como servidores de impresión están más expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al restringir las rutas de acceso desde las que el administrador de trabajos de impresión puede cargar una DLL.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB961501-x86-ENU /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB961501-x86-ENU /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | kb961501.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB961501$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 961501 de Microsoft Knowledge Base](http://support.microsoft.com/kb/961501).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB961501\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB961501$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/961501">artículo 961501 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Jun Mao, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de desbordamiento del búfer en el administrador de trabajos de impresión (CVE-2009-0228)
...
-   V1.1 (17 de junio de 2009): Se ha agregado "Deshabilitar el servicio Administrador de colas de impresión" como solución provisional para CVE-2009-0230.
