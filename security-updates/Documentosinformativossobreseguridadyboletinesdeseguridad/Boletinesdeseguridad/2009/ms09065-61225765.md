---
TOCTitle: 'MS09-065'
Title: 'Boletín de seguridad de Microsoft MS09-065 - Crítica'
ms:assetid: 'ms09-065'
ms:contentKeyID: 61225765
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-065(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-065 - Crítica
====================================================

Vulnerabilidades en los controladores modo kernel de Windows podrían permitir la ejecución remota de código (969947)
--------------------------------------------------------------------------------------------------------------------

Publicado: martes, 10 de noviembre de 2009 | Actualizado: jueves, 12 de noviembre de 2009
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Microsoft Windows 2000, Windows XP y Windows Server 2003, e importante para todas las ediciones compatibles de Windows Vista y Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado** en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar el método usado para validar el argumento pasado a la llamada del sistema, al validar la entrada pasada del modo usuario a través del componente de kernel de GDI y al corregir la manera en la que los controladores modo kernel de Windows analizan el código de fuente. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.**[Microsoft Knowledge Base Article 969947](http://support.microsoft.com/kb/969947) documenta los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan igualmente las soluciones recomendadas para estas cuestiones
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=45db8bb1-c81b-4d3f-a658-74f5fa445f81)                                                                          | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=916abdad-44b7-4f9d-986a-0c3558fb8e06)                                                          | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d0464c6-5ed8-4064-887e-618a2db09236)                                                             | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cd62750-e269-44ae-8c7c-c335e8545b9a)                                                                             | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04a7f817-f330-4003-8b25-d3e744905b12)                                                                 | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b95daac0-4c99-47a4-b0ca-9429997ea3d9)                                                          | Ejecución remota de código      | Crítica                             | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54562103-1d99-42d7-8f7f-c0cbcdce90db)                                     | Elevación de privilegios        | Importante                          | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fcb87cc8-6fd7-4f16-93d6-552999462fb1) | Elevación de privilegios        | Importante                          | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b97d48de-0f6d-4bca-b990-acf543fdb8b7)\*   | Elevación de privilegios        | Importante                          | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e2b8607-10fa-406a-96a5-18290f479c48)\*                 | Elevación de privilegios        | Importante                          | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=28eba3f3-99a5-424c-bc8d-a718c716699e)   | Elevación de privilegios        | Importante                          | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
...
<th style="border:1px solid black;" >Vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de datos insuficiente en Win32k (CVE-2009-2513)</th>
<th style="border:1px solid black;" >Vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)</th>
...
Vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)  
-----------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debida a que el kernel de Windows no valida correctamente un argumento pasado a una llamada del sistema del kernel de Windows. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1127).
  
#### Factores atenuantes para la vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)
...
#### Soluciones provisionales para la vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)
...
**¿Qué es el controlador modo kernel Win32k?**    
...
Vulnerabilidad de validación de datos insuficiente en Win32k (CVE-2009-2513)  
----------------------------------------------------------------------------
  
existe una vulnerabilidad de elevación de privilegios en los controladores modo kernel de Windows debido a una validación incorrecta de la entrada pasada desde el modo de usuario a través del componente de kernel de GDI. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-2513](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2513).
  
#### Factores atenuantes para la vulnerabilidad de validación de datos insuficiente en Win32k (CVE-2009-2513)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de datos insuficiente en Win32k (CVE-2009-2513)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de datos insuficiente en Win32k (CVE-2009-2513)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores modo kernel de Windows no validan correctamente la entrada enviada desde el modo de usuario a través del componente de kernel de GDI.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al validar la entrada enviada desde el modo de usuario a través del componente de kernel de GDI.
...
Vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)  
-----------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en los controladores modo kernel de Windows debido al análisis incorrecto del código de fuente al crear una tabla de entradas de directorio. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-2514](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2514).
  
#### Factores atenuantes para la vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)
...
#### Soluciones provisionales para la vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)
...
-   **Deshabilitar la compatibilidad para analizar fuentes incrustadas en Internet Explorer**
    ...
    **Nota** Vea el [artículo 969947 de Microsoft Knowledge Base](http://support.microsoft.com/kb/969947) para usar la solución Microsoft Fix it automática para habilitar o deshabilitar esta solución provisional.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
Los controladores modo kernel de Windows no analiza correctamente el código de fuente al crear una tabla de entradas de directorio.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la manera en la que los controladores modo kernel de Windows analizan el código de fuente.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-kb969947-x86-enu /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-kb969947-x86-enu /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | kb969947.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB969947$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 969947 de Microsoft Knowledge Base](http://support.microsoft.com/kb/969947).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969947\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB969947$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969947">artículo 969947 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Agin Sun, por informar de la vulnerabilidad de anulación de referencia de puntero nulo en Win32k (CVE-2009-1127)  
-   Tavis Ormandy, de [Google Inc.](http://www.google.com/), por informar de la vulnerabilidad de análisis de OET en Win32k (CVE-2009-2514)
...
-   V1.1 (12 de Noviembre de 2009): Se ha añadido un link al artículo 969947 de la Microsoft Knowledge Base en virtud de problemas conocidos en el Resumen Ejecutivo
