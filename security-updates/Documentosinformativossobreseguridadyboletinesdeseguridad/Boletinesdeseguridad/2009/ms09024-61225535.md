---
TOCTitle: 'MS09-024'
Title: 'Boletín de seguridad de Microsoft MS09-024 - Crítica'
ms:assetid: 'ms09-024'
ms:contentKeyID: 61225535
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-024(v=Security.10)'
---
...
Publicado: martes, 9 de junio de 2009 | Actualizado: martes, 13 de octubre de 2009
...
Esta actualización de seguridad se considera crítica para las ediciones compatibles de Microsoft Office Word 2000. Esta actualización de seguridad también se considera importante para las ediciones compatibles de Microsoft Office Word 2002, Microsoft Office Word 2003 con el convertidor de archivos de Microsoft Works 6–9, Microsoft Office Word 2007 Service Pack 1, Microsoft Works 8.5 y Microsoft Works 9. Para obtener más información, vea la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que Microsoft Office abre los archivos de Works. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;">
[Microsoft Office Word 2003 Service Pack 3 con el convertidor de archivos de Microsoft Works 6–9](http://www.microsoft.com/downloads/details.aspx?familyid=a7ba3ea7-d06a-4c14-9107-9b92ef68fcae)\*  
(KB968326)
</td>
<td style="border:1px solid black;">
Ejecución remota de código
...
**¿Por qué se ha revisado este boletín el 13 de octubre de 2009?**  
Microsoft ha revisado este boletín para anunciar la adición de las versiones de idioma a la actualización para Works 9. Los idiomas adicionales son: croata, checo, eslovaco, esloveno, estonio, letón, lituano, macedonio y ucraniano. Works 9 no estaba disponible en estos idiomas cuando el boletín se publicó originalmente. Los clientes que ya han aplicado la actualización original a Works 9 no están afectados por esta revisión.
...
**En MS09-017 también se describen vulnerabilidades en Microsoft Works 8.5 y Microsoft Works 9. ¿Cómo se relaciona MS09-017 con este boletín (MS09-024)?**  
Los paquetes de actualización de seguridad para Microsoft Works 8.5 (KB967043) y Microsoft Works 9 (KB967044) de este boletín, MS09-024, también corrigen las vulnerabilidad descritas en [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017). Los usuarios con Microsoft Works 8.5 o Microsoft Works 9 instalado sólo deberán instalar los paquetes de actualización una sola vez.

**¿Qué es el convertidor de archivos de Microsoft Works 6-9?**  
El convertidor de archivos de Microsoft Works 6-9 permite que Microsoft Office Word 2003 abra, edite y guarde archivos con el formato de archivo del procesador de textos de Works, que admiten las versiones 6, 7, 8 y 9 de Works. Para obtener más información, vea [Convertidor de archivos de Microsoft Works 6–9](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento del búfer en el convertidor de archivos (CVE-2009-1533)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que los convertidores de documentos de Works para Windows tratan los archivos de Works especialmente diseñados. La vulnerabilidad podría permitir la ejecución remota de código si un usuario abre un archivo de Works especialmente diseñado. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1533](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533).

#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en el convertidor de archivos (CVE-2009-1533)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   2007 Microsoft Office System Service Pack 2 no está afectado por la vulnerabilidad.
-   Microsoft Office Word 2003 sólo está afectado si el convertidor de Works está instalado. Para obtener más información, vea [Convertidor de archivos de Microsoft Works 6–9](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en el convertidor de archivos (CVE-2009-1533)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **Para Word 2000 y Word 2002, deshabilite el convertidor de Works 4.x mediante la restricción del acceso**

    Un administrador puede aplicar una lista de control de acceso a los convertidores afectados para garantizar que ya no se cargan en Works ni Office. De este modo se impide de forma eficaz que se aproveche la vulnerabilidad con esta vía de ataque.

    **Para Microsoft Windows 2000, Windows XP y Windows Server 2003**
    ...
    **Consecuencias de la solución provisional.** Después de implementar la solución provisional, el usuario ya no podrá abrir o guardar los documentos de Works 4.x. Al intentar abrir un documento de Works 4.x, se devolverá un error que indica que "el archivo parece estar dañado".

-   **Para Word 2003 con el** [**convertidor de archivos de Microsoft Works 6–9**](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en) **y Word 2007, deshabilite el convertidor de Works 6-9 mediante la restricción de acceso**

    Un administrador puede aplicar una lista de control de acceso a los convertidores afectados para garantizar que el convertidor ya no se carga en Works y Office. De este modo se impide de forma eficaz que se aproveche la vulnerabilidad con esta vía de ataque.
    ...
    **Consecuencias de la solución provisional.** Después de implementar la solución provisional, el usuario ya no podrá abrir o guardar los documentos de Works 6-9. Al intentar abrir un documento de Works 6-9, se devolverá un error que indica que "el archivo parece estar dañado".

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en el convertidor de archivos (CVE-2009-1533)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
Cuando un usuario abre un archivo de Works especialmente diseñado, se puede alterar la memoria del sistema de forma tal que un atacante podría ejecutar código arbitrario.
...
Esta vulnerabilidad requiere que un usuario abra un archivo de Works especialmente diseñado con una versión afectada del software.

En el supuesto de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía al usuario un archivo de Works especialmente diseñado y lo convence de que lo abra.

En el caso de un ataque basado en web, un sitio web podría contener un archivo de Works destinado a aprovechar esta vulnerabilidad. El atacante tendría que persuadir a los usuarios para que visitaran el sitio web y abrieran un archivo de Works especialmente diseñado; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.
...
La actualización corrige la vulnerabilidad al modificar la manera en que Microsoft Office abre los archivos de Works.
...
| Microsoft Office 2007 Service Pack 1 | Sí       |
...
|--------------------------------------|---------|--------------------|-------------------|----------------------------|
| Office 2000 Service Pack 3           | Sí      | Sí                 | No                | No                         |
| Office XP Service Pack 3             | Sí      | Sí                 | Sí                | Sí                         |
| Office 2003 Service Pack 3           | Sí      | Sí                 | Sí                | Sí                         |
| Microsoft Office 2007 Service Pack 1 | No      | No                 | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/957838">artículo 957838 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/957646">artículo 957646 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Word 2003 (todas las ediciones) con el convertidor de archivos de Microsoft Works 6–9
...
<tr class="even">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Microsoft Office Word 2003 con el convertidor de archivos de Microsoft Works 6-9:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/968326">artículo 968326 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969559">artículo 969559 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Shaun Colley, de [NGS Software](http://www.ngssoftware.com/), y Yuji Ukai, de [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/), por informar de la vulnerabilidad de desbordamiento del búfer en el convertidor de archivos (CVE-2009-1533)
...
-   V1.1 (13 de octubre de 2009): Se ha revisado el boletín para anunciar la adición de las versiones de idioma a la actualización para Works 9. Los clientes que ya han aplicado la actualización original a Works 9 no están afectados por esta revisión.
