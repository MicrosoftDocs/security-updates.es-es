---
TOCTitle: 'MS09-002'
Title: 'Boletín de seguridad de Microsoft MS09-002 - Crítica'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61225513
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-002(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-002 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (961260)
----------------------------------------------------------------------

Publicado: martes, 10 de febrero de 2009 | Actualizado: lunes, 16 de febrero de 2009
...
Esta actualización de seguridad se considera crítica para Internet Explorer 7 en ediciones compatibles de Windows XP y Windows Vista. Para Internet Explorer 7 en ediciones compatibles de Windows Server 2003 y Windows Server 2008, esta actualización de seguridad se considera moderada. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
| Windows XP Service Pack 2 y Windows XP Service Pack 3                                                         | Microsoft Internet Explorer 6                   |
...
| Windows Server 2003 con SP1 para sistemas con Itanium y Windows Server 2003 con SP2 para sistemas con Itanium | Microsoft Internet Explorer 6                   |

Preguntas más frecuentes (P+F) relacionadas con esta actualización de seguridad
-------------------------------------------------------------------------------

**¿Dónde están los detalles de información de archivos?**  
Los detalles de información de archivos se pueden encontrar en el [artículo 961260 de Microsoft Knowledge Base](http://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2009-0075)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2009-0076)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2009-0075)
...
-   Esta vulnerabilidad sólo afecta a Windows Internet Explorer 7. No afecta alas versiones compatibles de Microsoft Internet Explorer 5 y Microsoft Internet Explorer 6.

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2009-0075)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2009-0075)
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer trata las hojas de estilo en cascada (CSS). Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2009-0076)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2009-0076)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2009-0076)
...
**¿Cuál es la causa de esta vulnerabilidad?**  
Cuando Internet Explorer muestra una página web que contiene determinados estilos CSS, la memoria se puede dañar de tal manera que un atacante podría ejecutar código arbitrario en el contexto del usuario que ha iniciado sesión.
...
**¿Qué es CSS?**  
CSS, u hojas de estilo en cascada, es un método de formato para páginas web que usa HTML. Para obtener más información acerca de CSS, visite el [sitio web de Microsoft TechNet](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true).

**¿Cómo funciona esta actualización?**   
La actualización modifica la forma en que Internet Explorer trata las hojas de estilo en cascada.
...
| Windows Server 2003 Service Pack 1 y Microsoft Windows Server 2003 Service Pack 2                             | No      | No                 | Sí                                                                  | Sí                         |
...
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB961260-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/961260">artículo 961260 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2009-0075)  
-   Sam Thomas (<http://eshu.co.uk/>), en colaboración con [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2009-0076)
...
-   V1.1 (16 de febrero de 2009): Se ha agregado un vínculo al artículo 961260 de Microsoft Knowledge Base en Problemas conocidos en **Resumen ejecutivo**.
