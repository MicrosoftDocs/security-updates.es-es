---
TOCTitle: 'MS09-069'
Title: 'Boletín de seguridad de Microsoft MS09-069 - Importante'
ms:assetid: 'ms09-069'
ms:contentKeyID: 61225769
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-069(v=Security.10)'
---
...
La actualización de seguridad corrige la vulnerabilidad al cambiar la forma en que LSASS trata las solicitudes especialmente diseñadas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128)                 | Denegación de servicio          | Importante                          | [MS06-025](http://technet.microsoft.com/security/bulletin/ms06-025) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=5448b168-6bf7-4bae-9627-b88d76c4d5c5) | Denegación de servicio          | Importante                          | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2bbf515-f81a-436b-947b-cbf2db85fdd9)    | Denegación de servicio          | Importante                          | Ninguna                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a779aae1-7724-4458-94fb-a2343356ecae)                    | Denegación de servicio          | Importante                          | Ninguna                                                             |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8a9bf12-4ad6-49fd-b2b7-f379dc3309d2)        | Denegación de servicio          | Importante                          | Ninguna                                                             |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f5b003ad-af25-488a-91fb-98835a0bfeac) | Denegación de servicio          | Importante                          | Ninguna                                                             |
...
<th style="border:1px solid black;" >
Vulnerabilidad de agotamiento de recursos en el servicio de subsistema de autoridad de seguridad local (CVE-2009-3675)
</th>
<th style="border:1px solid black;" >
...
<span></span>
Existe una vulnerabilidad de denegación de servicio en Microsoft Windows debida a que el servicio de subsistema de autoridad de seguridad local (LSASQL SERVER) trata incorrectamente los mensajes ISAKMP especialmente diseñados durante la comunicación a través de IPSec.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3675](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3675).

#### Factores atenuantes para la vulnerabilidad de agotamiento de recursos en el servicio de subsistema de autoridad de seguridad local (CVE-2009-3675)

Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de agotamiento de recursos en el servicio de subsistema de autoridad de seguridad local (CVE-2009-3675)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   Deshabilitar el servicio IPSec

    Puede deshabilitar el servicio IPSec si no lo usa.
    ...
    **Nota** El uso incorrecto del Editor del Registro puede originar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no garantiza que los problemas derivados del uso incorrecto del Editor del Registro puedan resolverse. El uso del Editor del Registro es responsabilidad suya. Para obtener información sobre cómo editar el Registro, consulte el tema “Cambiar claves y valores” de la Ayuda del Editor del Registro (Regedit.exe) o los temas “Agregar y eliminar valores del Registro” y “Editar valores del Registro” de la Ayuda de Regedt32.exe.
    ...
    -   **Con el método interactivo**
        ...
        3.  Expanda **System**, **CurrentControlSet** y **Services**.
        4.  Haga clic en la clave **PolicyAgent**.
        5.  Cree una copia de seguridad de la clave del Registro del siguiente modo:
            En el menú Archivo, haga clic en **Exportar**.
            En el cuadro de diálogo Exportar archivo del Registro, escriba **PolicyAgent\_configuration\_backup.reg** y, a continuación, haga clic en **Guardar**.
        6.  .En la clave **PolicyAgent**, haga doble clic en el valor denominado **Start**.
        7.  Cambie el campo **Información del valor** a **4**.
        8.  Haga clic en **Aceptar**.
        9.  .Ejecute el siguiente comando en un símbolo del sistema como administrador:
    ...
    -   **Con una secuencia de comandos de implementación administrada**
        ...
        2.  Guarde lo siguiente en un archivo con la extensión .REG (por ejemplo, Disable\_PolicyAgent.reg):
        ...
        5.  Cree una copia de seguridad de la clave del Registro del siguiente modo:
            En el menú Archivo, haga clic en **Exportar**.
            En el cuadro de diálogo Exportar archivo del Registro, escriba **PolicyAgent\_configuration\_backup.reg** y, a continuación, haga clic en **Guardar**.
        6.  Ejecute la secuencia de comandos del Registro anterior creada en el paso 2 en el sistema de destino con el siguiente comando:
            Regedit /s Disable\_PolicyAgent.reg
        7.  Cambie el campo **Información del valor** a **4**.
        8.  Haga clic en **Aceptar**.
        9.  Ejecute el siguiente comando en un símbolo del sistema como administrador en el sistema de destino:
            net stop PolicyAgent

    **Consecuencias de la solución provisional.**El equipo específico no podrá usar IPSec.
...
-   **Con el método interactivo**
    ...
    3.  En el cuadro de diálogo Importar archivo del Registro seleccione **PolicyAgent\_configuration\_backup.reg** y, a continuación, haga clic en **Abrir**.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de agotamiento de recursos en el servicio de subsistema de autoridad de seguridad local (CVE-2009-3675)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de denegación de servicio. Un atacante remoto autenticado podría enviar un mensaje ISAKMP especialmente diseñado durante la comunicación a través de IPSec al servidor, lo que podría provocar que LSASS.exe consuma recursos del sistema y derive en una denegación de servicio que podría continuar hasta que se reiniciara el servidor.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que LSASS no trata correctamente los mensajes ISAKMP especialmente diseñados con paquetes con formato incorrecto.

**¿Qué es IPsec?** 
El protocolo de seguridad de protocolo de Internet (IPSec) es un marco de estándares abiertos para proteger las comunicaciones a través de redes IP (protocolo de Internet) mediante el uso de servicios de seguridad criptográficos. IPSec admite la autenticación del mismo nivel de red, autenticación de origen de datos, integridad de datos, confidencialidad de datos (cifrado) y protección de reproducción. La implementación de Microsoft de IPSec se basa en estándares desarrollados por el grupo de trabajo de IPSec Internet Engineering Task Force (IETF).
...
**¿Qué es IKE?**  
IKE es un estándar de Internet, definido en RFC 2409, que describe un mecanismo para establecer asociaciones de seguridad (SA) de IPSec. Una asociación de seguridad es una combinación de directivas y claves acordadas mutuamente que definen los servicios de seguridad y los mecanismos que contribuyen a proteger las comunicaciones entre homólogos IPSec. En concreto, IKE combina el protocolo de administración de claves y de asociación de seguridad de Internet (ISAKMP) en RFC 2408 y el protocolo de determinación de claves Oakley en RFC 2412
IKE usa el protocolo Oakley para generar claves secretas para las comunicaciones protegidas. IKE utiliza ISAKMP para negociar asociaciones de seguridad.

**¿Qué es un mensaje ISAKMP?**  
ISAKMP es un marco para negociar comunicaciones protegidas que es independiente de los protocolos de intercambio de claves específicos, algoritmos de cifrado e integridad y métodos de autenticación. ISAKMP incluye funciones para identificar y autenticar los homólogos, administrar asociaciones de seguridad e intercambiar claves.

**¿Para qué puede usar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría provocar que un sistema afectado consumiera recursos de CPU y dejara de responder hasta que se reiniciara.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante podría aprovechar esta vulnerabilidad si envía un mensaje ISAKMP especialmente diseñado mientras están conectado y autenticado en un servidor LSASS a través de IPSEC.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los servidores que solicitan o requieren la comunicación IPSec con los clientes están más expuestos a esta vulnerabilidad.

**¿Cómo funciona esta actualización?**  
Esta actualización cambia la forma en que LSASS trata las solicitudes ISAKMP especialmente diseñadas.
...
| **Implementación**                          |                                                                                                                                                                            |
| Instalación sin intervención del usuario    | Windows2000-KB974392-x86-ENU /quiet                                                                                                                                        |
| Instalación sin reiniciar                   | Windows2000-KB974392-x86-ENU /norestart                                                                                                                                    |
| Actualizar archivo de registro              | KB974392.log                                                                                                                                                               |
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB974392$\\Spuninst |
| **Información sobre archivos**              | Vea el [artículo 974392 de Microsoft Knowledge Base](http://support.microsoft.com/kb/974392).                                                                              |
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974392\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB974392$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/974392">artículo 974392 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
