---
TOCTitle: 'MS09-021'
Title: 'Boletín de seguridad de Microsoft MS09-021 - Crítica'
ms:assetid: 'ms09-021'
ms:contentKeyID: 61225532
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-021(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS09-021 - Crítica
====================================================
...
<tr>
<td style="border:1px solid black;">
[Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (ediciones de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (ediciones de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1 (ediciones de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2 (ediciones de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
No aplicable
...
**En MS09-017 y MS09-027 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. ¿Cómo se relacionan MS09-017 y MS09-027 con este boletín (MS09-021)?**  
Los paquetes de actualización de seguridad para Microsoft Office 2004 para Mac (KB969661), Microsoft Office 2008 para Mac (KB971822) y Convertidor de archivos con formatos XML abiertos para Mac (KB971824) en este boletín, MS09-021, también corrigen las vulnerabilidades descritas en [MS09-017](http://technet.microsoft.com/security/bulletin/ms09-017) y [MS09-027](http://technet.microsoft.com/security/bulletin/ms09-027). Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac o Convertidor de archivos con formatos XML abiertos para Mac instalado sólo deberán instalar una vez los paquetes de actualización.
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en los punteros de registro (CVE-2009-0549)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en los registros de objeto (CVE-2009-0557)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2009-0558)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de saturación basada en la pila de copia de cadenas (CVE-2009-0559)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria relacionada con el saneamiento de campos (CVE-2009-0560)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en los punteros de registro (CVE-2009-1134)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Convertidor de archivos con formatos XML abiertos de Microsoft Office para Mac
</td>
<td style="border:1px solid black;">
**Importante**  
Ejecución remota de código
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549).

#### Factores atenuantes para la vulnerabilidad de daños en los punteros de registro (CVE-2009-0549)
...
#### Soluciones provisionales para la vulnerabilidad de daños en los punteros de registro (CVE-2009-0549)
...
-   No abra ni **guarde** los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en los punteros de registro (CVE-2009-0549)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557).

#### Factores atenuantes para la vulnerabilidad de daños en los registros de objeto (CVE-2009-0557)
...
#### Soluciones provisionales para la vulnerabilidad de daños en los registros de objeto (CVE-2009-0557)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en los registros de objeto (CVE-2009-0557)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2009-0558)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2009-0558)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra ni guarde los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2009-0558)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559).

#### Factores atenuantes para la vulnerabilidad de saturación basada en la pila de copia de cadenas (CVE-2009-0559)
...
#### Soluciones provisionales para la vulnerabilidad de saturación basada en la pila de copia de cadenas (CVE-2009-0559)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   No abra ni guarde los archivos de Excel que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de saturación basada en la pila de copia de cadenas (CVE-2009-0559)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el saneamiento de campos (CVE-2009-0560)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el saneamiento de campos (CVE-2009-0560)
...
#### Preguntas más frecuentes para la vulnerabilidad de daños en la memoria relacionada con el saneamiento de campos (CVE-2009-0560)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0561](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134).

#### Factores atenuantes para la vulnerabilidad de daños en los punteros de registro (CVE-2009-1134)
...
#### Soluciones provisionales para la vulnerabilidad de daños en los punteros de registro (CVE-2009-1134)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en los punteros de registro (CVE-2009-1134)
...
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                                                                                      | Sí      | Sí                 | Sí                                                                         | Sí                                                                         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                                                                                      | Sí      | Sí                 | Sí                                                                         | Sí                                                                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969683">artículo 969683 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969680">artículo 969680 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Excel 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/969681">artículo 969681 de Microsoft Knowledge Base</a>.<br />
<br />
Para Excel Viewer 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/969685">artículo 969685 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Excel 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/969682">artículo 969682 de Microsoft Knowledge Base</a>.<br />
<br />
Para Excel Viewer:<br />
Vea el <a href="http://support.microsoft.com/kb/969686">artículo 969686 de Microsoft Knowledge Base</a>.<br />
<br />
Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007:<br />
Vea el <a href="http://support.microsoft.com/kb/969679">artículo 969679 de Microsoft Knowledge Base</a>.<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/969737">artículo 969737 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Bing Liu, de [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) de Fortinet, por informar de la vulnerabilidad de daños en los punteros (CVE-2009-0549)  
-   Bing Liu, de [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) de Fortinet, por informar de la vulnerabilidad de daños en los registros de objeto (CVE-2009-0557)  
-   Carsten H. Eiram, de [Secunia](http://secunia.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con la indización de matrices (CVE-2009-0558)  
-   [TELUS Security Labs Vulnerability Research Team](http://telussecuritylabs.com/), por informar de la vulnerabilidad de saturación basada en la pila de copia de cadenas (CVE-2009-0559)  
-   Bing Liu, de [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) de Fortinet, por informar de la vulnerabilidad de daños en la memoria relacionada con el saneamiento de campos (CVE-2009-0560)  
-   Sean Larsson y Joshua Drake, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)  
-   Carsten H. Eiram, de [Secunia](http://secunia.com/), por informar de la vulnerabilidad de desbordamiento de enteros en los registros (CVE-2009-0561)  
-   [TippingPoint](http://www.tippingpoint.com/) y [Zero Day Initiative](http://www.zerodayinitiative.com/), por informar de la vulnerabilidad de daños en los punteros de registro (CVE-2009-1134)
...
-   V1.1 (17 de junio de 2009): Se ha agregado un vínculo al artículo 969462 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
