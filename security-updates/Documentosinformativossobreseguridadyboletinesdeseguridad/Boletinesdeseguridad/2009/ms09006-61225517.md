---
TOCTitle: 'MS09-006'
Title: 'Boletín de seguridad de Microsoft MS09-006 - Crítica'
ms:assetid: 'ms09-006'
ms:contentKeyID: 61225517
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-006(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS09-006 - Crítica
====================================================
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=98bb7d40-89a0-470a-8eb7-06f15072a635)                                                                         | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e09641ba-6cbe-4095-82b5-703d3a7dc33b)                                                         | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Professional x64 Edition y Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d0d704c6-48c2-4907-b6c3-2455d7cf21c8)                      | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 Service Pack 1 y Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f5cfb8da-e7cc-4183-8631-507c2a406500)                                       | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 x64 Edition y Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ecf75c70-8489-41ad-9759-3a07e13957be)                              | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 con SP1 para sistemas con Itanium y Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=04be3d7e-7dda-4dca-887a-e7a8156ede1c) | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista y Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4b1aaaba-f355-4265-83c0-50b901856ced)                                                                  | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista x64 Edition y Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fcac480-d6db-4a94-8c7d-b7319282cf56)                                          | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=38851df2-4fb5-4d28-9d15-181c260cf8cf)\*                                                                | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=ec15acc4-3e0f-4414-9383-61c122ff1382)\*                                                                       | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=eead6f93-10fd-4492-8137-481d9876a5fe)                                                                 | Ejecución remota de código      | Crítica                             | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
...
Los detalles de información de archivos se pueden encontrar en el [artículo 958690 de Microsoft Knowledge Base](http://support.microsoft.com/kb/958690).
...
<th style="border:1px solid black;" >Vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)</th>
<th style="border:1px solid black;" >Vulnerabilidad de puntero no válido en el kernel de Windows (CVE-2009-0083)</th>
...
Vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)  
-------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081).
  
#### Factores atenuantes para la vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)
...
#### Soluciones provisionales para la vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)
...
-   **Desactive el procesamiento de metarchivos mediante la modificación del Registro**  
    Los clientes que han aplicado la actualización de seguridad asociada al boletín de seguridad de Microsoft MS07-017 o los clientes que usan Windows Vista o Windows Server 2008 pueden deshabilitar el procesamiento de metarchivos mediante la modificación del Registro. Esta configuración ayudará a proteger el sistema afectado de intentos para aprovechar esta vulnerabilidad.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El kernel de Windows no valida correctamente la entrada enviada desde el modo de usuario a través del componente de kernel de GDI.
...
Para obtener más información sobre los tipos y formatos de imagen, consulte el [artículo 320314 de Microsoft Knowledge Base](http://support.microsoft.com/kb/320314). Para obtener información adicional acerca de estos formatos de archivo, visite el [sitio Web de MSDN Library](http://msdn2.microsoft.com/en-us/library/ms536391.aspx).
...
Para la ejecución remota de código esta vulnerabilidad requiere que un usuario vea un archivo de imagen especialmente diseñado. Esta vulnerabilidad también la puede aprovechar un atacante que haya iniciado sesión en el sistema local. Seguidamente, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo del sistema afectado.
  
En un ataque por correo electrónico, el atacante puede aprovechar la vulnerabilidad si envía un correo electrónico con un archivo de imagen EMF o WMF especialmente diseñado incrustado en él al usuario y lo convence de que vea u obtenga una vista previa del correo electrónico. Un atacante también podría incrustar un archivo de imagen EMF o WMF especialmente diseñado en un documento de Office y convencer al usuario de que abra el archivo.
...
Vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)  
-------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios en el kernel de Windows debida a la manera en que el kernel valida los controladores. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082).
  
#### Factores atenuantes para la vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)
...
#### Soluciones provisionales para la vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
El kernel de Windows no valida correctamente los controladores al realizar determinadas acciones.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al modificar la forma en que el kernel valida los controladores.
...
Vulnerabilidad de puntero no válido en el kernel de Windows (CVE-2009-0083)  
---------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios en el kernel de Windows debida a un tratamiento incorrecto de un puntero no válido especialmente diseñado. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-0083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083).
  
#### Factores atenuantes para la vulnerabilidad de puntero no válido en el kernel de Windows (CVE-2009-0083)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, el atacante debe tener credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión localmente en un sistema vulnerable. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de puntero no válido en el kernel de Windows (CVE-2009-0083)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de puntero no válido en el kernel de Windows (CVE-2009-0083)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El kernel de Windows no trata correctamente los punteros no válidos especialmente diseñados.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al cambiar la forma en que el kernel de Windows trata los punteros no válidos especialmente diseñados.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/958690">artículo 958690 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/958690">artículo 958690 de Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/958690">artículo 958690 de Microsoft Knowledge Base</a></td>
...
-   Helmut Buhler (<http://home.arcor.de/clipboarder/>), por informar de la vulnerabilidad de validación de entrada en el kernel de Windows (CVE-2009-0081)  
-   Thomas Garnier, de [SkyRecon](http://www.skyrecon.com/), por informar de la vulnerabilidad de validación de controladores en el kernel de Windows (CVE-2009-0082)
