---
TOCTitle: 'MS09-064'
Title: 'Boletín de seguridad de Microsoft MS09-064 - Crítica'
ms:assetid: 'ms09-064'
ms:contentKeyID: 61225764
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-064(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-064 - Crítica
====================================================
...
Esta actualización de seguridad se considera crítica para Microsoft Windows 2000. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al cambiar la forma en la que el servicio de registro de licencias válida un campo específico en el paquete RPC. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135) | Ejecución remota de código      | Crítica                             | Ninguna                                       |
...
**¿Qué es el servicio de registro de licencias?**  
El servicio de registro de licencias es una herramienta diseñada originalmente para ayudar a los clientes a administrar sus licencias de los productos de servidores de Microsoft que cuentan con licencia del modelo de licencia de acceso de cliente (CAL) de servidor.

**¿El servidor de registro de licencias se instala de forma predeterminada en Microsoft Windows 2000 Server?**  
Sí, de forma predeterminada, Microsoft Windows 2000 Server se instala con el servicio de registro de licencias y está habilitado de forma predeterminada.

**¿Cómo puedo saber si el servicio de registro de licencias está en uso en mi servidor?**  
El servicio de registro de licencias no está disponible en Microsoft Windows 2000 Professional. De forma predeterminada, el servicio de registro de licencias se instala y ejecuta en Microsoft Windows Server 2000. Puede determinar si el servicio de registro de licencias esta instalado si realiza el procedimiento siguiente.

1.  Haga clic en **Inicio**, **Programas**, **Herramientas administrativas** y finalmente en **Servicios**.
2.  Para verificar que el servicio de registro de licencias esté presente:
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)</th>
...
Vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)  
---------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código sin autenticación en la forma en que el software del servidor de registro de licencias de Microsoft trata los paquetes RPC especialmente diseñados. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo que un atacante podría enviar un mensaje de red especialmente diseñado a un equipo que ejecuta el servicio de registro de licencias. Un atacante que aprovechara esta vulnerabilidad podría obtener el control completo del sistema.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-2523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Deshabilitar el servicio de registro de licencias**
  
    Deshabilitar el servicio de registro de licencias le ayudará a proteger su sistema de los intentos remotos para aprovechar esta vulnerabilidad.
    ...
    4.  Haga doble clic en el **Servicio de registro de licencias**.  
    5.  En la lista **Tipo de inicio**, haga clic en **Deshabilitado**.  
    6.  Haga clic en **Detener** y, a continuación, en **Aceptar**.
  
    **Consecuencias de la solución provisional.** Si se deshabilita el servicio de registro de licencias, cualquier servicio que dependa explícitamente de él podría guardar un mensaje de error en el registro de eventos del sistema. Para obtener más información, vea el [artículo 316631 de Microsoft Knowledge Base](http://support.microsoft.com/kb/316631).
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El servicio de registro de licencias no valida la longitud de una cadena pasada a través de una llamada RPC. Esto tiene como resultado un desbordamiento de búfer en el montón.
...
Un atacante podría intentar aprovechar la vulnerabilidad mediante la creación y el envío de un mensaje RPC especialmente diseñado a un sistema afectado.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Los servidores de Microsoft Windows 2000 que ejecutan el servicio de registro de licencias están afectados por esta vulnerabilidad. Por lo tanto, los controladores de dominio están más expuestos a esta vulnerabilidad que las estaciones de trabajo u otros servidores.
  
**¿Cómo funciona esta actualización?**    
La actualización de seguridad corrige las vulnerabilidades al modificar la validación de los mensajes RPC en el servicio de registro de licencias.
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB974783-x86-enu /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB974783-x86-enu /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | KB974783.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB974783$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 974783 de Microsoft Knowledge Base](http://support.microsoft.com/kb/974783).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974783                                                                                            |
...
-   Cody Pierce, de [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/), por informar de la vulnerabilidad de desbordamiento del montón en el servidor de registro de licencias (CVE-2009-2523)
