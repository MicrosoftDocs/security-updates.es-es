---
TOCTitle: 'MS09-066'
Title: 'Boletín de seguridad de Microsoft MS09-066 - Importante'
ms:assetid: 'ms09-066'
ms:contentKeyID: 61225766
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-066(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para Active Directory, ADAM y AD LDS en todas las ediciones compatibles de Microsoft Windows 2000 Server, Windows XP, Windows Server 2003 y Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al cambiar la forma en que Active Directory, ADAM y AD LDS procesar las solicitudes LDAP o LDAPS con formato incorrecto. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=297158cf-374c-45d9-b213-978e1f54d244">Active Directory</a><br />
(KB973037)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=cbe09780-f288-457a-b254-58c9c8744055">Active Directory Application Mode (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=b65ddf36-a02d-4aa2-9b4f-7416dbf59e2a">Active Directory Application Mode (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=28f1c494-4e16-43b6-93d2-49e15f142ac9">Active Directory</a><br />
(KB973037)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=44cb9029-4b19-4bad-8fc9-3efe285adb0e">Active Directory Application Mode (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=509aeec0-112b-44ab-8686-43f381b61940">Active Directory</a><br />
(KB973037)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=87f2109e-5129-467c-930f-70af31ebf5de">Active Directory Application Mode (ADAM)</a><br />
(KB973039)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=040e691b-1ef0-4b73-bef7-a1d77b84b0ca">Active Directory</a><br />
(KB973037)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms09-018">MS09-018</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=701abf15-7f93-41de-8d09-13404fd79a7e">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?displaylang=es&amp;amp;familyid=17f5f9e0-5869-41da-9b3b-6e67540af1f0">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB973037)</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-035">MS08-035</a></td>
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento de pila recursiva en LSASS (CVE-2009-1928)  
</th>
<th style="border:1px solid black;" >
...
Existe una vulnerabilidad de denegación de servicio en implementaciones de Active Directory en Microsoft Windows 2000 Server, Windows Server 2003 y Windows Server 2008. La vulnerabilidad también existe en implementaciones de Active Directory Application Mode (ADAM) cuando se instala en Windows XP y Windows Server 2003 y AD LDS (servicio de directorio ligero de Active Directory) en Windows Server 2008. La vulnerabilidad se debe a que el espacio de la pila se agota durante la ejecución de determinados tipos de solicitudes LDAP o LDAPS. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado dejara de responder.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1928](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de pila recursiva en LSASS (CVE-2009-1928)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de pila recursiva en LSASS (CVE-2009-1928)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de pila recursiva en LSASS (CVE-2009-1928)
...
El servicio LDAP procesa incorrectamente solicitudes LDAP o LDAPS específicas de un modo tal que puede provocar que se agote el espacio de pila.
...
**¿Qué es el servicio de directorio ligero de Active Directory?**  
Los servicios de directorio ligero de Active Directory (AD ADS) son un modo independiente de Active Directory que proporciona servicios de directorio dedicado para las aplicaciones. AD LDS está disponible en Windows Server 2008 y posterior, y reemplaza a Active Directory Application Mode (ADAM), que estaba disponible en Windows XP y Windows Server 2003.
...
**¿Cómo puedo confirmar que mi servidor ejecuta el servicio LDAP si uso Active Directory**?  
Para confirmar si un servidor escucha consultas LDAP o LDAPS, ejecute el siguiente comando desde un símbolo del sistema con privilegios de administrador y compruebe si el sistema escucha en el puerto LDAP (389) o LDAPS (636), o bien en cualquiera de los puertos del servicio de catálogo global (3268 o 3269):
netstat –a
...
Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema de un usuario dejara de responder y requerir que se reiniciara.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante podría intentar aprovechar la vulnerabilidad mediante el envío de un paquete LDAP o LDAPS especialmente diseñado al servidor ADAM, AD LDS o Active Directory. Para Microsoft Windows 2000 Server, un usuario anónimo con acceso a la red de destino que pudiera enviar un paquete de red especialmente diseñado al sistema afectado podría aprovechar esta vulnerabilidad. En todas las demás plataformas afectadas, el atacante debe tener credenciales de autenticación válidas para aprovechar esta vulnerabilidad.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
El protocolo ligero de acceso a directorios (LDAP) es un requisito para Active Directory, ADAM y AD LDS. Por lo tanto, cualquier sistema que se ejecute como un servidor ADAM, AD LDS o Active Directory está afectado por esta vulnerabilidad.

**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al procesar correctamente las solicitudes LDAP o LDAPS con formato incorrecto.
...
<td style="border:1px solid black;">Para Active Directory en Microsoft Windows 2000 Server:<br />
...
<td style="border:1px solid black;">Para Active Directory en Microsoft Windows 2000 Server, use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/973037">artículo 973037 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM) en Windows XP Service Pack 2 y Windows XP Service Pack 3:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/973039">artículo 973039 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM), use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Active Directory en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/973037">artículo 973037 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM) en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/973039">artículo 973039 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para Active Directory en Windows Server 2003:<br />
