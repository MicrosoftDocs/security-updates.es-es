...
<p>Ejemplo de instalación básica:<br />
SQLWMSDE-KB960082-x86-ENU.exe SAPWD=&quot;(contraseña del administrador)&quot; INSTANCENAME=UDDI</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Microsoft SQL Server 2000 Desktop Engine (WMSDE):<br />
...
<p><strong>Nota</strong> No hay disponible ningún asistente ni cuadro de diálogo de instalación</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Requisito de reinicio</strong></td>
<td style="border:1px solid black;"></td>
...
Use la herramienta <strong>Agregar o quitar programas</strong>, que se encuentra en el Panel de control
<p><strong>Nota</strong> Al quitar esta actualización de seguridad para WYukon se quitará por completo la instancia WYukon del sistema. WYukon se muestra en <strong>Agregar o quitar programas</strong> como “Base de datos interna de Windows”</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/959420">artículo 959420 de Microsoft Knowledge Base</a></td>
