---
TOCTitle: 'MS09-049'
Title: 'Boletín de seguridad de Microsoft MS09-049 - Crítica'
ms:assetid: 'ms09-049'
ms:contentKeyID: 61225749
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-049(v=Security.10)'
---

Boletín de seguridad de Microsoft MS09-049 - Crítica
====================================================

Una vulnerabilidad en el servicio de configuración automática de LAN inalámbrica podría permitir la ejecución remota de código (970710)
---------------------------------------------------------------------------------------------------------------------------------------
...
Esta actualización de seguridad resuelve una vulnerabilidad de la que se ha informado de forma privada en el servicio de configuración automática de LAN inalámbrica. La vulnerabilidad podría permitir la ejecución remota de código si un cliente o un servidor con una interfaz de red inalámbrica recibe tramas inalámbricas especialmente diseñadas. Los sistemas sin una tarjeta inalámbrica no están expuestos a esta vulnerabilidad.

Esta actualización de seguridad se considera crítica para las ediciones compatibles de Windows Vista e importante para las ediciones compatibles de Windows Server 2008. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al ampliar el servicio de configuración automática de LAN inalámbrica para validar correctamente las tramas inalámbricas antes de procesarlas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows Vista, Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9fe967f-d78d-43c2-bbcc-5098bd20267e)                                     | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f93470bd-2e6d-4340-88c6-bb212baf750a) | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac3f6800-bc3e-4b35-a482-54e1a2da1ab5)\*   | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d1b9b4f-bf35-44aa-a660-afb2ef2c9e30)\*                 | Ejecución remota de código      | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132)</th>
...
Vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132)  
--------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad ejecución remota de código en la forma en la que el servicio de configuración automática de LAN inalámbrica (wlansvc) analiza determinadas tramas recibidas en la red inalámbrica. Esta vulnerabilidad podría permitir la ejecución remota de código si un cliente o un servidor con una interfaz de red inalámbrica recibe tramas inalámbricas especialmente diseñadas. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1132).
  
#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Los sistemas sin una tarjeta inalámbrica no están expuestos a esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Cancelar el registro de Wlansvc**
    ...
    **Con el método interactivo**
    ...
    3.  Haga clic en **Wlansvc**.  
    4.  Haga clic en el menú **Archivo** y seleccione **Exportar**.  
    5.  En el cuadro de diálogo **Exportar archivo del Registro** escriba **Wlansvc\_configuration\_backup.reg** y haga clic en **Guardar**.    
    ...
    6.  Haga doble clic en el valor **Start** y cambie el campo de datos **Información del valor** a **4**  
    7.  Haga clic en **Aceptar**.  
    8.  Ejecute el siguiente comando desde un símbolo del sistema como administrador:
    ...
    **Con una secuencia de comandos de implementación administrada**
    ...
    2.  Después, guarde lo siguiente en un archivo con la extensión .REG, por ejemplo Disable\_Wlansvc.reg:  
        Editor del Registro de Windows versión 5.00  
        \[HKEY\_LOCAL\_MACHINE\\System\\CurrentControlSet\\Services\\Wlansvc\]  
        "Start"=dword:00000004  
    3.  Ejecute la secuencia de comandos del Registro anterior en el equipo de destino con el siguiente comando:  
        Regedit.exe /s Disable\_Wlansvc.reg  
    4.  Ejecute el siguiente comando desde un símbolo del sistema como administrador:  
        sc stop Wlansvc
  
    **Consecuencias de la solución provisional.** La red inalámbrica no estará disponible.
    ...
    **Con el método interactivo**
    ...
    3.  En el cuadro de diálogo Importar archivo del Registro seleccione **Wlansvc\_configuration\_backup.reg** y haga clic en **Abrir**.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Esta vulnerabilidad afecta a los clientes y servidores Windows que usan una red inalámbrica y están dentro del alcance de un transmisor inalámbrico de un atacante. Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a la ausencia de validación de parte de una determinada trama con formato incorrecto enviada por un transmisor inalámbrico remoto. Esto puede provocar una situación de desbordamiento del montón que podría dar lugar a la ejecución arbitraria de código.
  
**¿Qué es el servicio de configuración automática de LAN inalámbrica? (Wlansvc)?**    
Es un servicio que configura la seguridad inalámbrica y las opciones de conectividad. Con la configuración automática de WLAN se configuran los adaptadores inalámbricos IEEE (Institute of Electrical and Electronics Engineers) 802.11 para la conectividad a redes inalámbricas ad hoc, a redes de infraestructura inalámbricas de pequeñas oficinas y a redes que proporcionan el acceso de red autenticado mediante 802.1x. Cuando se habilita, las opciones de configuración automática de WLAN se aplican a todos los adaptadores de red inalámbricos IEEE 802.11 que están instalados en un equipo.
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**    
Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**    
Un atacante podría implementar un transmisor inalámbrico que enviara tramas diseñadas malintencionadamente para desencadenar la vulnerabilidad.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Todos los clientes y servidores con una interfaz de red inalámbrica habilitada están expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
Esta actualización de seguridad resuelve la vulnerabilidad al ampliar el servicio de configuración automática de LAN inalámbrica para validar correctamente las tramas inalámbricas antes de procesarlas.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/970710">artículo 970710 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (9 de septiembre de 2009): Se ha revisado la descripción de la vulnerabilidad de ejecución remota de código en el análisis de tramas inalámbricas (CVE-2009-1132) para aclarar las condiciones para aprovechar la vulnerabilidad.
