---
TOCTitle: 'MS09-068'
Title: 'Boletín de seguridad de Microsoft MS09-068 - Importante'
ms:assetid: 'ms09-068'
ms:contentKeyID: 61225768
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-068(v=Security.10)'
---
...
**En MS09-067 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. ¿Cómo se relaciona MS09-067 con este boletín (MS09-068)?**  
Los paquetes de actualización de seguridad de este boletín, MS09-068, para Microsoft Office 2004 para Mac (KB976830), Microsoft Office 2008 para Mac (KB976828) y Convertidor de archivos con formatos XML abiertos para Mac (KB976831) también corrigen las vulnerabilidades descritas en MS09-067. Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac o Convertidor de archivos con formatos XML abiertos para Mac instalado sólo deberán instalar una vez los paquetes de actualización.
...
**¿Por qué esta actualización sólo es importante para todas las versiones afectadas de Word?**  
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria relacionada con la información de archivo de Microsoft Office Word (CVE-2009-3135)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-3135](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3135).

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la información de archivo de Microsoft Office Word (CVE-2009-3135)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la información de archivo de Microsoft Office Word (CVE-2009-3135)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **No abra documentos de Word de orígenes que no sean de confianza**
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la información de archivo de Microsoft Office Word (CVE-2009-3135)
...
La vulnerabilidad se debe a la forma en que Microsoft Office Word analiza un archivo de Word especialmente diseñado que puede dañar la memoria del sistema de forma tal que un atacante podría ejecutar código arbitrario.
...
| Office 2003 Service Pack 3                                                      | No      | No                | Sí                | Sí                         |
...
| Microsoft Office Word Viewer 2003 Service Pack 3 y Microsoft Office Word Viewer | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/973444">artículo 973444 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Word 2003:<br />
Vea el <a href="http://support.microsoft.com/kb/973443">artículo 973443 de Microsoft Knowledge Base</a>.<br />
<br />
Para Word Viewer 2003 y Word Viewer:<br />
Vea el <a href="http://support.microsoft.com/kb/973866">artículo 973866 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Jun Mao, de [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de daños en la memoria relacionada con la información de archivo de Microsoft Office Word (CVE-2009-3135).
