---
TOCTitle: 'MS09-025'
Title: 'Boletín de seguridad de Microsoft MS09-025 - Importante'
ms:assetid: 'ms09-025'
ms:contentKeyID: 61225536
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms09-025(v=Security.10)'
---
...
La actualización de seguridad corrige estas vulnerabilidades al modificar los métodos usados para validar un cambio en objetos del kernel específicos, para validar la entrada pasada desde el modo de usuario al kernel y para validar el argumento pasado a la llamada del sistema. La actualización de seguridad también corrige una vulnerabilidad al garantizar que el kernel de Windows limpia los punteros en condiciones de error. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=79b0481d-a3d7-477b-928a-a98cc79374af)                                | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows XP Service Pack 2 y Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6349e046-a3f8-4ae5-b8c3-c9879cc99e8f)                | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3769800e-af93-4a44-8a1e-b30cc54b226f)                   | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9356404c-d89a-4de0-b9b4-f6e1bdadf745)                                   | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a3123af-173d-49eb-9997-14e82e764aee)                       | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=13b50993-410f-4e7a-a33a-6d9b48dbb4d1)                | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista y Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                         | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                                         | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Vista x64 Edition y Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc) | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc)                             | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*                       | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*        | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*                              | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*               | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows Server 2008 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd)                        | Elevación de privilegios        | Importante                          | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd)         | Elevación de privilegios        | Importante                          | Ninguna                                                             |
...
<th style="border:1px solid black;" >Vulnerabilidad del escritorio en el kernel de Windows (CVE-2009-1123)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de punteros en el kernel de Windows CVE-2009-1124)</th>
<th style="border:1px solid black;" >Vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)</th>
<th style="border:1px solid black;" >Vulnerabilidad de edición de parámetro del escritorio de Windows (CVE-2009-1126)</th>
...
Vulnerabilidad del escritorio en el kernel de Windows (CVE-2009-1123)  
---------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios debido a que el kernel de Windows no valida correctamente los cambios en determinados objetos del kernel. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1123](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123).
  
#### Factores atenuantes para la vulnerabilidad del escritorio en el kernel de Windows (CVE-2009-1123)
...
#### Soluciones provisionales para la vulnerabilidad del escritorio en el kernel de Windows (CVE-2009-1123)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad del escritorio en el kernel de Windows (CVE-2009-1123)
...
El kernel de Windows no valida correctamente los cambios en determinados objetos del kernel.
...
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2009-1123](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123).
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**    
No. En el momento de emitir este boletín de seguridad, Microsoft no había recibido ningún informe directo que indicara que esta vulnerabilidad se había utilizado para atacar a los clientes y no tenía ninguna prueba de que se hubiera publicado código de tipo conceptual.
  
Vulnerabilidad de validación de punteros en el kernel de Windows CVE-2009-1124)  
-------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en el kernel de Windows debida a una validación insuficiente de determinados punteros pasados desde el modo de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1124](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1124).
  
#### Factores atenuantes para la vulnerabilidad de validación de punteros en el kernel de Windows CVE-2009-1124)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de punteros en el kernel de Windows CVE-2009-1124)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de punteros en el kernel de Windows CVE-2009-1124)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El kernel de Windows no valida correctamente determinados punteros pasados desde el modo de usuario.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige la vulnerabilidad al garantizar que el kernel de Windows limpia los punteros en condiciones de error.
...
Vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)  
-------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1125](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1125).
  
#### Factores atenuantes para la vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)
...
Vulnerabilidad de edición de parámetro del escritorio de Windows (CVE-2009-1126)  
--------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios cuando el kernel de Windows valida incorrectamente la entrada pasada desde el modo de usuario al kernel al editar un parámetro de escritorio específico. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2009-1126](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126).
  
#### Factores atenuantes para la vulnerabilidad de edición de parámetro del escritorio de Windows (CVE-2009-1126)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de edición de parámetro del escritorio de Windows (CVE-2009-1126)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de edición de parámetro del escritorio de Windows (CVE-2009-1126)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
El kernel de Windows no valida correctamente la entrada pasada desde el modo de usuario al kernel al editar un parámetro de escritorio específico.
...
**¿Cómo funciona esta actualización?**    
La actualización corrige esta vulnerabilidad al modificar el método usado para validar la entrada pasada desde el modo de usuario al kernel al establecer un parámetro de escritorio específico.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2009-1126](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126).
...
| **Implementación**                          |                                                                                                                                                                            |  
| Instalación sin intervención del usuario    | Windows2000-KB968537-x86-ENU /quiet                                                                                                                                        |  
| Instalación sin reiniciar                   | Windows2000-KB968537-x86-ENU /norestart                                                                                                                                    |  
| Actualizar archivo de registro              | kb968537.log                                                                                                                                                               |  
...
| **Información sobre la eliminación**        | Use la herramienta **Agregar o quitar programas** del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB968537$\\Spuninst |  
| **Información sobre archivos**              | Vea el [artículo 968537 de Microsoft Knowledge Base](http://support.microsoft.com/kb/968537).                                                                              |  
| **Comprobación de las claves del Registro** | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB968537\\Filelist                                                                                  |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB968537$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/968537">artículo 968537 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Thomas Garnier, por informar de la vulnerabilidad de validación de punteros en el kernel de Windows (CVE-2009-1124) y la vulnerabilidad de registros de clases de controlador de Windows (CVE-2009-1125)
