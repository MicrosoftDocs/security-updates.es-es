---
TOCTitle: 'MS07-065'
Title: 'Boletín de seguridad de Microsoft MS07-065 - Importante'
ms:assetid: 'ms07-065'
ms:contentKeyID: 61225342
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms07-065(v=Security.10)'
---

Boletín de seguridad de Microsoft MS07-065 - Importante
=======================================================

Una vulnerabilidad en Message Queue Server podría permitir la ejecución remota de código (937894)
-------------------------------------------------------------------------------------------------

Publicado: martes, 11 de diciembre de 2007 | Actualizado: miércoles, 16 de enero de 2008
...
Esta actualización de seguridad importante resuelve una vulnerabilidad de la que se ha informado de forma privada en el servicio de Message Queue Server (MSMQ) que podría permitir la ejecución remota de código en implementaciones de Microsoft Windows 2000 o la elevación de privilegios en implementaciones de Microsoft Windows XP. Un atacante debe tener credenciales de inicio de sesión válidas para aprovechar la vulnerabilidad de elevación de privilegios en Windows XP. De esta forma, un atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas.

Es una actualización de seguridad importante para ediciones compatibles de Microsoft Windows 2000 y una actualización de seguridad moderada para las ediciones compatibles de Windows XP. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

Esta actualización de seguridad corrige esta vulnerabilidad al validar la cadena de entrada antes de copiarla al búfer. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|----------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=bda9d0b4-f7cb-4d9d-b030-043d7437734b) | Ejecución remota de código      | Importante                          | [MS05-017](http://www.microsoft.com/spain/technet/seguridad/boletines/ms05-017-it.mspx) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09d4e6ae-5d19-4f11-bb7e-60cee8263bc8)             | Elevación de privilegios        | Moderada                            | Ninguna                                                                                 |
...
<th style="border:1px solid black;" >Vulnerabilidad de ejecución remota de código en el servicio de Message Queue Server (CVE-2007-3039)</th>
...
Vulnerabilidad de ejecución remota de código en el servicio de Message Queue Server (CVE-2007-3039)  
---------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en el servicio de Message Queue Server cuando valida incorrectamente las cadenas de entrada al transferirlas a un búfer. Un atacante podría aprovechar esta vulnerabilidad mediante la construcción de un mensaje MSMQ especialmente diseñado que permitiera la ejecución remota de código en un escenario de ataque remoto en Microsoft Windows 2000 y una elevación local de privilegios en un escenario local en Windows XP. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2007-3039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3039).
  
#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el servicio de Message Queue Server (CVE-2007-3039)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Un atacante debe tener credenciales de inicio de sesión válidas para aprovechar esta vulnerabilidad en Windows XP.  
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el servicio de Message Queue Server (CVE-2007-3039)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución de código en el servicio de Message Queue Server (CVE-2007-3039)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código en Microsoft Windows 2000 y de una vulnerabilidad de elevación de privilegios local en Windows XP. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota en Microsoft Windows 2000 y localmente en Windows XP. De esta forma, un atacante podría instalar programas o ver, cambiar o eliminar datos.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código en Microsoft Windows 2000 Server y de una vulnerabilidad de elevación de privilegios local en Microsoft Windows 2000 Professional y Windows XP. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado de forma remota en Microsoft Windows 2000 Server y localmente en Microsoft Windows 2000 Professional y Windows XP. De esta forma, un atacante podría instalar programas o ver, cambiar o eliminar datos.
...
Un atacante que aprovechara esta vulnerabilidad podría conseguir derechos locales de sistema que podrían permitir la ejecución remota de código en implementaciones en Microsoft Windows 2000 o la elevación de privilegios en implementaciones en Windows XP. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad? ** lineBreak/&gt;Para aprovechar esta vulnerabilidad localmente en Windows XP, un atacante tendría que iniciar sesión en el sistema. Para aprovechar esta vulnerabilidad de forma remota en Microsoft Windows 2000, un atacante tendría que enviar paquetes especialmente diseñados al servicio MSMQ que pudieran aprovechar la vulnerabilidad y conseguir el control completo del sistema afectado.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los sistemas Windows 2000 y Windows XP que tengan habilitado el servicio MSMQ están más expuestos.
  
**¿Cómo funciona esta actualización?**  
La actualización elimina la vulnerabilidad al modificar la forma en que el servicio MSMQ valida las cadenas de entrada antes de transferirlas al búfer asignado.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:
Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB937894$\Spuninst</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB937894$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Consulte en la subsección siguiente, <strong>Información sobre archivos</strong>, el manifiesto de archivo completo</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para todas las versiones de 32 bits compatibles y afectadas de Windows XP:
...
-   [Zero Day Initiative](http://www.zerodayinitiative.com/) por informar de la vulnerabilidad de ejecución remota de código en MSMQ (CVE-2007-3039).
-   ADLAB, de [Venustech](http://www.venustech.com.cn/), por informar de la vulnerabilidad de ejecución remota de código en MSMQ (CVE-2007-3039).
...
-   V1.1 (11 de diciembre de 2007): Actualización del boletín para reflejar que el atacante debe iniciar sesión para la elevación local de privilegios en Microsoft Windows 2000 Professional y Windows XP.
-   V1.2 (19 de diciembre de 2007): Actualización del boletín para combinar las referencias a Windows 2000 Professional y Windows 2000 Server con una referencia a Windows 2000 debido a que ambas plataformas comparten la misma vulnerabilidad y gravedad.
-   V1.3 (16 de enero de 2008): Actualización del boletín para agregar Windows XP Home Edition SP2 a la tabla Software no afectado.
