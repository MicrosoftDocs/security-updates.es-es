---
TOCTitle: 'MS07-036'
Title: 'Boletín de seguridad de Microsoft MS07-036 - Crítica'
ms:assetid: 'ms07-036'
ms:contentKeyID: 61225315
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms07-036(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS07-036 - Crítica
====================================================

Vulnerabilidades en Microsoft Excel podrían permitir la ejecución remota de código (936542)
-------------------------------------------------------------------------------------------
...
Es una actualización de seguridad crítica para ediciones compatibles de Microsoft Office 2000. Para ediciones compatibles de Microsoft Office XP, Microsoft Office 2003, Microsoft Office 2004 para Mac y 2007 Microsoft Office System, la clasificación de esta actualización es importante. La clasificación de esta actualización también es importante para Excel Viewer 2003, Paquete de compatibilidad de Office para formatos de archivo de Word, Excel y PowerPoint 2007. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
<p><a href="http://www.microsoft.com/downloads/details.aspx?familyid=11f42977-8828-494a-a183-d1aba827b708">Microsoft Excel 2003 Viewer</a></p></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>  
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e592ae5b-09ac-4f5b-b457-a54c9850ad4a">Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>  
...
<th>Vulnerabilidad de error de cálculo (CVE-2007-1756)</th>  
<th>Vulnerabilidad de daños en la memoria relacionada con la hoja de cálculo (CVE-2007-3029)</th>  
<th>Vulnerabilidad de daños en la memoria relacionada con el libro (CVE-2007-3030)</th>  
<th>Clasificación de gravedad acumulada</th>  
</tr>  
</thead>  
<tbody>  
...
Para ver esta vulnerabilidad como una entrada estándar en las lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2007-1756](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1756).
  
#### Factores atenuantes para la vulnerabilidad de error de cálculo (CVE-2007-1756)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   En 2007 Microsoft Office System al abrir un documento de Excel especialmente diseñado, al usuario se le pide recuperar el "contenido ilegible" del libro y que confirme si el documento es de una fuente de confianza. Si se elige la opción predeterminada **No**, Office no abrirá el archivo con formato incorrecto y, por lo tanto, el usuario está mejor protegido de un ataque.  
...
#### Soluciones provisionales para la vulnerabilidad de error de cálculo (CVE-2007-1756)
...
-   **Use el Entorno aislado de conversión de Microsoft Office (MOICE) al abrir archivos de fuentes desconocidas o que no sean de confianza.**
    ...
    La característica Entorno aislado de conversión de Microsoft Office (MOICE), cuando se agrega al Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007, se usa para abrir archivos en formato binario de Word, Excel y PowerPoint de una forma más segura. Para obtener más información acerca de MOICE, consulte el [artículo 935865 de Microsoft Knowledge Base](http://support.microsoft.com/kb/935865).
  
    **Consecuencias de la solución provisional**: Los documentos de Office 2003 y con formatos anteriores que se conviertan al formato XML abierto de 2007 Microsoft Office System no conservarán la funcionalidad de macro. Además, los documentos con contraseñas o que estén protegidos con Administración de derechos digitales no se podrán convertir.
    ...
    -   **Use la directiva Bloqueo de archivos de Microsoft Office para bloquear la apertura de documentos de Office 2003 y anteriores de fuentes y lugares desconocidos o que no sean de confianza.**
        ...
        **Para 2007 Microsoft Office System**
...
#### Preguntas más frecuentes sobre la vulnerabilidad de error de cálculo (CVE-2007-1756)
...
Excel no valida correctamente la información de versión, lo que puede tener como resultado daños en la memoria.
...
La actualización elimina la vulnerabilidad al modificar la manera en que Microsoft Excel valida los datos relacionados con la versión.
...
Vulnerabilidad de daños en la memoria relacionada con la hoja de cálculo (CVE-2007-3029)  
----------------------------------------------------------------------------------------
  
<span></span>  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Excel trata los archivos de Excel con formato incorrecto. Un atacante podría aprovechar la vulnerabilidad si envía un archivo con formato incorrecto que se podría incluir como datos adjuntos de correo electrónico, o alojarse en un sitio web malintencionado o vulnerable.
  
Para ver esta vulnerabilidad como una entrada estándar en las lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2007-3029](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3029).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la hoja de cálculo (CVE-2007-3029)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la hoja de cálculo (CVE-2007-3029)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Use el Entorno aislado de conversión de Microsoft Office (MOICE) al abrir archivos de fuentes desconocidas o que no sean de confianza.**
  
    La característica Entorno aislado de conversión de Microsoft Office (MOICE) que se incluye en el Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 se usa para abrir archivos en formato binario de Word, Excel y PowerPoint de una forma más segura. Para obtener más información acerca de MOICE, consulte el [artículo 935865 de Microsoft Knowledge Base](http://support.microsoft.com/kb/935865).
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la hoja de cálculo (CVE-2007-3029)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Si se aprovechara, esta vulnerabilidad de ejecución remota de código podría permitir al atacante ejecutar código arbitrario como el usuario que ha iniciado sesión.
  
**¿Cuál es la causa de esta vulnerabilidad? **  
Excel no realiza una validación suficiente de los datos al procesar el número de hojas de cálculo activas, lo que puede provocar daños en la memoria.
...
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al modificar la manera en que Microsoft Excel valida el número de hojas de cálculo activas.
  
**En el momento de publicar este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**    
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común CVE-2007-3029.
  
**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba usando esta vulnerabilidad?**    
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes y no tenía constancia de que se hubiera publicado código demostrativo.
  
Vulnerabilidad de daños en la memoria relacionada con el libro (CVE-2007-3030)  
------------------------------------------------------------------------------
  
<span></span>  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Excel trata los archivos de Excel con formato incorrecto. Un atacante podría aprovechar la vulnerabilidad si envía un archivo con formato incorrecto que se podría incluir como datos adjuntos de correo electrónico, o alojarse en un sitio web malintencionado o vulnerable.
  
Para ver esta vulnerabilidad como una entrada estándar en las lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2007-3030](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3030).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el libro (CVE-2007-3030)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el libro (CVE-2007-3030)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Use el Entorno aislado de conversión de Microsoft Office (MOICE) al abrir archivos de fuentes desconocidas o que no sean de confianza.**
  
    La característica Entorno aislado de conversión de Microsoft Office (MOICE) que se agrega al Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 se usa para abrir archivos en formato binario de Word, Excel y PowerPoint de una forma más segura. Para obtener más información acerca de MOICE, consulte el [artículo 935865 de Microsoft Knowledge Base](http://support.microsoft.com/kb/935865).
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el libro (CVE-2007-3030)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Si se aprovechara, esta vulnerabilidad de ejecución remota de código podría permitir al atacante ejecutar código arbitrario como el usuario que ha iniciado sesión.
  
**¿Cuál es la causa de esta vulnerabilidad? **  
Excel no realiza una validación suficiente cuando indica el inicio de una designación de área de trabajo.
...
**¿Cómo funciona esta actualización?**    
La actualización elimina la vulnerabilidad al modificar la manera en que Microsoft Excel valida el comienzo de los atributos de archivo relacionados con la información de área de trabajo.
...
| Microsoft Office Excel 2007                   | Sí         | Sí         |  
| Paquete de compatibilidad de Microsoft Office | Sí         | Sí         |
...
**Nota** MBSA 1.2.1 utiliza una versión integrada de Office Detection Tool (ODT) que no permite la exploración remota de esta actualización de seguridad. Para obtener más información acerca de MBSA, visite el sitio web de MBSA &lt;[/spain/technet/seguridad/herramientas/mbsa.mspx](http://www.microsoft.com/spain/technet/seguridad/herramientas/mbsa.mspx)&gt; .
...
-   **Comprobación de la versión del archivo**
    ...
    6.  **Los atributos distintos a la versión del archivo pueden cambiar durante la instalación. La comparación de otros atributos de los archivos con los datos de la tabla de información de archivos no constituye un método apropiado para comprobar que se haya aplicado la actualización. Además, en ciertos casos, el nombre de los archivos se puede cambiar durante la instalación. Si no aparece información de la versión o del archivo, recurra a otro de los métodos disponibles para comprobar la instalación de la actualización.**
...
#### Excel 2007 y el paquete de compatibilidad de Microsoft Office
...
Para todas las ediciones compatibles de Microsoft Office Excel 2007:
  
| Nombre de archivo | Versión        | Fecha       | Hora  | Tamaño     |  
|-------------------|----------------|-------------|-------|------------|  
| Excel.exe         | 12.0.6024.5000 | 01-Jun-2007 | 02:36 | 17,892,216 |
  
Para todas las ediciones compatibles de Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007:
...
-   V2.0 (12 de julio de 2007): Actualización del boletín. Boletín actualizado para incluir Microsoft Office 2004 para Mac como un producto afectado. Se ha actualizado la información de manifiesto de archivo para el paquete de compatibilidad de Microsoft Office para Word, Excel y PowerPoint 2007.
