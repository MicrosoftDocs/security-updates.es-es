...
<th>Vulnerabilidad de ataques de suplantación en DNS (CVE-2007-3898)</th>
...
<p>Windows2000-kb941672-x86-enu /quiet</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Windows 2000 Server Service Pack 4:
<p>Windows2000-kb941672-x86-enu /norestart</p></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Windows 2000 Server Service Pack 4:
<p>HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows 2000\SP5\KB941672\Filelist</p></td>
</tr>
</tbody>
</table>
<p> </p>
...
<p>Windowsserver2003-kb941672-x86-enu /quiet</p>
<p>Para todas las ediciones con Itanium compatibles de Windows Server 2003:</p>
<p>WindowsServer2003-KB941672-ia64-enu /quiet</p>
<p>Para todas las ediciones x64 compatibles de Windows Server 2003:</p>
<p>WindowsServer2003.WindowsXP-KB941672-x64-enu /quiet</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:
<p>Windowsserver2003-kb941672-x86-enu /norestart</p>
<p>Para todas las ediciones con Itanium compatibles de Windows Server 2003:</p>
<p>WindowsServer2003-KB941672-ia64-enu /norestart</p>
<p>Para todas las ediciones x64 compatibles de Windows Server 2003:</p>
<p>WindowsServer2003.WindowsXP-KB941672-x64-enu /norestart</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Información adicional</td>
<td style="border:1px solid black;">Vea la subsección <strong>Herramientas y consejos de detección e implementación de Microsoft</strong></td>
...
<p>Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB941672$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Consulte en el apartado <strong>Información sobre archivos</strong>, más adelante, el manifiesto de archivo completo</td>
...
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:
<p>HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB941672\Filelist</p></td>
</tr>
</tbody>
</table>
<p> </p>
