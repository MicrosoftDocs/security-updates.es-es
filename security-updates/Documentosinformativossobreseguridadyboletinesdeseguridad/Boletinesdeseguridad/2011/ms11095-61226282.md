---
TOCTitle: 'MS11-095'
Title: 'Boletín de seguridad de Microsoft MS11-095 - Importante'
ms:assetid: 'ms11-095'
ms:contentKeyID: 61226282
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-095(v=Security.10)'
---
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Active Directory, Active Directory Application Mode (ADAM) y servicio de directorio ligero de Active Directory (AD LDS) tratan los objetos en memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=470da512-2c8b-4ba9-b7bb-b9e6c45cd33f">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8daf9a49-60cb-4813-ac7a-e9a4bf296889">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d2e87199-6469-4bc0-a721-f43e817e4344">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ba8d7aa9-8299-49a3-b0c0-b8b5eab48434">Servicio de directorio ligero de Active Directory (AD LDS)</a><br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408">Active Directory y servicio de directorio ligero de Active Directory (AD LDS)</a>*<br />
(KB2621146)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-086">MS11-086</a></td>
...
Gravedad e identificadores de vul nerabilidad  
---------------------------------------------
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento de búfer en Active Directory (CVE-2011-3406)  
</th>
<th style="border:1px solid black;" >
...
Existe una vulnerabilidad de ejecución remota de código en Active Directory. Para aprovechar esta vulnerabilidad, el atacante primero debe adquirir las credenciales para iniciar sesión en un directorio de Active Directory. Seguidamente, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo del sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-3406](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3406).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de búfer en Active Directory (CVE-2011-3406)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, el atacante debe tener credenciales de cuenta miembro en el dominio de Active Directory de destino. No obstante, el atacante no necesita tener una estación de trabajo unida a un dominio de Active Directory.
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de búfer en Active Directory (CVE-2011-3406)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **Bloquear el puerto TCP 389 en el firewall de la empresa**
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de búfer en Active Directory (CVE-2011-3406)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código en el contexto del servicio de red.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se produce cuando Active Directory procesa una consulta especialmente diseñada e intenta obtener acceso al contenido de un búfer de memoria que no se ha inicializado correctamente.
...
**¿Qué es Active Directory Application Mode?  
...
Para aprovechar esta vulnerabilidad, el atacante primero debe adquirir las credenciales para iniciar sesión en un directorio de Active Directory. Seguidamente, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad a fin de obtener el control completo del sistema afectado.
...
La actualización corrige las vulnerabilidades al modificar la forma en que Active Directory, Active Directory Application Mode (ADAM) y servicio de directorio ligero de Active Directory (AD LDS) tratan los objetos en memoria.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2626416$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2626416">artículo 2626416 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Para Active Directory, use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2621146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM), use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2626416$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Active Directory en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/2621146">artículo 2621146 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Active Directory Application Mode (ADAM) en Windows Server 2003, vea el <a href="http://support.microsoft.com/kb/2626416">artículo 2626416 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2621146">artículo 2621146 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Active Directory y servicio directorio ligero de Active Directory (AD LDS) en todas las ediciones x64 compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB2621146-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de</strong> <strong>las</strong> <strong>claves del Registro</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</td>
</tr>
</tbody>
</table>
