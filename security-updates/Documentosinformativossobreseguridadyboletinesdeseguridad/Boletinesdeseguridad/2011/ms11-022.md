---
TOCTitle: 'MS11-022'
Title: 'Boletín de seguridad de Microsoft MS11-022 - Importante'
ms:assetid: 'ms11-022'
ms:contentKeyID: 61226002
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-022(v=Security.10)'
---
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010 (ediciones de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=549ca7f0-44bf-4965-a9d2-aa5e8dac2238)<sup>[1]</sup>
(KB2519975)
</td>
<td style="border:1px solid black;">
Ejecución remota de código
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010 (ediciones de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=ef62deae-2b07-41c9-a4bf-b746566e59ee)<sup>[1]</sup>
(KB2519975)
</td>
<td style="border:1px solid black;">
Ejecución remota de código
...
<sup>[1]</sup> La solución **Microsoft Fix it** automatizada para PowerPoint 2010, "Deshabilitar la edición en Vista protegida para PowerPoint 2010", disponible en el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) , bloquea las vías de ataque para aprovechar las vulnerabilidades descritas en CVE-2011-0655 y CVE-2011-0656. Para obtener más información, vea la entrada de las preguntas más frecuentes, "¿Cuál es la ventaja de aplicar la solución Microsoft Fix it para deshabilitar la edición en la vista protegida?", en la siguiente sección.
...
Sí. Las actualizaciones para Microsoft PowerPoint 2003 Service Pack 3 (KB2464588) y Microsoft PowerPoint 2007 Service Pack 2 (KB2464594), junto con la actualización ofrecida en [MS11-023](http://technet.microsoft.com/security/bulletin/ms11-023) , proporcionan compatibilidad con la característica Validación de documento de Office. Para obtener más información acerca de la característica Validación de documento de Office, vea el [documento informativo sobre seguridad de Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584) .
  
**¿Cómo está relacionada esta actualización de seguridad con MS10-087 y MS10-088?**  
La actualización para Microsoft Office 2004 para Mac (KB2505924) ofrecida en este boletín también corrige las vulnerabilidades descritas en los boletines de seguridad [MS10-087](http://technet.microsoft.com/security/bulletin/ms10-087) y [MS10-088](http://technet.microsoft.com/security/bulletin/ms10-088) .
  
**¿Cuál es la ventaja de aplicar la solución Microsoft Fix it para deshabilitar la edición en la vista protegida?**  
Al configurar Validación de documento de Office para no permitir la edición de archivos sospechosos en PowerPoint 2010, la solución **Microsoft Fix it** "Deshabilitar la edición en Vista protegida para PowerPoint 2010" bloquea las vías de ataque para aprovechar las vulnerabilidades descritas en CVE-2011-0655 y CVE-2011-0656. Los clientes pueden aplicar la solución Fix it como una solución provisional si deciden no instalar la actualización de seguridad para PowerPoint 2010 más adelante.  
Consulte el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) para obtener instrucciones acerca de cómo aplicar la solución Fix it automatizada "Deshabilitar la edición en Vista protegida para PowerPoint 2010", o consulte las secciones de soluciones provisionales para CVE-2011-0655 y CVE-2011-0656 en la sección Información sobre la vulnerabilidad de este boletín para obtener instrucciones acerca de cómo aplicar la solución manualmente.
  
**En MS11-021 y MS11-023 también se describen las vulnerabilidades en Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac y Convertidor de archivos con formatos XML abiertos para Mac. En MS11-021 también se describen vulnerabilidades en Microsoft Office para Mac 2011. ¿Cómo se relacionan MS11-021 y MS11-023 con este boletín (MS11-022)?**  
Los paquetes de actualización de seguridad para Microsoft Office 2004 para Mac (KB2505924), Microsoft Office 2008 para Mac (KB2505927) y Convertidor de archivos con formatos XML abiertos para Mac (KB2505935) ofrecidos en este boletín también corrigen las vulnerabilidades descritas en los boletines de seguridad [MS11-021](http://technet.microsoft.com/security/bulletin/ms11-021) y [MS11-023](http://technet.microsoft.com/security/bulletin/ms11-023) . El paquete de actualización de seguridad para Microsoft Office para Mac 2011 (KB2525412) ofrecido en este boletín también corrige las vulnerabilidades descritas en [MS11-021](http://technet.microsoft.com/security/bulletin/ms11-021) . Los usuarios con Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Convertidor de archivos con formatos XML abiertos para Mac o Microsoft Office para Mac 2011 instalados solo deberán estos paquetes de actualización de seguridad una sola vez.
...
Microsoft PowerPoint Viewer, que se basa en la tecnología de Microsoft Office 2010, es un reemplazo de Microsoft PowerPoint Viewer 2007 Service Pack 2. Microsoft PowerPoint Viewer permite ver presentaciones completas creadas en Microsoft PowerPoint 97 y versiones posteriores.
...
<th style="border:1px solid black;" >
Vulnerabilidad de ejecución remota de código en Time Bandit thecnocolor de punto flotante (CVE-2011-0655)  
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de ejecución remota de código en persistencia de directorio (CVE-2011-0656)  
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de ejecución remota de código en OfficeArt Atom (CVE-2011-0976)  
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada  
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0655](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0655) .

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en Time Bandit thecnocolor de punto flotante (CVE-2011-0655)
...
-   En Microsoft PowerPoint 2010, la posibilidad de que un atacante consiga aprovechar esta vulnerabilidad se reduce debido a las protecciones que aporta la característica Validación de documento de Office habilitada en Microsoft Office 2010 de forma predeterminada. Los archivos especialmente diseñados usados para aprovechar esta vulnerabilidad se abren Vista protegida y el usuario está advertido de que el archivo no es seguro y puede provocar daños porque no ha superado la validación. Un usuario tendría que hacer clic en varias advertencias y, a continuación, abrir el archivo para editarlo o guardarlo antes de que pudiera aprovechar la vulnerabilidad. Para obtener más información acerca de Vista protegida y Validación de documento de Office, vea el artículo de TechNet [Información general de la seguridad para Office 2010](http://technet.microsoft.com/es-es/library/cc179050.aspx) .  
    **Nota** La desactivación de Validación de documento de Office en Microsoft PowerPoint 2010 quitaría las protecciones que proporciona Validación de documento de Office como factor atenuante. Por este motivo, Microsoft no recomienda deshabilitar la característica Validación de documento de Office en Microsoft PowerPoint 2010.

#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en Time Bandit thecnocolor de punto flotante (CVE-2011-0655)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad

-   **Configurar Validación de documento de Office para deshabilitar la edición en la vista protegida en PowerPoint 2010**

    **Nota** Vea el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) para usar la solución **Microsoft Fix it** automatizada "Deshabilitar la edición en Vista protegida para PowerPoint 2010", a fin de habilitar o deshabilitar esta solución provisional.
    ...
    **Advertencia** El uso incorrecto del Editor del Registro puede originar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no garantiza que los problemas derivados del uso incorrecto del Editor del Registro puedan resolverse. El uso del Editor del Registro es responsabilidad suya. Para obtener información sobre cómo editar el Registro, consulte el tema “Cambiar claves y valores” de la Ayuda del Editor del Registro (Regedit.exe) o los temas “Agregar y eliminar valores del Registro” y “Editar valores del Registro” de la Ayuda de Regedt32.exe.
    ...
    Para aplicar esta solución provisional manualmente:

    1.  Abra el Editor del Registro y vaya a la siguiente clave del Registro:
        HKEY\_CURRENT\_USER\\Software\\Microsoft\\Office\\14.0\\PowerPoint\\Security\\FileValidation
    2.  Establezca el valor de **DisableEditFromPV** en "00000001"
    3.  Salga del Editor del Registro

    **Consecuencias de la solución provisional.** Validación de documento de Office ya no permitirá la edición de archivos sospechosos en PowerPoint 2010.

    **Cómo deshacer la solución provisional.**

    1.  Abra el Editor del Registro y vaya a la siguiente clave del Registro:
        HKEY\_CURRENT\_USER\\Software\\Microsoft\\Office\\14.0\\PowerPoint\\Security\\FileValidation
    2.  Establezca el valor de **DisableEditFromPV** en "00000000"
    3.  Salga del Editor del Registro
...
-   **No abrir los documentos de PowerPoint de fuentes que no sean de confianza**

    No abra los archivos de PowerPoint que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.

#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en Time Bandit thecnocolor de punto flotante (CVE-2011-0655)
...
Microsoft PowerPoint es el componente afectado por esta vulnerabilidad.
...
La actualización modifica la forma en que PowerPoint valida los registros de punto flotante TimeColorBehaviorContainer al abrir archivos de PowerPoint.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0656](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0656) .

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en persistencia de directorio (CVE-2011-0656)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en persistencia de directorio (CVE-2011-0656)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en persistencia de directorio (CVE-2011-0656)
...
**¿Cómo funciona esta actualización?**  
La actualización modifica la forma en que PowerPoint valida los registros PersistDirectoryEntry al abrir archivos de PowerPoint.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0976](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0976) .

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en OfficeArt Atom (CVE-2011-0976)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en OfficeArt Atom (CVE-2011-0976)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en OfficeArt Atom (CVE-2011-0976)
...
| Microsoft PowerPoint Viewer                                                                                            | Sí   |
| Microsoft PowerPoint Web App                                                                                           | Sí   |
...
| Microsoft PowerPoint Viewer                                                                                            | No      | No                | Sí                | Sí                         |
| Microsoft PowerPoint Web App                                                                                           | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2464617">artículo 2464617 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2464588">artículo 2464588 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### PowerPoint 2007 (todas las ediciones) y Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 (todas las versiones) y PowerPoint Viewer 2007 (todas las versiones)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para PowerPoint 2007, vea el <a href="http://support.microsoft.com/kb/2464594">artículo 2464594 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007 Service Pack 2, vea el <a href="http://support.microsoft.com/kb/2464635">artículo 2464635 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Viewer 2007 Service Pack 2, vea el <a href="http://support.microsoft.com/kb/2464623">artículo 2464623 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### PowerPoint 2010 (todas las ediciones), PowerPoint Viewer (todas las versiones) y PowerPoint Web App
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para PowerPoint 2010 (ediciones de 32 bits):<br />
PowerPoint2010-kb2519975-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint 2010 (ediciones de 64 bits):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para PowerPoint 2010, vea el <a href="http://support.microsoft.com/kb/2519975">artículo 2519975 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Viewer, vea el <a href="http://support.microsoft.com/kb/2519984">artículo 2519984 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Web App, vea el <a href="http://support.microsoft.com/kb/2520047">artículo 2520047 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office para Mac 2011 14.1 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3) .
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office para Mac 2011 14.1. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office para Mac 2011 14.1, haga doble clic en la aplicación Actualización de Microsoft Office para Mac 2011 14.1 y siga las instrucciones en pantalla.  
-   Cuando la instalación se realice correctamente, podrá eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office para Mac 2011 14.1 a la Papelera y, a continuación, el archivo descargado.
...
Si el último número de versión de actualización instalada es **14.1** , significa que la actualización se ha instalado correctamente.
...
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/)* de*[TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de ejecución remota de código en Time Bandit thecnocolor de punto flotante (CVE-2011-0655)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/)* de*[TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de ejecución remota de código en persistencia de directorio (CVE-2011-0656)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/)* de*[TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de ejecución remota de código en OfficeArt Atom (CVE-2011-0976)
...
-   V1.0 (12 de abril de 2011): Publicación del boletín.
    ...
    V1.1 (20 de abril de 2011): Se ha corregido la información de reemplazo de boletín para la actualización de Microsoft PowerPoint Web App (KB2520047). Se trata únicamente de un cambio informativo. No hubo cambios en la lógica de detección ni en los archivos de actualización.
