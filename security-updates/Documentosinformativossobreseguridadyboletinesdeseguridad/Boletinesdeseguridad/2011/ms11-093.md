---
TOCTitle: 'MS11-093'
Title: 'Boletín de seguridad de Microsoft MS11-093 - Importante'
ms:assetid: 'ms11-093'
ms:contentKeyID: 61226277
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-093(v=Security.10)'
---
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=73531165-f299-4b62-b738-52fca410eaae)                             | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a98bb7cf-9939-4927-8d21-ccb3845e7cb7)    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6b555040-1117-4b06-a48c-02f0e1b686d8)                    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eb17782c-f754-42ab-905b-6f141df008c3)        | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4cdde8a9-6d44-41fa-82c0-a25404cdfbb5) | Ejecución remota de código      | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de propiedad OLE (CVE-2011-3400)</th>
...
Vulnerabilidad de propiedad OLE (CVE-2011-3400)  
-----------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-3400](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3400).
  
#### Factores atenuantes para la vulnerabilidad de propiedad OLE (CVE-2011-3400)
...
#### Soluciones provisionales para la vulnerabilidad de propiedad OLE (CVE-2011-3400)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de propiedad OLE (CVE-2011-3400)
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2624667$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2624667">artículo 2624667 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Un usuario anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de propiedad OLE (CVE-2011-3400)
