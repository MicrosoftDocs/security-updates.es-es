---
TOCTitle: 'MS11-080'
Title: 'Boletín de seguridad de Microsoft MS11-080 - Importante'
ms:assetid: 'ms11-080'
ms:contentKeyID: 61226248
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-080(v=Security.10)'
---

Boletín de seguridad de Microsoft MS11-080 - Importante
=======================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el controlador de función auxiliar (AFD) valida la entrada antes de pasarla desde el modo usuario al kernel de Windows. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805)                             | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76)    | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5)                    | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29)        | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8) | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
...
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)</th>
...
Vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)  
------------------------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2005).
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)
...
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2592799$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2592799">artículo 2592799 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2592799-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2592799-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2592799-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2592799-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2592799.log</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2592799\Filelist</td>
</tr>
</tbody>
</table>
...
-   Bo Zhou, de [National University of Defense Technology](http://www.nudt.edu.cn/), por informar de la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2011-2005)
