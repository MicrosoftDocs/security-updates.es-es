---
TOCTitle: 'MS11-012'
Title: 'Boletín de seguridad de Microsoft MS11-012 - Importante'
ms:assetid: 'ms11-012'
ms:contentKeyID: 61225992
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-012(v=Security.10)'
---
...
La actualización de seguridad corrige las vulnerabilidades al modificar la manera en que los controladores en modo kernel de Windows validan la entrada pasada desde el modo usuario. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e)                                                                                          | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f)                                                                 | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e)                                                                                 | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63)                                                                     | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)                                                              | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9)                                                        | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882)                                | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1) \*      | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569) \*                    | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)       | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2)                             | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16)                                           | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e) \*              | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d) | Elevación de privilegios        | Importante                          | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
...
<span></span>
**¿Por qué se ha revisado este boletín el 18 de marzo de 2011?**
...
<th style="border:1px solid black;" >Vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)</th>
<th style="border:1px solid black;" >Vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)</th>
<th style="border:1px solid black;" >Vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)</th>
...
Vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)  
---------------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086) .
  
#### Factores atenuantes para la vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)
...
#### Soluciones provisionales para la vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)
...
Vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)  
-----------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan los datos suministrados desde el modo usuario al modo kernel. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087) .
  
#### Factores atenuantes para la vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)
...
Vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)  
------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan los datos suministrados desde el modo usuario al modo kernel. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088) .
  
#### Factores atenuantes para la vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)
...
Vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)  
------------------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan los datos suministrados desde el modo usuario al modo kernel. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089) .
  
#### Factores atenuantes para la vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)
...
Vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)  
----------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan los datos suministrados desde el modo usuario al modo kernel. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090) .
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2479628$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2479628">artículo 2479628 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
Windows6.1-KB2479628-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows 7:<br />
Windows6.1-KB2479628-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows 7:<br />
Windows6.1-KB2479628-x86.msu /quiet /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows 7:<br />
Windows6.1-KB2479628-x64.msu /quiet /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Información adicional</td>
<td style="border:1px solid black;">Vea la subsección <strong>Herramientas y consejos de detección e implementación</strong></td>
...
Windows6.1-KB2479628-ia64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2008 R2:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB2479628-ia64.msu /quiet /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Información adicional</td>
<td style="border:1px solid black;">Vea la subsección <strong>Herramientas y consejos de detección e implementación</strong></td>
...
-   Tarjei Mandt, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de validación de entrada de usuario incorrecta en Win32k (CVE-2011-0086)  
-   Tarjei Mandt, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de validación de entrada de usuario insuficiente en Win32k (CVE-2011-0087)  
-   Tarjei Mandt, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de confusión de puntero de clase de ventana en Win32k (CVE-2011-0088)  
-   Tarjei Mandt, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de validación de puntero incorrecto de clase de ventana en Win32k (CVE-2011-0089)  
-   Tarjei Mandt, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de daños en la memoria relacionada con Win32k (CVE-2011-0090)
