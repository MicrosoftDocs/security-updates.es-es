---
TOCTitle: 'MS11-050'
Title: 'Boletín de seguridad de Microsoft MS11-050 - Crítica'
ms:assetid: 'ms11-050'
ms:contentKeyID: 61226050
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-050(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-050 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (2530548)
-----------------------------------------------------------------------

Publicado: martes, 14 de junio de 2011 | Actualizado: martes, 9 de agosto de 2011
...
Esta actualización de seguridad se considera crítica para Internet Explorer 6 en clientes Windows, Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9; y moderada para Internet Explorer 6 en servidores Windows. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Internet Explorer aplica la configuración de contenido suministrada por el servidor web, trata el saneamiento de HTML con toStaticHTML, trata los objetos en memoria y trata el script durante determinados procesos. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
Sí. Además de los cambios que se enumeran en la sección **Información sobre la vulnerabilidad** de este boletín, esta actualización incluye actualizaciones de seguridad en profundidad para mejorar la protección de la memoria en Internet Explorer. Una de las actualizaciones de defensa en profundidad corrige un problema de fuga de direcciones de memoria, que se denomina de forma pública [CVE-2011-1346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1346) .
...
<th>
Vulnerabilidad de divulgación de información en examen de MIME (CVE-2011-1246)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el tratamiento de propiedades de vínculo (CVE-2011-1250)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con la manipulación de DOM (CVE-2011-1251)
</th>
<th>
Vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con la operación de arrastrar y colocar (CVE-2011-1254)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el elemento de tiempo (CVE-2011-1255)
</th>
</tr>
<tr>
<th colspan="7">
...
<th>
Vulnerabilidad de daños en la memoria relacionada con la modificación de DOM (CVE-2011-1256)
</th>
<th>
Vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-1258)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el diseño (CVE-2011-1260)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con los objetos de selección (CVE-2011-1261)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con el redireccionamiento de HTTP (CVE-2011-1262)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1246) .

#### Factores atenuantes para la vulnerabilidad de divulgación de información en examen de MIME (CVE-2011-1246)
...
#### Soluciones provisionales para la vulnerabilidad de divulgación de información en examen de MIME (CVE-2011-1246)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información en examen de MIME (CVE-2011-1246)

**¿Cuál es el alcance de esta vulnerabilidad?**
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que aprovechara la vulnerabilidad cuando un usuario descarga contenido web podría obligar al explorador a realizar acciones inesperadas, lo que le permitiría ver contenido desde un dominio o una zona de Internet Explorer distinto del dominio o de la zona de la página web del atacante.
...
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que el usuario haya iniciado una sesión, visite un sitio web e intente descargar contenido especialmente diseñado. Por lo tanto, cualquier sistema en el que se use Internet Explorer de forma habitual, como estaciones de trabajo y servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a un objeto que no se ha inicializado correctamente o se ha eliminado. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1250) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el tratamiento de propiedades de vínculo (CVE-2011-1250)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el tratamiento de propiedades de vínculo (CVE-2011-1250)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el tratamiento de propiedades de vínculo (CVE-2011-1250)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1251) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la manipulación de DOM (CVE-2011-1251)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la manipulación de DOM (CVE-2011-1251)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la manipulación de DOM (CVE-2011-1251)
...
#### Factores atenuantes para la vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)
...
-   De forma predeterminada, todas las versiones compatibles de Microsoft Outlook, Microsoft Outlook Express y Windows Mail abren los mensajes de correo electrónico HTML en la zona Sitios restringidos, que deshabilita los scripts y los controles ActiveX, lo que contribuye a reducir el riesgo de que un atacante pueda usar esta vulnerabilidad para ejecutar código malintencionado. Si un usuario hace clic en un vínculo de un mensaje de correo electrónico, podría quedar vulnerable por la posibilidad de un ataque basado en Web.
-   De forma predeterminada, Internet Explorer en Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx) . Este modo atenúa esta vulnerabilidad. Vea la sección P+F correspondiente a esta vulnerabilidad para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer.
-   Internet Explorer 6 e Internet Explorer 9 no están afectados por esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)

**¿Cuál es el alcance de esta vulnerabilidad?**
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que aprovechara la vulnerabilidad cuando un usuario visita una página web que usa la API toStaticHTML podría ejecutar scripts en el contexto de seguridad del usuario dirigidos al sitio.
...
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**
Un atacante que aprovechara esta vulnerabilidad podría ejecutar un script en el contexto de seguridad del usuario dirigido a un sitio web cuando el usuario está visualizando HTML en el sitio web y se haya omitido el saneamiento de datos de usuario realizado a través de la API de toStaticHTML.
...
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que el usuario haya iniciado una sesión y visite un sitio web que la API de toStaticHTML para sanear los datos de usuario. Por lo tanto, cualquier sistema en el que se use Internet Explorer de forma habitual, como estaciones de trabajo y servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1254) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la operación de arrastrar y colocar (CVE-2011-1254)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En un escenario de ataque web, un atacante podría hospedar un sitio web especialmente diseñado para aprovecharse de esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web y arrastre y coloque contenido en él. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico; además, el atacante tendría que convencer a los usuarios para que realicen una operación de arrastrar y colocar.
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.
-   De forma predeterminada, todas las versiones compatibles de Microsoft Outlook, Microsoft Outlook Express y Windows Mail abren los mensajes de correo electrónico HTML en la zona Sitios restringidos, que deshabilita los scripts y los controles ActiveX, lo que contribuye a reducir el riesgo de que un atacante pueda usar esta vulnerabilidad para ejecutar código malintencionado. Si un usuario hace clic en un vínculo de un mensaje de correo electrónico, podría quedar vulnerable por la posibilidad de un ataque basado en Web.
-   De forma predeterminada, Internet Explorer en Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx) . Este modo atenúa esta vulnerabilidad. Vea la sección P+F correspondiente a esta vulnerabilidad para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer.
-   Internet Explorer 9 no está afectado por esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la operación de arrastrar y colocar (CVE-2011-1254)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la operación de arrastrar y colocar (CVE-2011-1254)
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web y arrastre y coloque contenido en él. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico; además, el atacante tendría que convencer a los usuarios para que realicen una operación de arrastrar y colocar.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1255) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el elemento de tiempo (CVE-2011-1255)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el elemento de tiempo (CVE-2011-1255)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el elemento de tiempo (CVE-2011-1255)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1256) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con la modificación de DOM (CVE-2011-1256)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En un escenario de ataque web, un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que realice operaciones de copiar/pegar mientras está en el sitio web del atacante. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico.
-   Se requiere un grado de interacción considerable por parte del usuario para desencadenar la vulnerabilidad.
-   De forma predeterminada, todas las versiones compatibles de Microsoft Outlook, Microsoft Outlook Express y Windows Mail abren los mensajes de correo electrónico HTML en la zona Sitios restringidos, que deshabilita los scripts y los controles ActiveX, lo que contribuye a reducir el riesgo de que un atacante pueda usar esta vulnerabilidad para ejecutar código malintencionado. Si un usuario hace clic en un vínculo de un mensaje de correo electrónico, podría quedar vulnerable por la posibilidad de un ataque basado en Web.
-   De forma predeterminada, Internet Explorer en Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx) . Este modo atenúa esta vulnerabilidad. Vea la sección P+F correspondiente a esta vulnerabilidad para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer.
-   Internet Explorer 9 no está afectado por esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con la modificación de DOM (CVE-2011-1256)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con la modificación de DOM (CVE-2011-1256)
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que realice operaciones de copiar/pegar mientras está en el sitio web del atacante. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que el usuario haya iniciado una sesión, visite un sitio web y realice operaciones de copiar/pegar. Por lo tanto, cualquier sistema en el que se use Internet Explorer de forma habitual, como estaciones de trabajo y servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer que podría permitir a una secuencia de comandos obtener acceso a información en otro dominio o zona de Internet Explorer. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada que permita la divulgación de información si un usuario visita una página web y realiza una operación de arrastrar y colocar. Un atacante que consiga aprovechar esta vulnerabilidad podría ver el contenido de otro dominio o zona de Internet Explorer.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1258) .

#### Factores atenuantes para la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-1258)
...
#### Soluciones provisionales para la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-1258)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-1258)

**¿Cuál es el alcance de esta vulnerabilidad?**
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que aproveche la vulnerabilidad cuando un usuario visita una página web y realice una operación arrastrar y colocar podría ver el contenido de un dominio o una zona de Internet Explorer distinto del dominio o de la zona de la página web del atacante.
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web y realice una operación de arrastrar y colocar. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. En su lugar, el atacante tendría que persuadir a los usuarios para que visitaran el sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante y para que realice una operación de arrastrar y colocar. También sería posible que se mostrara contenido web diseñado especialmente mediante titulares de anuncios u otros métodos para hacer llegar contenido web a los sistemas afectados.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que el usuario haya iniciado una sesión, visite un sitio web y realice una operación de arrastrar y colocar. Por lo tanto, cualquier sistema en el que se use Internet Explorer de forma habitual, como estaciones de trabajo y servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1260) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el diseño (CVE-2011-1260)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el diseño (CVE-2011-1260)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el diseño (CVE-2011-1260)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1261) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos de selección (CVE-2011-1261)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos de selección (CVE-2011-1261)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos de selección (CVE-2011-1261)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1262) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el redireccionamiento de HTTP (CVE-2011-1262)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el redireccionamiento de HTTP (CVE-2011-1262)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el redireccionamiento de HTTP (CVE-2011-1262)
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2530548$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2530548-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2530548-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2530548">artículo 2530548 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2530548$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Robert Swiecki, de [Google Inc.](http://www.google.com/) , por informar de la vulnerabilidad de divulgación de información en examen de MIME (CVE-2011-1246)  
-   [NSFOCUS Security Team](http://www.nsfocus.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con el tratamiento de propiedades de vínculo (CVE-2011-1250)  
-   Un investigador anónimo, en colaboración con el programa [SecuriTeam Secure Disclosure de Beyond Security](http://www.beyondsecurity.com/ssd.html) , por informar de la vulnerabilidad de daños en la memoria relacionada con la manipulación de DOM (CVE-2011-1251)  
-   Adi Cohen, de [IBM Rational Application Security](http://blog.watchfire.com/) , por informar de la vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)  
-   [Trend Micro](http://www.trendmicro.com/) , por colaborar con nosotros en la vulnerabilidad de divulgación de información de toStaticHTML (CVE-2011-1252)  
-   Nirmal Singh Bhary, de [Norman](http://www.norman.com) , por informar de la vulnerabilidad de daños en la memoria relacionada con la operación de arrastrar y colocar (CVE-2011-1254)  
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con el elemento de tiempo (CVE-2011-1255)  
-   Damian Put, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con la modificación de DOM (CVE-2011-1256)  
-   Yoel Gluck, Yogesh Badwe y Varun Badhwar, del equipo de seguridad de productos de [salesforce.com](http://www.salesforce.com/) , por informar de la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-1258)  
-   José Antonio Vázquez González, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con el diseño (CVE-2011-1260)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos de selección (CVE-2011-1261)  
-   Peter Winter-Smith, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con el redireccionamiento de HTTP (CVE-2011-1262)  
-   Stephen Fewer, de [Harmony Security](http://www.harmonysecurity.com/) , en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por colaborar con nosotros en los cambios de defensa tratados en este boletín
...
-   V1.1 (9 de agosto de 2011): Se ha aclarado que uno de los cambios de defensa en profundidad incluidos en este boletín de seguridad corrige un problema de fuga de direcciones de memoria, que se denomina de forma pública CVE-2011-1346. Se trata únicamente de un cambio informativo.
