---
TOCTitle: 'MS11-008'
Title: 'Boletín de seguridad de Microsoft MS11-008 - Importante'
ms:assetid: 'ms11-008'
ms:contentKeyID: 61225988
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-008(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para Microsoft Visio 2002 Service Pack 2, Microsoft Visio 2003 Service Pack 3 y Microsoft Visio 2007 Service Pack 2. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Microsoft Visio trata las estructuras dañadas y los objetos en memoria al analizar los archivos de Visio especialmente diseñados. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
<thead>
<tr class="header">
<th style="border:1px solid black;" >Microsoft Office y otro software de productividad</th>
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)</th>
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)  
------------------------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092) .
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Restringir el acceso a ORMELEMS.DLL**
    ...
    **Para ediciones de 32 bits de Windows XP y Windows Server 2003:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll" /E /P everyone:N`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    **Para ediciones de 64 bits de Windows XP y Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll" /E /P everyone:N`
    ...
    **Consecuencias de la solución provisional.** Los usuarios no podrán usar la característica de modelado de base de datos en Visio.
    ...
    **Cómo deshacer la solución provisional:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 64 bits de Windows XP y Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 32 bits de Windows Vista, Windows Server 2008 y Windows 7:
  
    `takeown /f "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll"cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 64 bits de Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll"cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\ormelems.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
-   **Deshabilitar complementos en Microsoft Visio 2007**
  
    Abra Visio 2007 y siga estos pasos:
  
    1.  Haga clic en **Herramientas** .  
    2.  Haga clic en **Centro de confianza** .  
    3.  Haga clic en **Complementos** .  
    4.  Asegúrese de que la casilla **Deshabilitar todos los complementos de aplicaciones** está seleccionada.  
    5.  Haga clic en **Aceptar** para aplicar la configuración.
  
    **Consecuencias de la solución provisional.** La funcionalidad que depende de los complementos de Visio no funcionará.
    ...
    **Cómo deshacer la solución provisional.**
    ...
    2.  Haga clic en **Centro de confianza** .  
    3.  Haga clic en **Complementos** .  
    4.  Asegúrese de que la casilla **Deshabilitar todos los complementos de aplicaciones** no está seleccionada.  
    5.  Haga clic en **Aceptar** para aplicar la configuración.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)
...
Vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)  
-------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Visio analiza determinadas estructuras al tratar archivos de Visio especialmente diseñados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema podrían verse menos afectados que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093) .
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Restringir el acceso a ELEMENTS.DLL**
  
    Ejecute los siguientes comandos desde un símbolo del sistema como administrador:
  
    **Para ediciones de 32 bits de Windows XP y Windows Server 2003:**
  
    `cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll" /E /P everyone:N`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    **Para ediciones de 64 bits de Windows XP y Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll" /E /P everyone:N`
    ...
    **Cómo deshacer la solución provisional:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 64 bits de Windows XP y Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 32 bits de Windows Vista, Windows Server 2008 y Windows 7:
  
    `Takeown /f "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll"cacls "%ProgramFiles%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone`
  
    **Nota** En &lt;versión de Office&gt;, indique la versión del componente de Microsoft Office adecuado en su sistema, como "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 y "Office12" para Microsoft Visio 2007. Para comprobar la versión, abra este componente de Microsoft Visio y haga clic en **Ayuda** .
  
    Para ediciones de 64 bits de Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
  
    `Takeown /f "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll"cacls "%ProgramFiles(86)%\Microsoft Office\<versión de Office>\elements.dll" /E /R everyone`
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Microsoft Visio no trata correctamente las estructuras dañadas al abrir archivos de Visio especialmente diseñados.
...
En el caso de un ataque a través de web, el atacante tendría que hospedar un sitio web que contuviera un archivo de Visio especialmente diseñado destinado a intentar aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido proporcionado por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. El atacante no podría obligar a los usuarios a visitar estos sitios web. En su lugar, el atacante tendría que persuadir a los usuarios para que visitaran el sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio del atacante y para que abran un archivo de Visio especialmente diseñado.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los sistemas donde se usa Microsoft Visio, incluidas las estaciones de trabajo y los servidores de Terminal Server, están más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, las prácticas recomendadas desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**  
Esta actualización corrige la vulnerabilidad al modificar la forma en que Microsoft Visio analiza las estructuras dañadas al abrir archivos de Visio especialmente diseñados.
...
| Microsoft Visio2003 Service Pack 3  | Sí   |  
...
|-------------------------------------|---------|-------------------|-------------------|----------------------------|  
| Microsoft Visio 2002 Service Pack 2 | No      | No                | Sí                | Sí                         |  
| Microsoft Visio 2003 Service Pack 3 | No      | No                | Sí                | Sí                         |  
| Microsoft Visio 2007 Service Pack 2 | No      | No                | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2434711">artículo 2434711 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2434733">artículo 2434733 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2434737">artículo 2434737 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Procyun, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)  
-   Xin Ouyang, de [Palo Alto Networks](http://www.paloaltonetworks.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos de Visio (CVE-2011-0092)  
-   Xin Ouyang, de [Palo Alto Networks](http://www.paloaltonetworks.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con los tipos de datos de Visio (CVE-2011-0093)
