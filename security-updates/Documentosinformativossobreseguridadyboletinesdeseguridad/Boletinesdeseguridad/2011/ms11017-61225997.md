...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) .
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Conexión a Escritorio remoto 7.0 en todas las ediciones de 32 bits compatibles de la versión original de Windows 7:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexión a Escritorio remoto 7.0 en todas las ediciones x64 compatibles de la versión original de Windows 7:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2483614">artículo 2483614 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Conexión a Escritorio remoto 7.0 en todas las ediciones x64 compatibles de la versión original de Windows Server 2008 R2:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexión a Escritorio remoto 7.0 en todas las ediciones con Itanium compatibles de la versión original de Windows Server 2008 R2:<br />
...
-   Eyal Gruner, de [Versafe Anti Fraud](http://www.versafe-login.com/) , por informar de la vulnerabilidad en la carga de bibliotecas no seguras en Escritorio remoto (CVE-2011-0029)
...
-   V1.1 (8 de marzo de 2011): Se han corregido las entradas de tabla de Systems Management Server para SMS 2.0 y SMS 2003 con SUIT para Windows XP Service Pack 3 y Windows Server 2003 Service Pack 2. Solo son cambios informativos. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.  
-   V1.2 (9 de marzo de 2011): Se han corregido las entradas de componente de **Software no afectado** para las versiones de Service Pack 1 de Windows 7 y Windows Server 2008 R2 de Cliente de Conexión a Escritorio remoto 7.0 a Cliente de Conexión a Escritorio remoto 7.1. Sólo son cambios informativos. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.  
-   V1.3 (13 de abril de 2011): Se ha corregido la información de reemplazo de boletín para Cliente de Conexión a Escritorio remoto 6.0 en las ediciones compatibles de Windows Server 2003 y de Cliente de Conexión a Escritorio remoto 6.1 en las ediciones compatibles de Windows Vista. Se trata únicamente de un cambio de boletín. No había cambios en la detección o en los archivos de la actualización de seguridad.  
-   V1.4 (15 de abril de 2011): Se ha corregido la información de reemplazo de boletín para Cliente de Conexión a Escritorio remoto 6.0 en las ediciones compatibles de Windows Server 2003 y de Cliente de Conexión a Escritorio remoto 6.1 en las ediciones compatibles de Windows Server 2008. Se trata únicamente de un cambio de boletín. No había cambios en la detección o en los archivos de la actualización de seguridad.  
-   V1.5 (4 de mayo de 2011): Se ha corregido la información de reemplazo de boletín para Cliente de Conexión a Escritorio remoto 5.2 en las ediciones compatibles de Windows XP Service Pack 3. Se trata únicamente de un cambio de boletín. No había cambios en la detección o en los archivos de la actualización de seguridad.
