---
TOCTitle: 'MS11-083'
Title: 'Boletín de seguridad de Microsoft MS11-083 - Crítica'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61226257
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-083(v=Security.10)'
---

Boletín de seguridad de Microsoft MS11-083 - Crítica
====================================================
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que la pila TCP/IP de Windows realiza el seguimiento de los paquetes UDP en memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                           | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                               | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                          | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                 | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                           | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7) | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)               | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1\*                                                                                    | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
| Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1                                                                      | Crítica                         | Ejecución remota de código          | [MS11-064](http://technet.microsoft.com/es-es/security/bulletin/ms11-064) |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del contador de referencias (CVE-2011-2013)</th>
...
Vulnerabilidad de desbordamiento del contador de referencias (CVE-2011-2013)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la pila de TCP/IP de Windows debido al procesamiento de un flujo continuo de paquetes UDP especialmente diseñados. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte CVE-2011-2013.
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del contador de referencias (CVE-2011-2013)
  
Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del contador de referencias (CVE-2011-2013)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Bloquear los puertos UDP no usados en el firewall perimetral**
  
    Al bloquear los puertos UDP no usados (cerrados) en el firewall perimetral, contribuirá a proteger los sistemas situados detrás del firewall frente a los intentos de aprovechar esta vulnerabilidad. Para obtener más información acerca de los puertos, vea el artículo de TechNet [Asignación de puertos TCP y UDP](http://go.microsoft.com/fwlink/?linkid=21312).
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del contador de referencias (CVE-2011-2013)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de ejecución remota de código en el contexto del kernel de Windows.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que la pila TCP/IP de Windows procesa un flujo continuo de paquetes UDP especialmente diseñados, lo que provoca un desbordamiento de enteros.
...
**¿Qué es UDP?    
**El protocolo de datagramas de usuario (UDP) es un estándar TCP/IP definido en RFC 768, "Protocolo de datagramas de usuario (UDP)". Algunos programas usan UDP en vez de TCP para el transporte rápido, ligero y no confiable de datos entre hosts TCP/IP. UDP proporciona un servicio de datagramas sin conexión que ofrece una entrega de servicios mínimos, lo que significa que UDP no garantiza la entrega ni comprueba la secuenciación de ningún datagrama. Un host de origen que necesite comunicación confiable debe usar TCP o un programa que proporcione sus propios servicios de secuenciación y confirmación. Para obtener más información, vea el artículo de TechNet [Protocolo de datagramas de usuario (UDP)](http://technet.microsoft.com/en-us/library/cc785220(ws.10).aspx).
...
Un atacante podría aprovechar esta vulnerabilidad si envía un flujo continuo de paquetes UDP especialmente diseñados a un puerto cerrado en un sistema de destino.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**   
Las estaciones de trabajo y los servidores están más expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**   
La actualización corrige esta vulnerabilidad al modificar la forma en que la pila TCP/IP de Windows realiza el seguimiento de los paquetes UDP en memoria.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2588516">artículo 2588516 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
