---
TOCTitle: 'MS11-038'
Title: 'Boletín de seguridad de Microsoft MS11-038 - Crítica'
ms:assetid: 'ms11-038'
ms:contentKeyID: 61226027
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-038(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-038 - Crítica
====================================================
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2371079f-fb20-4fd5-999e-e73f3701818c)                                                                                          | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53d6631-4ded-48f5-a503-925b89b322b2)                                                                 | Ejecución remota de código      | Crítica                             | [MS08-008](http://technet.microsoft.com/security/bulletin/ms08-008) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7e6ff410-4552-4687-81ab-83d9c91f8af5)                                                                                 | Ejecución remota de código      | Crítica                             | [MS08-008](http://technet.microsoft.com/security/bulletin/ms08-008) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9c1a539f-1472-4394-8354-bd549d8332e0)                                                                     | Ejecución remota de código      | Crítica                             | [MS08-008](http://technet.microsoft.com/security/bulletin/ms08-008) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c194dd35-b9db-44a5-a252-38f9f803802f)                                                              | Ejecución remota de código      | Crítica                             | [MS08-008](http://technet.microsoft.com/security/bulletin/ms08-008) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33c9e54-c2e5-498d-a798-5bbfe9e4249c)                                                        | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4566528f-62ee-4d78-b3af-131a7cc15e1f)                                | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c9614d9-6f61-463d-b1fa-bd5eb2c1a5c5) \*\*    | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36698775-0e4e-4980-ae4c-43542de424ca) \*\*                  | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3edb613f-5bf0-4e28-9835-4afbb6ef0e01)       | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=50ae36ff-2406-48a4-97cc-12782b6d30ac)                             | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1241f0f8-a5c7-420a-a5b7-b6c3caa9e5e2)                                           | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8181c359-cd79-438a-87be-093b363d0b04) \*\*            | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6b63a1eb-445a-4cd3-b357-9a1dd82d7a35) | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)</th>
...
Vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)  
-------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0658](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0658) .
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Restringir el acceso a VBScript.dll**
  
    Para restringir el acceso a VBScript.dll, ejecute el siguiente comando desde el símbolo del sistema:
  
    Para Windows XP (sistemas de 32 bits):
  
    `cacls %windir%\system32\vbscript.dll /E /P everyone:N`
  
    Para Windows XP (sistemas de 64 bits):
  
    `cacls %windir%\syswow64\vbscript.dll /E /P everyone:N`
  
    Para Windows Vista y posterior (sistemas de 32 bits):
  
    `takeown /f %windir%\system32\vbscript.dllcacls %windir%\system32\vbscript.dll /E /P everyone:N`
  
    Para Windows Vista y posterior (sistemas de 64 bits):
  
    `takeown /f %windir%\syswow64\vbscript.dllcacls %windir%\syswow64\vbscript.dll /E /P everyone:N`
  
    **Consecuencias de la solución provisional.** Es posible que las páginas web y otras aplicaciones que requieran VBScript no se muestren correctamente.
  
    **Cómo deshacer la solución provisional.**
  
    Para deshacer la solución provisional, ejecute el siguiente comando en el símbolo del sistema:
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)
...
La vulnerabilidad se debe a la forma en que la automatización OLE analiza un archivo WMF especialmente diseñado.
...
El formato de imagen WMF es un formato de metarchivo de 16 bits que puede contener tanto información vectorial como información de mapa de bits. Está optimizado para el sistema operativo Windows.
...
Esta vulnerabilidad requiere que un usuario visualice un archivo de imagen WMF especialmente diseñado. Un atacante podría alojar un sitio web especialmente diseñado para aprovecharse de esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web. También puede tratarse de sitios web vulnerables y sitios web que aceptan u hospedan contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para hacer clic en un vínculo de un mensaje de correo electrónico o en una solicitud de Instant Messenger que lleven a los usuarios al sitio web del atacante. También sería posible que se mostrara contenido web diseñado especialmente mediante titulares de anuncios u otros métodos para hacer llegar contenido web a los sistemas afectados.
...
Esta actualización de seguridad corrige la vulnerabilidad al modificar la manera en que la automatización OLE analiza los archivos WMF.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2476490$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2476490">artículo 2476490 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
-   Yamata Li, de [Palo Alto Networks](http://www.paloaltonetworks.com/) , por informar de la vulnerabilidad de desbordamiento de la automatización OLE (CVE-2011-0658)
