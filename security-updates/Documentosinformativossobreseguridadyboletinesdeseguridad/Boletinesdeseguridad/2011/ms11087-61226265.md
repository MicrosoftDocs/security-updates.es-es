---
TOCTitle: 'MS11-087'
Title: 'Boletín de seguridad de Microsoft MS11-087 - Crítica'
ms:assetid: 'ms11-087'
ms:contentKeyID: 61226265
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-087(v=Security.10)'
---
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que un controlador en modo kernel de Windows trata los archivos de fuentes TrueType. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.

Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2639658](http://technet.microsoft.com/es-es/security/advisory/2639658).
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa)                                                                                          | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                 | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69)                                                                                 | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41)                                                                     | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                              | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af)                                                                                       | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e)                                                                           | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25)\*\*\*\*                                                | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416)\*\*\*\*                                                       | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                       | Ejecución remota de código      | Crítica                             | [MS11-077](http://technet.microsoft.com/es-es/security/bulletin/ms11-077) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6)                             | Ejecución remota de código      | Crítica                             | [MS11-084](http://technet.microsoft.com/es-es/security/bulletin/ms11-084) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629)                                           | Ejecución remota de código      | Crítica                             | [MS11-084](http://technet.microsoft.com/es-es/security/bulletin/ms11-084) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea)\*\*\*\*         | Ejecución remota de código      | Crítica                             | [MS11-084](http://technet.microsoft.com/es-es/security/bulletin/ms11-084) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813) | Ejecución remota de código      | Crítica                             | [MS11-084](http://technet.microsoft.com/es-es/security/bulletin/ms11-084) |
...
<span></span>
**Si he aplicado las soluciones provisionales del documento informativo sobre seguridad de Microsoft 2639658, ¿debo deshacerlas antes de aplicar esta actualización?  **
No. No debe deshacer la solución provisional "Denegar el acceso a T2EMBED.DLL" en los sistemas donde las haya aplicado previamente antes de instalar esta actualización de seguridad.

No obstante, después de aplicar esta actualización de seguridad, debe deshacer la solución provisional "Denegar el acceso a T2EMBED.DLL" en los sistemas donde las haya aplicado anteriormente para restaurar la funcionalidad deshabilitada por la solución provisional. Vea el [artículo 2639417 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2639417) para usar la solución Microsoft Fix it automática para deshabilitar esta solución provisional.

**¿Dónde están los detalles de información de archivos?** 
Consulte en las tablas de referencia de la sección **Implementación de la actualización de seguridad** la ubicación de los detalles de información de archivo.

**¿Windows Developer Preview está afectado por este problema?** 
Sí, la actualización KB2639417 está disponible para la versión de Windows Developer Preview. Se recomienda que los usuarios de Windows Developer Preview apliquen la actualización a sus sistemas. La actualización solo está disponible en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
Windows Server 2008 y Windows Server 2008 R2, si se instalan con la opción de instalación de Server Core, solo son vulnerables en el escenario de ataque de elevación de privilegios local para CVE-2011-3402. No se aplican los escenarios de ataque web y de uso compartido de archivos.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en el kernel de Windows debido al tratamiento incorrecto de un archivo de fuente TrueType especialmente diseñado. La vulnerabilidad podría permitir que un atacante ejecutara código en el modo kernel y, a continuación, instalara programas; viera, cambiar o eliminara datos; o bien crear nuevas cuentas con derechos administrativos completos.
...
-   **Denegar el acceso a T2EMBED.DLL**
    ...
    **Nota** Esta solución provisional solo mitiga los escenarios de ataque web y de uso compartido de archivos. El escenario de ataque local no se mitiga con esta solución provisional.
    ...
    **En Windows XP y Windows Server 2003:**
    ...
    -   Para sistemas de 32 bits, escriba el siguiente comando en un símbolo del sistema con privilegios administrativos:`Echo y| cacl``s "%windir%\system32\t2embed.dll" /E /P everyone:N`  
    -   Para sistemas de 64 bits, escriba los siguientes comandos en un símbolo del sistema con privilegios administrativos:`Echo y| cacls "%windir%\system32\t2embed.dll" /E /P everyone:NEcho y| cacls "%windir%\sys``wow64\t2embed.dll" /E /P everyone:N`
  
    **En Windows Vista, Windows 7, Windows Server 2008 y Windows Server 2008 R2:**
  
    -   Para sistemas de 32 bits, escriba los siguientes comandos en un símbolo del sistema con privilegios administrativos:`Takeown.exe /f "%windir%\syst``em32\t2embed.dll"Icacls.exe "%windir%\system32\t2embed.dll" /deny *S-1-1-0:(F)`  
    -   Para sistemas de 64 bits, escriba los siguientes comandos en un símbolo del sistema con privilegios administrativos:`Takeown.exe /f "%windir%\system32\t2embed.dll"Icacls.exe "%wi``ndir%\system32\t2embed.dll" /deny *S-1-1-0:(F)Takeown.exe /f "%windir%\syswow64\t2embed.dll"Icacls.exe "%windir%\syswow64\t2embed.dll" /deny *S-1-1-0:(F)`
    ...
    **Cómo deshacer la solución provisional.**
    ...
    -   Para sistemas de 64 bits, escriba los siguientes comandos en un símbolo del sistema con privilegios administrativos:`cacls "%windir%\system32\t2embed.dll" /E /R everyonecacls "%windir%\sy``swow64\t2embed.dll" /E /R everyone`
    ...
    -   Para sistemas de 64 bits, escriba los siguientes comandos en un símbolo del sistema con privilegios administrativos:`Icacls.exe "%windir%\system32\t2embed.DLL" /remove:d *S-1-1-0Icacls.exe "%windir%\syswow6``4\t2embed.DLL" /remove:d *S-1-1-0`
...
La actualización corrige la vulnerabilidad al modificar la forma en que un controlador en modo kernel de Windows trata los archivos de fuentes TrueType.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2639417$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2639417">artículo 2639417 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Symantec y Laboratory of Cryptography and System Security (CrySyS), por colaborar con nosotros en la vulnerabilidad de análisis de fuentes TrueType (CVE-2011-3402)
