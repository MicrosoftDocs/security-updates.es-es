---
TOCTitle: 'MS11-026'
Title: 'Boletín de seguridad de Microsoft MS11-026 - Importante'
ms:assetid: 'ms11-026'
ms:contentKeyID: 61226006
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-026(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows XP, Windows Vista y Windows 7, y baja para todas las ediciones compatibles de Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2. Para obtener más información, consulte la subsección **Software afectado y no afectado** de esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el analizador MHTML trata las solicitudes. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .

Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2501696](http://technet.microsoft.com/security/advisory/2501696) .
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae)                                                                                          | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579)                                                                 | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f)                                                                                 | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3)                                                                     | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a)                                                              | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256)                                                        | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c)                                | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596) \*\*    | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8) \*\*                  | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba)       | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b)                             | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb)                                           | Divulgación de información      | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498) \*\*            | Divulgación de información      | Baja                                | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970) | Divulgación de información      | Baja                                | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)</th>
...
Vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)  
----------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de divulgación de información en la forma en que MHTML interpreta las solicitudes con formato MIME para los bloques de contenido en un documento. Es posible en determinadas circunstancias que esta vulnerabilidad permita a un atacante ejecutar un script del lado cliente en el contexto de seguridad incorrecto. Al igual que sucede en las vulnerabilidades de scripts de sitios de lado servidor (XSS), es posible que esta vulnerabilidad permita a un atacante insertar un script del lado cliente como respuesta a una solicitud web ejecutada en el contexto de la instancia del usuario de Internet Explorer.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) .
  
#### Factores atenuantes para la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   En el caso de un ataque basado en web, un sitio web podría contener un vínculo especialmente diseñado que empezara por "MHTML:" destinado a aprovechar esta vulnerabilidad. El atacante tendría que persuadir a los usuarios para que visitaran el sitio web y abrieran una dirección URL especialmente diseñada; por lo general, convenciéndoles de que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante y de que hagan clic en el vínculo especialmente diseñado.  
...
-   De forma predeterminada, Internet Explorer en Windows Server 2003 y 2008 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp) . Este modo soluciona esta vulnerabilidad. Para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer, vea la entrada de las preguntas más frecuentes en la siguiente subsección: "Estoy ejecutando Internet Explorer para Windows Server 2003, Windows Server 2008 o Windows Server 2008 R2. ¿Soluciona esto la vulnerabilidad?"
  
#### Soluciones provisionales para la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Deshabilitar el controlador de protocolo MHTML**
    ...
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no le garantiza que pueda resolver los problemas provocados por el uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
    ...
    Para deshabilitar el controlador de protocolo MHTML, siga estos pasos para crear una copia de seguridad de una clave del Registro y eliminarla:
  
    1.  Abra el Editor del Registro.  
    2.  Desplácese a la siguiente clave del Registro:  
        HKEY\_CLASSES\_ROOT\\CLSID\\{05300401-BCBC-11d0-85E3-00C04FD85AB4}  
    3.  Realice una copia de seguridad de la clave del Registro; para ello, haga doble clic en ella, seleccione **Exportar** y guárdela en un archivo del Registro, por ejemplo, "mhtml.reg".  
    4.  Elimine la clave del Registro; para ello, haga clic con el botón secundario en ella y seleccione **Eliminar** .
  
    **Nota** Puede aplicar el archivo .reg exportado a sistemas individuales si lo copia en un sistema de destino y hace doble clic en él. También puede aplicarlo entre dominios mediante Directiva de grupo. Para obtener más información acerca de la directiva de grupo, vea el artículo de TechNet [Colección de directivas de grupo](http://go.microsoft.com/fwlink/?linkid=215719) .
  
    **Consecuencias de la solución provisional.** El protocolo MHTML dejará de funcionar. Cualquier aplicación que usa MHTML estará afectada por esta solución provisional.
  
    **Cómo deshacer la solución provisional.** Para deshacer esta solución provisional, haga doble clic en el archivo de Registro que exportó en el paso 3 anterior.
  
-   **Habilitar el bloqueo del protocolo MHTML**
  
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no le garantiza que pueda resolver los problemas provocados por el uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
  
    **Nota** Vea el [artículo 2503658 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2503658) para usar la solución **Microsoft Fix it** automática para habilitar y deshabilitar esta solución provisional.
    ...
    **Para ediciones de 32 bits de Microsoft Windows:**
    ...
    **Para ediciones de 64 bits de Microsoft Windows:**
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\1]"mhtml"="mhtml"
    
    [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\2]"mhtml"="mhtml"
    
    [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\3]"mhtml"="mhtml"
    
    [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Internet Settings\RestrictedProtocols\4]"mhtml"="mhtml"
    ```
    ...
    **Consecuencias de la solución provisional.** El protocolo MHTML se restringirá para impedir el inicio de un script en todas las zonas en un documento MHTML. Cualquier aplicación que usa MHTML estará afectada por esta solución provisional. Los scripts en archivos HTML estándar no están afectados por esta solución provisional.
  
    **Cómo deshacer la solución provisional.** Para revertir esta solución provisional, pegue el texto siguiente en un editor de textos como el Bloc de notas. A continuación, guarde el archivo con la extensión de nombre de archivo .reg.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de divulgación de información que afecta a todas las versiones compatibles de Microsoft Windows.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que MHTML interpreta las solicitudes con formato MIME de bloques de contenido en un documento, con lo que un atacante puede ejecutar un script en el contexto de seguridad erróneo (por ejemplo, algunos scripts podrían ejecutarse en la zona de seguridad de Internet Explorer incorrecta).
  
**¿Qué es MHTML?**  
MHTML (Encapsulado MIME de HTML agregado) es un estándar de Internet que define la estructura que se usa para incluir contenido HTML. El controlador de protocolo MHTML de Windows proporciona un [protocolo acoplable](http://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx) que permite que los documentos codificados en MHTML se representen en las aplicaciones.
...
El componente afectado es MHTML, que usan varios productos, por ejemplo, Outlook Express, Windows Mail, Internet Explorer y programas de Microsoft Office como Microsoft Word.
  
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría insertar un script del lado cliente en la instancia del usuario de Internet Explorer. El script podría suplantar contenido, divulgar información o realizar las mismas acciones permitidas al usuario en el sitio web afectado en nombre del usuario atacado.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Debido a la forma en que MHTML interpreta las solicitudes con formato MIME en un documento, un atacante podría aprovechar esta vulnerabilidad para ejecutar un script en el contexto de seguridad incorrecto.
...
**Instalé la solución Microsoft Fix it para habilitar el bloqueo del protocolo MHTML. ¿Cómo me afectará la instalación de esta actualización de seguridad?**  
La solución Microsoft Fix it del [artículo 2503658 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2503658) habilita el bloqueo del protocolo MHTML. La actualización de seguridad corrige la vulnerabilidad en MHTML, pero no anula el bloqueo del protocolo MHTML aplicado por la solución Microsoft Fix it. Las consecuencias de la solución provisional permanecen vigentes después de instalar la actualización de seguridad. Los usuarios que no deseen mantener bloqueado el protocolo MHTML pueden usar la solución Microsoft Fix it para deshabilitar el bloqueo. Para obtener más información acerca de la solución Microsoft Fix it, consulte la entrada de solución provisional "Habilitar el bloqueo del protocolo MHTML" en la subsección anterior.
  
**Instalé la solución Microsoft Fix it para habilitar el bloqueo del protocolo MHTML. ¿Debo desinstalar esta actualización antes de instalar esta actualización de seguridad?**  
No. No debe desinstalar la solución Microsoft Fix it para instalar la actualización de seguridad.
  
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que el analizador MHTML trata las solicitudes.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) .
...
Sí. Esta actualización de seguridad soluciona la vulnerabilidad. A la vulnerabilidad que se ha tratado se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096) .
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2503658$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2503658">artículo 2503658 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
-   [Google Security Team](http://www.google.com/) , por colaborar con nosotros en la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-0096)
