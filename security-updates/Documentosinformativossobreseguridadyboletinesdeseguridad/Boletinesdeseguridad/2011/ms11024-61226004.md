...
**¿Por qué este boletín contiene dos actualizaciones para la mayoría de los sistemas operativos afectados? **  
...
<th>Vulnerabilidad de daños en la memoria relacionada con Editor de portadas de fax (CVE-2010-3974)</th>
<th>Vulnerabilidad en el uso de portadas de fax después de la liberación (CVE-2010-4701)</th>
<th>Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2008 y para todas las ediciones x64 compatibles de Windows Server 2008, vea los artículos <a href="http://support.microsoft.com/kb/2491683">2491683</a> y <a href="http://support.microsoft.com/kb/2506212">2506212</a> de Microsoft Knowledge Base.<br />
<br />
Para todas las ediciones con Itanium compatibles de Windows Server 2008, vea el <a href="http://support.microsoft.com/kb/2506212">artículo 2506212 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2008 R2, vea los artículos <a href="http://support.microsoft.com/kb/2491683">2491683</a> y <a href="http://support.microsoft.com/kb/2506212">2506212</a> de Microsoft Knowledge Base.<br />
<br />
Para todas las ediciones con Itanium compatibles de Windows Server 2008 R2, vea el <a href="http://support.microsoft.com/kb/2506212">artículo 2506212 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</td>
...
-   Carsten Eiram, de [Secunia](http://secunia.com/) , por colaborar con nosotros en la vulnerabilidad en el uso de portadas de fax después de la liberación (CVE-2010-4701)
...
-   V1.1 (20 de abril de 2011): Se ha agregado un vínculo al artículo 2527308 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.  
-   V1.2 (27 de abril de 2011): Se ha corregido la tabla de la gravedad y la sección de vulnerabilidad para agregar CVE-2010-4701 como una vulnerabilidad corregida por esta actualización. Se trata únicamente de un cambio informativo.
