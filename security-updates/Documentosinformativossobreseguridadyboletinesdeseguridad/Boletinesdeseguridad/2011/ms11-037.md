---
TOCTitle: 'MS11-037'
Title: 'Boletín de seguridad de Microsoft MS11-037 - Importante'
ms:assetid: 'ms11-037'
ms:contentKeyID: 61226026
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-037(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-037 - Importante
=======================================================

Una vulnerabilidad en MHTML podría permitir la divulgación de información (2544893)
-----------------------------------------------------------------------------------

Publicado: martes, 14 de junio de 2011 | Actualizado: martes, 15 de noviembre de 2011
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=ce5bc2d7-9438-4bf0-be5e-be9dd00c3286)                                                                                          | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b211b02-a005-46a3-ad1d-d4baaeec8289)                                                                 | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6427ea5d-05d0-4367-805c-9cb305802b3c)                                                                                 | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7f65891-32c0-4817-b3b2-d8be73145df9)                                                                     | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ca8b1d09-9f80-417b-99b1-8f86e86e1f11)                                                              | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ebea38a7-1fbe-4141-a529-52d7a7326d6a)                                                        | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54833350-a385-4a31-995a-9ddc38798c21)                                | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6a3bbd67-94db-40b2-8786-cb39a493ec92)\*\*     | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4cb870f3-9878-4075-b8fd-2ee90c8e3bc8)\*\*                   | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1243011-00e6-49f2-a676-c04cb805d36a)       | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c3647646-658a-423b-b0cb-bba7613b67e7)                             | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7996511d-4b8e-49c3-a0fa-4da907a6c947)                                           | Divulgación de información      | Importante                          | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=40354f73-4f4d-4a4a-abac-f8a3d4c3ae5f)\*\*             | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=22853823-8f63-4258-8991-1ad50e58a0d9) | Divulgación de información      | Baja                                | [MS11-026](http://technet.microsoft.com/es-es/security/bulletin/ms11-026) |
...
Microsoft ha vuelto publicar este boletín para ofrecer de nuevo la actualización de seguridad KB2544893 para todas las ediciones compatibles de Windows XP y Windows Server 2003. La nueva oferta de esta actualización proporciona a los sistemas que ejecutan Windows XP o Windows Server 2003 la misma protección acumulativa que se proporciona con esta actualización a todos los demás sistemas operativos afectados. A los sistemas que ejecutan las ediciones compatibles de Windows XP y Windows Server 2003 se les ofrecerá automáticamente la nueva versión de esta actualización. Los clientes que usan estos sistemas operativos, incluidos los que hayan instalado correctamente la actualización que se ofreció originalmente el 14 de junio de 2011, deben instalar la actualización que se ofrece de nuevo.
...
<th style="border:1px solid black;" >Vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-1894)</th>
...
Vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-1894)  
----------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de divulgación de información en la forma en que MHTML interpreta las solicitudes con formato MIME para el contenido que está insertado en un documento HTML. Al igual que sucede en las vulnerabilidades de scripts de sitios de lado servidor (XSS), es posible que esta vulnerabilidad permita a un atacante insertar un script del lado cliente como respuesta a una solicitud web ejecutada en el contexto de la instancia del usuario de Internet Explorer.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894).
  
#### Factores atenuantes para la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-1894)
...
#### Soluciones provisionales para la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-1894)
...
-   **Deshabilitar el controlador de protocolo MHTML**
    ...
    **Método interactivo:**
    ...
    Para deshabilitar manualmente el controlador de protocolo MHTML, siga estos pasos:
  
    1.  Abra el Editor del Registro.  
    2.  Desplácese a la siguiente clave del Registro:  
        HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    3.  Realice una copia de seguridad de la clave del Registro mhtml; para ello, haga clic con el botón secundario en ella, seleccione **Exportar** y guárdela en un archivo del Registro (por ejemplo, "mhtml pluggable protocol registry backup.reg").  
    4.  Elimine la clave del Registro mhtml; para ello, haga clic con el botón secundario en ella y seleccione **Eliminar**.
  
    **Con una secuencia de comandos de implementación administrada:**
  
    Para deshabilitar el controlador de protocolo MHTML mediante un script de implementación administrada, siga estos pasos:
  
    1.  Realice una copia de seguridad de la clave del Registro mhtml con la siguiente entrada de la línea de comandos:  
        regedit /e mhtml\_pluggable\_protocol\_registry\_backup.reg HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    2.  Cree el script de implementación administrada; para ello, guarde lo siguiente en un archivo con la extensión .reg (por ejemplo, disable\_mhtml\_pluggable\_protocol.reg):  
        Editor del Registro de Windows versión 5.00  
        \[-HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml\]  
    3.  Ejecute el script de implementación administrada en un sistema de destino con la siguiente entrada de la línea de comandos:  
    ...
    **Cómo deshacer la solución provisional.** Para deshacer esta solución provisional, haga doble clic en el archivo de Registro que creó en los procedimientos anteriores.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de procesamiento de solicitudes con formato MIME en MHTML (CVE-2011-1894)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Esta vulnerabilidad afecta a la divulgación de información.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que MHTML interpreta las solicitudes con formato MIME de contenido que está insertado en un documento HTML, con lo que un atacante puede ejecutar un script en el contexto de seguridad erróneo (por ejemplo, algunos scripts podrían ejecutarse en la zona de seguridad de Internet Explorer incorrecta).
  
**¿Qué es MHTML?**   
MHTML (Encapsulado MIME de HTML agregado) es un estándar de Internet que define la estructura que se usa para incluir contenido HTML. El controlador de protocolo MHTML en Windows ofrece un protocolo acoplable (MHTML:) que permite que los documentos codificados con MHTML se representen en las aplicaciones. Para obtener más información, vea el artículo de MSDN [Acerca de los protocolos acoplables asincrónicos](http://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx).
  
**¿Qué son los scripts de sitios (XSS)?**   
Los scripts de sitios (XSS) son un tipo de vulnerabilidad que puede permitir a un atacante insertar un script en la respuesta de una página web. A continuación, este script lo ejecuta la aplicación que efectúa la solicitud, frecuentemente un explorador web. El script podría suplantar contenido, divulgar información o realizar las mismas acciones permitidas al usuario en el sitio web afectado en nombre del usuario atacado.
...
Un atacante que aprovechara esta vulnerabilidad podría crear un sitio que inserte un script malintencionado en la página con la etiqueta &lt;EMBED&gt; HTML. El atacante podría convencer al usuario para que visitara el sitio, lo que le permitiría ejecutar un script de lado cliente en el contexto de seguridad erróneo. El script podría suplantar contenido, divulgar información o realizar las mismas acciones permitidas al usuario en un sitio web.
...
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894).
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2544893-v2$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2544893">artículo 2544893 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<br />
<strong>Nota</strong> En los sistemas donde se instaló la versión inicial del archivo de actualización, también estará presente la siguiente clave del Registro:<br />
...
-   Billy Rios y Eduardo Vela Nava, de [Google Security Team](http://www.google.com/), por colaborar con nosotros en los cambios de este boletín.
