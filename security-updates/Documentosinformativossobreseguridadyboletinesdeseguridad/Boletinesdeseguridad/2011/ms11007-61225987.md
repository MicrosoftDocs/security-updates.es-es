---
TOCTitle: 'MS11-007'
Title: 'Boletín de seguridad de Microsoft MS11-007 - Crítica'
ms:assetid: 'ms11-007'
ms:contentKeyID: 61225987
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-007(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-007 - Crítica
====================================================
...
Publicado: martes, 8 de febrero de 2011 | Actualizado: martes, 9 de julio de 2013
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el controlador de OpenType CFF (Compact Font Format) de Windows valida los valores de parámetro de las fuentes OpenType especialmente diseñadas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, Información sobre la vulnerabilidad.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f86e9e64-801a-431a-b24e-772011dfa66d)                                                                                          | Elevación de privilegios        | Importante                          | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=074396f0-a68c-4190-8dac-0b883d56e3f1)                                                                 | Elevación de privilegios        | Importante                          | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a99c2b13-db81-4f18-9cf7-c20614ba0132)                                                                                 | Elevación de privilegios        | Importante                          | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aeed45fb-9395-4c2b-a674-e38b04fe0914)                                                                     | Elevación de privilegios        | Importante                          | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bc09e42b-2eed-41b3-a03f-cb8cc94adfee)                                                              | Elevación de privilegios        | Importante                          | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d60a2098-7351-4fce-83b2-2c1c3a24faa0)                                                        | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=065ad8fe-1caf-488e-a2e1-96db29f2fa57)                                | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88ba83b9-c14e-499a-8335-04bac1c49c0c)\*       | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c74d7f4-6372-4809-89b8-c79b05e54cdd)\*                     | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91d5d34b-9d7e-4e83-89a4-f1aa388dc4e4)       | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1da57fbc-9ea4-4fc4-911d-d5c7825e012c)                             | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=587adb89-2f6a-4893-9906-b6d6d9ada2bd)                                           | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=638318ed-4000-4b1a-bb4b-65b795f59784)\*               | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4688ea0d-a467-4f24-ac52-104d05c8cae8) | Ejecución remota de código      | Crítica                             | [MS10-091](http://go.microsoft.com/fwlink/?linkid=203895) |
...
<th style="border:1px solid black;" >Vulnerabilidad de caracteres codificados en fuentes OpenType (CVE-2011-0033)</th>
...
Vulnerabilidad de caracteres codificados en fuentes OpenType (CVE-2011-0033)  
----------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el controlador de OpenType CFF (Compact Font Format) de Windows analiza incorrectamente las fuentes OpenType especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-0033](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0033).
  
#### Factores atenuantes para la vulnerabilidad de caracteres codificados en fuentes OpenType (CVE-2011-0033)
...
#### Soluciones provisionales para la vulnerabilidad de caracteres codificados en fuentes OpenType (CVE-2011-0033)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de caracteres codificados en fuentes OpenType (CVE-2011-0033)
...
La vulnerabilidad se debe a que el controlador de OpenType CFF (Compact Font Format) de Windows no valida correctamente los valores de parámetro de fuentes OpenType especialmente diseñadas.
...
¿Qué son las fuentes OpenType CFF (Compact Font Format)?   
Una fuente OpenType CFF es una fuente OpenType que contiene contornos PostScript de tipo 1. Las fuentes OpenType pueden contener contornos PostScript de tipo 1 o TrueType. Todas las fuentes de Microsoft Windows contienen contornos de TrueType. Las aplicaciones de autoedición como Adobe InDesign y QuarkXPress admiten la mayor parte de las características de OpenType. Adobe Photoshop y Adobe Illustrator admiten muchas características. En Microsoft Office Publisher y Microsoft Office Word también se ha agregado la compatibilidad con las características de OpenType comunes. Para obtener más información, vea [Preguntas más frecuentes acerca de la tipografía OpenType de Microsoft](http://www.microsoft.com/typography/opentypefaq.mspx).
...
La actualización corrige la vulnerabilidad al modificar la manera en que el controlador de OpenType CFF (Compact Font Format) de Windows valida los valores de parámetro de las fuentes OpenType especialmente diseñadas.
...
<td style="border:1px solid black;">Use la herramienta Agregar o quitar programas del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2485376$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Información sobre archivos</td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2485376">artículo 2485376 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   V2.1 (9 de julio de 2013): se ha revisado el boletín para anunciar un cambio de detección que excluye los paquetes de idioma de Windows 7 de la actualización 2485376 para Windows XP Professional x64 Edition Service Pack 2. Se trata únicamente de un cambio de detección. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.
