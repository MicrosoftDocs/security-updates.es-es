---
TOCTitle: 'MS11-070'
Title: 'Boletín de seguridad de Microsoft MS11-070 - Importante'
ms:assetid: 'ms11-070'
ms:contentKeyID: 61226220
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-070(v=Security.10)'
---
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que WINS trata la comunicación interna en la dirección de bucle invertido. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299)                                                                   | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99)                                                       | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495)\*                                        | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9)\*                                               | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986)\* | Elevación de privilegios        | Importante                          | [MS11-035](http://technet.microsoft.com/es-es/security/bulletin/ms11-035) |
...
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)</th>
...
Vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)  
--------------------------------------------------------------------------
  
En WINS existe una vulnerabilidad de elevación de privilegios que permite la ejecución de código arbitrario en el contexto del sistema local. La vulnerabilidad se debe a que el servidor WINS procesa incorrectamente una secuencia de paquetes especialmente diseñados en la interfaz de bucle invertido. Un atacante local que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, el atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984).
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)
...
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de elevación de privilegios locales.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que el servidor WINS procesa incorrectamente una secuencia de paquetes especialmente diseñados en la interfaz de bucle invertido.
...
Un atacante que consiguiera aprovechar esta vulnerabilidad en Windows Server 2003 podría ejecutar código arbitrario en el contexto de un sistema local. Un atacante que consiguiera aprovechar esta vulnerabilidad en Windows Server 2008 o Windows Server 2008 R2 podría ejecutar código arbitrario en el contexto del servicio local. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**   
Para aprovechar esta vulnerabilidad, el atacante primero debe iniciar sesión en el sistema. A continuación, podría ejecutar una aplicación especialmente diseñada que aprovechara la vulnerabilidad mediante el envío de paquetes especialmente diseñados a la interfaz de bucle invertido lo que le permitiría obtener el control completo de un sistema afectado.
...
La actualización corrige la vulnerabilidad al modificar la forma en que WINS trata la comunicación interna en la dirección de bucle invertido.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2571621$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2571621">artículo 2571621 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Nicolas Economou, de [Core Security Technologies](http://www.coresecurity.com/), por informar de la vulnerabilidad de elevación de privilegios locales en WINS (CVE-2011-1984)
