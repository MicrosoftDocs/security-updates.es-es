---
TOCTitle: 'MS11-081'
Title: 'Boletín de seguridad de Microsoft MS11-081 - Crítica'
ms:assetid: 'ms11-081'
ms:contentKeyID: 61226252
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-081(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-081 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (2586448)
-----------------------------------------------------------------------

Publicado: martes, 11 de octubre de 2011 | Actualizado: miércoles, 2 de noviembre de 2011
...
Esta actualización de seguridad se considera crítica para Internet Explorer en clientes Windows y moderada para Internet Explorer en servidores de Windows. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización corrige las vulnerabilidades al modificar la forma en que Internet Explorer trata los objetos en memoria y la forma en que Internet Explorer asigna y tiene acceso a la memoria. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<span></span>
**¿Por qué se ha revisado este boletín el** **2** **de noviembre de 2011?**
Microsoft ha revisado este boletín para anunciar la publicación de una revisión para resolver un problema que afecta a los clientes de Internet Explorer 7, por el que algunas listas desplegables y cuadros combinados no aparecen en Internet Explorer 7 después de instalar la actualización de seguridad KB2586448. Para obtener más información acerca de este problema e instrucciones para aplicar la revisión a fin de solucionar el problema, vea [Artículo 2586448 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2586448).
...
Sí. Además de los cambios que se enumeran en la sección Información sobre la vulnerabilidad que este boletín, esta actualización incluye actualizaciones de defensa en profundidad para mejorar la protección de la memoria, administración de marcos y cookies, la API de Bing y el filtro XSS en Internet Explorer.
...
<th>
Vulnerabilidad de ejecución remota de código en el evento Scroll (CVE-2011-1993)
</th>
<th>
Vulnerabilidad de ejecución remota de código en OLEAuto32.dll (CVE-2011-1995)
</th>
<th>
Vulnerabilidad de ejecución remota de código en el elemento Option (CVE-2011-1996)
</th>
<th colspan="2">
Vulnerabilidad de ejecución remota de código en el evento OnLoad (CVE-2011-1997)
</th>
</tr>
<tr>
<th colspan="6">
...
<th>
Vulnerabilidad de ejecución remota de código en Jscript9.dll (CVE-2011-1998)
</th>
<th>
Vulnerabilidad de ejecución remota de código en el elemento Select (CVE-2011-1999)
</th>
<th>
Vulnerabilidad de ejecución remota de código en el elemento Body (CVE-2011-2000)
</th>
<th>
Vulnerabilidad de ejecución remota de código de daños en la tabla de funciones virtuales (CVE-2011-2001)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1993](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el evento Scroll (CVE-2011-1993)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el evento Scroll (CVE-2011-1993)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el evento Scroll (CVE-2011-1993)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a un objeto que no se ha inicializado correctamente. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1995](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en OLEAuto32.dll (CVE-2011-1995)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en OLEAuto32.dll (CVE-2011-1995)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en OLEAuto32.dll (CVE-2011-1995)

**¿Cuál es el alcance de esta vulnerabilidad?**
Se trata de una vulnerabilidad de ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

**¿Cuál es la causa de esta vulnerabilidad?**
Cuando Internet Explorer intenta obtener acceso a un objeto que no se ha inicializado, puede dañar la memoria de tal manera que un atacante podría ejecutar código arbitrario en el contexto del usuario que ha iniciado sesión.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1996](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el elemento Option (CVE-2011-1996)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el elemento Option (CVE-2011-1996)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el elemento Option (CVE-2011-1996)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1997](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el evento OnLoad (CVE-2011-1997)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el evento OnLoad (CVE-2011-1997)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el evento OnLoad (CVE-2011-1997)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1998](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en Jscript9.dll (CVE-2011-1998)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en Jscript9.dll (CVE-2011-1998)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en Jscript9.dll (CVE-2011-1998)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a una dirección de memoria desreferenciada. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1999](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el elemento Select (CVE-2011-1999)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el elemento Select (CVE-2011-1999)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el elemento Select (CVE-2011-1999)

**¿Cuál es el alcance de esta vulnerabilidad?**
Se trata de una vulnerabilidad de ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

**¿Cuál es la causa de esta vulnerabilidad?**
Cuando Internet Explorer intenta obtener acceso a una dirección de memoria desreferenciada, se puede dañar la memoria de tal manera que un atacante podría ejecutar código arbitrario en el contexto del usuario que ha iniciado sesión.
...
**¿Cómo funciona esta actualización?**
La actualización corrige la vulnerabilidad al modificar la manera en que Internet Explorer asigna la memoria y obtiene acceso a ella.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2000](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el elemento Body (CVE-2011-2000)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el elemento Body (CVE-2011-2000)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el elemento Body (CVE-2011-2000)
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a una tabla de funciones virtuales después de que se haya dañado. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001).

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código de daños en la tabla de funciones virtuales (CVE-2011-2001)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código de daños en la tabla de funciones virtuales (CVE-2011-2001)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código de daños en la tabla de funciones virtuales (CVE-2011-2001)

**¿Cuál es el alcance de esta vulnerabilidad?**
Se trata de una vulnerabilidad de ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

**¿Cuál es la causa de esta vulnerabilidad?**
Cuando Internet Explorer intenta obtener acceso a una tabla de funciones virtuales dañada, se puede permitir que un atacante ejecutara código arbitrario en el contexto del usuario que ha iniciado sesión.
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2586448$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2586448-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2586448-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2586448">artículo 2586448 de Microsoft Knowledge Base</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2586448$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Vishwas Sharma, de McAfee Labs, por informar de la vulnerabilidad de ejecución remota de código en el evento Scroll (CVE-2011-1993)  
-   David Bloom, de [Greplin](https://www.greplin.com), por informar de la vulnerabilidad de ejecución remota de código en OLEAuto32.dll (CVE-2011-1995)  
-   Ivan Fratric, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com) de [TippingPoint](http://www.tippingpoint.com), por informar de la vulnerabilidad de ejecución remota de código en el elemento Option (CVE-2011-1996)  
-   [GWSlabs](http://www.gwslabs.com), en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com), por informar de la vulnerabilidad de ejecución remota de código en el evento OnLoad (CVE-2011-1997)  
-   David Bloom, de [Greplin](https://www.greplin.com), por informar de la vulnerabilidad de ejecución remota de código en Jscript9.dll (CVE-2011-1998)  
-   Ivan Fratric, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com) de [TippingPoint](http://www.tippingpoint.com), por informar de la vulnerabilidad de ejecución remota de código en el elemento Select (CVE-2011-1999)  
-   Sebastian Apelt, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com) de [TippingPoint](http://www.tippingpoint.com), por informar de la vulnerabilidad de ejecución remota de código en el elemento Body (CVE-2011-2000)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com) de [TippingPoint](http://www.tippingpoint.com), por informar de la vulnerabilidad de ejecución remota de código de daños en la tabla de funciones virtuales (CVE-2011-2001)  
-   Eduardo Vela Nava, de [Google Inc.](http://www.google.com), y David Bloom, de [Greplin](https://www.greplin.com), por colaborar con nosotros en los cambios de defensa en profundidad incluidos en este boletín  
-   [Soroush Dalili,](http://www.secproject.com) por colaborar con nosotros en los cambios de defensa en profundidad incluidos en este boletín  
-   Billy Rios, de [Google Inc.](http://www.google.com), por colaborar con nosotros en los cambios de defensa en profundidad incluidos en este boletín
...
-   V1.1 (12 de octubre de 2011): Se ha agregado un vínculo al artículo 2586448 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.  
-   V1.2 (2 de noviembre de 2011): Se ha anunciado la publicación de una revisión para resolver un problema conocido que afecta a los clientes de Internet Explorer 7 después de instalar la actualización de seguridad KB2586448. Vea las preguntas más frecuentes de la actualización para obtener más detalles.
