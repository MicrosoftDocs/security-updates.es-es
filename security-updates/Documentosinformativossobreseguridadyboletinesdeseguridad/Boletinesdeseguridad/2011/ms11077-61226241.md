---
TOCTitle: 'MS11-077'
Title: 'Boletín de seguridad de Microsoft MS11-077 - Importante'
ms:assetid: 'ms11-077'
ms:contentKeyID: 61226241
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-077(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-077 - Importante
=======================================================
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que los controladores en modo kernel de Windows validan los datos pasados del modo usuario, tratan el tipo de fuente TrueType, asignan el tamaño de búfer correcto antes de escribir en memoria y administran los objetos de controlador en modo kernel. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7)                                                                                          | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                                 | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8)                                                                                 | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d)                                                                     | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                              | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c)                                                                                       | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc)                                                                           | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705)\*                                                      | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6)\*                                                             | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                       | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56)                             | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd)                                           | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72)\*               | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e) | Ejecución remota de código      | Importante                          | [MS11-054](http://technet.microsoft.com/es-es/security/bulletin/ms11-054) |
...
<span></span>
En las siguientes clasificaciones de gravedad se supone la máxima repercusión posible de la vulnerabilidad. Para obtener información acerca de la probabilidad, en el plazo de 30 días después de la publicación de este boletín de seguridad, de la explotabilidad de la vulnerabilidad en relación con su clasificación de gravedad y repercusiones de seguridad, vea el índice de explotabilidad en el [resumen del boletín de octubre](http://technet.microsoft.com/en-us/security/bulletin/ms11-oct). Para obtener más información, vea [Índice de explotabilidad de Microsoft](http://technet.microsoft.com/en-us/security/cc998259.aspx).
...
<th style="border:1px solid black;" >Vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)</th>
<th style="border:1px solid black;" >Vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)</th>
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)</th>
<th style="border:1px solid black;" >Vulnerabilidad en el uso de Win32k después de la liberación (CVE-2011-2011)</th>
...
</strong>Elevación de privilegios</td>
...
<td style="border:1px solid black;"><strong>Moderada</strong> <strong><br />
</strong>Denegación de servicio</td>
<td style="border:1px solid black;">No aplicable</td>
<td style="border:1px solid black;"><strong>Importante</strong> <strong><br />
</strong>Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong> <strong><br />
...
Vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)  
-------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios debida a la forma en que los controladores en modo kernel de Windows validan los datos suministrados desde el modo usuario al modo kernel. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985).
  
#### Factores atenuantes para la vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)
...
#### Soluciones provisionales para la vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
En sistemas operativos de 32 bits se trata de una vulnerabilidad de elevación de privilegios. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el modo kernel y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos. En sistemas operativos x64 y con Itanium, se trata de una vulnerabilidad de denegación de servicio.
...
Vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)  
---------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de denegación de servicio en las implementaciones de Microsoft Windows cuando el sistema procesa incorrectamente un archivo de fuente TrueType especialmente diseñado. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado dejara de responder.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2002](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002).
  
#### Factores atenuantes para la vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)
...
-   A menudo, el protocolo SMB de uso compartido de archivos está deshabilitado en el firewall perimetral. Esto limita los posibles vectores de ataque remoto para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que el controlador en modo kernel de Windows no trata correctamente el tipo de fuente TrueType.
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**   
Un atacante podría hospedar un archivo de fuente TrueType especialmente diseñado en un recurso compartido de red. Después, cuando el usuario navegue al recurso compartido en el Explorador de Windows, la ruta de acceso de control afectado se activa a través de los paneles de detalles y de vista previa. La fuente TrueType especialmente diseñada podría aprovechar la vulnerabilidad y provocar que el sistema dejara de responder.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**   
Las estaciones de trabajo y los servidores de Terminal Server son los más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, los procedimientos recomendados desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**   
La actualización corrige la vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows tratan el tipo de fuente TrueType.
...
Vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)  
-------------------------------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código en el kernel de Windows debido al tratamiento incorrecto de un archivo de fuente .fon especialmente diseñado. La vulnerabilidad podría permitir que un atacante ejecutara código en el modo kernel y, a continuación, instalara programas; viera, cambiar o eliminara datos; o bien crear nuevas cuentas con derechos administrativos completos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2003](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003).
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para que un ataque remoto se lleve a cabo, el usuario debe visitar una ubicación de sistema de archivo o recurso compartido WebDAV remoto que no sea de confianza y abrir un archivo de fuente especialmente diseñado (como un archivo .fon), o bien abrir el archivo como datos adjuntos de correo electrónico.  
-   A menudo, el protocolo SMB de uso compartido de archivos está deshabilitado en el firewall perimetral. Esto limita los posibles vectores de ataque remoto para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)
...
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que un controlador en modo kernel de Windows no realiza una validación correcta al escribir en un búfer.
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**   
En un ataque de red, un atacante podría guardar un archivo de fuente (como un archivo .fon) especialmente diseñado en un recurso compartido de red o una ubicación UNC o WebDAV, y, a continuación, convencer al usuario de que abra el archivo.
  
En el supuesto de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía un archivo de fuente (como un archivo .fon) especialmente diseñado como datos adjuntos a un usuario y le convence de que lo abra.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**   
Las estaciones de trabajo y los servidores de Terminal Server son los más expuestos. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, los procedimientos recomendados desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**   
La actualización corrige la vulnerabilidad al modificar la manera en que los controladores en modo kernel de Windows asignan el tamaño de búfer correcto antes de escribir en la memoria.
...
Vulnerabilidad en el uso de Win32k después de la liberación (CVE-2011-2011)  
---------------------------------------------------------------------------
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011).
  
#### Factores atenuantes para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2011-2011)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2011-2011)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2011-2011)
...
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que los controladores en modo kernel administran incorrectamente los objetos de controlados en modo kernel.
...
**¿Cómo funciona esta actualización?**   
La actualización corrige la vulnerabilidad al modificar la forma en que los controladores en modo kernel de Windows administran los objetos de controlador en modo kernel.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2567053$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2567053">artículo 2567053 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2567053-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2567053-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2567053-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2567053-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2567053.log</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2567053\Filelist</td>
</tr>
</tbody>
</table>
...
-   Andrei Lutas, de [BitDefender](http://www.bitdefender.com/), por informar de la vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)  
-   Tarjei Mandt, de [Norman](http://www.norman.com/), por informar de la vulnerabilidad de desreferencia de puntero nulo en Win32k (CVE-2011-1985)  
-   Maik Wellmann, por informar de la vulnerabilidad de traducción de tipo de fuente TrueType en Win32k (CVE-2011-2002)  
-   Will Dorman, de [CERT/CC](http://www.cert.org/), por informar de la vulnerabilidad de desbordamiento del búfer en el archivo de biblioteca de fuentes (CVE-2011-2003)
