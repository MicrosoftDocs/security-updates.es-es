---
TOCTitle: 'MS11-064'
Title: 'Boletín de seguridad de Microsoft MS11-064 - Importante'
ms:assetid: 'ms11-064'
ms:contentKeyID: 61226082
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-064(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows Server 2008 y Windows Server 2008 R2, y moderada para todas las ediciones compatibles de Windows Vista y Windows 7. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que la pila de TCP/IP de Windows procesa los mensajes ICMP y trata las direcciones URL en memoria cuando está habilitado QoS basado en dirección URL. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9)                                                                                       | Denegación de servicio          | Moderada                            | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653)                                                                           | Denegación de servicio          | Moderada                            | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e) \*                                                     | Denegación de servicio          | Importante                          | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0) \*                                                            | Denegación de servicio          | Importante                          | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab)                                                       | Denegación de servicio          | Importante                          | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00)                             | Denegación de servicio          | Moderada                            | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53)                                           | Denegación de servicio          | Moderada                            | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3) \*              | Denegación de servicio          | Importante                          | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17) | Denegación de servicio          | Importante                          | [MS10-058](http://technet.microsoft.com/security/bulletin/ms10-058) |
...
<th style="border:1px solid black;" >Vulnerabilidad de denegación de servicio en ICMP (CVE-2011-1871)</th>
<th style="border:1px solid black;" >Vulnerabilidad de denegación de servicio en QoS de TCP/IP (CVE-2011-1965)</th>
...
Vulnerabilidad de denegación de servicio en ICMP (CVE-2011-1871)  
----------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en la pila TCP/IP de Windows debida a que la pila TCP/IP trata incorrectamente una secuencia de mensajes ICMP especialmente diseñados. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema de destino dejara de responder y se reiniciara automáticamente.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1871](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871) .
  
#### Factores atenuantes para la vulnerabilidad de denegación de servicio en ICMP (CVE-2011-1871)
  
Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de denegación de servicio en ICMP (CVE-2011-1871)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Bloquear ICMP en el firewall**
  
    El bloqueo de todos los mensajes ICMP en el firewall perimetral de la red o en el enrutador protegerá a los sistemas que se encuentran detrás del firewall o enrutador frente a los intentos de aprovechar esta vulnerabilidad. Se recomienda bloquear toda la comunicación entrante no solicitada desde Internet.
  
    **Consecuencias de la solución provisional.** Esta solución provisional puede afectar negativamente al rendimiento ya que impide que TCP optimice la comunicación de red. Los paquetes de red ICMP pueden eliminar la fragmentación en los enrutadores que conectan redes con MTU distintos. La fragmentación reduce el rendimiento de TCP y aumenta la congestión de red.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de denegación de servicio en ICMP (CVE-2011-1871)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que la pila TCP/IP de Windows procesa incorrectamente una secuencia de mensajes ICMP especialmente diseñados.
  
**¿Cuál es el componente afectado por esta vulnerabilidad?**  
Tcpip.sys es el componente afectado por la vulnerabilidad.
...
Un atacante no autenticado podría aprovechar esta vulnerabilidad mediante la creación de un programa para enviar una secuencia de mensajes ICMP especialmente diseñados a un sistema de destino.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los servidores y las estaciones de trabajo están afectados por esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que la pila TCP/IP de Windows procesa los mensajes ICMP.
...
Vulnerabilidad de denegación de servicio en QoS de TCP/IP (CVE-2011-1965)  
-------------------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en la pila TCP/IP de Windows debida a que la pila TCP/IP trata incorrectamente las direcciones URL en memoria cuando la calidad de servicio (QoS) basada en dirección URL está habilitada. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema de destino dejara de responder y se reiniciara automáticamente.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2010-1965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965) .
  
#### Factores atenuantes para la vulnerabilidad de denegación de servicio en QoS de TCP/IP (CVE-2011-1965)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, la característica de calidad de servicio basada en dirección URL no está habilitada en ningún sistema operativo Windows. Los usuarios deberían instalar esta característica manualmente para verse afectados por esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de denegación de servicio en QoS de TCP/IP (CVE-2011-1965)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   Deshabilite QoS basada en directivas. Para obtener más información, vea el artículo de Microsoft TechNet [Calidad de servicio (QoS) basada en directivas](http://technet.microsoft.com/en-us/library/dd919203(ws.10).aspx) .
  
#### Preguntas más frecuentes sobre la vulnerabilidad de denegación de servicio en QoS de TCP/IP (CVE-2011-1965)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que la pila TCP/IP trata incorrectamente las direcciones URL especialmente diseñadas en memoria. Esta vulnerabilidad solo se activa cuando el sistema de destino hospeda contenido web con un servicio como IIS y tiene habilitada QoS basada en dirección URL.
  
**¿Cuál es el componente afectado por esta vulnerabilidad?**  
Tcpip.sys es el componente afectado por la vulnerabilidad.
  
**¿Qué es la calidad de servicio (QoS) basada en dirección URL?**  
La calidad de servicio (QoS) para redes es un conjunto de estándares y mecanismos del sector para garantizar un rendimiento de alta calidad en aplicaciones críticas. Los administradores de red pueden usar mecanismos de QoS para asignar prioridades y administrar la velocidad de envío del tráfico de red. El uso de estos mecanismos garantiza que los recursos se usan de un modo eficaz para ofrecer el nivel de servicio requerido.
  
Windows Server 2008 R2 permite a los profesionales de TI asignar prioridades al tráfico web basado en la dirección URL. Con QoS basada en dirección URL, los profesionales de TI pueden garantizar que el tráfico web importante se procesa antes que el que no es importante, con lo que se mejora el rendimiento en las redes con mucho tráfico. Por ejemplo, los profesionales de TI pueden asignar al tráfico web de los sitios web internos una prioridad mayor que a los sitios web externos, lo que maximiza el rendimiento cuando la red tiene mucho tráfico. Para obtener más información, vea el artículo de Microsoft TechNet [QoS basada en dirección URL](http://technet.microsoft.com/en-us/library/dd637810(ws.10).aspx) .
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
En un escenario de ataque remoto, un atacante no autenticado podría aprovechar esta vulnerabilidad si envía una solicitud de dirección URL especialmente diseñada al servidor que sirve el contenido web y tiene habilitada QoS basada en dirección URL.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los servidores que hospedan contenido con QoS basada en dirección URL habilitada están más expuestos. Los servidores que no tienen habilitada QoS basada en dirección URL o no sirven contenido web no están expuestos. Las estaciones de trabajo como sistemas Windows 7, que pueden ejecutar Internet Information Services (IIS), están más expuestos si se habilitan IIS y QoS basada en dirección URL.
  
**¿Los sistemas Windows 7 están más expuestos si se configuran como servidores con IIS?**  
Sí. El software de servidor, como IIS, se puede instalar y configurar en sistemas Windows 7. Aunque los sistemas Windows 7 se consideran estaciones de trabajo, en esta configuración actúan como servidores y, por lo tanto, están más expuestos a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que la pila TCP/IP trata las direcciones URL en memoria cuando se ha habilitado QoS basada en dirección URL.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2563894">artículo 2563894 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="odd">
