---
TOCTitle: 'MS11-056'
Title: 'Boletín de seguridad de Microsoft MS11-056 - Importante'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61226061
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-056(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-056 - Importante
=======================================================
...
Publicado: martes, 12 de julio de 2011 | Actualizado: jueves, 21 de julio de 2011
...
La actualización de seguridad corrige las vulnerabilidades al no permitir que múltiples objetos de consola se asocien a un proceso, al modificar la forma en que CSRSS inicializa la memoria, al validar la entrada del usuario antes de usarla como índice de una matriz y al modificar la comprobación de límites para prevenir daños en la memoria. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 con SP2 para sistemas con Itanium</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-010">MS11-010</a><em>,</em><br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-069">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a5e192af-dae5-47ef-a9d0-f761a8caa974">Windows Vista Service Pack 1 y Windows Vista Service Pack 2</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1007f5d3-9be1-4f03-a3f0-12ddb555653c">Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2</a> *</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2</a> *</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1</a> *</td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1</a></td>
<td style="border:1px solid black;">Elevación de privilegios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)</th>
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)</th>
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)</th>
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)</th>
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)  
------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en CSRSS de Windows debida a la forma en que el subsistema CSRSS asigna memoria para determinadas transacciones de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281) .
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)
...
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Para intentar aprovechar esta vulnerabilidad, un atacante debe poder iniciar una sesión localmente en un sistema y ejecutar un programa.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Esta vulnerabilidad se debe a una condición de daños en la memoria que se produce cuando se asocian múltiples objetos de consola a un proceso. Cuando el proceso finaliza, los objetos de consola adicionales se quedan huérfanos y este controlador de objeto lo puede obtener otro proceso ejecutado con mayores privilegios de los previstos.
  
**¿Qué es el subsistema de tiempo de ejecución de cliente-servidor (CSRSS) de Windows?**  
El subsistema de tiempo de ejecución de cliente-servidor (CSRSS) es la parte del modo usuario del subsistema Win32 (y Win32.sys es la parte del modo kernel). CSRSS es un subsistema esencial que debe estar en ejecución en todo momento. CSRSS es responsable de las ventanas de consola, así como de la creación y eliminación de subprocesos.
  
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría ejecutar código arbitrario en un contexto de sistema. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
...
La actualización corrige esta vulnerabilidad al no permitir que múltiples objetos se asocien a un proceso.
...
Vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)  
----------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en CSRSS de Windows debida a la forma en que el subsistema CSRSS asigna memoria para determinadas transacciones de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282) .
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Para intentar aprovechar esta vulnerabilidad, un atacante debe poder iniciar una sesión localmente en un sistema y ejecutar un programa.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de daños en la memoria que pueden permitir la ejecución de código en el contexto del sistema. Se pasa un puntero NULL sin validación a una función de CSRSS. Esto permite que CSRSS escriba en una página NULL en su espacio de proceso. En los sistemas Windows XP, en determinadas condiciones, un atacante puede aprovechar esta página para ejecutar código con mayores permisos.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige esta vulnerabilidad al modificar la forma en que CSRSS inicializa la memoria para evitar la ejecución de código arbitrario en el contexto del sistema.
...
Vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)  
----------------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en CSRSS de Windows debida a la forma en que el subsistema CSRSS asigna memoria para determinadas transacciones de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283) .
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Para intentar aprovechar esta vulnerabilidad, un atacante debe poder iniciar una sesión localmente en un sistema y ejecutar un programa.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Esta vulnerabilidad se produce cuando la entrada del usuario se usa como índice de una matriz sin comprobar antes si se trata de un valor negativo. Esto podría permitir al atacante leer datos de la memoria, o de la memoria dañada, de forma tal que podría permitir la ejecución de código.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige esta vulnerabilidad al validar la entrada del usuario antes de usarla como índice para una matriz.
...
Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)  
---------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en CSRSS de Windows debida a la forma en que el subsistema CSRSS asigna memoria para determinadas transacciones de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284) .
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Esta vulnerabilidad se debe a una condición de desbordamiento de enteros que podría permitir a un atacante ejecutar código en el contexto de la cuenta del sistema.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige esta vulnerabilidad al modificar la comprobación de límites para evitar que se dañe la memoria y la ejecución de código.
...
Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)  
---------------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios en CSRSS de Windows debida a la forma en que el subsistema CSRSS asigna memoria para determinadas transacciones de usuario. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870) .
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)
...
**¿Cómo funciona esta actualización?**  
La actualización corrige esta vulnerabilidad al modificar la comprobación de límites para evitar que se dañe la memoria.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2507938$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2507938">artículo 2507938 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
-   Matthew 'j00ru' Jurczyk, de [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) , por informar de la vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)  
-   Matthew 'j00ru' Jurczyk, de [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) , por informar de la vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)  
-   Matthew 'j00ru' Jurczyk, de [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) , por informar de la vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)  
-   Matthew 'j00ru' Jurczyk, de [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) , por informar de la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)  
-   Matthew 'j00ru' Jurczyk, de [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/) , por informar de la vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)
...
-   V1.1 (21 de julio de 2011): Se ha agregado un vínculo al artículo 2507938 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
