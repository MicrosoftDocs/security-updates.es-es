...
<th>Vulnerabilidad de elevación de privilegios local por AllocConsole en CSRSS (CVE-2011-1281)</th>  
<th>Vulnerabilidad de elevación de privilegios local por SrvSetConsoleLocalEUDC en CSRSS (CVE-2011-1282)</th>  
<th>Vulnerabilidad de elevación de privilegios local por SrvSetConsoleNumberOfCommand en CSRSS (CVE-2011-1283)</th>  
<th>Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutput en CSRSS (CVE-2011-1284)</th>  
<th>Vulnerabilidad de elevación de privilegios local por SrvWriteConsoleOutputString en CSRSS (CVE-2011-1870)</th>  
<th>Clasificación de gravedad acumulada</th>  
</tr>  
</thead>  
<tbody>  
