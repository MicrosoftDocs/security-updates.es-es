---
TOCTitle: 'MS11-045'
Title: 'Boletín de seguridad de Microsoft MS11-045 - Importante'
ms:assetid: 'ms11-045'
ms:contentKeyID: 61226041
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-045(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-045 - Importante
=======================================================

Vulnerabilidades en Microsoft Excel podrían permitir la ejecución remota de código (2537146)
--------------------------------------------------------------------------------------------

Publicado: martes, 14 de junio de 2011 | Actualizado: miércoles, 10 de agosto de 2011
...
La actualización corrige las vulnerabilidades al modificar la forma en que Microsoft Excel valida la información de registro al analizar archivos de Excel especialmente diseñados. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
Cuando la característica Validación de documento de Office está habilitada en Microsoft Excel 2003 y Microsoft Excel 2007, los archivos especialmente diseñados que se podrían usar para aprovechar las vulnerabilidades descritas en CVE-2011-1272, CVE-2011-1273 y CVE-2011-1279 no se abren automáticamente; de forma predeterminada, se pide al usuario que elija si desea abrir o no un archivo de ese tipo. Un usuario podría hacer clic en la advertencia para abrir el archivo antes de que se pudieran aprovechar las vulnerabilidades. Para obtener más información acerca de Validación de documento de Office en Microsoft Excel 2003 o Microsoft Excel 2007, vea el [documento informativo sobre seguridad de Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584) .

Validación de documento de Office se habilita de forma predeterminada en Microsoft Excel 2010. Los archivos especialmente diseñados que se podrían usar para aprovechar las vulnerabilidades descritas en CVE-2011-1272, CVE-2011-1273 y CVE-2011-1279 no superan la validación y se abren en [Vista protegida](http://www.microsoft.com/security/pc-security/office2010.aspx) ; el usuario debe hacer clic en varios mensajes de advertencia para que el archivo se pueda abrir para editarlo y se puedan aprovechar las vulnerabilidades.

**¿Cuál es la ventaja de deshabilitar la apertura de archivos que no superan la validación de archivo en Excel 2003 y Excel 2007?**
Al configurar Validación de documento de Office para no permitir la apertura de archivos sospechosos en Excel 2003 y Excel 2007, la solución **Microsoft Fix it** "Deshabilitar la apertura de documentos para Excel 2003 y 2007", disponible en el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) , bloquea las vías de ataque para aprovechar las vulnerabilidades descritas en CVE-2011-1272, CVE-2011-1273 y CVE-2011-1279.

Consulte el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) para obtener instrucciones acerca de cómo aplicar la solución Fix it automatizada "Deshabilitar la apertura de documentos para Excel 2003 y 2007", o consulte las secciones de soluciones provisionales para CVE-2011-1272, CVE-2011-1273 y CVE-2011-1279 en la sección Información sobre la vulnerabilidad de este boletín para obtener instrucciones acerca de cómo aplicar la solución manualmente.

**¿Cuál es la ventaja de deshabilitar la apertura de archivos que no superan la validación de archivo en Excel 2010?**
Microsoft Excel 2010 solo está afectado por CVE-2011-1273 descrito en este boletín. La solución **Microsoft Fix it** automatizada "Deshabilitar la edición en Vista protegida en Excel 2010", disponible en el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) , bloquea las vías de ataque para aprovechar CVE-2011-1273. Los clientes pueden aplicar la solución Fix it como una solución provisional si deciden no instalar la actualización de seguridad para Excel 2010 hasta más adelante.

Consulte el [artículo 2501584 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2501584) para obtener instrucciones acerca de cómo aplicar la solución Fix it automatizada "Deshabilitar la edición en Vista protegida para Excel 2010", o consulte la sección de soluciones provisionales para CVE-2011-1273 en la sección Información sobre la vulnerabilidad de este boletín para obtener instrucciones acerca de cómo aplicar la solución manualmente.
...
**¿Cómo está relacionada esta actualización de seguridad con MS11-036?**
Los paquetes de actualización de seguridad para Microsoft Office 2004 para Mac (KB2555786), Microsoft Office 2008 para Mac (KB2555785) y Convertidor de archivos con formatos XML abiertos para Mac (KB2555784) ofrecidos en este boletín también corrigen las vulnerabilidades descritas en el boletín de seguridad [MS11-036](http://technet.microsoft.com/security/bulletin/ms11-036) .
...
<th>
Vulnerabilidad de validación insuficiente de registros en Excel (CVE-2011-1272)
</th>
<th>
Vulnerabilidad de análisis incorrecto de registros en Excel (CVE-2011-1273)
</th>
<th>
Vulnerabilidad de acceso a matriz fuera de los límites en Excel (CVE-2011-1274)
</th>
<th>
Vulnerabilidad de sobrescritura del montón de memoria en Excel (CVE-2011-1275)
</th>
<th>
Vulnerabilidad de desbordamiento del búfer en Excel (CVE-2011-1276)
</th>
<th>
Vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-1277)
</th>
<th>
Vulnerabilidad de WriteAV en Excel (CVE-2011-1278)
</th>
<th>
Vulnerabilidad de WriteAV fuera de los límites en Excel (CVE-2011-1279)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1272](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1272) .

#### Factores atenuantes para la vulnerabilidad de validación insuficiente de registros en Excel (CVE-2011-1272)
...
#### Soluciones provisionales para la vulnerabilidad de validación insuficiente de registros en Excel (CVE-2011-1272)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de validación insuficiente de registros en Excel (CVE-2011-1272)
...
La vulnerabilidad se debe a que Microsoft Excel no valida suficientemente las estructuras de registro de Excel al analizar archivos de Excel especialmente diseñados.
...
La actualización corrige la vulnerabilidad al modificar la forma en que Microsoft Excel valida la información de registro al analizar archivos de Excel especialmente diseñados.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1273](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273) .

#### Factores atenuantes para la vulnerabilidad de análisis incorrecto de registros en Excel (CVE-2011-1273)
...
#### Soluciones provisionales para la vulnerabilidad de análisis incorrecto de registros en Excel (CVE-2011-1273)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis incorrecto de registros en Excel (CVE-2011-1273)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1274](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274) .

#### Factores atenuantes para la vulnerabilidad de acceso a matriz fuera de los límites en Excel (CVE-2011-1274)
...
#### Soluciones provisionales para la vulnerabilidad de acceso a matriz fuera de los límites en Excel (CVE-2011-1274)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de acceso a matriz fuera de los límites en Excel (CVE-2011-1274)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1275](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275) .

#### Factores atenuantes para la vulnerabilidad de sobrescritura del montón de memoria en Excel (CVE-2011-1275)
...
#### Soluciones provisionales para la vulnerabilidad de sobrescritura del montón de memoria en Excel (CVE-2011-1275)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de sobrescritura del montón de memoria en Excel (CVE-2011-1275)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1276](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276) .

#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer en Excel (CVE-2011-1276)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer en Excel (CVE-2011-1276)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer en Excel (CVE-2011-1276)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1277](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-1277)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-1277)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-1277)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1278](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278) .

#### Factores atenuantes para la vulnerabilidad de WriteAV en Excel (CVE-2011-1278)
...
#### Soluciones provisionales para la vulnerabilidad de WriteAV en Excel (CVE-2011-1278)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de WriteAV en Excel (CVE-2011-1278)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1279](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279) .

#### Factores atenuantes para la vulnerabilidad de WriteAV fuera de los límites en Excel (CVE-2011-1279)
...
#### Soluciones provisionales para la vulnerabilidad de WriteAV fuera de los límites en Excel (CVE-2011-1279)
...
-   **Configurar Validación de documento de Office para deshabilitar la apertura de archivos que no superen la validación en Excel 2003**
    ...
    **Nota** La modificación incorrecta del Registro puede originar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no garantiza que los problemas derivados de la modificación incorrecta del Registro puedan resolverse. Realice las modificaciones al Registro bajo su propio riesgo.
    ...
    Use el script del Registro para su software de Office.
...
#### Preguntas más frecuentes sobre la vulnerabilidad de WriteAV fuera de los límites en Excel (CVE-2011-1279)
...
| Software                                                                                                               | MBSA |
|------------------------------------------------------------------------------------------------------------------------|------|
| Microsoft Excel 2002 Service Pack 3                                                                                    | Sí   |
| Microsoft Excel 2003 Service Pack 3                                                                                    | Sí   |
| Microsoft Excel 2007 Service Pack 2                                                                                    | Sí   |
| Microsoft Excel 2010 (ediciones de 32 bits)                                                                            | Sí   |
| Microsoft Excel 2010 (ediciones de 64 bits)                                                                            | Sí   |
...
| Microsoft Excel 2003 Service Pack 3                                                                                    | Sí                | Sí                         |
| Microsoft Excel 2007 Service Pack 2                                                                                    | Sí                | Sí                         |
| Microsoft Excel 2010 (ediciones de 32 bits)                                                                            | Sí                | Sí                         |
| Microsoft Excel 2010 (ediciones de 64 bits)                                                                            | Sí                | Sí                         |
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2541003">artículo 2541003 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2541025">artículo 2541025 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Excel 2007 (todas las ediciones)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Microsoft Excel 2007, vea el <a href="http://support.microsoft.com/kb/2541007">artículo 2541007 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Excel Viewer, vea el <a href="http://support.microsoft.com/kb/2541015">artículo 2541015 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007, vea el <a href="http://support.microsoft.com/kb/2541012">artículo 2541012 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
#### Excel 2010 (todas las ediciones)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2523021">artículo 2523021 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2004 para Mac 11.6.4 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=d12d0868-4f28-4c0a-ab61-338878064b70) .
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office 2004 para Mac 11.6.4. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office 2004 para Mac 11.6.4, haga doble clic en la aplicación Actualización de Microsoft Office 2004 para Mac 11.6.4 y siga las instrucciones en pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office 2004 para Mac 11.6.4 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **11.6.4** , significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2008 para Mac 12.3.0 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=9e2d348b-c753-4eab-838c-370cd5af5e14) .
  
-   Cierre todas las aplicaciones en ejecución, incluidos los programas antivirus, todas las aplicaciones de Microsoft Office, Microsoft Messenger para Mac y Office Notifications, ya que podrían interferir con la instalación.  
-   Abra en el escritorio el volumen de actualización de Microsoft Office 2008 para Mac 12.3.0. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office 2008 para Mac 12.3.0, haga doble clic en la aplicación Actualización de Microsoft Office 2008 para Mac 12.3.0 y siga las instrucciones en pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office 2008 para Mac 12.3.0 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **12.3.0** , significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office para Mac 2011 14.1.2 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=3c58555c-1eba-42fe-a10f-b30af9031e44) .
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office para Mac 2011 14.1.2. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office para Mac 2011 14.1.2, haga doble clic en la aplicación Actualización de Microsoft Office para Mac 2011 14.1.2 y siga las instrucciones en pantalla.  
-   Cuando la instalación se realice correctamente, podrá eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office para Mac 2011 14.1.2 a la Papelera y, a continuación, el archivo descargado.
...
Si el último número de versión de actualización instalada es **14.1.2** , significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.2.0 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=6118d5f5-b6fd-4584-be25-209534772379) .
  
-   Cierre todas las aplicaciones en ejecución, incluidos los programas antivirus, todas las aplicaciones de Microsoft Office, Microsoft Messenger para Mac y Office Notifications, ya que podrían interferir con la instalación.  
-   Abra en el escritorio el volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.2.0. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.2.0, haga doble clic en la aplicación de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.2.0 y siga las instrucciones que aparecen en la pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen de actualización de Convertidor de archivos con formatos XML abiertos para Mac 1.2.0 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **1.2.0** , significa que la actualización se ha instalado correctamente.
...
-   Bing Liu, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com/) , por informar de la vulnerabilidad de validación insuficiente de registros en Excel (CVE-2011-1272)  
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de análisis incorrecto de registros en Excel (CVE-2011-1273)  
-   Omair, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de acceso a matriz fuera de los límites en Excel (CVE-2011-1274)  
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de sobrescritura del montón de memoria en Excel (CVE-2011-1275)  
-   Nicolas Gregoire, de [Agarri](http://www.agarri.fr/) , en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de desbordamiento del búfer en Excel (CVE-2011-1276)  
-   Omair, por informar de la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-1277)  
-   Will Dormann, de [CERT/CC](http://www.cert.org/) , por informar de la vulnerabilidad de WriteAV en Excel (CVE-2011-1278)  
-   Will Dormann, de [CERT/CC](http://www.cert.org/) , por informar de la vulnerabilidad de WriteAV fuera de los límites en Excel (CVE-2011-1279)
...
-   V1.1 (10 de agosto de 2011): Se han quitado dos soluciones provisionales erróneas de la sección de vulnerabilidades de este boletín para CVE-2011-1276. Se trata únicamente de un cambio informativo.
