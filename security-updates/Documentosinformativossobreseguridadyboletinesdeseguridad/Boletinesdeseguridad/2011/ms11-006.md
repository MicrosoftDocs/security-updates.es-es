---
TOCTitle: 'MS11-006'
Title: 'Boletín de seguridad de Microsoft MS11-006 - Crítica'
ms:assetid: 'ms11-006'
ms:contentKeyID: 61225986
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-006(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-006 - Crítica
====================================================
...
Publicado: martes, 8 de febrero de 2011 | Actualizado: lunes, 14 de febrero de 2011
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Windows XP, Windows Server 2003, Windows Vista y Windows Server 2008. Las ediciones compatibles de Windows 7 y Windows Server 2008 R2 no están afectadas por la vulnerabilidad. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el procesador de gráficos del shell de Windows analiza las imágenes en miniatura. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .

Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2490606](http://technet.microsoft.com/security/advisory/2490606) .
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3)                                                                                       | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57)                                                              | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf)                                                                              | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398)                                                                  | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)                                                           | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8)                                                     | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d)                             | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb) \*\* | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c) \*\*               | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b)    | Ejecución remota de código      | Crítica                             | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
...
**Si he aplicado las soluciones provisionales del documento informativo sobre seguridad de Microsoft 2490606, ¿debo deshacerlas antes de aplicar esta actualización?**  
Sí. Antes de instalar esta actualización de seguridad, debe deshacer la solución provisional "Modificar la lista de control de acceso (ACL) en shimgvw.dll en sistemas Windows XP y Windows Server 2003" en los sistemas donde la ha aplicado anteriormente. Vea el [artículo 2483185 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2483185) para usar la solución Microsoft Fix it automática para deshabilitar esta solución provisional.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)</th>
...
Vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)  
-----------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el procesador de gráficos del shell de Windows trata las imágenes en miniatura especialmente diseñadas. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en el contexto de seguridad del usuario que ha iniciado sesión. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) .
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Modificar la lista de control de acceso (ACL) en shimgvw.dll en sistemas Windows XP y Windows Server 2003**
  
    **Nota** Vea el [artículo 2483185 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2483185) para usar la solución **Microsoft Fix** it automática para habilitar o deshabilitar esta solución provisional.
    ...
    **Consecuencias de la solución provisional.** Los archivos multimedia que normalmente administra el procesador de gráficos del shell de Windows no se mostrarán correctamente. Tenga en cuenta que antes de instalar la actualización de seguridad MS11-006, debe deshacer esta solución provisional en los sistemas donde la ha aplicado anteriormente.
...
-   **Deshabilitar la visualización de vistas en miniatura en el Explorador de Windows en sistemas Windows Vista y Windows Server 2008**
  
    Para deshabilitar la visualización de vistas en miniatura en el Explorador de Windows en Windows Vista y Windows Server 2008, realice los pasos siguientes:
  
    1.  Abra **Panel de control** y seleccione **Apariencia y personalización** .  
    2.  Seleccione **Opciones de carpeta** en el menú.  
    3.  Seleccione la pestaña **Ver** y asegúrese de que está seleccionada la opción **Mostrar siempre iconos, nunca vistas en miniatura** . Haga clic en **Aceptar** para guardar la configuración.  
    4.  Cierre todas las instancias abiertas del Explorador de Windows para que el cambio surta efecto.
  
    **Consecuencias de la solución provisional.** El Explorador de Windows no mostrará las imágenes de vista en miniatura.
  
    **Cómo deshacer la solución provisional.**
  
    Para habilitar las vistas en miniatura en Windows Vista y Windows Server 2008, realice los pasos siguientes:
  
    1.  Abra **Panel de control** y seleccione **Apariencia y personalización** .  
    2.  Seleccione **Opciones de carpeta** en el menú.  
    3.  Seleccione la pestaña **Ver** y asegúrese de que no está seleccionada la opción **Mostrar siempre iconos, nunca vistas en miniatura** . Haga clic en **Aceptar** para guardar la configuración.  
    4.  Cierre todas las instancias abiertas del Explorador de Windows para que el cambio surta efecto.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)
...
La vulnerabilidad se produce cuando el procesador de gráficos del shell de Windows analiza incorrectamente una imagen en miniatura especialmente diseñada, lo que provoca un desbordamiento del búfer de la pila.
...
Esta vulnerabilidad requiere que un usuario visualice una imagen en miniatura especialmente diseñada.
  
En un ataque de red, el atacante podría guardar una imagen en miniatura especialmente diseñada o un archivo que contenga una imagen en miniatura especialmente diseñada en un recurso compartido de red, como una ubicación UNC o WebDAV, y, a continuación, convencer al usuario para que examinara la ubicación en el Explorador de Windows. Cuando el usuario se desplace al recurso compartido, la ruta de acceso de control afectada se activa a través del procesador de gráficos del shell de Windows. La imagen en miniatura especialmente diseñada podría aprovechar la vulnerabilidad y ejecutar código en el contexto de seguridad del usuario que ha iniciado la sesión. El atacante no podría obligar a los usuarios a visitar un recurso compartido de red, UNC o ubicación WebDAV. Por lo tanto, tendría que atraerlos al recurso compartido; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio del atacante.
  
**¿Qué es la convención de nomenclatura universal (UNC)?**  
La convención de nomenclatura universal (UNC) es un método para identificar los recursos, como, por ejemplo, los nombres de recursos compartidos o los archivos de una red. Un nombre UNC típico comienza con dos barras diagonales inversas seguidas de un nombre de servidor, como \\\\servidor\\recurso compartido\\subdirectorio\\nombre de archivo.
...
La actualización corrige la vulnerabilidad al modificar la manera en que el procesador de gráficos del shell de Windows analiza las imágenes en miniatura.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esa vulnerabilidad ya se ha divulgado. Tiene asignado el número de vulnerabilidad y exposición común [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) . Esta vulnerabilidad se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2490606](http://technet.microsoft.com/security/advisory/2490606) .
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2483185$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2483185">artículo 2483185 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
-   Kobi Pariente y Yaniv Miron, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de desbordamiento en el procesamiento de gráficos del shell de Windows (CVE-2010-3970)
...
-   V1.1 (14 de febrero de 2011): Se ha agregado una entrada a las preguntas más frecuentes de la actualización para notificar a los clientes que antes de instalar esta actualización de seguridad deben deshacer la solución provisional "Modificar la lista de control de acceso (ACL) en shimgvw.dll en sistemas Windows XP y Windows Server 2003" en los sistemas donde se había aplicado anteriormente.
