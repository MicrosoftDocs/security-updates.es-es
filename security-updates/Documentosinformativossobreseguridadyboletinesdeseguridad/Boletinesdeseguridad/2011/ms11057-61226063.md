---
TOCTitle: 'MS11-057'
Title: 'Boletín de seguridad de Microsoft MS11-057 - Crítica'
ms:assetid: 'ms11-057'
ms:contentKeyID: 61226063
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-057(v=Security.10)'
---
...
Sí. Además de los cambios que se enumeran en la sección **Información sobre la vulnerabilidad** de este boletín, esta actualización incluye una actualización de defensa en profundidad para actualizar el filtro XSS de Internet Explorer y actualizaciones de defensa en profundidad para contribuir a mejorar la protección de la memoria en Internet Explorer.

Una de las actualizaciones de defensa en profundidad agrega la capacidad para que los usuarios configuren sus sistemas a fin de bloquear las acciones de arrastrar y bloquear entre dominios en Internet Explorer. Para obtener más información acerca de esta funcionalidad agregada, vea el [artículo 2581921 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2581921) .
...
**¿Contiene esta actualización algún cambio en relación con la seguridad en su funcionalidad?**
Sí, esta actualización corrige un problema de omisión del modo protegido, que se denomina de forma pública como [CVE-2011-1347](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1347) .
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer obtiene acceso a un objeto que se puede haber dañado debido a una condición de ejecución. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1257) .

#### Factores atenuantes para la vulnerabilidad de condición de ejecución de apertura de ventana (CVE-2011-1257)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En un escenario de ataque web, un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web y realice una serie de clics en distintas ventanas de Internet Explorer. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico.
...
#### Soluciones provisionales para la vulnerabilidad de condición de ejecución de apertura de ventana (CVE-2011-1257)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de condición de ejecución de apertura de ventana (CVE-2011-1257)
...
Un atacante podría hospedar un sitio web especialmente diseñado para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web y realice una serie de clics en distintas ventanas de Internet Explorer. Un atacante también podría insertar un control ActiveX marcado como "seguro para inicialización" en una aplicación o un documento de Microsoft Office que aloje el motor de representación de IE. El atacante también podría aprovechar sitios web vulnerables y sitios web que aceptan o reciben contenido o anuncios proporcionados por el usuario. Estos sitios web podrían incluir contenido malintencionado a través del cual se podría aprovechar esta vulnerabilidad. No obstante, el atacante no podría en ningún caso obligar a los usuarios a ver el contenido controlado por el atacante. En su lugar, tendría que convencerlos para que realizaran alguna acción, normalmente al hacer clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que los lleve al sitio web del atacante o al abrir datos adjuntos enviados por correo electrónico.
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer. Un atacante podría aprovechar la vulnerabilidad mediante la creación de una página web especialmente diseñada disimulada como contenido legítimo. Un atacante que consiga aprovechar esta vulnerabilidad podría ver el contenido de otro dominio o zona de Internet Explorer.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1960](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1960) .

#### Factores atenuantes para la vulnerabilidad de divulgación de información en controladores de evento (CVE-2011-1960)
...
#### Soluciones provisionales para la vulnerabilidad de divulgación de información en controladores de evento (CVE-2011-1960)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información en controladores de evento (CVE-2011-1960)
...
**¿Cómo funciona esta actualización?**
La actualización corrige la vulnerabilidad al modificar la manera en que Internet Explorer trata los controladores de evento JavaScript.
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Internet Explorer usa el controlador de URI de telnet. El controlador se puede usar de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario que ha iniciado la sesión.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1961](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1961) .

#### Factores atenuantes para la vulnerabilidad de ejecución remota de código en el controlador de telnet (CVE-2011-1961)
...
#### Soluciones provisionales para la vulnerabilidad de ejecución remota de código en el controlador de telnet (CVE-2011-1961)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución remota de código en el controlador de telnet (CVE-2011-1961)

**¿Cuál es el alcance de esta vulnerabilidad?**
Se trata de una vulnerabilidad de ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

**¿Cuál es la causa de esta vulnerabilidad?**
Cuando Internet Explorer intenta invocar la aplicación asociada al controlador de URI de telnet, se puede cargar un archivo binario que conlleve la ejecución de código arbitrario en el contexto del usuario que ha iniciado sesión.
...
**¿Cómo funciona esta actualización?**
La actualización corrige la vulnerabilidad al modificar la forma en que el controlador de telnet ejecuta la aplicación asociada.
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer que podría permitir a una secuencia de comandos obtener acceso a información en otro dominio o zona de Internet Explorer. Un atacante podría aprovechar la vulnerabilidad mediante la inserción de cadenas especialmente diseñadas en un sitio web, lo que provoca la divulgación de información cuando un usuario visita el sitio web. Un atacante que consiga aprovechar esta vulnerabilidad podría ver el contenido de otro dominio o zona de Internet Explorer.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1962) .

#### Factores atenuantes para la vulnerabilidad de codificación de caracteres de desplazamiento JIS (CVE-2011-1962)
...
#### Soluciones provisionales para la vulnerabilidad de codificación de caracteres de desplazamiento JIS (CVE-2011-1962)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de codificación de caracteres de desplazamiento JIS (CVE-2011-1962)

**¿Cuál es el alcance de esta vulnerabilidad?**
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que aproveche la vulnerabilidad, cuando un usuario visite una página web, podría ver el contenido del equipo local o de una ventana de explorador en un dominio o zona de Internet Explorer distintos del dominio o zona de la página web del atacante.

**¿Cuál es la causa de esta vulnerabilidad?**
En determinados procesos, Internet Explorer trata incorrectamente determinadas secuencias de caracteres, lo que provoca que los sitios web implementen filtrado inactivo.

**¿Para qué puede utilizar un atacante esta vulnerabilidad?**
Un atacante que consiga aprovechar esta vulnerabilidad podría ver el contenido de otro dominio o zona de Internet Explorer.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Un atacante podría insertar cadenas en un sitio web diseñadas para aprovechar esta vulnerabilidad a través de Internet Explorer y convencer a un usuario para que visite el sitio web. No obstante, el atacante no podría obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web con el contenido malintencionado.
...
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-1962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1962) .
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1963) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con XSLT (CVE-2011-1963)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con XSLT (CVE-2011-1963)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con XSLT (CVE-2011-1963)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-1964](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1964) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con los objetos de estilo (CVE-2011-1964)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con los objetos de estilo (CVE-2011-1964)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con los objetos de estilo (CVE-2011-1964)
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada que permita la divulgación de información si un usuario visita una página web y realiza una operación de arrastrar y colocar. Un atacante que aprovechara esta vulnerabilidad podría obtener acceso a los archivos de cookie almacenados en el equipo local.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2011-2383](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383) .

#### Factores atenuantes para la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-2383)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web y a realizar una operación arrastrar y colocar. En su lugar, el atacante tendría que persuadir a los usuarios para que visitaran el sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante y para que realice una operación de arrastrar y colocar.
-   De forma predeterminada, todas las versiones compatibles de Microsoft Outlook, Microsoft Outlook Express y Windows Mail abren los mensajes de correo electrónico HTML en la zona Sitios restringidos, que deshabilita los scripts y los controles ActiveX, lo que contribuye a reducir el riesgo de que un atacante pueda usar esta vulnerabilidad para ejecutar código malintencionado. Si un usuario hace clic en un vínculo de un mensaje de correo electrónico, podría quedar vulnerable por la posibilidad de un ataque basado en Web.
-   De forma predeterminada, Internet Explorer en Windows Server 2003, Windows Server 2008 y Windows Server 2008 R2 se ejecuta en un modo restringido conocido como [Configuración de seguridad mejorada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx) . Este modo atenúa esta vulnerabilidad. Vea la sección P+F correspondiente a esta vulnerabilidad para obtener más información acerca de la configuración de seguridad mejorada de Internet Explorer.

#### Soluciones provisionales para la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-2383)
...
-   **Cambiar la carpeta de cookies predeterminada**
    ...
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no puede garantizar que pueda resolver los problemas derivados del uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
    ...
    Para cambiar el nombre de la carpeta de cookies, realice los pasos siguientes para cada usuario.

    **Parte 1: cree una nueva carpeta para las cookies y use nombre aleatorio para la carpeta.**

    1.  Salga de todas las ventanas y procesos relacionados con Internet Explorer.
    2.  En un equipo con Windows Vista, Windows Server 2008, Windows 7 o Windows Server 2008 R2, abra una ventana del símbolo del sistema y, a continuación, cambie a la carpeta principal de cookies. Para ello, ejecute el comando siguiente:
        **CD %USERPROFILE%\\AppData\\Roaming\\Microsoft\\Windows**
        En un equipo con Windows XP o Windows Server 2003, ejecute el comando siguiente:
        **CD %USERPROFILE%**
    3.  Cree una nueva carpeta de cookies y use un nombre de carpeta de ocho caracteres aleatorios para la nueva carpeta. Use una combinación de letras, números y otros caracteres para el nombre de carpeta. No puede usar los siguientes caracteres en el nombre de la carpeta porque están reservados para el sistema operativo:
        \\ / ? : \* " &gt; &lt; |
        En un símbolo del sistema, escriba el siguiente comando, donde Nombre\_carpeta\_aleatorio es el nombre aleatorio de ocho caracteres:
        **Mkdir*Nombre\_carpeta\_aleatorio*-Cookies**
        y, a continuación, presione Entrar.

    **Parte 2: copie los archivos de cookie actuales de la carpeta de cookies predeterminada.**

    Ejecute el siguiente comando desde un símbolo del sistema, donde *Nombre\_carpeta\_aleatorio* es el nombre de la carpeta de ocho caracteres que creó en la parte 1 anterior.

    -   Para Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
        **Xcopy /S /H %USERPROFILE%\\AppData\\Roaming\\Microsoft\\Windows\\Cookies\\\*.\* %USERPROFILE%\\AppData\\Roaming\\Microsoft\\Windows\\*Nombre\_carpeta\_aleatorio*-Cookies\\**
    -   Para Windows XP y Windows Server 2003:
        **Xcopy /S /H %USERPROFILE%\\Cookies\\\*.\* %USERPROFILE%\\*Nombre\_carpeta\_aleatorio*-Cookies\\**

    **Parte 3: edite la entrada del Registro que determina la carpeta de cookies.**

    1.  Haga clic en **Inicio** , en **Ejecutar** , escriba **regedit** y, a continuación, haga clic en **Aceptar** .
    2.  Busque y, a continuación, haga clic en la siguiente entrada del Registro:
    ...
    4.  En el cuadro de texto **Información del valor** , escriba el siguiente texto, donde *Nombre\_carpeta\_aleatorio* es el nombre de la nueva carpeta de cookies que ha creado anteriormente:
        Para Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
        **%USERPROFILE%\\AppData\\Roaming\\Microsoft\\Windows\\*Nombre\_carpeta\_aleatorio*-Cookies**
        Para Windows XP y Windows Server 2003:
        **%USERPROFILE%\\*Nombre\_carpeta\_aleatorio*-Cookies**
    5.  Presione **Entrar** y, a continuación, reinicie el equipo. Este comando libera los archivos de la carpeta de cookies original que se estaba usando.
    6.  Después del reinicio, elimine el contenido de la carpeta de cookies anterior. Para ello, escriba el siguiente comando en un símbolo del sistema y, a continuación, presione Entrar:
        Para Windows Vista, Windows Server 2008, Windows 7 y Windows Server 2008 R2:
        **Del /S /Q %USERPROFILE%\\AppData\\Roaming\\Microsoft\\Windows\\Cookies\\\*.\***
        Para Windows XP y Windows Server 2003:
        **Del /S /Q %USERPROFILE%\\Cookies\\\*.\***
        **Nota** Si aparece un mensaje de error que indica que no se puede eliminar el archivo index.dat, puede omitir el error.

#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información en la operación de arrastrar y colocar (CVE-2011-2383)

**¿Cuál es el alcance de esta vulnerabilidad?**
Esta vulnerabilidad afecta a la divulgación de información. Un atacante que aproveche la vulnerabilidad cuando un usuario consulta una página web y realiza una operación de arrastrar y colocar podría obtener acceso a los archivos de cookies almacenados en el equipo local.

**¿Cuál es la causa de esta vulnerabilidad?**
Internet Explorer restringe incorrectamente el acceso a los archivos de cookies almacenados en el equipo local.

**¿Para qué puede utilizar un atacante esta vulnerabilidad?**
Un atacante que aprovechara esta vulnerabilidad podría obtener acceso a los archivos de cookie almacenados en el equipo local.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Existe una vulnerabilidad de divulgación de información en Internet Explorer que podría permitir a un atacante obtener acceso a los archivos de cookies almacenados en el equipo local. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada que permita la divulgación de información si un usuario visita una página web y realiza una operación de arrastrar y colocar. Un atacante que aprovechara esta vulnerabilidad podría obtener acceso a los archivos de cookie almacenados en el equipo local.
...
**¿Cómo funciona esta actualización?**
La actualización corrige la vulnerabilidad al modificar la forma en que Internet Explorer obtiene acceso a los archivos almacenados en el equipo local y administra los archivos de cookies. Esto incluye un cambio en la forma en que Internet Explorer establece los nombres de los archivos de cookies para que dichos nombres sean menos predecibles.

**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-2383](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383) .

**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba utilizando esta vulnerabilidad?**
No. En el momento de publicar este boletín de seguridad, Microsoft no había recibido ninguna información que indicara que esta vulnerabilidad se hubiera utilizado para atacar a clientes.

**¿Ayuda la aplicación de esta actualización de seguridad a proteger a los clientes del código, que se ha divulgado públicamente, que podría intentar aprovechar esta vulnerabilidad?**
Sí. Esta actualización de seguridad soluciona la vulnerabilidad que podría aprovecharse al utilizar el código de tipo conceptual publicado. A la vulnerabilidad que se ha tratado se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-2383](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383) .
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2559049$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2559049-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2559049-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2559049">artículo 2559049 de Microsoft Knowledge Base</a> .</td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2559049$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Yngve N. Pettersen, de [Opera Software ASA](http://www.opera.com/) , por informar de la vulnerabilidad de divulgación de información en controladores de evento (CVE-2011-1960)  
-   [Lostmon Lords](http://lostmon.blogspot.com) , por informar de la vulnerabilidad de condición de ejecución de apertura de ventana (CVE-2011-1257)  
...
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de daños en la memoria relacionada con XSLT (CVE-2011-1963)  
-   Stephen Fewer, de [Harmony Security](http://www.harmonysecurity.com/) , en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con los objetos de estilo (CVE-2011-1964)  
-   Michal Zalewski, de [Google Inc.](http://www.google.com/) , por colaborar con nosotros en los cambios de defensa en profundidad incluidos en este boletín.  
-   Stephen Fewer, de [Harmony Security](http://www.harmonysecurity.com/) , en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) , por colaborar con nosotros para mejorar la característica del modo protegido en Internet Explorer.
