---
TOCTitle: 'MS11-042'
Title: 'Boletín de seguridad de Microsoft MS11-042 - Crítica'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61226034
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-042(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-042 - Crítica
====================================================

Vulnerabilidades en el sistema de archivos distribuido podrían permitir la ejecución remota de código (2535512)
---------------------------------------------------------------------------------------------------------------

Publicado: martes, 14 de junio de 2011 | Actualizado: martes, 14 de junio de 2011
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Windows XP y Windows Server 2003; importante para todas las ediciones compatibles de Windows Vista y Windows Server 2008; e importante para Windows 7 para sistemas de 32 bits, Windows 7 para sistemas x64, Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas con Itanium. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que el cliente DFS valida los campos en respuestas de referencia DFS especialmente diseñadas y al modificar la forma en que el servicio DFS trata las respuestas de referencia DFS especialmente diseñadas. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                    | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                           | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                           | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                               | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                        | Ejecución remota de código      | Crítica                             | Ninguna                                       |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                  | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                          | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\* | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*               | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                           | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                  | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                   | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                             | Denegación de servicio          | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de daños en la memoria relacionada con DFS (CVE-2011-1868)</th>
<th style="border:1px solid black;" >Vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)</th>
...
Vulnerabilidad de daños en la memoria relacionada con DFS (CVE-2011-1868)  
-------------------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de ejecución remota de código no autenticado en la forma en que el cliente del sistema de archivos distribuido (DFS) analiza las respuestas DFS especialmente diseñadas. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo que un atacante podría enviar una respuesta DFS especialmente diseñada a una solicitud DFS iniciada por el cliente. Un atacante que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con DFS (CVE-2011-1868)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con DFS (CVE-2011-1868)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con DFS (CVE-2011-1868)
  
**¿Cuál es el alcance de esta vulnerabilidad?**    
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la implementación del sistema de archivos distribuido (DFS) de Microsoft valida incorrectamente todos los campos con respuestas DFS especialmente diseñadas.
  
**¿Qué es el sistema de archivos distribuido (DFS)?**    
El sistema de archivos distribuido (DFS) permite a los administradores agrupar carpetas que se encuentran en servidores distintos mediante su conexión transparente a uno o varios espacios de nombres DFS. Un espacio de nombres DFS es una vista virtual de las carpetas compartidas de una organización. Mediante las herramientas de DFS, los administradores seleccionan las carpetas compartidas que se presentarán en el espacio de nombres, designan la jerarquía en que aparecerán dichas carpetas y determinan los nombres que las carpetas compartidas muestran en el espacio de nombres. Cuando un usuario ve el espacio de nombres, las carpetas parecen residir en un único disco duro de alta capacidad. Los usuarios pueden navegar por las carpetas del espacio de nombres sin tener que conocer los nombres de servidor o las carpetas compartidas que hospedan los datos. Para obtener más información, vea la [referencia técnica de DFS](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx).
...
Un atacante podría hospedar un servidor especialmente diseñado con la intención de aprovechar esta vulnerabilidad y, a continuación, convencer a un usuario para que iniciara una conexión DFS con él. Adicionalmente, un atacante en la red local podría realizar un ataque del tipo "Man in the middle" para responder a una solicitud DFS legítima con una respuesta DFS con formato incorrecto.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Todas las ediciones compatibles de Windows XP y Windows Server 2003 están expuestas a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el cliente DFS valida los campos en las respuestas DFS especialmente diseñadas.
...
Vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)  
-------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de denegación de servicio en la forma en que el sistema de archivos distribuido (DFS) de Microsoft trata las respuestas de referencia DFS especialmente diseñadas. El intento para aprovechar la vulnerabilidad no requiere autenticación, por lo un atacante podría enviar un mensaje de red especialmente diseñado a un equipo que ejecuta el servicio de servidor.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### Factores atenuantes para la vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Esta vulnerabilidad de denegación de servicio no permitiría a un atacante ejecutar código o elevar sus derechos de usuario, pero podría provocar que el sistema afectado dejara de responder hasta que se reiniciara manualmente.  
-   Los procedimientos recomendados para firewall y las configuraciones de firewall predeterminadas estándar pueden proteger a las redes de los ataques procedentes del exterior del perímetro de la empresa. Se recomienda que los sistemas conectados a Internet tengan expuesta la cantidad mínima de puertos.
  
#### Soluciones provisionales para la vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)
...
**¿Cuál es la causa de esta vulnerabilidad?**    
La vulnerabilidad se debe a que la implementación del sistema de archivos distribuido (DFS) trata incorrectamente las respuestas de referencia DFS especialmente diseñadas.
...
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**    
Todas las versiones compatibles de Windows están expuestas a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**    
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el servicio DFS trata las respuestas de referencia DFS especialmente diseñadas.
...
| Windows 7 para sistemas de 32 bits                                                                           | Sí                | Sí                         |  
| Windows 7 para sistemas x64                                                                                  | Sí                | Sí                         |  
| Windows Server 2008 R2 para sistemas x64                                                                     | Sí                | Sí                         |  
| Windows Server 2008 R2 para sistemas con Itanium                                                             | Sí                | Sí                         |
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2535512$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2535512">artículo 2535512 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Windows 7 para sistemas de 32 bits:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows 7 para sistemas x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las versiones de Windows 7 para sistemas x64:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para Windows 2008 R2 para sistemas x64:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows 2008 R2 para sistemas con Itanium:<br />
...
-   Laurent Gaffié, de [NGS Software](http://www.ngssoftware.com/), por informar de la vulnerabilidad de respuesta de referencia DFS (CVE-2011-1869)
...
-   V1.1 (14 de junio de 2011): Se ha cambiado Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas x64 Service Pack 1, Windows Server 2008 R2 para sistemas x64 Service Pack 1 y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1 de la tabla de software afectado a la tabla de software no afectado. Se trata únicamente de un cambio informativo. No había cambios en los archivos de la actualización de seguridad o en la lógica de la detección.
