---
TOCTitle: 'MS11-065'
Title: 'Boletín de seguridad de Microsoft MS11-065 - Importante'
ms:assetid: 'ms11-065'
ms:contentKeyID: 61226085
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-065(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows Server 2003 y moderada para todas las ediciones compatibles de Windows XP. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c07e1630-43ba-491e-bd59-9eb53105986c)                             | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=797a01dc-39fb-4511-832a-42d2975133f5)    | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=694ba1a6-7512-497d-a572-646a6e07b13b)                    | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=308da543-d49d-4591-8bbc-d65c524bb0ad)        | Denegación de servicio          | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b459bf0-7844-4740-895c-d149d56e781f) | Denegación de servicio          | Importante                          | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de protocolo de Escritorio remoto (CVE-2011-1968)</th>
...
Vulnerabilidad de protocolo de Escritorio remoto (CVE-2011-1968)  
----------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en la forma en que el protocolo de Escritorio remoto tiene acceso a un objeto que se ha inicializado incorrectamente o se ha eliminado. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema de destino dejara de responder y se reiniciara automáticamente.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1968](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1968) .
  
#### Factores atenuantes para la vulnerabilidad de protocolo de Escritorio remoto (CVE-2011-1968)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   De forma predeterminada, el protocolo de Escritorio remoto no está habilitado en ningún sistema operativo Windows. En Windows XP y Windows Server 2003, Asistencia remota puede habilitar RDP.  
...
#### Soluciones provisionales para la vulnerabilidad de protocolo de Escritorio remoto (CVE-2011-1968)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de protocolo de Escritorio remoto (CVE-2011-1968)
...
No, RDP para la administración no está habilitado de forma predeterminada. A los clientes que no han habilitado RDP se les ofrecerá la actualización para garantizar la protección de sus equipos. Para obtener más información acerca de esta opción de configuración, vea el artículo de TechNet [Cómo habilitar y configurar Escritorio remoto para administración en Windows Server 2003](http://support.microsoft.com/kb/814590) .
...
La actualización corrige la forma en que el protocolo de Escritorio remoto procesa los paquetes en memoria.
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2570222$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2570222">artículo 2570222 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
