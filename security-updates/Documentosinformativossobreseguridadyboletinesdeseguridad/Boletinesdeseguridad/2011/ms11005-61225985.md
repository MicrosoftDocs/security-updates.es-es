---
TOCTitle: 'MS11-005'
Title: 'Boletín de seguridad de Microsoft MS11-005 - Importante'
ms:assetid: 'ms11-005'
ms:contentKeyID: 61225985
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-005(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para Active Directory en todas las ediciones compatibles de Windows Server 2003. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el servidor de Active Directory trata las solicitudes de actualización de nombre de entidad de seguridad de servicio (SPN). Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
<td style="border:1px solid black;">Servicio de directorio ligero de Active Directory (AD LDS)</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">(ADAM, AD LDS y Active Directory no son componentes de esta versión de Microsoft Windows)</td>
</tr>
<tr class="even">
...
<th style="border:1px solid black;" >Vulnerabilidad de validación de SPN en Active Directory (CVE-2011-0040)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de validación de SPN en Active Directory (CVE-2011-0040)  
-----------------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en las implementaciones de Microsoft Windows Active Directory debida a la validación incorrecta de los nombres de entidad de seguridad de servicio (SPN), lo que puede producir colisiones de SPN. Cuando esto sucede, los servicios que usan SPN se degradarán a NT LAN Manager (NTML) si se han configurado para negociar. Los servicios que no están configurados para negociar dejarán de estar disponibles, lo que dará como resultado una condición de denegación de servicio. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado dejara de responder.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040) .
  
#### Factores atenuantes para la vulnerabilidad de validación de SPN en Active Directory (CVE-2011-0040)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad de denegación de servicio, el atacante debe ser administrador en un equipo unido al dominio.
  
#### Soluciones provisionales para la vulnerabilidad de validación de SPN en Active Directory (CVE-2011-0040)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de SPN en Active Directory (CVE-2011-0040)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una degradación de autenticación así como de una vulnerabilidad de denegación de servicio. Un atacante que aprovechara esta vulnerabilidad podría provocar que el sistema afectado se degradara de Kerberos a NT LAN Manager (NTLM) y, en el peor de los casos, provocar que el servicio dejara de responder. Tenga en cuenta que esta vulnerabilidad no permitiría a un atacante ejecutar código o elevar sus derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
Active Directory procesa incorrectamente las solicitudes especialmente diseñadas para actualizar el nombre de entidad de seguridad de servicio (SPN) y puede producir colisiones de nombres en el dominio.
...
**¿Qué es SPN?**  
Un nombre principal de servicio (SPN) es el nombre por el que un cliente identifica de forma exclusiva una instancia de un servicio. Para obtener más información acerca del uso de los nombres de entidad de seguridad de servicio, vea el artículo de MSDN [Nombres de entidad de seguridad de servicio](http://msdn.microsoft.com/en-us/library/ms677949(vs.85).aspx) .
  
**¿Qué es NTLM?**  
Desafío/Respuesta de Windows (NT LAN Manager o NTLM) es el protocolo de autenticación que se usa en redes que incluyen sistemas que ejecutan el sistema operativo Windows y en sistemas independientes. Las credenciales NTLM se basan en datos obtenidos durante el proceso de inicio de sesión interactivo y constan de un nombre de dominio, un nombre de usuario y un hash unidireccional de la contraseña del usuario. NTLM utiliza un protocolo de desafío/respuesta cifrado para autenticar al usuario sin enviar su contraseña a través de la red. En su lugar, el sistema que solicita la autenticación debe realizar un cálculo que demuestre que tiene acceso a las credenciales de seguridad NTLM.
...
Un atacante que aprovechara esta vulnerabilidad podría provocar colisiones de nombres en el dominio, lo que produciría que la autenticación de los servicios que usan el SPN se degradara a NTLM. En configuraciones específicas donde el servicio no está configurado para negociar, el servicio dejará de estar disponible.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante podría intentar aprovechar esta vulnerabilidad mediante el envío de paquetes especialmente diseñados al servidor de Active Directory. El atacante debe tener privilegios de administrador válidos en el equipo unido al dominio para aprovechar esta vulnerabilidad.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Esta vulnerabilidad afecta a los entornos que ejecutan Active Directory en Windows Server 2003.
  
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que el servidor de Active Directory trata las solicitudes de actualización de nombre de entidad de seguridad de servicio (SPN).
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040) .
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2478953$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2478953">artículo 2478953 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
