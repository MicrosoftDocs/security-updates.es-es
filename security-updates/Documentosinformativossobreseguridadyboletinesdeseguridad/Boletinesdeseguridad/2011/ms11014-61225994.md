---
TOCTitle: 'MS11-014'
Title: 'Boletín de seguridad de Microsoft MS11-014 - Importante'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61225994
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-014(v=Security.10)'
---
...
Publicado: martes, 8 de febrero de 2011 | Actualizado: jueves, 28 de abril de 2011
...
Esta actualización de seguridad resuelve una vulnerabilidad de la que se ha informado de forma privada en el servicio de subsistema de autoridad de seguridad local (LSASS) en Windows XP y Windows Server 2003. Esta actualización de seguridad se considera importante para todas las ediciones compatibles de estos sistemas operativos. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.
...
La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que LSASS trata los valores específicos usados en el proceso de autenticación. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
**Problemas conocidos.** En el [artículo 2478960 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2478960) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                             | Elevación de privilegios        | Importante                          | Ninguna                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)    | Elevación de privilegios        | Importante                          | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                    | Elevación de privilegios        | Importante                          | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)        | Elevación de privilegios        | Importante                          | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Elevación de privilegios        | Importante                          | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
...
<th style="border:1px solid black;" >Vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)</th>
...
Vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)  
-----------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de elevación de privilegios en la forma en que el subsistema de autoridad de seguridad local (LSASS) de Microsoft Windows procesa las solicitudes de autenticación especialmente diseñadas. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039) .
  
#### Factores atenuantes para la vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)
...
#### Soluciones provisionales para la vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)
...
La vulnerabilidad se produce cuando Windows LSASS procesa una solicitud de autenticación especialmente diseñada.
...
La actualización corrige esta vulnerabilidad al modificar la manera en que LSASS trata los valores específicos usados en el proceso de autenticación.
...
WindowsXP-KB2478960-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2478960-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para Windows XP Service Pack 3:<br />
WindowsXP-KB2478960-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2478960-x64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2478960.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2478960">artículo 2478960 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows XP:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB2478960\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows XP:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB2478960\Filelist</td>
</tr>
</tbody>
</table>
...
WindowsServer2003-KB2478960-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2478960-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2478960-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2478960-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2478960.log</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2478960\Filelist</td>
</tr>
</tbody>
</table>
...
-   El evaluador de seguridad Jorge Moura, de Primavera BSS, por informar de la vulnerabilidad de validación de longitud en LSASS (CVE-2011-0039)
...
-   V1.1 (28 de abril de 2011): Se ha agregado un vínculo al artículo 2478960 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
