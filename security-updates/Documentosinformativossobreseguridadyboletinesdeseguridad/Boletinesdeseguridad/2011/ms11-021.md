...
#### Factores atenuantes para la vulnerabilidad de desbordamiento del montón en Excel (CVE-2011-0098)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de registros WriteAV en Excel (CVE-2011-0101)
...
#### Soluciones provisionales para la vulnerabilidad de daños de sobrescritura de búfer en Excel (CVE-2011-0104)
...
#### Soluciones provisionales para la vulnerabilidad de indización de matrices en Excel (CVE-2011-0978)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de indización de matrices en Excel (CVE-2011-0978)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la lista vinculada en Excel (CVE-2011-0979)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Microsoft Excel no administra correctamente los miembros de una estructura de datos al analizar un archivo de Excel especialmente diseñado.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la manera en que Microsoft Excel administra las estructuras de datos.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980) .

#### Factores atenuantes para la vulnerabilidad de puntero pendiente en Excel (CVE-2011-0980)
...
#### Soluciones provisionales para la vulnerabilidad de puntero pendiente en Excel (CVE-2011-0980)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de puntero pendiente en Excel (CVE-2011-0980)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Microsoft Excel no administra correctamente las estructuras de datos al analizar un archivo de Excel especialmente diseñado.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2466169">artículo 2466169 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2502786">artículo 2502786 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Para Microsoft Excel 2007, vea el <a href="http://support.microsoft.com/kb/2464583">artículo 2464583 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Excel Viewer, vea el <a href="http://support.microsoft.com/kb/2466158">artículo 2466158 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Paquete de compatibilidad de Microsoft Office para formatos de archivo de Word, Excel y PowerPoint 2007, vea el <a href="http://support.microsoft.com/kb/2466156">artículo 2466156 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2466146">artículo 2466146 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
-   Alin Rad Pop, de [Secunia](http://secunia.com/) , por informar de la vulnerabilidad de desbordamiento de enteros en Excel (CVE-2011-0097)  
-   Alin Rad Pop, de [Secunia](http://secunia.com/) , por informar de la vulnerabilidad de desbordamiento del montón en Excel (CVE-2011-0098)  
-   Muhammad Junaid Bohio, de [Telus Security Labs](http://www.telussecuritylabs.com) , por informar de la vulnerabilidad de análisis de registros WriteAV en Excel (CVE-2011-0101)  
-   Aniway, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de análisis de registros WriteAV en Excel (CVE-2011-0101)  
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/) , por informar de la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2011-0103)  
-   Rodrigo Rubira Branco, de [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT), por informar de la vulnerabilidad de daños de sobrescritura de búfer en Excel (CVE-2011-0104)  
-   Aniway, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de inicialización de datos en Excel (CVE-2011-0105)  
-   Aniway, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de indización de matrices en Excel (CVE-2011-0978)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de daños en la lista vinculada en Excel (CVE-2011-0979)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de puntero pendiente en Excel (CVE-2011-0980)
