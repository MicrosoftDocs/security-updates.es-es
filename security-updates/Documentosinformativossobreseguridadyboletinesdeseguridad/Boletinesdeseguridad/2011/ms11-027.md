---
TOCTitle: 'MS11-027'
Title: 'Boletín de seguridad de Microsoft MS11-027 - Crítica'
ms:assetid: 'ms11-027'
ms:contentKeyID: 61226007
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-027(v=Security.10)'
---

Boletín de seguridad de Microsoft MS11-027 - Crítica
====================================================

Actualización de seguridad acumulativa de bits de interrupción de ActiveX (2508272)
-----------------------------------------------------------------------------------

Publicado: martes, 12 de abril de 2011 | Actualizado: miércoles, 27 de julio de 2011
...
Esta actualización de seguridad se considera crítica para todas las ediciones compatibles de Windows XP, Windows Vista y Windows 7, y moderada para todas las ediciones compatibles de Windows Server 2003 (excepto las ediciones para sistemas con Itanium), Windows Server2008 (excepto las ediciones para sistemas con Itanium) y Windows Server 2008 R2. En el caso de las ediciones para sistemas con Itanium de Windows Server 2003 y Windows Server 2008, esta actualización de seguridad no tiene ninguna clasificación de gravedad. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b031a496-aa74-4367-b2ae-24843c061745)                                                                                       | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eddd2964-9765-461d-9df8-2c05402948e8)                                                              | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=53756404-39e4-43af-81e9-81471536aa66)                                                                              | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c8d59f49-45ec-4527-b3a8-4925f710bbfd)                                                                  | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9c784734-f44f-4a3c-8223-6289f7dc2ad8)                                                           | Ninguna                         | Sin clasificación de gravedad <sup>[1]</sup> | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista Service Pack 1 y Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=80bf050a-9aff-4cd4-8e2f-196b0a92b1c0)                                                     | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a81412d0-2516-4bf4-87f7-3e41ebf6b82b)                             | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c3247886-76d0-4292-be9d-3e9b0221c46a) \*\* | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=51521b6b-94a7-4bcf-ad5f-fc304728b10f) \*\*               | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 para sistemas con Itanium y Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7c38b0d-7240-420a-88d3-2749a40e386f)    | Ninguna                         | Sin clasificación de gravedad <sup>[1]</sup> | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d)                                                                              | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d)                                                               | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows 7 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082)                                                                                     | Ejecución remota de código      | Crítica                             | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082)                                                                      | Ejecución remota de código      | Crítica                             | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de) \*\*                                                                   | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de) \*\*                                                    | Ejecución remota de código      | Moderada                            | Ninguna                                                             |
| [Windows Server 2008 R2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                                | Ejecución remota de código      | Moderada                            | [MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) |
| [Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                 | Ejecución remota de código      | Moderada                            | Ninguna                                                             |

<sup>[1]</sup> Las vulnerabilidades no afectan este sistema operativo específico. No obstante, las actualizaciones disponibles que establecen los bits de interrupción de los controles de terceros se aplican a varios sistemas operativos, incluido este. Para obtener más información, vea la subsección "Bits de interrupción de terceros", en la sección **Información sobre la vulnerabilidad** .
...
**En MS10-034 ya se estableció un bit de interrupción para la vulnerabilidad en las herramientas de desarrollo de Microsoft Internet Explorer 8 (CVE-2010-0811). ¿Por qué esta actualización establece otro bit de interrupción?**  
Microsoft agrega un CLSID adicional a la lista de bits de interrupción para este control ActiveX.
...
<th style="border:1px solid black;" >Vulnerabilidad en las herramientas de desarrollo de Microsoft Internet Explorer 8 (CVE-2010-0811)</th>
<th style="border:1px solid black;" >Vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)</th>
<th style="border:1px solid black;" >Vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)</th>
...
Ejecución remota de código <sup>[2]</sup></td>
...
<sup>[2]</sup> Internet Explorer 8 no se instala de forma predeterminada en este sistema operativo. La clasificación de gravedad solo se aplica si está instalado Internet Explorer 8.
...
-   **Evite que los objetos COM se ejecuten en Internet Explorer**
    ...
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no puede garantizar que pueda resolver los problemas derivados del uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
    ...
    Para configurar el bit de interrupción para un CLSID con un valor de {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1}, pegue el texto siguiente en un editor de textos como el Bloc de notas. A continuación, guarde el archivo con la extensión de nombre de archivo .reg.
...
Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Si el usuario inicia sesión con derechos de usuario administrativos, un intruso que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.
...
|----------------------------------------|--------------|-------------------------------------------------------------|  
| {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1} | iedvtool.dll | Herramientas de desarrollo de Microsoft Internet Explorer 8 |
  
**Nota** El establecimiento de este bit de interrupción corrige las variantes de la vulnerabilidad [CVE-2010-0811](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811) que se describió por primera vez en el [boletín de seguridad de Microsoft MS10-034](http://technet.microsoft.com/security/bulletin/ms10-034) .
...
Vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)  
-----------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en los controles ActiveX de Microsoft WMITools. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3973](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973) .
  
#### Factores atenuantes para la vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   El paquete de herramientas administrativas de WMI no se instala de forma predeterminada.  
-   Los controles ActiveX de WMITools no están firmados. De forma predeterminada, Internet Explorer bloque los controles que no están firmados. Para obtener más información, vea el artículo de MSDN [Bloqueo de ActiveX](http://msdn.microsoft.com/en-us/library/dd565667.aspx) .  
-   En el caso de un ataque basado en web, el intruso podría alojar un sitio web que contuviera una página web para aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan o alojan contenido o anuncios proporcionados por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. Sin embargo, el atacante no podría en ningún caso obligar a los usuarios a visitar estos sitios web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante.  
-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.  
-   De forma predeterminada, todas las versiones compatibles de Microsoft Outlook, Microsoft Outlook Express y Windows Mail abren los mensajes de correo electrónico HTML en la zona Sitios restringidos, que deshabilita las secuencias de comandos y los controles ActiveX, con lo que se quita el riesgo de que un atacante pueda usar esta vulnerabilidad para ejecutar código malintencionado. Si un usuario hace clic en un vínculo de un mensaje de correo electrónico, podría quedar vulnerable por la posibilidad de un ataque basado en Web.
  
#### Soluciones provisionales para la vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad.
  
-   **Evite que los objetos COM se ejecuten en Internet Explorer**
  
    Puede deshabilitar los intentos de ejecutar un objeto COM en Internet Explorer configurando los bits de interrupción del control en el Registro.
  
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no puede garantizar que pueda resolver los problemas derivados del uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
  
    Si desea ver el procedimiento detallado para impedir que un control se ejecute en Internet Explorer, consulte el [artículo 240797 de Microsoft Knowledge Base](http://support.microsoft.com/kb/240797) . Siga los pasos de este artículo para crear un valor de indicadores de compatibilidad en el Registro para evitar que se ejecute un objeto COM en Internet Explorer.
  
    Para configurar los bits de interrupción de CLSID con valores de {2745E5F5-D234-11D0-847A-00C04FD7BB08}, {FF371BF4-213D-11D0-95F3-00C04FD9B15B} y {AC146530-87A5-11D1-ADBD-00AA00B8E05A}, pegue el texto siguiente en un editor de textos, como el Bloc de notas. A continuación, guarde el archivo con la extensión de nombre de archivo .reg.
...
#### Preguntas más frecuentes sobre la vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)
...
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Para que se produzca una acción malintencionada, esta vulnerabilidad en uno de los controles ActiveX de Microsoft WMITools requiere que el usuario haya iniciado una sesión y visite un sitio web. Por lo tanto, cualquier sistema en el que estén instalados los controles ActiveX de Microsoft WMITools y se use Internet Explorer de forma habitual, como estaciones de trabajo o servidores de Terminal Server, está expuesto a esta vulnerabilidad.
  
**¿Cómo funciona esta actualización?**  
La actualización deshabilita el control Microsoft ActiveX al configurar el bit de interrupción para los identificadores de clase hospedados en los archivos de biblioteca enumerados a continuación:
  
| Identificador de clase                 | Archivo            | Descripción                           |  
|----------------------------------------|--------------------|---------------------------------------|  
| {2745E5F5-D234-11D0-847A-00C04FD7BB08} | WBEMSingleView.OCX | Control ActiveX de Microsoft WMITools |  
| {FF371BF4-213D-11D0-95F3-00C04FD9B15B} | WBEMMultiView.OCX  | Control ActiveX de Microsoft WMITools |  
| {AC146530-87A5-11D1-ADBD-00AA00B8E05A} | WBEMEventList.OCX  | Control ActiveX de Microsoft WMITools |
  
**¿Este control ActiveX está firmado digitalmente?**  
No, este control ActiveX no está firmado digitalmente. Para obtener más información acerca de la firma de controles ActiveX, vea la publicación del blog de MSDN [Todo lo que necesita saber acerca de la firma de código Authenticode](http://blogs.msdn.com/b/ieinternals/archive/2011/03/22/authenticode-code-signing-for-developers-for-file-downloads-building-smartscreen-application-reputation.aspx) .
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3973](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973) .
...
Sí. Esta actualización de seguridad soluciona la vulnerabilidad que podría aprovecharse al utilizar el código de tipo conceptual publicado. A la vulnerabilidad que se ha tratado se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3973](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973) .
  
Vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)  
-----------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en el control ActiveX de Microsoft Windows Messenger. Un atacante podría aprovechar esta vulnerabilidad mediante la creación de una página web especialmente diseñada. Si un usuario visita la página web, la vulnerabilidad podría permitir la ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1243](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1243) .
  
#### Factores atenuantes para la vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)
...
#### Soluciones provisionales para la vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)
...
-   **Evite que los objetos COM se ejecuten en Internet Explorer**
    ...
    **Advertencia** Si utiliza el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no puede garantizar que pueda resolver los problemas derivados del uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya.
    ...
    Para configurar el bit de interrupción para un CLSID con un valor de {FB7199AB-79BF-11d2-8D94-0000F875C541}, pegue el texto siguiente en un editor de textos como el Bloc de notas. A continuación, guarde el archivo con la extensión de nombre de archivo .reg.
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)
...
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Para que se produzca una acción malintencionada, esta vulnerabilidad en el control ActiveX de Microsoft Windows Messenger requiere que el usuario haya iniciado una sesión y visite un sitio web. Por lo tanto, cualquier sistema en el que esté instalado el control ActiveX de Microsoft Windows Messenger y se use Internet Explorer de forma habitual, como estaciones de trabajo o servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
| Identificador de clase                 | Archivo   | Descripción                                    |  
|----------------------------------------|-----------|------------------------------------------------|  
| {FB7199AB-79BF-11d2-8D94-0000F875C541} | msgsc.dll | Control ActiveX de Microsoft Windows Messenger |
...
-   [Oracle](http://www.oracle.com) ha solicitado un bit de interrupción para un control ActiveX, Java Deployment Toolkit. Para obtener más información acerca de los problemas de seguridad en el control ActiveX Java Deployment Toolkit, vea [Alerta de seguridad de Oracle CVE-2010-0886](http://www.oracle.com/technetwork/topics/security/alert-cve-2010-0886-094541.html) . El identificador de clase de este control ActiveX:  
    -   {CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA}  
-   [CA](http://www.ca.com/us/) ha publicado un documento informativo sobre seguridad en relación con un documento informativo para el control ActiveX WebScan. Si tiene alguna pregunta o duda con respecto al control ActiveX WebScan, póngase en contacto con CA en <http://www.ca.com> . Consulte el boletín de seguridad de CA para obtener más información. El identificador de clase (CLSID) de este control ActiveX es:  
    -   {7B297BFD-85E4-4092-B2AF-16A91B2EA103}  
-   [IBM](http://www.ibm.com) ha solicitado un bit de interrupción para el control ActiveX "Rational Suite License". Si tiene alguna pregunta o duda con respecto al control ActiveX Rational Suite License, póngase en contacto con IBM en <http://www.ibm.com> . Los identificadores de clase (CLSID) de este control ActiveX son:  
...
<td style="border:1px solid black;">Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2508272$\Spuninst</td>
</tr>
<tr class="odd">
...
-   Chris Ries, de Carnegie Mellon University Information Security Office, por informar de la vulnerabilidad en las herramientas de desarrollo de Microsoft Internet Explorer 8 (CVE-2010-0811)  
-   Brian Gorenc, de [DVLabs](http://dvlabs.tippingpoint.com/) de  [TippingPoint](http://www.tippingpoint.com/) , por colaborar con nosotros en la vulnerabilidad en los controles ActiveX de Microsoft WMITools (CVE-2010-3973)  
-   RadLSneak, en colaboración con [iSIGHT Partners](http://www.isightpartners.com/) Global Vulnerability Partnership, por informar de la vulnerabilidad en el control ActiveX de Microsoft Windows Messenger (CVE-2011-1243)
...
-   V1.1 (27 de julio de 2011): Se han agregado identificadores de clase para el control ActiveX de Microsoft WMITools descrito en la sección de vulnerabilidad de este boletín correspondiente a CVE-2010-3973. Se trata únicamente de un cambio informativo. Los clientes que ya han aplicado la solución provisional "Evitar que los objetos COM se ejecuten en Internet Explorer" para esta vulnerabilidad deben volver a aplicarla con los identificadores de clase adicionales.
