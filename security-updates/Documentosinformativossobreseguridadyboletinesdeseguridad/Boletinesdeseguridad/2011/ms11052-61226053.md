---
TOCTitle: 'MS11-052'
Title: 'Boletín de seguridad de Microsoft MS11-052 - Crítica'
ms:assetid: 'ms11-052'
ms:contentKeyID: 61226053
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-052(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-052 - Crítica
====================================================

Una vulnerabilidad en el lenguaje de marcado vectorial podría permitir la ejecución remota de código (2544521)
--------------------------------------------------------------------------------------------------------------

Publicado: martes, 14 de junio de 2011 | Actualizado: martes, 12 de julio de 2011
...
<span></span>
**¿Por qué se ha revisado este boletín el 12 de julio de 2011?**
Microsoft ha revisado este boletín para anunciar un cambio en la lógica de detección y la corrección de la información de reemplazo del boletín para algunas configuraciones afectadas.

Para los clientes que ejecutan Internet Explorer 6 todas las ediciones x64 compatibles de Windows XP y para todas las ediciones compatibles de Windows Server 2003, se trata de un cambio en la lógica de detección y una corrección de la información de reemplazo del boletín. No había cambios en los archivos de la actualización de seguridad. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.

Para los clientes que ejecutan Internet Explorer 7 para todas las ediciones compatibles de Windows XP y Windows Server 2003, se trata únicamente de una corrección de la información de reemplazo del boletín. No había cambios en la lógica de detección o en los archivos de la actualización de seguridad. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.
...
Sí. A los clientes que han instalado la actualización de seguridad de VML actual en sistemas con Internet Explorer 6 y posteriormente instalan Internet Explorer 7, se les ofrecerá esta actualización para Internet Explorer 7. La versión de vgx.dll instalada con Windows Internet Explorer 7 es una versión principal más alta que la de vgx.dll incluida en Windows XP o Windows Server 2003. Cuando se instala Internet Explorer 7, se reemplazará el archivo vgx.dll actualizado por Internet Explorer 6 que se proporciona en esta actualización de seguridad.
...
<th>
Vulnerabilidad de daños en la memoria relacionada con VML (CVE-2011-1266)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-1266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1266) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con VML (CVE-2011-1266)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con VML (CVE-2011-1266)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con VML (CVE-2011-1266)
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2544521$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2544521-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2544521-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2544521">artículo 2544521 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2544521$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [TippingPoint](http://www.tippingpoint.com/) por informar de la vulnerabilidad de daños en la memoria relacionada con VML (CVE-2011-1266)
...
-   V1.1 (12 de julio de 2011): Se ha anunciado un cambio en la lógica de detección y se ha corregido la información de reemplazo del boletín para algunas configuraciones afectadas. No había cambios en los archivos de la actualización de seguridad. Vea las preguntas más frecuentes de la actualización para obtener más detalles.
