---
TOCTitle: 'MS11-003'
Title: 'Boletín de seguridad de Microsoft MS11-003 - Crítica'
ms:assetid: 'ms11-003'
ms:contentKeyID: 61225983
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-003(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS11-003 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (2482017)
-----------------------------------------------------------------------

Publicado: martes, 8 de febrero de 2011 | Actualizado: martes, 8 de marzo de 2011
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Internet Explorer trata los objetos en memoria y las hojas de estilos en cascada, y carga las bibliotecas externas. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .

Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2488013](http://technet.microsoft.com/security/advisory/2488013) .
...
La versión beta de Internet Explorer 9 está afectada por las vulnerabilidades que se describen en este boletín. Se recomienda que los usuarios que ejecutan esta versión beta descarguen y apliquen la actualización en sus sistemas. Las actualizaciones de seguridad están disponibles en [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) y [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) . Las actualizaciones de seguridad para esta versión beta también están disponibles para la descarga en el [Centro de descarga de Microsoft](http://go.microsoft.com/fwlink/?linkid=21129) .
...
**Si he aplicado las soluciones provisionales del documento informativo sobre seguridad de Microsoft 2488013, ¿debo revertirlas antes de aplicar esta actualización?**
Microsoft recomienda que antes de instalar esta actualización de seguridad, deshaga la solución provisional "Impedir la carga recursiva de las hojas de estilos en cascada (CSS) en Internet Explorer" en los sistemas en los que la ha aplicado. Vea el [artículo 2482017 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2482017) para usar la solución **Microsoft Fix it** automática para deshabilitar esta solución provisional.

**¿Esta actualización está relacionada con el documento informativo sobre seguridad de Microsoft 2269637?**
Sí, la vulnerabilidad, [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) , corregida por esta actualización está relacionada con la clase de vulnerabilidades descrita en el [documento informativo sobre seguridad de Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637) que afecta al modo en que las aplicaciones cargan las bibliotecas externas. Esta actualización de seguridad corrige una determinada instancia de este tipo de vulnerabilidad.
...
<th>
Vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2010-3971)
</th>
<th>
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0035)
</th>
<th>
Vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0036)
</th>
<th>
Vulnerabilidad en la carga de bibliotecas no seguras en Internet Explorer (CVE-2011-0038)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2010-3971)
...
-   **Impedir la carga recursiva de las hojas de estilos en cascada (CSS) en Internet Explorer**

    Esta solución provisional ayuda a evitar que se aproveche la vulnerabilidad mediante el bloqueo del vector de ataques de hojas de estilos en cascada (CSS) en Internet Explorer.

    Esta solución provisional sólo está disponible como una solución **Microsoft Fix it** . Vea el [artículo 2482017 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2482017) para usar la solución **Microsoft Fix it** automática para habilitar o deshabilitar esta solución provisional.

    **Nota** Los clientes de Internet Explorer que todavía no hayan aplicado la actualización [MS10-090](http://technet.microsoft.com/security/bulletin/ms10-090) también deben aplicarla antes de habilitar esta solución provisional.

    **Consecuencias de la solución provisional.** El bloqueo de la carga recursiva de una hoja de estilos en cascada (CSS) tiene efectos secundarios. Los usuarios pueden observar ligeros problemas de rendimiento debidos a la mayor comprobación que se necesita para bloquear la carga de los archivos CSS.

    **Nota** En los sistemas en los que está habilitada esta solución provisional, Microsoft recomienda que se deshabilite antes de aplicar esta actualización de seguridad.

#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con CSS (CVE-2010-3971)
...
Internet Explorer no trata correctamente la memoria al analizar una hoja de estilos en cascada que hace referencia a sí misma de forma recursiva.
...
Esta actualización corrige la vulnerabilidad al modificar la forma en que Internet Explorer trata las hojas de estilos en cascada.

**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**
Sí. Esa vulnerabilidad ya se ha divulgado. Tiene asignado el número de vulnerabilidad y exposición común [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971) . Esta vulnerabilidad se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2488013](http://technet.microsoft.com/security/advisory/2488013) .
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0035)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0035)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0035)

**¿Cuál es el alcance de esta vulnerabilidad?**
Se trata de una vulnerabilidad de ejecución remota de código. Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario que ha iniciado sesión. Por tanto, los usuarios cuyas cuentas estén configuradas con pocos derechos de usuario en el sistema correrían un riesgo menor que aquellos que cuenten con derechos de usuario administrativos.

**¿Cuál es la causa de esta vulnerabilidad?**
Internet Explorer no trata correctamente los objetos en memoria al analizar el contenido web especialmente diseñado.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036) .

#### Factores atenuantes para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0036)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0036)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0036)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) .

#### Factores atenuantes para la vulnerabilidad en la carga de bibliotecas no seguras en Internet Explorer (CVE-2011-0038)
...
#### Soluciones provisionales para la vulnerabilidad en la carga de bibliotecas no seguras en Internet Explorer (CVE-2011-0038)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en la carga de bibliotecas no seguras en Internet Explorer (CVE-2011-0038)
...
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) .
...
<p>Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2482017$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2482017-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2482017-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2482017">artículo 2482017 de Microsoft Knowledge Base</a> .</td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use la herramienta <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2482017$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
-   Yuki Chen, de [Trend Micro](http://www.trendmicro.com) , por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0035)  
-   SkyLined, de [Google Inc.](http://www.google.com/) , por informar de la vulnerabilidad de daños en la memoria sin inicializar (CVE-2011-0036)  
-   Haifei Li, de [FortiGuard Labs de Fortinet](http://www.fortiguard.com/) , por informar de la vulnerabilidad en la carga de bibliotecas no seguras en Internet Explorer (CVE-2011-0038)
