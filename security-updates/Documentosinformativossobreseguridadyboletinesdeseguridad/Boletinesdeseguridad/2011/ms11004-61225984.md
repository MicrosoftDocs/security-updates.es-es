---
TOCTitle: 'MS11-004'
Title: 'Boletín de seguridad de Microsoft MS11-004 - Importante'
ms:assetid: 'ms11-004'
ms:contentKeyID: 61225984
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms11-004(v=Security.10)'
---
...
Esta actualización de seguridad se considera importante para Servicio FTP 7.0 de Microsoft para IIS 7.0 y Servicio FTP 7.5 de Microsoft para IIS 7.0 cuando están instalados en todas las ediciones compatibles de Windows Vista y Windows Server 2008, y para Servicio FTP 7.5 de Microsoft para Internet Information Services 7.5 en todas las ediciones compatibles de Windows 7 y Windows Server 2008 R2. Para obtener más información, consulte la subsección **Software afectado y no afectado** , en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el servicio FTP de IIS trata los comandos de FTP especialmente diseñados. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad** .
...
**Problemas conocidos.** En el [artículo 2489256 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2489256) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c09ccc72-8f94-416b-9a7f-ed16e90342a2">Servicio FTP 7.0 de Microsoft para IIS 7.0</a>[1]<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=da9b7982-1c6b-45ac-8dd0-d7101bb83949">Servicio FTP 7.5 de Microsoft para IIS 7.0</a><sup>[1]</sup></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e88d072f-0f5f-4c85-ad2f-91b9b8bf6b3a">Servicio FTP 7.0 de Microsoft para IIS 7.0</a>[1]<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=6e4b9878-b5d2-4025-8839-b41515932cf2">Servicio FTP 7.5 de Microsoft para IIS 7.0</a><sup>[1]</sup></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3cc55af7-5cd9-4923-8ec5-462ff201d734">Servicio FTP 7.0 de Microsoft para IIS 7.0</a>[1] *<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=4dfa0a25-b7e3-4fb6-a351-58ec3f8a8435">Servicio FTP 7.5 de Microsoft para IIS 7.0</a>[1] *</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f485b30d-dcaf-47c3-ac62-982b14670a1f">Servicio FTP 7.0 de Microsoft para IIS 7.0</a>[1] *<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=a98a74c1-0c91-446d-b822-fe57ff06d90b">Servicio FTP 7.5 de Microsoft para IIS 7.0</a>[1] *</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9dabd1d1-3f1e-46d1-b171-aafd3f08d291">Servicio FTP 7.5 de Microsoft para IIS 7.5</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=66fb4efe-bcd3-4e90-8e35-b013e014a952">Servicio FTP 7.5 de Microsoft para IIS 7.5</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1e075f57-1723-4933-9b8e-7bce4a44a1c1">Servicio FTP 7.5 de Microsoft para IIS 7.5</a> *</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bfddd539-c64f-4467-88ee-6bdfe645b478">Servicio FTP 7.5 de Microsoft para IIS 7.5</a></td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Ninguna</td>
</tr>
...
<td style="border:1px solid black;">Servicio FTP 5.1 de Microsoft para IIS 5.1</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">Servicio FTP 5.1 de Microsoft para IIS 6.0</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;">Servicio FTP 6.0 de Microsoft para IIS 6.0</td>
</tr>
<tr class="even">
...
Servicio FTP 6.0 de Microsoft para IIS 7.5 <sup>[1]</sup></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;">Servicio FTP 6.0 de Microsoft para IIS 7.0 [1]<br />
...
**Tengo IIS instalado, pero no he habilitado FTP. ¿Debo aplicar esta actualización?**  
Esta vulnerabilidad sólo afecta a los sistemas en los que están habilitadas las versiones enumeradas del servicio FTP. Si una versión afectada del servicio FTP está instalada pero no habilitada, la actualización se seguirá ofreciendo a través de las actualizaciones automáticas.

**¿Cómo puedo comprobar la versión del servicio FTP que está instalada en mi sistema?**  
En Windows Vista y Windows Server 2008, si ftpsvc.dll se encuentra en el directorio %SystemRoot%\\system32\\inetsrv, significa que el sistema contiene una versión del servicio FTP afectado por esta vulnerabilidad (Servicio FTP 7.0 de Microsoft o Servicio FTP 7.5 de Microsoft). Si el sistema contiene ftpsvc2.dll en este directorio, indica la presencia de Servicio FTP 6.0 de Microsoft en el sistema, que no está afectado por esta vulnerabilidad.
...
Sí. Esta vulnerabilidad se produce antes de la autenticación, por lo que un cliente malintencionada puede poner en peligro un sistema vulnerable incluso si está configurado para no permitir la autenticación anónima.
...
<th style="border:1px solid black;" >Vulnerabilidad de desbordamiento del búfer del montón en el servicio FTP (CVE-2010-3972)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.0 cuando está instalado en Windows Vista Service Pack 1 y Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.5 cuando está instalado en Windows Vista Service Pack 1 y Windows Vista Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.0 cuando está instalado en Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.5 cuando está instalado en Windows Vista x64 Edition Service Pack 1 y Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.0 cuando está instalado en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.5 cuando está instalado en Windows Server 2008 para sistemas de 32 bits y Windows Server 2008 para sistemas de 32 bits Service Pack 2*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Servicio FTP 7.0 de Microsoft para IIS 7.0 cuando está instalado en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Servicio FTP 7.5 de Microsoft para IIS 7.0 cuando está instalado en Windows Server 2008 para sistemas x64 y Windows Server 2008 para sistemas x64 Service Pack 2*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Internet Information Services 7.5 en Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Internet Information Services 7.5 en Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Internet Information Services 7.5 en Windows Server 2008 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1*</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Internet Information Services 7.5 en Windows Server 2008 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong><br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilidad de desbordamiento del búfer del montón en el servicio FTP (CVE-2010-3972)  
----------------------------------------------------------------------------------------
  
Existe una vulnerabilidad en el servicio FTP en Microsoft Internet Information Services (IIS) 7.0 y Microsoft Internet Information Services (IIS) 7.5. La vulnerabilidad podría permitir la ejecución remota de código.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, consulte [CVE-2010-3972](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3972) .
  
#### Factores atenuantes para la vulnerabilidad de desbordamiento del búfer del montón en el servicio FTP (CVE-2010-3972)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   El servicio FTP no se instala de forma predeterminada en Internet Information Services (IIS).  
-   El servicio FTP no se inicia automáticamente después de la instalación.  
-   No se crea ningún sitio FTP incluso si el servicio FTP está instalado e iniciado.
  
#### Soluciones provisionales para la vulnerabilidad de desbordamiento del búfer del montón en el servicio FTP (CVE-2010-3972)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Detener y deshabilitar el servicio FTP**
    ...
    **Consecuencias de la solución provisional.** Los clientes no podrán conectarse al servidor FTP ni cargar o descargar archivos mediante el servicio FTP.
...
-   **Bloquear el tráfico entrante FTP en el firewall perimetral**
  
    Bloquee el siguiente puerto en el firewall:  
    Puerto TCP 21
    ...
    **Consecuencias de la solución provisional.** Las aplicaciones y los servicios pueden usar el puerto afectado. El bloqueo de la conectividad al puerto puede causar que no funcionen varias aplicaciones o servicios.
  
    **Cómo deshacer la solución provisional.**
  
    Desbloquee el puerto TCP 21 en el firewall. Para obtener más información acerca de los puertos, vea el artículo de TechNet [Asignación de puertos TCP y UDP](http://go.microsoft.com/fwlink/?linkid=21312) .
  
#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento del búfer del montón en el servicio FTP (CVE-2010-3972)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un atacante podría instalar programas, ver, cambiar o eliminar datos, o crear cuentas nuevas en el contexto del sistema local.
...
Un atacante que consiguiera aprovechar esta vulnerabilidad podría provocar la ejecución remota de código en el sistema de destino en el contexto del sistema local en ejecución.
...
Los sistemas donde se usan los servicios FTP 7.0 y 7.5 de Microsoft IIS están más expuestos.
...
Sí. Esa vulnerabilidad ya se ha divulgado. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-3972](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3972) .
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2489256">artículo 2489256 de Microsoft Knowledge Base</a> .</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Servicio FTP 7.0 de Microsoft para IIS 7.5 cuando está instalado en todas las ediciones x64 compatibles de Windows Server 2008:<br />
ftp75_x64_kb2489256.msp /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
