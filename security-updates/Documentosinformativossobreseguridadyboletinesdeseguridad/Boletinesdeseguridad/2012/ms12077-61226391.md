---
TOCTitle: 'MS12-077'
Title: 'Boletín de seguridad de Microsoft MS12-077 - Crítica'
ms:assetid: 'ms12-077'
ms:contentKeyID: 61226391
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-077(v=Security.10)'
---
...
Actualización de seguridad acumulativa para Internet Explorer (2761465)
-----------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2744842 en [MS12-063](http://technet.microsoft.com/es-es/security/bulletin/ms12-063) se reemplaza por KB2761465
</td>
</tr>
...
<td style="border:1px solid black;">
KB2761451 en [MS12-071](http://technet.microsoft.com/es-es/security/bulletin/ms12-071) se reemplaza por KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2761465 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2761465).
...
Sí. La actualización KB2761465 está disponible para Internet Explorer 10 en Windows 8 Release Preview e Internet Explorer 10 en Windows Server 2012 Release Candidate. Se recomienda que los usuarios con Windows 8 Release Preview y Windows Server 2012 Release Candidate apliquen las actualizaciones a sus sistemas. Las actualizaciones están disponibles en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
Sí. La actualización KB2761465 está disponible para Internet Explorer 10 Release Preview para Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas x64 Service Pack 1 y Windows Server 2008 R2 para sistemas x64 Service Pack 1. Se recomienda a los usuarios con Internet Explorer 10 Release Preview para Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas x64 Service Pack 1 y Windows Server 2008 R2 para sistemas x64 Service Pack 1 que apliquen las actualizaciones a sus sistemas. Las actualizaciones están disponibles en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de InjectHTMLStream después de la liberación (CVE-2012-4781)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de CMarkup después de la liberación (CVE-2012-4782)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso del recuento de referencia incorrecto después de la liberación (CVE-2012-4787)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4781](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781).

#### Factores atenuantes para la vulnerabilidad en el uso de InjectHTMLStream después de la liberación (CVE-2012-4781)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de InjectHTMLStream después de la liberación (CVE-2012-4781)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de InjectHTMLStream después de la liberación (CVE-2012-4781)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4782](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782).

#### Factores atenuantes para la vulnerabilidad en el uso de CMarkup después de la liberación (CVE-2012-4782)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de CMarkup después de la liberación (CVE-2012-4782)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de CMarkup después de la liberación (CVE-2012-4782)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4787](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787).

#### Factores atenuantes para la vulnerabilidad en el uso del recuento de referencia incorrecto después de la liberación (CVE-2012-4787)
...
#### Soluciones provisionales para la vulnerabilidad en el uso del recuento de referencia incorrecto después de la liberación (CVE-2012-4787)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso del recuento de referencia incorrecto después de la liberación (CVE-2012-4787)
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2761465-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2761465-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2761465">artículo 2761465 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2761465$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
...
| **Informaciónsobrearchivos**                   | Vea el [artículo 2761465 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2761465).                                                                                                                                                                                                                    |
...
-   por informar de la vulnerabilidad en el uso de InjectHTMLStream después de la liberación (CVE-2012-4781)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola)  
-   por informar de la vulnerabilidad en el uso de CMarkup después de la liberación (CVE-2012-4782)  
-   Fermín J. Serna de [Google Inc](http://www.google.com) por informar de la vulnerabilidad en el uso del recuento de referencia incorrecto después de la liberación (CVE-2012-4787)
