...
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2012-1886)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de longitud no válida de SST en Excel después de la liberación (CVE-2012-1887)
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2687481">artículo 2687481 de Microsoft Knowledge Base</a>.</td>
</tr>  
<tr class="even">
...
#### Microsoft Excel 2007 (todas las ediciones)
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2687307">artículo 2687307 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2687313">artículo 2687313 de Microsoft Knowledge Base</a>.<br />
Vea el <a href="http://support.microsoft.com/kb/2687311">artículo 2687311 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2597126">artículo 2597126 de Microsoft Knowledge Base</a>.</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office 2008 para Mac 12.3.5 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=d3d801a2-d57f-4b4c-970a-c296bc716521).
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office 2008 para Mac 12.3.5. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office 2008 para Mac 12.3.5, haga doble clic en la aplicación Actualización de Microsoft Office 2008 para Mac 12.3.5 y siga las instrucciones en pantalla.  
-   Si la instalación se realiza correctamente, puede eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office 2008 para Mac 12.3.5 a la Papelera y, a continuación, el archivo descargado.
...
Si el número de versión es **12.3.5**, significa que la actualización se ha instalado correctamente.
...
Descargue e instale la versión de idioma adecuada de la actualización de Microsoft Office para Mac 2011 14.2.5 del [Centro de descarga de Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=0f4e073f-4fec-440d-a9bf-1e01ee9e92ad).
...
-   Abra en el escritorio el volumen de actualización de Microsoft Office para Mac 2011 14.2.5. Es posible que este paso ya se haya llevado a cabo.  
-   Para iniciar el proceso de actualización, en la ventana del volumen Actualización de Microsoft Office para Mac 2011 14.2.5, haga doble clic en la aplicación Actualización de Microsoft Office para Mac 2011 14.2.5 y siga las instrucciones en pantalla.  
-   Cuando la instalación se realice correctamente, podrá eliminar el programa de instalación de la actualización del disco duro. Para comprobar que la instalación ha finalizado correctamente, vea el apartado "Comprobación de la instalación de la actualización" siguiente. Para eliminar el programa de instalación de la actualización, primero arrastre el volumen Actualización de Microsoft Office para Mac 2011 14.2.5 a la Papelera y, a continuación, el archivo descargado.
...
Si el último número de versión de actualización instalada es **14.2.5**, significa que la actualización se ha instalado correctamente.
...
-   Sean Larsson, en colaboración con [iDefense VCP](http://labs.idefense.com), por informar de la vulnerabilidad de desbordamiento del montón de SerAuxErrBar en Excel (CVE-2012-1885)  
-   Un investigador anónimo, en colaboración con [iDefense VCP](http://labs.idefense.com), por informar de la vulnerabilidad de daños en la memoria relacionada con Excel (CVE-2012-1886)  
-   Un investigador anónimo, en colaboración con [iDefense VCP](http://labs.idefense.com), por informar de la vulnerabilidad en el uso de longitud no válida de SST en Excel después de la liberación (CVE-2012-1887)  
-   Un investigador anónimo, en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [HP TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), por informar de la vulnerabilidad de subdesbordamiento de la pila del registro FEAT (CVE-2012-2543)
