---
TOCTitle: 'MS12-009'
Title: 'Boletín de seguridad de Microsoft MS12-009 - Importante'
ms:assetid: 'ms12-009'
ms:contentKeyID: 61226311
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-009(v=Security.10)'
---
...
La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que AFD valida la entrada antes de pasarla desde el modo usuario al kernel de Windows. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.

**Recomendación.** La mayoría de los clientes tienen habilitada la actualización automática y no deben realizar ninguna acción porque esta actualización de seguridad se descargará e instalará automáticamente. Los clientes que no han habilitado la actualización automática deben buscar las actualizaciones e instalar esta actualización manualmente. Para obtener información acerca de las opciones de configuración específicas en las actualizaciones automáticas, vea el [artículo 294871 de Microsoft Knowledge Base](http://support.microsoft.com/kb/294871). Microsoft recomienda que los clientes apliquen la actualización a la primera oportunidad con el software de administración de actualizaciones o busquen las actualizaciones con el servicio [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|---------------------------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                 | Elevación de privilegios        | Importante                          | [MS11-080](http://technet.microsoft.com/es-es/security/bulletin/ms11-080) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744)                                                                                 | Elevación de privilegios        | Importante                          | [MS11-080](http://technet.microsoft.com/es-es/security/bulletin/ms11-080) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96)                                                                     | Elevación de privilegios        | Importante                          | [MS11-080](http://technet.microsoft.com/es-es/security/bulletin/ms11-080) |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                              | Elevación de privilegios        | Importante                          | [MS11-080](http://technet.microsoft.com/es-es/security/bulletin/ms11-080) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43)                                                                           | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb)\*                                                             | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                       | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127)                                           | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744)\*               | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc) | Elevación de privilegios        | Importante                          | [MS11-046](http://technet.microsoft.com/es-es/security/bulletin/ms11-046) |
...
**¿Por qué Windows Server 2003 Service Pack 2 es la única edición de 32 bits de Windows afectada en este boletín?  
**Esta actualización de seguridad corrige dos vulnerabilidades, CVE-2012-0148 y CVE-2012-0149. La primera no afecta a ninguna de las ediciones de 32 bits de Windows, mientras que la segunda solo afecta a las ediciones compatibles de Windows Server 2003, incluidas las ediciones de 32 bits. Por lo tanto, Windows Server 2003 Service Pack 2 es la única edición de 32 bits de Windows incluida como software afectado en este boletín.
...
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios en AfdPoll (CVE-2012-0148)</th>
<th style="border:1px solid black;" >Vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2012-0149)</th>
...
Vulnerabilidad de elevación de privilegios en AfdPoll (CVE-2012-0148)  
---------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios por la que el controlador de función auxiliar (afd.sys) no valida correctamente los datos enviados desde el modo usuario al kernel de Windows. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante local que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, el atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con derechos administrativos completos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148).
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios en AfdPoll (CVE-2012-0148)
...
-   Esta vulnerabilidad no se puede aprovechar en ediciones de 32 bits de Microsoft Windows.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios en AfdPoll (CVE-2012-0148)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios en AfdPoll (CVE-2012-0148)
...
La vulnerabilidad se debe a que el controlador afd.sys valida incorrectamente la entrada al recibir datos del modo usuario.
...
Vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2012-0149)  
------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de elevación de privilegios por la que el controlador de función auxiliar (afd.sys) no valida correctamente los datos enviados desde el modo usuario al kernel de Windows. La vulnerabilidad podría permitir a un atacante ejecutar código con privilegios elevados. Un atacante local que consiga aprovechar esta vulnerabilidad podría ejecutar código arbitrario y tomar el control completo de un sistema afectado. De esta forma, el atacante podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con derechos administrativos completos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0149](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149).
  
#### Factores atenuantes para la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2012-0149)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.
  
#### Soluciones provisionales para la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2012-0149)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de elevación de privilegios en el controlador de función auxiliar (CVE-2012-0149)
...
**¿Cómo funciona esta actualización?**   
La actualización corrige esta vulnerabilidad al modificar la forma en que AFD valida la entrada antes de pasarla desde el modo usuario al kernel de Windows.
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2645640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2645640">artículo 2645640 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt, de [Azimuth Security](http://www.azimuthsecurity.com/), por informar de la vulnerabilidad de elevación de privilegios locales en AfdPoll (CVE-2012-0148)  
-   Tarjei Mandt, de [Azimuth Security](http://www.azimuthsecurity.com/), por informar de la vulnerabilidad de elevación de privilegios locales en AfdPoll (CVE-2012-0149)
