---
TOCTitle: 'MS12-057'
Title: 'Boletín de seguridad de Microsoft MS12-057 - Importante'
ms:assetid: 'ms12-057'
ms:contentKeyID: 61226371
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-057(v=Security.10)'
---
...
<td style="border:1px solid black;">KB2584063 en <a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-073">MS11-073</a> se reemplaza por KB2596615<br />
<br />
KB2288931 en <a href="http://technet.microsoft.com/es-es/security/bulletin/ms10-105">MS10-105</a> se reemplaza por KB2596754</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=953b9b69-2f66-4f71-b342-467cc05030ba">Microsoft Office 2010 Service Pack 1 (ediciones de 32 bits)</a><br />
(KB2687501)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=a55a33f9-1eb6-469a-967c-a483764772c3">Microsoft Office 2010 Service Pack 1 (ediciones de 32 bits)</a><br />
(KB2687510)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2584066 en <a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-073">MS11-073</a> se reemplaza por KB2553260 o KB2687501</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90b99372-4f13-4f3a-ae52-da6543745248">Microsoft Office 2010 Service Pack 1 (ediciones de 64 bits)</a><br />
(KB2687501)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=da8a4d12-d4fc-4b6e-b65f-096dedddf529">Microsoft Office 2010 Service Pack 1 (ediciones de 64 bits)</a><br />
(KB2687510)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2584066 en <a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-073">MS11-073</a> se reemplaza por KB2553260 o KB2687501</td>
...
Para corregir un problema que afecta a certificados digitales específicos que Microsoft generó sin los atributos de marca de hora adecuados, Microsoft ha vuelto a publicar este boletín para reemplazar las actualizaciones KB2553260 y KB2589322 por las actualizaciones KB2687501 y KB2687510, respectivamente, para Microsoft Office 2010 Service Pack 1. Para obtener más información, vea [Documento informativo sobre seguridad de Microsoft 2749655](http://technet.microsoft.com/security/advisory/2749655).
  
**Ya he instalado correctamente las actualizaciones KB2553260 y KB2589322 originales. ¿Debo aplicar los paquetes de actualización (KB2687501 y KB2687510, respectivamente) que se han vuelto a publicar el 11 de diciembre de 2012?**  
Sí. Aunque los clientes que ya han instalado correctamente las actualizaciones originales no necesitan instalar las actualizaciones que se han vuelto a publicar para estar protegidos frente a la vulnerabilidad descrita en este boletín, las actualizaciones que se han vuelto a publicar (KB2687501 y KB2687510) reemplazan s actualizaciones originales (KB2553260 y KB2589322, respectivamente) por una versión de producto más alta para el software aplicable.
  
A los clientes con las actualizaciones originales aplicadas se les ofrecerán las actualizaciones que se han vuelto a publicar. Los clientes deben aplicar todas las actualizaciones que se ofrecen para la versión del software Microsoft Office que se ejecuta en sus sistemas.
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2731879 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2731879).
  
**¿Por qué hay múltiples paquetes de actualización disponibles para parte del software afectado?**   
Las actualizaciones necesarias para corregir las vulnerabilidades descritas en este boletín se ofrecen en diferentes paquetes de actualizaciones, tal como se indica en la tabla **Software afectado** debido al modelo de servicio por componentes para Microsoft Office.
  
**Hay múltiples paquetes de actualización disponibles para cada software de Microsoft Office afectado. ¿Debo instalar todas las actualizaciones enumeradas en la tabla Software afectado para el software?**   
...
Sí. Además de los cambios que se indican en la sección Información sobre la vulnerabilidad de este boletín, esta actualización incluye cambios de defensa en profundidad para Microsoft Office 2007 y Microsoft Office 2010. Estos cambios contribuyen a garantizar que las aplicaciones de Microsoft Office tratan correctamente los archivos gráficos de WordPerfect (WPG).
...
Algún software no afectado, incluido Paquete de compatibilidad de Microsoft Office, Microsoft Word Viewer, Microsoft Excel Viewer y Microsoft PowerPoint Viewer, contiene el componente compartido vulnerable de Microsoft Office, pero como no tiene acceso al código vulnerable, no está afectado por esta vulnerabilidad. No obstante, debido a que el código vulnerable está presente, se ofrecerá esta actualización.
...
<th>Vulnerabilidad de daños en la memoria relacionada con el formato de archivo CGM (CVE-2012-2524)</th>
<th>Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft Word trata los archivos gráficos CGM especialmente diseñados. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2524).
  
#### Factores atenuantes para la vulnerabilidad de daños en la memoria relacionada con el formato de archivo CGM (CVE-2012-2524)
...
#### Soluciones provisionales para la vulnerabilidad de daños en la memoria relacionada con el formato de archivo CGM (CVE-2012-2524)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:
  
-   **No abra los archivos de Office ni inserte** **los archivos CGM que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza**
  
    No abra los archivos de Office ni inserte los archivos CGM que reciba de fuentes que no sean de confianza ni aquellos recibidos inesperadamente de fuentes de confianza. Esta vulnerabilidad se puede aprovechar si un usuario abre un archivo especialmente diseñado.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de daños en la memoria relacionada con el formato de archivo CGM (CVE-2012-2524)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de ejecución remota de código.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que Microsoft Office no trata correctamente los archivos CGM especialmente diseñados, lo que provoca que se dañe la memoria y se pueda ejecutar código arbitrario.
...
Esta vulnerabilidad requiere que un usuario abra un archivo especialmente diseñado con una versión afectada de Microsoft Office o inserte un archivo CGM especialmente diseñado en un documento con una versión afectada de Microsoft Office.
...
La actualización corrige la vulnerabilidad al deshabilitar la carga de archivos gráficos CGM en las aplicaciones de Microsoft Office.
...
<td style="border:1px solid black;">Para ediciones compatibles de Microsoft Office 2007 software:<br />
...
<td style="border:1px solid black;">Vea los <a href="http://support.microsoft.com/kb/2596615">artículos 2596615</a> y<br />
<a href="http://support.microsoft.com/kb/2596754">2596754 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">Para software de Microsoft Office 2010 (ediciones de 32 bits):<br />
mso2010-kb2687501-fullfile-x86-glb.exe /passive<br />
msconv972010-kb2687510-fullfile-x86-glb.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para software de Microsoft Office 2010 (ediciones de 64 bits):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea los <a href="http://support.microsoft.com/kb/2687501">artículos 2687501</a> y<br />
<a href="http://support.microsoft.com/kb/2687510">2687510 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">No aplicable</td>
