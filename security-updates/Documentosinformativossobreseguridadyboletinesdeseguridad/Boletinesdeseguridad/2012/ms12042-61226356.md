---
TOCTitle: 'MS12-042'
Title: 'Boletín de seguridad de Microsoft MS12-042 - Importante'
ms:assetid: 'ms12-042'
ms:contentKeyID: 61226356
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-042(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS12-042 - Importante
=======================================================

Vulnerabilidades del kernel de Windows podrían permitir la elevación de privilegios (2711167)
---------------------------------------------------------------------------------------------
...
Esta actualización de seguridad se considera importante para todas las ediciones de 32 bits de Windows XP y Windows Server 2003; Windows 7 para sistemas x64; y Windows Server 2008 R2 para sistemas x64. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige las vulnerabilidades al corregir la forma en que el Programador de modo de usuario de Windows trata una solicitud específica del sistema y la forma en que Windows administra ROM BIOS. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;">
KB2633171 en [MS11-098](http://technet.microsoft.com/es-es/security/bulletin/ms11-098) reemplazado por KB2707511
</td>
</tr>
...
<td style="border:1px solid black;">
KB2556532 en [MS11-068](http://technet.microsoft.com/es-es/security/bulletin/ms11-068) reemplazado por KB2709715
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Vulnerabilidad de corrupción de memoria del Programador de modo de usuario (CVE-2012-0217)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de corrupción ROM BIOS (CVE-2012-1515)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de elevación de privilegios en la forma en que el Programador de modo de usuario de Windows trata las solicitudes del sistema. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217).

#### Factores atenuantes para la vulnerabilidad de corrupción de memoria del Programador de modo de usuario (CVE-2012-0217)
...
-   Esta vulnerabilidad sólo afecta a las versiones Intel x64 de Windows 7 y Windows Server 2008 R2.
-   Los sistemas con CPU AMD o basada en ARM no están afectados por esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de corrupción de memoria del Programador de modo de usuario (CVE-2012-0217)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de corrupción de memoria del Programador de modo de usuario (CVE-2012-0217)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que el Programador de modo de usuario de Windows no trata correctamente una solicitud específica del sistema.

**¿Qué es el Programador de modo de usuario (UMS)?**  
El Programador de modo de usuario (UMS) es un mecanismo ligero con API de sistema que las aplicaciones pueden usar para programar sus propios subprocesos. Una aplicación puede cambiar entre subprocesos UMS en el modo de usuario sin implicar al programador del sistema y recuperar el control del procesador si un subproceso UMS se bloquea en el kernel.
...
La actualización corrige la vulnerabilidad al modificar la forma en que el Programador de modo de usuario de Windows trata una solicitud específica del sistema.
...
Existe una vulnerabilidad de elevación de privilegios en la forma en que Windows trata la memoria BIOS. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515).

#### Factores atenuantes para la vulnerabilidad de corrupción ROM BIOS (CVE-2012-1515)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local. Los usuarios anónimos o los usuarios remotos no pueden aprovechar esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de corrupción ROM BIOS (CVE-2012-1515)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de corrupción ROM BIOS (CVE-2012-1515)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios.

**¿Cuál** **es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Windows no protege correctamente ROM BIOS.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la manera en que Windows administra ROM BIOS.

**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515).
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2707511$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2707511">artículo 2707511 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2709715">artículo 2709715 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
...
-   Rafal Wojtczuk de [Bromium](http://www.bromium.com/) y Jan Beulich de [SUSE](http://www.suse.com/), por informar de la vulnerabilidad de corrupción de memoria del Programador de modo de usuario (CVE-2012-0217)
