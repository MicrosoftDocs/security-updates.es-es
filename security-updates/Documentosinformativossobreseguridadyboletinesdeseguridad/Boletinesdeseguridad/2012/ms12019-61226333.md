---
TOCTitle: 'MS12-019'
Title: 'Boletín de seguridad de Microsoft MS12-019 - Moderada'
ms:assetid: 'ms12-019'
ms:contentKeyID: 61226333
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-019(v=Security.10)'
---
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908)                                                                                       | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c)                                                                           | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3)\*\*                                                    | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b)\*\*                                                           | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6)                             | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0)                                           | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37)\*\*             | Denegación de servicio          | Moderada                            | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50) | Denegación de servicio          | Moderada                            | Ninguna                                       |
...
<th style="border:1px solid black;" >Vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)</th>
...
Vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)  
-------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de denegación de servicio en la forma en que DirectWrite representa una secuencia de caracteres Unicode especialmente diseñada. Un atacante que aprovechara esta vulnerabilidad podría provocar que una aplicación de destino dejara de responder.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156).
  
#### Factores atenuantes para la vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)
  
Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)
  
Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)
  
**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que DirectWrite representa incorrectamente una secuencia de caracteres Unicode especialmente diseñada en memoria.
  
**¿Qué es DirectWrite?**  
DirectWrite es una API completa de representación de texto Unicode, independiente de la resolución y multiformato que admite la medición, el dibujo y la prueba de texto. Para obtener más información acerca de DirectWrite, vea el artículo de MSDN [Presentación de DirectWrite](http://msdn.microsoft.com/en-us/library/windows/desktop/dd371554(v=vs.85).aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría provocar que una aplicación de destino, como Windows Live Messenger, dejara de responder.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
En el caso de un ataque a través de web, el atacante no autenticado tendría que hospedar un sitio web que contenga una secuencia de caracteres Unicode especialmente diseñada. Además, los sitios web vulnerables y los sitios web que aceptan u hospedan contenido proporcionado por el usuario podrían incluir contenido especialmente diseñado que se usara para aprovechar esta vulnerabilidad. Para que se pueda aprovechar la vulnerabilidad, la secuencia de caracteres Unicode especialmente diseñada tendría que analizarse mediante una aplicación que represente el contenido web con DirectWrite. La aplicación afectada podría dejar de responder cuando DirectWrite representa la secuencia de caracteres Unicode especialmente diseñada. En ningún caso el atacante podría obligar a los usuarios a visitar un sitio web que hospede el contenido con una secuencia de caracteres Unicode especialmente diseñada. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que dirija a los usuarios al sitio web del atacante.
  
En un escenario de ataque basado en Instant Messenger, un atacante no autenticado podría aprovechar esta vulnerabilidad mediante el envío de una secuencia de caracteres Unicode especialmente diseñada directamente a un cliente de Instant Messenger, como Windows Live Messenger. La aplicación de destino podría dejar de responder cuando DirectWrite representa la secuencia de caracteres Unicode especialmente diseñada.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Las estaciones de trabajo y los servidores de Terminal Server están expuestos a esta vulnerabilidad. Los servidores podrían correr un mayor riesgo si los administradores permiten a los usuarios iniciar sesión en los servidores y ejecutar programas. Sin embargo, los procedimientos recomendados desaconsejan permitir esto.
  
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al cambiar la forma en que DirectWrite representa los caracteres Unicode.
  
**En el momento de emitir este boletín de seguridad, ¿se había divulgado ya esta vulnerabilidad?**  
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156).
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2665364">artículo 2665364 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Khaled M. Salameh, por informar de la vulnerabilidad de denegación de servicio en la aplicación DirectWrite (CVE-2012-0156)
