...
-   **Deshabilitar el servicioLanmanWorkstation**
    ...
    **Con un script de implementación administrada:**
    ...
    1.  Haga una copia de seguridad de las claves del Registro mediante un script de implementación administrada con el siguiente comando:
    ```
    ...
    ```
    2.  Guarde lo siguiente en un archivo con la extensión .REG (por ejemplo, **Disable\_lanmanworkstation.reg**):
    ```
        Editor del Registro de Windows versión 5.00[HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\lanmanworkstation]"Start"=dword:00000004
    ```
...
-   **Deshabilite el servicio de administrador de impresión**
    ...
    **Con un script de implementación administrada:**
    ...
    ```
    3.  Ejecute el script del Registro creado en el paso 2 en equipo de destino con el siguiente comando:
    ```
