---
TOCTitle: 'MS12-005'
Title: 'Boletín de seguridad de Microsoft MS12-005 - Importante'
ms:assetid: 'ms12-005'
ms:contentKeyID: 61226305
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-005(v=Security.10)'
---

Boletín de seguridad de Microsoft MS12-005 - Importante
=======================================================
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                          | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                                 | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                                 | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                     | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2003 con SP2 para sistemas con Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                              | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                       | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                           | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                           | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                       | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas de 32 bits y Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                             | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows 7 para sistemas x64 y Windows 7 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                           | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*             | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | Ejecución remota de código      | Importante                          | Ninguna                                       |
...
**¿Está relacionada esta actualización de seguridad con** **MS12-002?**  
No. Aunque ambas actualizaciones afectan al Empaquetador de Windows, las actualizaciones afectan a componentes distintos y no están relacionadas. Estas actualizaciones se pueden aplicar en cualquier orden.

**¿Contiene esta actualización algún cambio en relación con la seguridad en su funcionalidad?**  
Si, esta actualización cambia la forma en que Empaquetador de Windows identifica los objetos no seguros.
...
<th style="border:1px solid black;" >Vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)</th>
...
Vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)  
----------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que Empaquetador de Windows carga las aplicaciones ClickOnce insertadas en archivos de Microsoft Office.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013).
  
#### Factores atenuantes para la vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)
...
-   Para implementarse a través de una red, el manifiesto de implementación y el manifiesto de aplicación de una implementación de ClickOnce deben estar firmados con un certificado digital.
  
#### Soluciones provisionales para la vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad
  
-   **Quitar la asociación de archivo**  
-   -   **.application**
    ...
    **Nota** Si usa el Editor del Registro incorrectamente, puede provocar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no puede garantizar que pueda resolver los problemas derivados del uso incorrecto del Editor del Registro. El uso del Editor del Registro es responsabilidad suya. Para obtener información sobre cómo editar el Registro, consulte el tema “Cambiar claves y valores” de la Ayuda del Editor del Registro (Regedit.exe) o los temas “Agregar y eliminar valores del Registro” y “Editar valores del Registro” de la Ayuda de Regedt32.exe.
    ...
    Para quitar la asociación de archivo .application, realice los siguientes pasos:
  
    **Con el método interactivo**
  
    1.  Haga clic en **Inicio**, en **Ejecutar**, escriba **regedit** y, a continuación, haga clic en **Aceptar.**  
    2.  Expanda **HKEY\_CLASSES\_ROOT**, haga clic en **.application** y, a continuación, en el menú **Archivo** y seleccione **Exportar.**  
    3.  En el cuadro de diálogo **Exportar archivo del Registro**, escriba **Copia de seguridad del Registro para la asociación de archivos HKCR de aplicación.reg** y haga clic en **Guardar**.    
    ...
    5.  Expanda **HKEY\_CURRENT\_USER**, **Software**, **Microsoft**, **Windows**, **CurrentVersion**, **Explorer** y **FileExts**.  
    6.  Haga clic en **.application** y, a continuación, en el menú **Archivo** y seleccione **Exportar.**  
    7.  En el cuadro de diálogo **Exportar archivo del Registro**, escriba **Copia de seguridad del Registro para la asociación de archivos HKCU de aplicación.reg** y haga clic en **Guardar**.    
        **Nota** De este modo se creará una copia de seguridad de esta clave del Registro en la carpeta Mis Documentos de forma predeterminada**.**  
    8.  Presione la tecla **Supr** en el teclado para eliminar la clave del Registro. Cuando se le pregunte si desea eliminar el valor del Registro, haga clic en **Sí.**
  
    **Con un script de implementación administrada**
  
    1.  Haga una copia de seguridad de las claves del Registro con el siguiente comando:`Regedit.exe /e application_HKCR_registry_backup.reg HKEY_CLASSES_ROOT\.applicationRegedit.exe /e application_HKCU_registry_backup.reg HKEY_CURRENT_USER\Software\Microsoft\Windows\Curr``entVersion\Explorer\FileExts\.application`  
    2.  Guarde lo siguiente en un archivo con la extensión .REG (por ejemplo, Delete\_Application\_File\_Association.reg):`Editor del Registro de Windows versión 5.00[-HKEY_CLASSES_ROOT\.application][-HKEY_CURRENT_USER\Softwar``e\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application]`  
    3.  Ejecute el script del Registro creado en el paso anteriormente con el siguiente comando:`Regedit.exe /s Delete_Application_File_Association.reg`
  
    **Consecuencias de la solución provisional.** Esta solución provisional quita la asociación de archivo .application. Al hacer doble clic en un archivo de aplicación ya no se iniciará.
    ...
    **Cómo deshacer la solución provisional.**
    ...
    3.  En el cuadro de diálogo Importar archivo del Registro, seleccione **Copia de seguridad del Registro para la asociación de archivos HKCR de aplicación.reg** y haga clic en **Abrir**.  
    4.  Haga clic en el menú **Archivo** y seleccione **Importar**.  
    5.  En el cuadro de diálogo Importar archivo del Registro, seleccione **Copia de seguridad del Registro para la asociación de archivos HKCU de aplicación.reg** y haga clic en **Abrir.**
...
#### Preguntas más frecuentes sobre la vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)
...
Esta vulnerabilidad se debe a que los tipos de archivo de aplicación ClickOnce no forman parte de la lista de tipos de archivo no seguros del Empaquetador de Windows, lo que permite que las aplicaciones ClickOnce se inserten en los documentos de Microsoft Office.
  
**¿Qué es ClickOnce?**   
ClickOnce es una tecnología de implementación que permite a los desarrolladores crear aplicaciones basadas en Windows de actualización automática que se pueden instalar y ejecutan con poca intervención del usuario. Una aplicación ClickOnce es cualquier aplicación de Windows Presentation Foundation (.xbap), Windows Forms (.exe), de consola (.exe) o solución de Office (.dll) publicada mediante la tecnología ClickOnce. Las aplicaciones ClickOnce se pueden publicar de tres formas distintas: desde una página web, desde un recurso compartido de archivos de red o desde un medio como un CD-ROM. Para obtener más información, vea el artículo de MSDN [Seguridad e implementación de ClickOnce](http://msdn.microsoft.com/es-es/library/t71a733d.aspx).
  
**¿Para qué puede usar un atacante esta vulnerabilidad?**   
Esta vulnerabilidad permite a los atacantes insertar programas de instalación de aplicaciones ClickOnce en documentos de Microsoft Office y ejecutar código sin la interacción del usuario.
  
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**   
Para aprovechar esta vulnerabilidad es necesario que un usuario abra un documento de Microsoft Office especialmente diseñado.
  
En el supuesto de un ataque por correo electrónico, un atacante podría aprovechar la vulnerabilidad si envía al usuario un archivo de Microsoft Office especialmente diseñado con una aplicación ClickOnce insertada y lo convence de que lo abra.
  
En el caso de un ataque a través de web, el atacante tendría que hospedar un sitio web que contuviera un archivo de Office destinado a intentar aprovechar esta vulnerabilidad. Además, los sitios web vulnerables y los sitios web que aceptan u hospedan contenido proporcionado por el usuario podrían incluir contenido especialmente diseñado que permita aprovechar esta vulnerabilidad. El atacante no podría obligar a los usuarios a visitar un sitio web especialmente diseñado. Por lo tanto, tendría que atraerlos al sitio web; para ello debería, por ejemplo, incitarles a hacer clic en un vínculo que les llevara al sitio del atacante y, después, convencerlos para abrir el archivo especialmente diseñado.
...
La actualización cambia la forma en que Empaquetador de Windows comprueba los archivos no seguros.
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar</strong> <strong>programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2584146">artículo 2584146 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2584146">artículo 2584146 de Microsoft Knowledge Base</a></td>
...
-   Yorick Koster, en colaboración con el programa [SecuriTeam Secure Disclosure de Beyond Security](http://www.beyondsecurity.com/ssd.html), por informar de la vulnerabilidad de ejecución de ensamblados (CVE-2012-0013)
