---
TOCTitle: 'MS12-071'
Title: 'Boletín de seguridad de Microsoft MS12-071 - Crítica'
ms:assetid: 'ms12-071'
ms:contentKeyID: 61226385
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-071(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS12-071 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (2761451)
-----------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2744842 en [MS12-063](http://technet.microsoft.com/es-es/security/bulletin/ms12-063) se reemplaza por KB2761451
</td>
</tr>
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2761451 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2761451).
...
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de CFormElement después de la liberación (CVE-2012-1538)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de CTreePos después de la liberación (CVE-2012-1539)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de CTreeNode después de la liberación (CVE-2012-4775)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1538](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538).

#### Factores atenuantes para la vulnerabilidad en el uso de CFormElement después de la liberación (CVE-2012-1538)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de CFormElement después de la liberación (CVE-2012-1538)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de CFormElement después de la liberación (CVE-2012-1538)
...
Para que se produzca una acción malintencionada, esta vulnerabilidad requiere que el usuario haya iniciado una sesión y visite un sitio web. Por lo tanto, cualquier sistema en el que se use Internet Explorer 9 de forma habitual, como estaciones de trabajo y servidores de Terminal Server, está expuesto a esta vulnerabilidad.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539).

#### Factores atenuantes para la vulnerabilidad en el uso de CTreePos después de la liberación (CVE-2012-1539)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de CTreePos después de la liberación (CVE-2012-1539)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de CTreePos después de la liberación (CVE-2012-1539)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4775](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775).

#### Factores atenuantes para la vulnerabilidad en el uso de CTreeNode después de la liberación (CVE-2012-4775)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de CTreeNode después de la liberación (CVE-2012-4775)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de CTreeNode después de la liberación (CVE-2012-4775)
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2761451">artículo 2761451 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
-   José A. Vázquez, de spa-s3c.blogspot.com, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad en el uso de CFormElement después de la liberación (CVE-2012-1538)  
-   José A. Vázquez, de spa-s3c.blogspot.com, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad en el uso de CTreePos después de la liberación (CVE-2012-1539)  
-   Cheng-da Tsai (Orange), Sung-ting Tsai y Ming-chieh Pan (Nanika), de [Trend Micro](http://www.trendmicro.com/), por informar de la vulnerabilidad en el uso de CTreeNode después de la liberación (CVE-2012-4775)
