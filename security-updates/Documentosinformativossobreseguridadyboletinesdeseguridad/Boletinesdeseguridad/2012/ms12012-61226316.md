---
TOCTitle: 'MS12-012'
Title: 'Boletín de seguridad de Microsoft MS12-012 - Importante'
ms:assetid: 'ms12-012'
ms:contentKeyID: 61226316
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-012(v=Security.10)'
---
...
Es una actualización de seguridad importante para todas las ediciones compatibles de Microsoft Windows Server 2008 y Windows Server 2008 R2. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la manera en que el Panel de control de color carga las bibliotecas externas. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------------------------------------|-----------------------------------------------|
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f6f89b3-3bc8-4325-b8d8-9a5a398b99c6)\*\*                                                    | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=35e6bd04-594f-42ef-97f8-abcf578b4f10)\*\*                                                           | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 para sistemas con Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d1d51b26-2d01-42a9-9bb1-9fb82c1fb914)                                                       | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c51e09b-51c3-4860-836e-6bcffde75f04)\*\*             | Ejecución remota de código      | Importante                          | Ninguna                                       |
| [Windows Server 2008 R2 para sistemas con Itanium y Windows Server 2008 R2 para sistemas con Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fba58a1b-9d9f-4a10-b1df-08a0ebfa2358) | Ejecución remota de código      | Importante                          | Ninguna                                       |
...
Sí, la vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082) corregida por esta actualización está relacionada con la clase de vulnerabilidades descrita en el [documento informativo sobre seguridad de Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637) que afecta al modo en que las aplicaciones cargan las bibliotecas externas. Esta actualización de seguridad corrige una determinada instancia de este tipo de vulnerabilidad.
...
Gravedad e identificadores de vulne rabilidad
---------------------------------------------
...
<th style="border:1px solid black;" >Vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082)</th>
...
Vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082)  
----------------------------------------------------------------------------------------------------
  
Existe una vulnerabilidad de ejecución remota de código en la forma en que el Panel de control de color trata la carga de archivos DLL. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082).
  
#### Factores atenuantes para la vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082)
  
El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:
  
-   Para que un ataque tenga éxito, un usuario debe visitar una ubicación de sistema de archivos o recurso compartido WebDAV remoto que no sea de confianza y abrir un archivo legítimo (como un archivo .icm o .icc).  
...
#### Soluciones provisionales para la vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:
  
-   **Instalar Experiencia de escritorio en Windows Server 2008 y Windows Server 2008 R2**
  
    Los sistemas con la característica Experiencia de escritorio instalada no están afectados por esta vulnerabilidad.
  
    Para obtener información adicional, incluidas instrucciones acerca de cómo instalar y quitar Experiencia de escritorio, vea el artículo de TechNet [Información general acerca de Experiencia de escritorio](http://technet.microsoft.com/en-us/library/cc772567.aspx).
...
#### Preguntas más frecuentes sobre la vulnerabilidad en la carga de bibliotecas no seguras en el Panel de control de color (CVE-2010-5082)
  
**¿Cuál** **es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de ejecución remota de código. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que el Panel de control de color restringe incorrectamente la ruta de acceso usada al cargar las bibliotecas externas.
  
**¿Qué es la característica Experiencia de escritorio en Windows Server 2008?**   
Hay una serie de características de escritorio, como Panel de control de color, que no se instalan de forma predeterminada en Windows Server 2008, sino que se pueden instalar de forma conjunta mediante Experiencia de escritorio en Windows Server 2008. Para obtener más información, vea el artículo de TechNet [Información general acerca de Experiencia de escritorio](http://technet.microsoft.com/en-us/library/cc772567.aspx).
...
Un atacante podría convencer a un usuario de que abra un archivo legítimo (como un archivo .icm o .icc) que se encuentre en el mismo directorio de red que un archivo de biblioteca de vínculos dinámicos (DLL) especialmente diseñado. Después, al abrir el archivo legítimo, el Panel de control de color puede intentar cargar el archivo DLL y ejecutar el código que contiene.
  
En un ataque por correo electrónico, el atacante puede aprovechar la vulnerabilidad mediante el envío de un archivo legítimo a un usuario (como un archivo .icm o .icc) y convencerle de que guarde los datos adjuntos en un directorio que contiene un archivo DLL especialmente diseñado y de que abra el archivo legítimo. Después, al abrir el archivo legítimo, el Panel de control de color puede intentar cargar el archivo DLL y ejecutar el código que contiene.
  
En un ataque de red, un atacante podría guardar un archivo legítimo (como un archivo .icm o .icc) y un archivo DLL especialmente diseñado en un recurso compartido de red o una ubicación UNC o WebDAV, y, a continuación, convencer al usuario de que abra el archivo.
  
**¿Qué sistemas están más expuestos a esta vulnerabilidad?**   
Los servidores en los que los usuarios pueden abrir archivos desde ubicaciones de red que no sean de confianza están más expuestos.
  
**¿Cómo funciona esta actualización?**   
La actualización corrige esta vulnerabilidad al modificar la manera en que el Panel de control de color carga las bibliotecas externas.
...
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082).
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2643719">artículo 2643719 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
