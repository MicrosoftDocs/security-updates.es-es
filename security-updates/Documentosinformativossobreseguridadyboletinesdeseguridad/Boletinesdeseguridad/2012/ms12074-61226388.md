---
TOCTitle: 'MS12-074'
Title: 'Boletín de seguridad de Microsoft MS12-074 - Crítica'
ms:assetid: 'ms12-074'
ms:contentKeyID: 61226388
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-074(v=Security.10)'
---

Boletín de seguridad de Microsoft MS12-074 - Crítica
====================================================

Vulnerabilidades en .NET Framework podrían permitir la ejecución remota de código (2745030)
-------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2572066 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplaza por KB2698035  
   
KB2656353 en [MS11-100](http://technet.microsoft.com/es-es/security/bulletin/ms11-100) se reemplaza por KB2698023
</td>
</tr>
...
<td style="border:1px solid black;">
KB2633880 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572073 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729450  
   
KB2633870 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572078 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729449
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2656405 en [MS12-034](http://technet.microsoft.com/es-es/security/bulletin/ms12-034) se reemplaza por KB2737019
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2572069 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplaza por KB2698032
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2633874 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572075 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729453  
   
KB2633870 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572078 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729449  
   
Ninguna actualización reemplazada por KB2729460
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
KB2656405 en [MS12-034](http://technet.microsoft.com/es-es/security/bulletin/ms12-034) se reemplaza por KB2737019  
   
Ninguna actualización reemplazada por KB2737083
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2633879 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572076 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729451  
   
KB2633870 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572078 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729449
</td>
</tr>
...
<td style="border:1px solid black;">
KB2633873 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572077 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729452  
   
KB2633870 en [MS12-016](http://technet.microsoft.com/es-es/security/bulletin/ms12-016) y KB2572078 en [MS11-078](http://technet.microsoft.com/es-es/security/bulletin/ms11-078) se reemplazan por KB2729449  
   
Ninguna actualización reemplazada por KB2729460
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2745030 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2745030).

**¿Esta actualización está relacionada con el documento informativo sobre seguridad de Microsoft 2269637?**  
Sí, la vulnerabilidad en la carga de bibliotecas no seguras en .NET Framework (CVE-2012-2519) corregida por esta actualización está relacionada con la clase de vulnerabilidades descrita en el [documento informativo sobre seguridad de Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637) que afecta al modo en que las aplicaciones cargan las bibliotecas externas. Esta actualización de seguridad corrige una determinada instancia de este tipo de vulnerabilidad.

**¿.Net Framework 4.5 Release Candidate está afectado por las vulnerabilidades corregidas en este boletín?  **
Sí. Las actualizaciones están disponibles para Microsoft .NET Framework 4.5 Release Candidate en Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8 Release Preview y Windows Server 2012 Release Candidate. Las actualizaciones también están disponibles para Microsoft .NET Framework 3.5 en Windows 8 Release Preview y Windows Server 2012 Release Candidate. Se recomienda que los usuarios que ejecutan estas configuraciones apliquen la actualización en sus sistemas. Estas actualizaciones solo están disponibles a través de [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
**Sí. Además de los cambios enumerados en la sección Información sobre la vulnerabilidad de este boletín, la actualización KB2756872 incluye otros cambios de funcionalidad, tal como se describe en el [artículo 2756872 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2756872). Tenga en cuenta que esta actualización se ofreció por primera vez el 10 de octubre de 2012. Los clientes que ya han instalado esta actualización no necesitan realizar ninguna acción y no se les volverá a ofrecer la actualización.
...
<th style="border:1px solid black;" >
Vulnerabilidad de omisión de reflejo (CVE-2012-1895)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de divulgación de información en la seguridad de acceso del código (CVE-2012-1896)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en la carga de bibliotecas no seguras en .NET Framework (CVE-2012-2519)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de detección automática en el proxy web (CVE-2012-4776)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de optimización de reflejo en WPF (CVE-2012-4777)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 cuando está instalado en Windows 7 para sistemas x64<sup>[1]</sup> \]  
(KB2737019)
</td>
<td style="border:1px solid black;">
No aplicable
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 3.5.1 en Windows Server 2008 R2 para sistemas x64 (instalación de Server Core)  
(KB2729451)
</td>
<td style="border:1px solid black;">
**Importante**   
...
<sup>[2]</sup>Las clasificaciones de gravedad no se aplican a esta actualización porque el software especificado no está afectado por la vulnerabilidad. No obstante, Microsoft recomienda que los clientes de este software apliquen la actualización como una medida de defensa en profundidad.

Vulnerabilidad de omisión de reflejo (CVE-2012-1895)
----------------------------------------------------

Existe una vulnerabilidad de elevación de privilegios en la forma en que .NET Framework valida los permisos de determinados objetos que realizan reflejo. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1895](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1895).

#### Factores atenuantes para la vulnerabilidad de omisión de reflejo (CVE-2012-1895)
...
#### Soluciones provisionales para la vulnerabilidad de omisión de reflejo (CVE-2012-1895)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de omisión de reflejo (CVE-2012-1895)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de elevación de privilegios.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que .NET Framework valida incorrectamente los permisos de los objetos que realizan reflejo.
...
Existe una vulnerabilidad de divulgación de información en Microsoft .NET Framework debida al saneamiento incorrecto de la salida cuando se llama una función desde código de confianza parcial. Un atacante que consiguiera aprovechar esta vulnerabilidad podría obtener información confidencial incluida en el sistema de destino.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-1896](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1896).

#### Factores atenuantes para la vulnerabilidad de divulgación de información en la seguridad de acceso del código (CVE-2012-1896)

Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de divulgación de información en la seguridad de acceso del código (CVE-2012-1896)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de divulgación de información en la seguridad de acceso del código (CVE-2012-1896)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Esta vulnerabilidad afecta a la divulgación de información.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que .NET Framework no realiza un saneamiento correcto de la salida de una función cuando se llama desde código de confianza parcial.

**¿Para qué puede usar un atacante esta vulnerabilidad?**  
En el escenario de exploración web, un atacante que aprovechara esta vulnerabilidad podría usar código de confianza parcial para obtener información confidencial incluida en el sistema de destino que normalmente solo estaría accesible a través de código de plena confianza.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al realizar el saneamiento correcto basándose al nivel de confianza del código de llamada.
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que Microsoft .NET Framework trata la carga de archivos DLL. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2519](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2519).

#### Factores atenuantes para la vulnerabilidad en la carga de bibliotecas no seguras en .NET Framework (CVE-2012-2519)
...
#### Soluciones provisionales para la vulnerabilidad en la carga de bibliotecas no seguras en .NET Framework (CVE-2012-2519)
...
#### Preguntas más frecuentes sobre la vulnerabilidad en la carga de bibliotecas no seguras en .NET Framework (CVE-2012-2519)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Entity Framework, un componente de .NET Framework, restringe incorrectamente la ruta de acceso empleada para cargar bibliotecas externas.

**¿Qué es Entity Framework?  **
Entity Framework es un conjunto de tecnologías en ADO.NET que respaldan el desarrollo de las aplicaciones de software orientadas a datos. Para obtener más información, vea el artículo de MSDN [Descripción general de Entity Framework](http://msdn.microsoft.com/en-us/library/bb399567.aspx).
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante podría convencer a un usuario de que abra una aplicación .NET creada con ADO.NET que se encuentre en el mismo directorio de red que un archivo de biblioteca de vínculos dinámicos (DLL) especialmente diseñado. Después, la aplicación .NET podría intentar cargar el archivo DLL y ejecutar el código que contuviera.
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que .NET Framework carga bibliotecas externas.
...
Existe una vulnerabilidad de ejecución remota de código en la forma en que .NET Framework recupera la configuración de proxy web predeterminada. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4776](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4776).

#### Factores atenuantes para la vulnerabilidad de detección automática en el proxy web (CVE-2012-4776)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Un intruso que aprovechara esta vulnerabilidad podría conseguir el mismo nivel de derechos de usuario que el usuario local. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

#### Soluciones provisionales para la vulnerabilidad de detección automática en el proxy web (CVE-2012-4776)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Configurar Internet Explorer para que no use WPAD**

    1.  Haga clic en **Inicio**, **Panel de control**, **Red e Internet** y, a continuación, en **Opciones de Internet**.
    2.  En la ventana **Propiedades de Internet**, haga clic en la pestaña **Conexiones** y, a continuación, en **Configuración de LAN**.
    3.  En la ventana **Configuración de la red de área local (LAN)**, desactive **Detectar la configuración automáticamente** y, a continuación, haga clic en **Aceptar**.

    **Consecuencias de la solución provisional.** La detección automática de proxy web se deshabilitará en Internet Explorer.

    **Cómo deshacer la solución provisional.** Siga los pasos anteriores en orden inverso y asegúrese de que la opción **Detectar la configuración automáticamente** está activada en la ventana **Configuración de la red de área local (LAN)**.

-   **Registrar WPAD**

    Siga los pasos que se indican en el [artículo 934864 de Microsoft Knowledge Base](http://support.microsoft.com/kb/934864) para registrar WPAD.

    **Consecuencias de la solución provisional.** Un administrador registrará WPAD antes de que un atacante tenga la oportunidad de hacerlo.

    **Cómo deshacer la solución provisional.** Para obtener más información, vea el [artículo 934864 de Microsoft Knowledge Base](http://support.microsoft.com/kb/934864).

-   **No basarse en la configuración de proxy web en su aplicación .NET**

    No se base en la configuración de proxy .NET predeterminada, tanto explícitamente mediante la propiedad WebRequest.DefaultWebProxy como implícitamente al no establecer el proxy (tal como se muestra a continuación) en la aplicación .NET. De forma predeterminada, esta propiedad la establece la configuración de proxy o WPAD en Internet Explorer. Los desarrolladores deben configurar explícitamente el proxy web en la aplicación de la siguiente forma:

    `IWebProxy proxy = new ``WebProxy(``"<DIRECCIÓN_IP>", <NÚMERO_DE_PUERTO>);`

    Si su aplicación .NET ya usa la propiedad DefaultWebProxy, asegúrese de que el nombre del proxy está incluido en el archivo app.config.

    Para obtener documentación sobre la propiedad WebRequest.DefaultWebProxy, vea [Propiedad WebRequest.DefaultWebProxy](http://msdn.microsoft.com/en-us/library/system.net.webrequest.defaultwebproxy.aspx).

    **Nota** Esto requiere volver a compilar e implementar las aplicaciones afectadas.

#### Preguntas más frecuentes sobre la vulnerabilidad de detección automática en el proxy web (CVE-2012-4776)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Se trata de una vulnerabilidad de ejecución remota de código.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a la falta de validación cuando .NET Framework adquiere la configuración de proxy web predeterminada y ejecuta código JavaScript incluido en el archivo de configuración automática de proxy.

**Ejecuto Microsoft .NET Framework 4.5 en Windows 8, Windows Server 2012 o Windows RT, ¿estoy afectado por este problema?  **
No, los clientes que ejecutan Microsoft .NET Framework 4.5 en Windows 8, Windows Server 2012 o Windows RT no están afectados por este problema. La actualización acumulativa de disponibilidad general de cliente de Windows 8 y Windows Server 2012 (KB2756872) que se publicó el 10 de octubre de 2012 contiene cambios de defensa en profundidad adicionales. Se recomienda a los clientes que todavía no hayan instalado esta actualización que lo hagan como medida de defensa en profundidad. Vea la sección Más información en el [artículo 2745030 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2745030) para obtener más detalles. Para obtener los vínculos de descarga y más información, vea el [artículo 2756872 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2756872). Tenga en cuenta que esta actualización contiene contenido no relacionado con la seguridad.
...
**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
En un atacante del tipo "Man in the middle", un atacante puede suplantar el contenido o la ubicación de un archivo de configuración automática de proxy (PAC) y, a continuación, insertar código en la aplicación que se esté ejecutando, omitiendo las restricciones de seguridad de acceso del código (CAS).

Si el atacante tiene acceso a la red local, podría suplantar la ubicación del archivo PAC mediante un ataque de tipo "poisoning" en la memoria caché del protocolo de resolución de direcciones (ARP), con lo que se redireccionarían las solicitudes del archivo WPAD a una dirección controlada por el atacante mediante la suplantación del servicio de nombres NetBIOS (NBNS), por lo que la aplicación destino se redireccionaría a un archivo PAC malintencionado hospedado en un servidor propiedad del atacante.

El aprovechamiento de la vulnerabilidad se podría producir si el atacante puede convencer a un usuario de que se conecte a un servidor fuera de los límites de la organización. Los escenarios específicos que pueden permitir que se produzca esta situación son los siguientes:

-   Devolución de DNS: una característica del cliente DNS de Windows que permite que los clientes DNS de Windows resuelvan las consultas DNS para los nombres de host de una sola etiqueta e incompletos. Un usuario malintencionado podría registrar un nombre de host específico fuera del límite de la organización con el que, si los clientes están configurados incorrectamente, un cliente podría ponerse involuntariamente en contacto cuando realiza la devolución fuera del límite de la organización mientras intenta obtener acceso a ese nombre de host.
-   Suplantación de DNS: el atacante podría aprovechar las vulnerabilidades en el sistema de nombres de domino (DNS) de Windows, lo que permitiría la suplantación de identidad. Estos ataques podrían permitir que un atacante remoto redireccionara el tráfico de red destinado a sistemas en Internet a su propio sistema.

**¿Qué son las restricciones de seguridad de acceso del código (CAS) de .NET Framework?**  
.NET Framework proporciona un mecanismo de seguridad denominado seguridad de acceso del código para proteger los equipos del código móvil malintencionado, para permitir que el código de origen desconocido se ejecute con protección y para prevenir que el código de confianza ponga en peligro la seguridad de forma intencionada o accidental. La seguridad de acceso del código (CAS) habilita el código para que se confíe en él en diferentes grados, según de dónde se origine y otros aspectos de la identidad del código. La seguridad de acceso del código también aplica niveles variables de confianza en el código, lo que minimiza la cantidad de código en el que se debe confiar completamente para que se ejecute. El uso de la seguridad de acceso del código puede reducir la probabilidad de que el código se use de forma incorrecta por parte de un código malintencionado o repleto de errores. Para obtener más información acerca de CAS, vea el artículo de MSDN [Seguridad de acceso del código](http://msdn.microsoft.com/en-us/library/c5tk9z76.aspx).

**¿Qué es la detección automática de proxy web (WPAD)?  **
La característica Detección automática de proxy web (WPAD) permite a los clientes web detectar automáticamente la configuración de proxy sin intervención del usuario. La característica WPAD antepone el nombre de host "wpad" al nombre de dominio completo y progresivamente quita subdominios hasta que encuentra un servidor WPAD que responde al nombre de dominio. Para obtener más información, vea [Compatibilidad con WinHTTP AutoProxy](http://msdn.microsoft.com/en-us/library/system.net.webproxy.getdefaultproxy(v=vs.110).aspx).
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al actualizar Microsoft.Jscript en System.Net y al restringir el modo en que .NET Framework ejecuta el código JavaScript incluido en un archivo de configuración WPAD. La actualización también cambia la forma en que se trata WPAD mediante el uso de WinHTTP en vez de Microsoft.Jscript. Este cambio, aunque improbable, puede provocar problemas de compatibilidad para entornos que tengan entornos de configuración automática de proxy no estándar. Para obtener más información acerca de este cambio, vea el [artículo 2745030 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2745030).
...
Existe una vulnerabilidad de elevación de privilegios en la forma en que .Net Framework valida los permisos de los objetos que intervienen en el reflejo. Un atacante que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario. Los usuarios cuyas cuentas estén configuradas con menos derechos de usuario en el sistema correrían un riesgo menor que los que cuenten con derechos de usuario administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4777](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4777).

#### Factores atenuantes para la vulnerabilidad de optimización de reflejo en WPF (CVE-2012-4777)
...
#### Soluciones provisionales para la vulnerabilidad de optimización de reflejo en WPF (CVE-2012-4777)
...
#### Preguntas más frecuentes sobre la vulnerabilidad de optimización de reflejo en WPF (CVE-2012-4777)
...
**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que .NET Framework optimiza el código en la memoria.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2745030">artículo 2745030 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 en todas las ediciones de 32 bits compatibles de Windows Server 2008:<br />
Windows6.0-KB2729453-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 en todas las ediciones x64 compatibles de Windows Server 2008:<br />
Windows6.0-KB2729453-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.5 cuando está instalado en todas las ediciones x64 compatibles de Windows 2008:<br />
NDP45-KB2729460-x64.exe /quiet<br />
NDP45-KB2737083-x64.exe /quiet</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones de 32 bits compatibles de Windows 2008 R2:<br />
<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2729449\<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;<br />
 <br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones x64 y con Itanium compatibles de Windows Server 2008 R2:<br />
<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2729449\<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;<br />
 <br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>implementación</strong></td>
<td style="border:1px solid black;">Las actualizaciones para Windows RT solo están disponibles a través de <a href="http://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Información adicional</td>
<td style="border:1px solid black;">Vea la subsección <strong>Herramientas y consejos de detección e implementación</strong></td>
...
Las actualizaciones para Windows RT solo están disponibles a través de [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
-   James Forshaw, de Context Information Security, por informar de la vulnerabilidad de omisión de reflejo (CVE-2012-1895)
-   James Forshaw, de Context Information Security, por informar de la vulnerabilidad de divulgación de información en la seguridad de acceso del código (CVE-2012-1896)
-   James Forshaw, de Context Information Security, por informar de la vulnerabilidad de detección automática en el proxy web (CVE-2012-4776)
-   James Forshaw, de Context Information Security, por informar de la vulnerabilidad de optimización de reflejo en WPF (CVE-2012-4777)
...
-   V1.1 (14 de noviembre de 2012): se ha corregido la clasificación de gravedad agregada para Microsoft .NET Framework 4.5 en Windows Server 2012 (instalación Server Core) en la tabla Gravedad. Se trata únicamente de un cambio de boletín. La clasificación de gravedad para esta configuración no ha cambiado.
