---
TOCTitle: 'MS12-075'
Title: 'Boletín de seguridad de Microsoft MS12-075 - Crítica'
ms:assetid: 'ms12-075'
ms:contentKeyID: 61226389
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-075(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS12-075 - Crítica
====================================================

Vulnerabilidades en los controladores en modo kernel de Windows podrían permitir la ejecución remota de código (2761226)
------------------------------------------------------------------------------------------------------------------------

Publicado: martes, 13 de noviembre de 2012 | Actualizado: martes, 13 de noviembre de 2012
...
<td style="border:1px solid black;">
KB2731847 en [MS12-055](http://technet.microsoft.com/es-es/security/bulletin/ms12-055) se reemplaza por KB2761226
</td>
</tr>
...
<td style="border:1px solid black;">
KB2731847 en [MS12-055](http://go.microsoft.com/fwlink/?linkid=257907) se reemplaza por KB2761226
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17b987db-0551-45c3-aab1-0cc11ae60dcc) (instalación de Server Core)  
(KB2761226)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dd9bd994-41e3-46a1-9dfb-c6d89a3ef883) (instalación de Server Core)  
(KB2761226)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=114b596c-36e1-45f5-99e2-f5fdd96b1a30)(instalación de Server Core)  
(KB2761226)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=114b596c-36e1-45f5-99e2-f5fdd96b1a30) (instalación de Server Core)  
(KB2761226)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=2e69d496-25b4-4f24-97e0-47cb59c178aa) (instalación de Server Core)  
(KB2761226)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2761226 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2761226).
...
Sí. La actualización KB2761226 está disponible para Windows 8 Release Preview y Windows Server 2012 Release Candidate. Se recomienda que los usuarios con Windows 8 Release Preview y Windows Server 2012 Release Candidate apliquen las actualizaciones a sus sistemas. Las actualizaciones solo están disponibles en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2530)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2553)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de análisis de fuentes TrueType (CVE-2012-2897)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530).

#### Factores atenuantes para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2530)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2530)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2530)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553).

#### Factores atenuantes para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2553)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.

#### Soluciones provisionales para la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2553)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de Win32k después de la liberación (CVE-2012-2553)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897).

#### Factores atenuantes para la vulnerabilidad de análisis de fuentes TrueType (CVE-2012-2897)
...
#### Soluciones provisionales para la vulnerabilidad de análisis de fuentes TrueType (CVE-2012-2897)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de análisis de fuentes TrueType (CVE-2012-2897)

**¿Cuál es el alcance de esta vulnerabilidad?** 
Se trata de una vulnerabilidad de ejecución remota de código

**¿Cuál es la causa de esta vulnerabilidad?** 
La vulnerabilidad se debe a que Windows no trata correctamente las fuentes TrueType (TTF) especialmente diseñadas.
...
**¿Cómo funciona esta actualización?** 
La actualización corrige la vulnerabilidad al modificar la forma en que Windows trata los archivos de fuentes TrueType especialmente diseñados.
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en las siguientes carpetas: %Windir%\$NTUninstallKB2761226$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2761226">artículo 2761226 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
| **Informaciónsobre** **la** **eliminación**    | Haga clic en **Panel de control**, haga clic en **Sistema y seguridad**, y, a continuación, en Windows Update, haga clic en **Ver actualizaciones instaladas** y haga su selección en la lista de actualizaciones. |  
| **Informaciónsobrearchivos**                   | Vea el [artículo 2761226 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2761226).                                                                                                                    |
...
-   Matthew Jurczyk, de [Google Inc](http://www.google.com), por informar de la vulnerabilidad en el uso de win32k.sys después de la liberación en el kernel de Windows (CVE-2012-2553)  
-   Eetu Luodemaa y Joni Vähämäki, de [Documill](http://www.documill.com), en colaboración con Chromium Security Rewards Program, por informar de la vulnerabilidad de análisis de fuentes TrueType (CVE-2012-2897)
...
-   V1.1 (13 de noviembre de 2012): se han corregido el título de la vulnerabilidad y las entradas de las preguntas más frecuentes para CVE-2012-2897. Se trata únicamente de un cambio informativo.
