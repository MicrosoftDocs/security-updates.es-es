---
TOCTitle: 'MS12-056'
Title: 'Boletín de seguridad de Microsoft MS12-056 - Importante'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61226370
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-056(v=Security.10)'
---
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Baja</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Baja</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 y VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">Ejecución remota de código</td>
<td style="border:1px solid black;">Baja</td>
<td style="border:1px solid black;">KB2510531 en <a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> se reemplaza por KB2706045</td>
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2706045 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2706045).
...
**¿Cómo está relacionada esta actualización de seguridad con MS12-052?** 
La vulnerabilidad de ejecución remota de código en desbordamiento de enteros en JavaScript (CVE-2012-2523) descrita en este boletín también se corrige en [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327).

Los clientes con Internet Explorer 8 instalado en sus sistemas deben instalar la actualización KB2706045, que se describe en este boletín, a fin de estar protegidos de la vulnerabilidad descrita en CVE-2012-2523.

Los clientes con Internet Explorer 9 instalado en sus sistemas deben instalar la actualización KB2722913, que se describe en [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327), a fin de estar protegidos de la vulnerabilidad descrita en CVE-2012-2523.

**¿Cómo determino las versiones de los motores de scripting de** **JScript** **y VBScript que están instaladas en mi sistema?** 
Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 incluyen los motores de scripting JScript 5.8 y VBScript 5.8. El paquete de actualización KB2706045 actualiza las versiones de Internet Explorer 8 de JScript y VBScript. El paquete de actualización KB2722913, que se describe en MS12-052, actualiza las versiones de Internet Explorer 9. Las versiones de Internet Explorer 10 ya están actualizadas y no requieren esta actualización.
...
<th style="border:1px solid black;" >Vulnerabilidad de ejecución remota de código en desbordamiento de enteros en JavaScript (CVE-2012-2523)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2008 para sistemas x64 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows 7 para sistemas x64</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows 7 para sistemas x64 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2008 R2 para sistemas x64</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2008 R2 para sistemas x64 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2008 R2 para sistemas con Itanium</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en Windows Server 2008 R2 para sistemas con Itanium Service Pack 1</td>
<td style="border:1px solid black;"><strong>Baja</strong> <br />
Ejecución remota de código</td>
<td style="border:1px solid black;"><strong>Baja</strong></td>
</tr>
...
<span></span>
Existe una vulnerabilidad de ejecución remota de código en la forma en que los motores JScript y VBScript calculan el tamaño de un objeto en memoria durante una operación de copia. La vulnerabilidad podría dañar la memoria de manera que un atacante pudiera ejecutar código arbitrario en el contexto del usuario actual. Si el usuario actual inicia sesión con derechos de usuario administrativos, un intruso que aprovechara esta vulnerabilidad podría lograr el control completo de un sistema afectado. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos de usuario.
...
La vulnerabilidad se debe a que el motor JScript calcula incorrectamente el tamaño de un objeto en memoria durante una operación de copia.
...
Los sistemas en los que se usen Internet Explorer 8 e Internet Explorer 9 con frecuencia, como las estaciones de trabajo o los servidores de Terminal Server, están más expuestos a esta vulnerabilidad.
...
#### Windows XP (ediciones de 64 bits)
...
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows XP:<br />
...
<td style="border:1px solid black;">Para JScript 5.8 y VBScript 5.8: KB2706045-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Para JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2706045-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2706045">artículo 2706045 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows Server 2003:<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Para JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2706045-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
...
#### Windows Vista (ediciones de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows Vista:<br />
...
#### Windows Server 2008 (ediciones de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows Server 2008:<br />
IE8-Windows6.0-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
...
#### Windows 7 (ediciones de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows 7:<br />
...
#### Windows Server 2008 R2 (ediciones de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalación sin intervención del usuario</td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones x64 compatibles de Windows Server 2008 R2:<br />
Windows6.1-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 y VBScript 5.8 en todas las ediciones con Itanium compatibles de Windows Server 2008 R2:<br />
