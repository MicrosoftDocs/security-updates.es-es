---
TOCTitle: 'MS12-068'
Title: 'Boletín de seguridad de Microsoft MS12-068 - Importante'
ms:assetid: 'ms12-068'
ms:contentKeyID: 61226382
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-068(v=Security.10)'
---
...
<td style="border:1px solid black;">
KB2707511 en [MS12-042](http://technet.microsoft.com/es-es/security/bulletin/ms12-042) se reemplaza por KB2724197
</td>
</tr>
...
<td style="border:1px solid black;">
KB971486 en [MS09-058](http://technet.microsoft.com/es-es/security/bulletin/ms12-058) se reemplaza por KB2724197
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB979683 en [MS10-021](http://technet.microsoft.com/es-es/security/bulletin/ms10-021) se reemplaza por KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2633171 en [MS11-098](http://technet.microsoft.com/es-es/security/bulletin/ms11-098) se reemplaza por KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2556532 en [MS11-068](http://technet.microsoft.com/es-es/security/bulletin/ms11-068) se reemplaza por KB2724197
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2556532 en [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) se reemplaza por KB2724197
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2709715 en [MS12-042](http://technet.microsoft.com/es-es/security/bulletin/ms12-042) se reemplaza por KB2724197
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=526f786b-7aef-4a1f-b03d-587baadf3f5b) (instalación de Server Core)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5697076c-541f-42b7-8dc3-e8bd4a25fda8) (instalación de Server Core)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f)(instalación de Server Core)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f) (instalación de Server Core)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevación de privilegios
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2724197 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2724197).
...
<th style="border:1px solid black;" >
Vulnerabilidad de desbordamiento de enteros en el kernel de Windows (CVE-2012-2529)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2529).

#### Factores atenuantes para la vulnerabilidad de desbordamiento de enteros en el kernel de Windows (CVE-2012-2529)
...
#### Soluciones provisionales para la vulnerabilidad de desbordamiento de enteros en el kernel de Windows (CVE-2012-2529)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de desbordamiento de enteros en el kernel de Windows (CVE-2012-2529)
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2724197$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2724197">artículo 2724197 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
WindowsServer2003-KB2724197-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
WindowsServer2003-KB2724197-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2724197-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2724197-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2724197.log</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2724197\Filelist</td>
</tr>
</tbody>
</table>
...
-   Un investigador anónimo, en colaboración con [VeriSign iDefense Labs](http://labs.idefense.com/), por informar de la vulnerabilidad de desbordamiento de enteros en el kernel de Windows (CVE-2012-2529)
