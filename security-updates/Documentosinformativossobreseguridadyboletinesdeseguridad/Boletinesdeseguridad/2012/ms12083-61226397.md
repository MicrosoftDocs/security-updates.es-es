---
TOCTitle: 'MS12-083'
Title: 'Boletín de seguridad de Microsoft MS12-083 - Importante'
ms:assetid: 'ms12-083'
ms:contentKeyID: 61226397
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-083(v=Security.10)'
---

Boletín de seguridad de Microsoft MS12-083 - Importante
=======================================================

Una vulnerabilidad en el componente IP-HTTPS podría permitir la omisión de característica de seguridad (2765809)
----------------------------------------------------------------------------------------------------------------
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que Microsoft Windows comprueba la validez de los certificados. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2765809 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2765809).
...
<th style="border:1px solid black;" >
Vulnerabilidad de omisión de certificado revocado (CVE-2012-2549)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de omisión de la característica de seguridad en Windows debida a la forma en que el componente IP-HTTPS trata los certificados. Un atacante que consiguiera aprovechar esta vulnerabilidad podría omitir las comprobaciones de validez de los certificados.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549).

#### Factores atenuantes para la vulnerabilidad de omisión de certificado revocado (CVE-2012-2549)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, el atacante debe poseer un certificado emitido desde el dominio.
-   Para el inicio de sesión en un sistema interno de la organización seguiría siendo necesario contar con credenciales del sistema o del dominio.

#### Soluciones provisionales para la vulnerabilidad de omisión de certificado revocado (CVE-2012-2549)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Deshabilite las cuentas del equipo del dominio asociadas con certificados de cliente.**

    Para obtener instrucciones sobre cómo deshabilitar las cuentas del equipo en Windows Server 2008 R2 y Windows Server 2012, vea [Habilitación o deshabilitación de cuentas de equipo](http://technet.microsoft.com/en-us/library/cc732965.aspx).

    Para obtener instrucciones sobre el uso de una secuencia de comandos para deshabilitar varias cuentas de equipo, vea [Deshabilitar cuentas de equipo](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c).

#### Preguntas más frecuentes para la vulnerabilidad de omisión de certificado revocado (CVE-2012-2549)

**¿Cuál es el alcance de esta vulnerabilidad?**  
Es una vulnerabilidad de omisión de característica de seguridad.

**¿Cuál es la causa de esta vulnerabilidad?**  
La vulnerabilidad se debe a que Windows no comprueba correctamente la validez de los certificados.

**¿Cuál es el componente afectado por esta vulnerabilidad?**  
IP-HTTPS es el componente de Windows afectado por esta vulnerabilidad.

**¿Qué es IP-HTTPS?  
**IP sobre HTTPS (IP-HTTPS) es un protocolo que permite el establecimiento de túneles IP seguros mediante conexiones HTTP. Se utiliza habitualmente en las implementaciones de Microsoft DirectAccess. Para obtener más información, vea [Protocolo de túnel IP sobre HTTPS (IP-HTTPS)](http://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx).

**¿Qué** **es** **DirectAccess?  
**DirectAccess, introducido en los sistemas operativos Windows 7 y Windows Server 2008 R2, permite a los usuarios remotos acceder con seguridad a recursos compartidos empresariales, sitios web y aplicaciones a través de protocolos seguros como IP-HTTPS. Para obtener más información, vea [DirectAccess](http://technet.microsoft.com/en-us/network/dd420463.aspx).

**¿Para qué puede usar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría omitir una característica de seguridad basada en la validez de certificados.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
La vulnerabilidad podría permitir la omisión de características de seguridad si un atacante presenta un certificado revocado a una aplicación o servicio que usa el componente IP-HTTPS.

**¿Qué sistemas están más expuestos a esta vulnerabilidad?**  
Los servidores están expuestos a esta vulnerabilidad.

**¿Cómo funciona esta actualización?**  
La actualización corrige la vulnerabilidad al modificar la forma en que Microsoft Windows comprueba la validez de los certificados.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2765809">artículo 2765809 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
