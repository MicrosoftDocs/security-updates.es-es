---
TOCTitle: 'MS12-017'
Title: 'Boletín de seguridad de Microsoft MS12-017 - Importante'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61226327
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms12-017(v=Security.10)'
---
...
Publicado: martes, 13 de marzo de 2012 | Actualizado: miércoles, 18 de abril de 2012
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el servidor DNS trata los objetos en memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2647170 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2647170) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="http://technet.microsoft.com/es-es/security/bulletin/ms12-009">MS12-009</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 con SP2 para sistemas con Itanium</a></td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="http://technet.microsoft.com/es-es/security/bulletin/ms12-009">MS12-009</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008 para sistemas x64 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-058">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 para sistemas x64 y Windows Server 2008 R2 para sistemas x64 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Denegación de servicio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/es-es/security/bulletin/ms11-058">MS11-058</a></td>
</tr>
...
La actualización sólo se puede instalar si DNS está habilitado en los sistemas operativos enumerados en la tabla Software afectado. De forma predeterminada, DNS no está habilitado en estos sistemas operativos, por lo que la actualización no se ofrecerá a menos que se haya habilitado.
...
<th style="border:1px solid black;" >Vulnerabilidad de denegación de servicio en DNS (CVE-2012-0006)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidad de denegación de servicio en DNS (CVE-2012-0006)  
---------------------------------------------------------------
  
<span></span>
Existe una vulnerabilidad de denegación de servicio en la forma incorrecta en que el servidor DNS trata los objetos en memoria al buscar el registro de recurso de un dominio. Un atacante que aproveche esta vulnerabilidad podría provocar que el servidor DNS en el sistema de destino deje de responder y se reinicie automáticamente.
  
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006).
  
#### Factores atenuantes para la vulnerabilidad de denegación de servicio en DNS (CVE-2012-0006)
  
Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.
  
#### Soluciones provisionales para la vulnerabilidad de denegación de servicio en DNS (CVE-2012-0006)
  
La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:
  
-   **Borrar la memoria caché de DNS periódicamente**
  
    Ejecute el siguiente comando dnscmd tal como se describe en el artículo [Sintaxis de Dnscmd](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx):
  
    `dnscmd [NombreDeServidor] /clearcache`
  
    Se puede ejecutar como una tarea programada o según sea necesario.
  
    **Consecuencias de la solución provisional.** Borrar la memoria caché de DNS de los registros de recurso en el servidor DNS especificado.
  
    **Cómo deshacer la solución provisional.**
  
    Elimine o deshabilite cualquier tarea programada que ejecute el comando dnscmd.
  
#### Preguntas más frecuentes sobre la vulnerabilidad de denegación de servicio en DNS (CVE-2012-0006)
  
**¿Cuál es el alcance de esta vulnerabilidad?**   
Se trata de una vulnerabilidad de denegación de servicio.
  
**¿Cuál es la causa de esta vulnerabilidad?**   
La vulnerabilidad se debe a que el servidor DNS trata incorrectamente los objetos en memoria al buscar un registro de recurso.
...
Un atacante no autenticado podría aprovechar esa vulnerabilidad si envía una consulta DNS especialmente diseñada al servidor DNS de destino.
...
La actualización corrige la vulnerabilidad al modificar la forma en que el servidor DNS trata los objetos en memoria.
...
WindowsServer2003-KB2647170-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB2647170-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2647170-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalación sin reiniciar</td>
<td style="border:1px solid black;">Para todas las ediciones de 32 bits compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2647170-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones x64 compatibles de Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB2647170-x64-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas las ediciones con Itanium compatibles de Windows Server 2003:<br />
WindowsServer2003-KB2647170-ia64-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Actualizar archivo de registro</td>
<td style="border:1px solid black;">KB2647170.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2647170$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2647170">artículo 2647170 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del Registro</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2647170\Filelist</td>
</tr>
</tbody>
</table>
...
-   V1.1 (18 de abril de 2012): Se ha agregado un vínculo al artículo 2647170 de Microsoft Knowledge Base en Problemas conocidos del resumen ejecutivo y se ha corregido la información de reemplazo de boletín para Windows Server 2003 Service Pack 2, Windows Server 2003 x64 Edition Service Pack 2 y Windows Server 2003 con SP2 para sistemas con Itanium. Se trata únicamente de un cambio de boletín. No había cambios en la detección o en los archivos de la actualización de seguridad.
