...
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Elevación de privilegios</strong></p></td>
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Elevación de privilegios</strong></p></td>
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Elevación de privilegios</strong></p></td>
...
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Divulgación de información</strong></p></td>
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Divulgación de información</strong></p></td>
<td style="border:1px solid black;"><p>Clientes y servidores de Windows:<br />
<strong>Importante/Divulgación de información</strong></p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>NOMBRE DE CVE</strong></p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1770">CVE-2014-1770</a></p></td>
<td style="border:1px solid black;"><p>Sí. Esta vulnerabilidad ya se ha divulgado públicamente.</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1772">CVE-2014-1772</a></p></td>
<td style="border:1px solid black;"><p>No</p></td>
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2957689$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2957689-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones de 32 bits y x64 compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2957689-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea el <a href="https://support.microsoft.com/kb/2957689">artículo 2957689 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
