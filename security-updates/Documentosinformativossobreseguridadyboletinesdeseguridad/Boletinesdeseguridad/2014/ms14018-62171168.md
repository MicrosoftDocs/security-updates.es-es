...
<td style="border:1px solid black;"><p><strong>Internet Explorer 6 para las ediciones compatibles de Windows Server 2003</strong></p></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><p>Vulnerabilidad de daños en la memoria relacionada con Internet Explorer</p></td>
<td style="border:1px solid black;"><p><strong>Crítica</strong><br />
Ejecución remota de código</p></td>
<td style="border:1px solid black;"><p><strong>Moderada</strong><br />
Ejecución remota de código</p></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><p><strong>Número CVE</strong></p></td>
<td style="border:1px solid black;"><p><strong>Título de vulnerabilidad</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 10 para las ediciones compatibles de Windows 7</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 10 para las ediciones compatibles de Windows Server 2008 R2</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 10 para las ediciones compatibles de Windows 8</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 10 para las ediciones compatibles de Windows Server 2012</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 10 para Windows RT</strong></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p><strong>Clasificación de gravedad acumulada</strong></p></td>
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p><strong>Ninguna</strong></p></td>
<td style="border:1px solid black;"><p><strong>Ninguna</strong></p></td>
<td style="border:1px solid black;"><p><strong>Ninguna</strong></p></td>
<td style="border:1px solid black;"><p><strong>Ninguna</strong></p></td>
<td style="border:1px solid black;"><p><strong>Ninguna</strong></p></td>
...
<td style="border:1px solid black;"><p><strong>Número CVE</strong></p></td>
<td style="border:1px solid black;"><p><strong>Título de vulnerabilidad</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 11 para las ediciones compatibles de Windows 7</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 11 para las ediciones compatibles de Windows Server 2008 R2</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 11 para las ediciones compatibles de Windows 8.1</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 11 para las ediciones compatibles de Windows Server 2012 R2</strong></p></td>
<td style="border:1px solid black;"><p><strong>Internet Explorer 11 para Windows RT 8.1</strong></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p><strong>Clasificación de gravedad acumulada</strong></p></td>
<td style="border:1px solid black;"><p><strong> </strong></p></td>
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones de 32 bits compatibles de Windows XP:<br />
<strong>WindowsXP-KB2936068-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones x64 compatibles de Windows XP:<br />
<strong>WindowsServer2003.WindowsXP-KB2936068-x64-ENU.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones de 32 bits compatibles de Windows XP:<br />
<strong>IE7-WindowsXP-KB2936068-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones x64 compatibles de Windows XP:<br />
<strong>IE7-WindowsServer2003.WindowsXP-KB2936068-x64-ENU.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones de 32 bits compatibles de Windows XP:<br />
<strong>IE8-WindowsXP-KB2936068-x86-ENU.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones x64 compatibles de Windows XP:<br />
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
KB2936068.log</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
KB2936068-IE7.log</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2936068$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2936068-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2936068-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
...
(Se trata de una actualización no relacionada con la seguridad. Vea las preguntas más frecuentes de la actualización para obtener más detalles.)</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 en todas las ediciones compatibles de Windows 7:<br />
Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones compatibles de Windows 7:<br />
Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong>Comprobación de las claves del Registro</strong></p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 en todas las ediciones compatibles de Windows 2008 R2:<br />
Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones compatibles de Windows Server 2008 R2:<br />
Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Comprobación de las claves del Registro</strong></p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones de 64 bits compatibles de Windows 8.1:<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 10 en todas las ediciones compatibles de Windows 8:<br />
Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones compatibles de Windows 8.1: Vea el <a href="https://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p><strong>Comprobación de las claves del Registro</strong></p></td>
<td style="border:1px solid black;"><p><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</p></td>
...
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones compatibles de Windows Server 2012 R2:<br />
Vea el <a href="http://support.microsoft.com/kb/2936068">artículo 2936068 de Microsoft Knowledge Base</a></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong>Comprobación de las claves del Registro</strong></p></td>
<td style="border:1px solid black;"><p><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</p></td>
...
<td style="border:1px solid black;"><p>Para Internet Explorer 10 en todas las ediciones compatibles de Windows RT:<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><strong> </strong></p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 11 en todas las ediciones compatibles de Windows RT 8.1:<br />
La actualización 2936068 está disponible a través de <a href="http://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a>.</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Requisito de reinicio</strong></p></td>
<td style="border:1px solid black;"><p>Sí, debe reiniciar el sistema después de aplicar esta actualización de seguridad.</p></td>
