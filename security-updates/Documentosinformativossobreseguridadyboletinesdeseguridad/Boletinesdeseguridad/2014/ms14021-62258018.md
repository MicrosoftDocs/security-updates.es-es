...
<th><p>Última actualización acumulativa que se debe aplicar antes de instalar la actualización MS14-021</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=393743">MS14-018</a> (tenga en cuenta que se trata una actualización no relacionada con la seguridad para Internet Explorer 10)</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p>Internet Explorer 11 en Windows 7 o Windows Server 2008 R2</p></td>
<td style="border:1px solid black;"><p>Para la actualización 2964444: <a href="http://go.microsoft.com/fwlink/?linkid=392064">MS14-012</a> (tenga en cuenta que MS14-018 no es una actualización acumulativa para Internet Explorer 11)<br />
<br />
Para la actualización 2964358: <a href="https://support.microsoft.com/kb/2929437">2929437</a></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p>Internet Explorer 11 en Windows 8.1, Windows Server 2012 R2 o Windows RT 8.1</p></td>
<td style="border:1px solid black;"><p>Para la actualización 2964444: <a href="http://go.microsoft.com/fwlink/?linkid=392064">MS14-012</a> (tenga en cuenta que MS14-018 no es una actualización acumulativa para Internet Explorer 11)<br />
<br />
Para la actualización 2964358: <a href="https://support.microsoft.com/kb/2919355">2919355</a></p></td>
</tr>
</tbody>
</table>
<p> </p>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1776">CVE-2014-1776</a></p></td>
<td style="border:1px solid black;"><p>Sí. Esta vulnerabilidad se describió por primera vez en el <a href="https://technet.microsoft.com/library/security/2963983">documento informativo sobre seguridad de Microsoft 2963983</a>.</p></td>
</tr>  
</tbody>  
</table>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1776">CVE-2014-1776</a></p></td>
<td style="border:1px solid black;"><p>Sí. Microsoft tiene constancia de ataques limitados y dirigidos que intentan aprovechar esta vulnerabilidad en Internet Explorer.</p></td>
</tr>  
</tbody>  
</table>
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2964358$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2964358-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2964358-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea el <a href="https://support.microsoft.com/kb/2964358">artículo 2964358 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea los artículos <a href="https://support.microsoft.com/kb/2964358">2964358</a> o <a href="https://support.microsoft.com/kb/2964444">2964444</a> de Microsoft Knowledge Base</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Comprobación de las claves del Registro</strong></p></td>
<td style="border:1px solid black;"><p><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</p></td>
