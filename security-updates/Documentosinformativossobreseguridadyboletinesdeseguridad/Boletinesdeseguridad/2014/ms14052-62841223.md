...
<strong>Baja/Divulgación de información</strong></p></td>
<td style="border:1px solid black;"><p>Clientes de Windows:<br />
<strong>Importante/Divulgación de información<br />  
</strong><br />  
Servidores de Windows:<br />
...
Servidores de Windows:<br />
<strong>Moderada/Denegación de servicio</strong></p></td>
<td style="border:1px solid black;"><p>Clientes de Windows:<br />
<strong>Moderada/Denegación de servicio<br />  
</strong><br />  
Servidores de Windows:<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-7331">CVE-2013-7331</a></p></td>
<td style="border:1px solid black;"><p>Sí. Microsoft tiene constancia de ataques activos y limitados que intentan aprovechar esta vulnerabilidad.</p></td>
</tr>  
</tbody>  
</table>
...
<td style="border:1px solid black;"><p>Para Internet Explorer 6 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2977629$\Spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 7 para todas las ediciones de 32 bits, x64 y con Itanium compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2977629-IE7\spuninst</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p> </p></td>
<td style="border:1px solid black;"><p>Para Internet Explorer 8 para todas las ediciones de 32 bits y x64 compatibles de Windows Server 2003:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2977629-IE8\spuninst</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea el <a href="https://support.microsoft.com/kb/2976627">artículo 2977629 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
