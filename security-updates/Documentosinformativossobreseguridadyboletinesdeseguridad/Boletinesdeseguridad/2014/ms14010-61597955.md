...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Versión</strong></td>
...
(Internet Explorer 6 excepto en Windows XP Service Pack 3)</td>
<td style="border:1px solid black;">VBScript 5.6 <br />
(2909213)</td>
...
(Internet Explorer 6 en Windows XP Service Pack 3 e Internet Explorer 7)</td>
<td style="border:1px solid black;">VBScript 5.7 <br />
(2909212)</td>
<td style="border:1px solid black;">No aplicable</td>
</tr>
...
<td style="border:1px solid black;"><strong>Baja<br />
</strong>Divulgación de información</td>
<td style="border:1px solid black;"><strong>Importante<br />
</strong>Divulgación de información</td>
<td style="border:1px solid black;"><strong>Baja<br />
...
<td style="border:1px solid black;">Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2909921$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2909921-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2909921-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="https://support.microsoft.com/kb/2909921">artículo 2909921 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
