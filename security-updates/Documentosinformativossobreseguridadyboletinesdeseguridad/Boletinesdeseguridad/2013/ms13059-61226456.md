---
TOCTitle: 'MS13-059'
Title: 'Boletín de seguridad de Microsoft MS13-059 - Crítica'
ms:assetid: 'ms13-059'
ms:contentKeyID: 61226456
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-059(v=Security.10)'
---
...
| Artículo de Knowledge Base | [2862772](https://support.microsoft.com/kb/2862772) |
|----------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2846071 en [MS13-055](http://go.microsoft.com/fwlink/?linkid=309324)
</td>
</tr>
...
**¿Internet Explorer 11 Preview en las versiones** **Windows 8.1 Preview y Windows RT** **8.1** **Preview está afectado por alguna de las vulnerabilidades corregidas en este** **boletín?**
Sí. La actualización 2862772 está disponible para Internet Explorer 11 Preview en las versiones Windows 8.1 Preview y Windows RT 8.1. Se recomienda que los usuarios con Windows 8.1 Preview y Windows RT 8.1 Preview apliquen las actualizaciones a sus sistemas. Las actualizaciones están disponibles en Windows Update.
...
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3184)
</th>
<th>
Vulnerabilidad de asignación de nivel de integridad de proceso (CVE-2013-3186)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3187)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3188)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3189)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3190)
</th>
</tr>
<tr>
<th colspan="7">
...
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3191)
</th>
<th>
Vulnerabilidad de codificación de caracteres EUC-JP (CVE-2013-3192)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3193)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3194)
</th>
<th>
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3199)
</th>
<th>
Clasificación de gravedad acumulada
</th>
...
<span></span>
Existe una vulnerabilidad de elevación de privilegios en la forma en que Internet Explorer trata el nivel de integridad de proceso en casos específicos. Un atacante que consiguiera aprovechar esta vulnerabilidad podría permitir que se ejecutara código arbitrario con privilegios elevados.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-3186](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3186).
...
En casos específicos, Internet Explorer no trata correctamente la asignación de nivel de integridad de proceso, lo que permite que el script se ejecute con privilegios elevados.

**¿Qué es el mecanismo de integridad de Windows?**
El mecanismo de integridad de Windows es un componente esencial de la arquitectura de seguridad de Windows que restringe los permisos de acceso de las aplicaciones que se ejecutan con la misma cuenta de usuario y que son menos confiables. Para obtener más información, vea [¿Qué es el mecanismo de integridad de Windows?](http://msdn.microsoft.com/library/bb625957)

**¿Para qué puede utilizar un atacante esta vulnerabilidad?**
Un atacante que aprovechar esta vulnerabilidad podría elevar los privilegios de un proceso que inicia Internet Explorer para ejecutarse en el contexto de seguridad del usuario actual.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**
Lo más probable es que esta vulnerabilidad se usara conjuntamente con otra que permitiera la ejecución remota de código. Por ejemplo, un atacante podría aprovechar otra vulnerabilidad para ejecutar código arbitrario a través de Internet Explorer, pero debido al contexto en el que Internet Explorer inicia los procesos, el código podría estar restringido para ejecutarse en un nivel de integridad bajo (permisos muy limitados). No obstante, un atacante podría, a su vez, aprovechar esta vulnerabilidad para provocar que el código arbitrario se ejecutara en un nivel de integridad medio (permisos del usuario actual).
...
La actualización corrige la vulnerabilidad al modificar el modo en que Internet Explorer trata la asignación de nivel de integridad de proceso en casos específicos.
...
<span></span>
Existe una vulnerabilidad de divulgación de información en Internet Explorer que podría permitir llevar a cabo ataques de scripts de sitios. Un atacante podría aprovechar la vulnerabilidad mediante la inserción de cadenas especialmente diseñadas en un sitio web, lo que provoca la divulgación de información cuando un usuario visita el sitio web.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-3192](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3192).
...
|------------------------------------------------------------|----------------------------------------------------------------------------------|
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3184](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3184) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3187](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3187) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3188](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3188) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3189](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3189) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3190](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3190) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3191](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3191) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3193](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3193) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3194](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3194) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3199](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3199) |
...
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2862772$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2862772-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2862772-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información</strong> <strong>sobre</strong> <strong>archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2862772">artículo 2862772 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
| **Información sobre archivos**       | Vea el [artículo 2862772 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2862772)                                                                                                                                |
...
-   [VUPEN Security](http://www.vupen.com), en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [HP](http://www.hpenterprisesecurity.com/products), por colaborar con nosotros en los cambios de defensa incluidos en este boletín.
