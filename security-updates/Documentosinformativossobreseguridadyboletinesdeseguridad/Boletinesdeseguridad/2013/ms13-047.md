...
-   **No depure un script en páginas web que no sean de confianza o en páginas web que no controle**
    ...
    En una configuración predeterminada, la depuración de scripts no está habilitada en Internet Explorer. Sin embargo, incluso cuando la depuración de scripts no esté habilitada, el usuario puede depurar un script. Para ello, debe presionar **F12** para mostrar el panel de herramientas de desarrollo y, a continuación, hacer clic en **Iniciar depuración** en la pestaña **Script** mientras visita una página malintencionada.  
     **Nota** Para bloquear la vía de ataque de herramientas de desarrollo, los administradores pueden usar las directivas de grupo para desactivar las herramientas de desarrollo F12.
