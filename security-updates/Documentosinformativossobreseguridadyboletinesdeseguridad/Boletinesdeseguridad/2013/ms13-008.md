---
TOCTitle: 'MS13-008'
Title: 'Boletín de seguridad de Microsoft MS13-008 - Crítica'
ms:assetid: 'ms13-008'
ms:contentKeyID: 61226405
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-008(v=Security.10)'
---

Boletín de seguridad de Microsoft MS13-008 - Crítica
====================================================

Actualización de seguridad para Internet Explorer (2799329)
-----------------------------------------------------------
...
Esta actualización de seguridad se considera crítica para Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 en clientes Windows y moderada para Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 en servidores Windows. Internet Explorer 9 e Internet Explorer 10 no están afectados. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2794220](http://technet.microsoft.com/security/advisory/2794220).
...
**¿Esta actualización,** **MS13-008, es una actualización de seguridad acumulativa para Internet Explorer?**  
No. Esta actualización de seguridad, MS13-008, solo corrige la vulnerabilidad descrita en este boletín.

**¿Debo instalar la última actualización de seguridad acumulativa para** **Internet Explorer, MS12-077?**  
Sí. En todos los casos, MS13-008 protege a los clientes frente a la vulnerabilidad descrita en este boletín. No obstante, los clientes que no han instalado la última actualización de seguridad para Internet Explorer pueden tener problemas de compatibilidad después de instalar la actualización MS13-008.

Los clientes deben asegurarse de que está instalada la última actualización de seguridad acumulativa para Internet Explorer, [MS12-077](http://technet.microsoft.com/es-es/security/bulletin/ms12-077), a fin de evitar problemas de compatibilidad.

**Si apliqué la solución Microsoft Fix it automatizada para Internet Explorer del documento informativo sobre seguridad de Microsoft 2794220, ¿debo deshacer la solución provisional antes de aplicar esta actualización?**  
Los clientes que implementaron la solución **Microsoft** **Fixit**, "Solución provisional de shim en MSHTML" del [documento informativo sobre seguridad de Microsoft 2794220](http://technet.microsoft.com/es-es/security/advisory/2794220), no necesitan deshacer la **solución Microsoft** **Fixit** antes de aplicar esta actualización.
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2799329 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2799329).
...
<th style="border:1px solid black;" >
Vulnerabilidad en el uso de Internet Explorer después de la liberación (CVE-2012-4792)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2012-4792](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792).

#### Factores atenuantes para la vulnerabilidad en el uso de Internet Explorer después de la liberación (CVE-2012-4792)
...
#### Soluciones provisionales para la vulnerabilidad en el uso de Internet Explorer después de la liberación (CVE-2012-4792)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Aplicar la solución Microsoft** **Fixit** **"Solución provisional de** **shim** **en MSHTML" que impide que se aproveche este problema**

    Vea el [artículo 2799329 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2799329) para usar la solución **Microsoft** **Fixit** automática para habilitar o deshabilitar esta solución provisional.
...
#### Preguntas más frecuentes sobre la vulnerabilidad en el uso de Internet Explorer después de la liberación (CVE-2012-4792)
...
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Tiene asignado el número de vulnerabilidad y exposición común [CVE-2012-4792](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792). Esta vulnerabilidad se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2794220](http://technet.microsoft.com/es-es/security/advisory/2794220).

**En el momento de publicar este boletín de seguridad, ¿había recibido Microsoft algún informe que indicase que se estaba usando esta vulnerabilidad?**  
Sí. Microsoft tiene constancia de ataques dirigidos que intentan aprovechar esta vulnerabilidad a través de Internet Explorer 8.
...
<td style="border:1px solid black;">Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\\$NTUninstallKB2799329$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2799329-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2799329-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2799329">artículo 2799329 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   , por colaborar con nosotros en la vulnerabilidad en el uso de Internet Explorer después de la liberación (CVE-2012-4792)
...
-   V1.0 (14 de enero de 2013): Publicación del boletín.
