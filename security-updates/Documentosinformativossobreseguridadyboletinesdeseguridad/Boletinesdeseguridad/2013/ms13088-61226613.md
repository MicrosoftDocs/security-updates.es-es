---
TOCTitle: 'MS13-088'
Title: 'Boletín de seguridad de Microsoft MS13-088 - Crítica'
ms:assetid: 'ms13-088'
ms:contentKeyID: 61226613
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-088(v=Security.10)'
---
...
Esta actualización de seguridad se considera crítica para Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, Internet Explorer 9, Internet Explorer 10 e Internet Explorer 11 en clientes Windows afectados e importante para Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 en servidores Windows afectados. Además, para Internet Explorer 11 en servidores de Windows afectados, esta actualización de seguridad se considera moderada. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que Internet Explorer trata los caracteres especiales de CSS, trata el contenido web especialmente diseñado al generar la vista previa de impresión y trata los objetos en memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
| Artículo de Knowledge Base | [2888505](https://support.microsoft.com/kb/2888505) |
|----------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2879017 en [MS13-080](http://go.microsoft.com/fwlink/?linkid=324021)
</td>
</tr>
...
<td style="border:1px solid black;">
2884101 en [MS13-080](http://go.microsoft.com/fwlink/?linkid=324021)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Sí. La actualización 2888505 está disponible para Internet Explorer 11 Preview para Windows 8.1 Preview y Windows RT 8.1 Preview. Se recomienda que los usuarios con Internet Explorer 11 Preview apliquen las actualizaciones a sus sistemas. Las actualizaciones están disponibles en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3871)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de divulgación de información en Internet Explorer (CVE-2013-3908)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de divulgación de información en Internet Explorer (CVE-2013-3909)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3910)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3911)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3912)
</th>
</tr>
<tr>
...
<tr>
<td style="border:1px solid black;">
Internet Explorer 10 para Windows 8 para sistemas x64
</td>
<td style="border:1px solid black;">
**Crítica**  
Ejecución remota de código
...
<tr>
<td style="border:1px solid black;">
Internet Explorer 11 para Windows 8.1 para sistemas x64
</td>
<td style="border:1px solid black;">
No aplicable
</td>
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3914)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3915)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3916)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3917)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Existe una vulnerabilidad de divulgación de información en la forma en que Internet Explorer trata el contenido web especialmente diseñado al generar la vista previa de impresión. Un atacante que aprovechara esta vulnerabilidad podría recopilar información de cualquier página que vea la víctima.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-3908](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3908).
...
-   **No usar la característica de** **vista** **previa** **de impresión en Internet Explorer**

    No use la característica **Vista previa de impresión**. Si se le pide que inicie una vista previa de impresión, seleccione **No** o **Cancelar**.

    **Nota** Esta solución provisional corrige la vía de ataque por la que un atacante intenta engañar o convencer a una posible víctima para que inicie una vista previa de impresión. Esta solución provisional se debe usar junto con una de las siguientes soluciones provisionales para corregir todas las vías de ataque conocidas:
...
-   **Configurar las zonas de seguridad de Internet e Intranet local en "Alta", de forma que se bloqueen los controles ActiveX y Active Scripting en estas zonas**
    ...
    **Nota** Esta solución provisional corrige las vías de ataque que utilizan Active scripting. Esta solución provisional se debe usar junto con la solución provisional **No usar la característica de** **vista** **previa de impresión en Internet Explorer** para corregir todas las vías de ataque conocidas.
...
En casos específicos, Internet Explorer no trata correctamente el contenido web especialmente diseñado al generar la vista previa de impresión.

**¿Para qué puede utilizar un atacante esta vulnerabilidad?**  
Un atacante que aprovechara esta vulnerabilidad podría recopilar información de cualquier página que vea la víctima. Por ejemplo, un atacante podría recopilar información de una página web que la víctima ha abierto en otra pestaña del explorador.

**¿Cómo podría aprovechar un atacante la vulnerabilidad?**  
Un atacante podría usar Active scripting para iniciar la vista previa de impresión de una página web especialmente diseñada. Si Active scripting está habilitado en el explorador de la víctima, un atacante tendría que convencerla para que inicie manualmente una vista previa de impresión de una página web especialmente diseñada. No obstante, el atacante no podría en ningún caso obligar a los usuarios a visitar el sitio web. Por lo tanto, tendría que atraerlos al sitio web; por lo general, convenciéndoles para que hagan clic en un vínculo de un mensaje de correo electrónico o de Instant Messenger que lleve a los usuarios al sitio web del atacante. También sería posible que se mostrara contenido web diseñado especialmente mediante titulares de anuncios u otros métodos para hacer llegar contenido web a los sistemas afectados.
...
La actualización corrige la vulnerabilidad al modificar la forma en que Internet Explorer trata el contenido web especialmente diseñado al generar la vista previa de impresión.
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-3909](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3909).
...
**¿Para qué puede utilizar un atacante esta vulnerabilidad?**  
Un atacante que aproveche la vulnerabilidad cuando un usuario visita una página web podría ver el contenido de otro dominio o zona de Internet Explorer distinto del dominio o zona de la página web del atacante.
...
|------------------------------------------------------------|----------------------------------------------------------------------------------|
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3871](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3871) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3910](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3910) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3911](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3911) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3912](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3912) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3914](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3914) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3915](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3915) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3916](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3916) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3917](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3917) |
...
Cuando Internet Explorer obtiene acceso de forma incorrecta a objetos en la memoria, se podría dañar la memoria de tal manera que un atacante podría ejecutar código arbitrario en el contexto del usuario actual.
...
<td style="border:1px solid black;">Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2888505$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2888505-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2888505-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información</strong> <strong>sobre</strong> <strong>archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2888505">artículo 2888505 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
