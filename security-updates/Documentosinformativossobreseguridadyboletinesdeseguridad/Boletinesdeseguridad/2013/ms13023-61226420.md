...
<th style="border:1px solid black;" >Vulnerabilidad de confusión de tipo de objeto de árbol en Visio Viewer (CVE-2013-0079)</th>
<th style="border:1px solid black;" >Clasificación de gravedad acumulada</th>
</tr>
</thead>
<tbody>
...
<td style="border:1px solid black;"><strong>Sin clasificación de gravedad</strong><sup>[1]</sup></td>
