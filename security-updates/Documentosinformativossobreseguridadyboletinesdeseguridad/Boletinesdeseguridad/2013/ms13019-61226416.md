---
TOCTitle: 'MS13-019'
Title: 'Boletín de seguridad de Microsoft MS13-019 - Importante'
ms:assetid: 'ms13-019'
ms:contentKeyID: 61226416
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-019(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS13-019 - Importante
=======================================================

Una vulnerabilidad en el subsistema de tiempo de ejecución de cliente-servidor (CSRSS) de Windows podría permitir la elevación de privilegios (2790113)
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
Es una actualización de seguridad importante para todas las ediciones compatibles de Windows 7 y Windows 2008 R2. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que CSRSS de Windows trata los objetos en memoria. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
<td style="border:1px solid black;">
KB2567680 en [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864)
</td>
</tr>
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2790113 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2790113).
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076).

#### Factores atenuantes para la vulnerabilidad de recuento de referencias (CVE-2013-0076)
...
#### Soluciones provisionales para la vulnerabilidad de recuento de referencias (CVE-2013-0076)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de recuento de referencias (CVE-2013-0076)
...
Sí. Esta vulnerabilidad ya se ha divulgado públicamente. Se le ha asignado el número de vulnerabilidad y exposición común [CVE-2013-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0076).
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2790113">artículo 2790113 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Max DeLiso, por colaborar con nosotros en la vulnerabilidad de recuento de referencias (CVE-2013-0076)
