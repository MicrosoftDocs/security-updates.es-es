---
TOCTitle: 'MS13-080'
Title: 'Boletín de seguridad de Microsoft MS13-080 - Crítica'
ms:assetid: 'ms13-080'
ms:contentKeyID: 61226477
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-080(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS13-080 - Crítica
====================================================

Actualización de seguridad acumulativa para Internet Explorer (2879017)
-----------------------------------------------------------------------

Publicado: martes, 8 de octubre de 2013 | Actualizado: jueves, 10 de octubre de 2013
...
Esta actualización de seguridad se considera crítica para Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, Internet Explorer 9, Internet Explorer 10 e Internet Explorer 11 en clientes Windows y moderada para Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, Internet Explorer 9, Internet Explorer 10 e Internet Explorer 11 en servidores Windows. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.
...
Esta actualización de seguridad también corrige la vulnerabilidad que se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2887505](http://technet.microsoft.com/security/advisory/2887505).
...
| Artículo de Knowledge Base | [2879017](https://support.microsoft.com/kb/2879017) |
|----------------------------|-----------------------------------------------------|
| Información sobre archivos | Sí                                                  |
| Valores hash SHA1/SHA2     | Sí                                                  |
| Problemas conocidos        | Ninguna                                             |

**Nota**[2879017](https://support.microsoft.com/kb/2879017) se aplica a las actualizaciones de seguridad acumulativas para todas las versiones de Internet Explorer excepto para Internet Explorer 11. Para Internet Explorer 11 en Windows 8.1, Windows RT 8.1 y Windows Server 2012 R2 consulte [2884101](https://support.microsoft.com/kb/2884101).
...
<td style="border:1px solid black;">
2870699 en [MS13-069](http://go.microsoft.com/fwlink/?linkid=320631)
</td>
</tr>
...
<span></span>
**¿Por qué se ha revisado este boletín el** **8deoctubre de 2013?**
Microsoft ha revisado este boletín para anunciar que la actualización 2884101 está disponible a través de [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).

**Tengo Internet Explorer 11 en** **Windows RT 8.1, Windows 8.1** **o** **Windows Server 2012 R2. ¿Qué actualización se aplica a mi sistema?**
La actualización 2884101 se aplica a los clientes que ejecutan Windows RT 8.1, Windows 8.1 y Windows Server 2012 R2. Para obtener más información acerca de la actualización 2884101, vea el [artículo 2884101 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2884101).

**¿Internet Explorer 11 Preview** **está** **afectado por alguna de las vulnerabilidades corregidas en este boletín?**
Sí. La actualización 2879017 está disponible para Internet Explorer 11 Preview para Windows 7, Windows 8.1 Preview y Windows RT 8.1 Preview. Se recomienda que los usuarios con Internet Explorer 11 Preview apliquen las actualizaciones a sus sistemas. Las actualizaciones están disponibles en [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
**Si apliqué la solución Microsoft Fix it automatizada para Internet Explorer** **descrita anteriormente en** **el documento informativo sobre seguridad de Microsoft 2887505, ¿debo deshacer la solución provisional antes** **o después** **de aplicar esta actualización?**
No. Los clientes que implementaron la **solución Microsoft Fix it** "CVE-2013-3893 Solución provisional de shim en MSHTML" descrita anteriormente en el [documento informativo sobre seguridad de Microsoft 2887505](http://technet.microsoft.com/security/advisory/2887505) no necesitan deshacer la **solución Microsoft Fix it** antes o después de aplicar esta actualización.

**Nota** Aunque no es necesario deshacer la **solución Microsoft Fix it**, los clientes pueden seguir los pasos del [artículo 2879017 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2879017) para deshacer la **solución Microsoft Fix it**.
...
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3872)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3873)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3874)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3875)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3882)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3885)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3886)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3893)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3897)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Explorer 11 para Windows 8.1 para sistemas de 32 bits
</td>
<td style="border:1px solid black;">
No aplicable
</td>
...
<tr>
<td style="border:1px solid black;">
Internet Explorer 11 para Windows 8.1 para sistemas de 64 bits
</td>
<td style="border:1px solid black;">
No aplicable
</td>
...
|------------------------------------------------------------|----------------------------------------------------------------------------------|
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3872) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3873) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3874](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3874) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3875) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3882) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3885) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3886](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3886) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893) |
| Vulnerabilidad de daños en la memoria de Internet Explorer | [CVE-2013-3897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3897) |
...
-   **Para CVE-2013-3893, aplicar la solución Microsoft Fix it "** **Solución provisional de shimMSHTML en CVE-2013-3893", que impide que se aproveche este problema**

    Vea el [artículo 2879017 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2879017) para usar la solución **Microsoft Fix it** automática para habilitar o deshabilitar esta solución provisional. **Nota** Esta solución provisional solo corrige la vulnerabilidad divulgada de forma pública CVE-2013-3893.
...
**Estoy** **ejecutando** **Internet** **Explorer** **para** **Windows Server 2003, Windows Server 2008, Windows Server 2008 R2, Windows Server 2012 o Windows Server 2012 R2. ¿Solucionan esto las vulnerabilidades?**
...
| [CVE-2013-3893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893) | Sí. Esta vulnerabilidad se describió por primera vez en el [documento informativo sobre seguridad de Microsoft 2887505](http://technet.microsoft.com/security/advisory/2887505). |
...
| [CVE-2013-3885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3885) | No                                                                                                                                            |
| [CVE-2013-3886](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3886) | No                                                                                                                                            |
| [CVE-2013-3893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3893) | Sí. Microsoft tiene constancia de ataques dirigidos que intentan aprovechar esta vulnerabilidad en Internet Explorer 8 e Internet Explorer 9. |
| [CVE-2013-3897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3897) | Sí. Microsoft tiene constancia de ataques dirigidos que intentan aprovechar esta vulnerabilidad en Internet Explorer 8.                       |
...
<td style="border:1px solid black;">Para Internet Explorer 6 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2879017$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 7 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie7updates\KB2879017-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 8 para todas las ediciones compatibles de Windows XP:<br />
Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\ie8updates\KB2879017-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Información</strong> <strong>sobre</strong> <strong>archivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2879017">artículo 2879017 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 10 en todas las ediciones de 64 bits compatibles de Windows 8:<br />
...
Vea el <a href="http://support.microsoft.com/kb/2879017">artículo 2879017 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Internet Explorer 11 en todas las ediciones compatibles de Windows 8.1:<br />
Vea el <a href="http://support.microsoft.com/kb/2884101">artículo 2884101 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Comprobación de las claves del</strong> <strong>Registro</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> No existe una clave del Registro para validar la presencia de esta actualización.</td>
...
-   [Aniway.Anyway@gmail.com](mailto:aniway.anyway@gmail.com), en colaboración con [Zero Day Initiative](http://www.zerodayinitiative.com/) de [HP](http://www.hpenterprisesecurity.com/products), por informar de la vulnerabilidad de daños en la memoria de Internet Explorer (CVE-2013-3872)  
...
-   V1.1 (8 de octubre de 2013): se han agregado vínculos de descarga e información de paquete de actualización para la actualización 2884101.  
-   V1.2 (8 de octubre de 2013): se ha revisado el boletín para anunciar que la actualización 2884101 está disponible a través de Windows Update.  
-   V1.3 (10 de octubre de 2013): el boletín se ha revisado para quitar CVE-2013-3871 de las vulnerabilidades corregidas por esta actualización. La inclusión de este CVE en el texto del boletín de seguridad original fue un error de documentación. CVE-2013-3871 está programado para corregirse en una actualización de seguridad futura. Se trata únicamente de un cambio informativo. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.
