---
TOCTitle: 'MS13-006'
Title: 'Boletín de seguridad de Microsoft MS13-006 - Importante'
ms:assetid: 'ms13-006'
ms:contentKeyID: 61226403
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-006(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS13-006 - Importante
=======================================================

Una vulnerabilidad en Microsoft Windows podría permitir la omisión de característica de seguridad (2785220)
-----------------------------------------------------------------------------------------------------------
...
La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que el componente de proveedor de SSL de Windows trata los paquetes de red cifrados. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2785220 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2785220) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2785220 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2785220).
...
<th style="border:1px solid black;" >
Vulnerabilidad de omisión de característica de seguridad en los protocolos SSL versión 3 y TLS (CVE-2013-0013)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
<span></span>
Existe una vulnerabilidad de omisión de característica de seguridad en la forma en que SSL/TLS (Capa de sockets seguros y Seguridad de la capa de transporte) de Microsoft Windows tratan los protocolos SSL versión 3 (SSLv3) y TLS. La vulnerabilidad permitiría la omisión de la característica de seguridad si un atacante inserta contenido especialmente diseñado en una sesión SSL/TLS.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0013).

#### Factores atenuantes para la vulnerabilidad de omisión de característica de seguridad en los protocolos SSL versión 3 y TLS (CVE-2013-0013)

Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de omisión de característica de seguridad en los protocolos SSL versión 3 y TLS (CVE-2013-0013)

La solución provisional hace referencia a un cambio de opción o configuración que no corrige la vulnerabilidad subyacente pero ayuda a bloquear los tipos de ataque conocidos antes de aplicar la actualización. Microsoft ha probado las soluciones provisionales y señala en la explicación si una solución provisional reduce la funcionalidad:

-   **Configurar Internet Explorer para deshabilitar SSLv2**

    Puede protegerse de los intentos para aprovechar esta vulnerabilidad mediante Internet Explorer si cambia la configuración para deshabilitar SSLv2. Para ello, realice los siguientes pasos:
    ...
    3.  Desplácese hasta la sección **Seguridad**.
    4.  Desactive la casilla situada junto a **Usar SSL 2.0**.
    5.  Haga clic en **Aceptar** para volver a Internet Explorer.

    **Consecuencias de la solución provisional.** La deshabilitación de SSLv2 conlleva efectos secundarios. Es posible que algunos sitios web que están en Internet o en una intranet usen SSLv2 para proporcionar comunicaciones seguras. No podrá usar estos sitios web después de deshabilitar SSLv2.
    ...
    **Cómo deshacer la solución provisional.**
    ...
    2.  Haga clic en la pestaña **Opciones avanzadas**.
    3.  Desplácese hasta la sección **Seguridad**.
    4.  Active la casilla situada junto a **Usar SSL 2.0**.
    5.  Haga clic en **Aceptar** para volver a Internet Explorer.

-   **Configurar Internet Information Services para deshabilitar SSLv2**
    ...
    **Advertencia** La modificación incorrecta del Registro puede originar problemas graves que conlleven la reinstalación del sistema operativo. Microsoft no garantiza que los problemas derivados de la modificación incorrecta del Registro puedan resolverse. Realice las modificaciones al Registro bajo su propio riesgo.
    ...
    Puede protegerse de los intentos para aprovechar esta vulnerabilidad mediante sus sitios web de IIS si cambia la configuración para deshabilitar SSLv2. Para ello, realice los siguientes pasos:

    1.  Haga clic en **Inicio**, en **Ejecutar**, escriba **regedit** y, a continuación, haga clic en **Aceptar**.
    2.  En el Editor del Registro, busque la siguiente clave o carpeta del Registro:

        `HKey_Local_Machine\System\CurrentControlSet\Control\SecurityProviders \SCHANNEL\Protocols\SSL 2.0  `

    3.  Haga clic con el botón secundario en la carpeta **SSL 2.0**, seleccione **Nuevo** y, a continuación, haga clic en **Clave**. Asigne el nombre **Server** a la nueva carpeta.
    4.  En la carpeta **Server**, haga clic en el menú **Edición**, seleccione **Nuevo** y haga clic en **Valor DWORD (32 bits)**.
    5.  Escriba **Enabled** como el nombre y presione **Entrar**.
    6.  Asegúrese de que se muestra 0x00000000 (0) en la columna Datos (debe aparecer de forma predeterminada). Si no es así, haga clic con el botón secundario, seleccione **Modificar** y escriba 0 como información del valor.
    7.  Reinicie el equipo.

    **Consecuencias de la solución provisional.** La deshabilitación de SSLv2 conlleva efectos secundarios. Es posible que algunos exploradores web usen SSLv2 para participar en las comunicaciones seguras. Estos usuarios no podrán ver sus sitios web después de deshabilitar SSLv2.
    ...
    **Cómo deshacer la solución provisional.**
    ...
    3.  En la carpeta **Server**, haga clic con el botón secundario en el valor DWORD **Enabled** y seleccione **Eliminar**. Seleccione **Sí**.
    4.  Reinicie el equipo.

#### Preguntas más frecuentes sobre la vulnerabilidad de omisión de característica de seguridad en los protocolos SSL versión 3 y TLS (CVE-2013-0013)

**¿Cuál es el alcance de esta vulnerabilidad?**
Es una vulnerabilidad de omisión de característica de seguridad. Un atacante que aprovechara esta vulnerabilidad podría omitir las características de seguridad en SSL versión 3 o TLS que impiden que se cambie una conexión a SSL versión 2.

**¿Cuál es la causa de esta vulnerabilidad?**
La vulnerabilidad se debe a que Windows no trata correctamente la negociación de versión de las sesiones SSL/TLS.
...
Un atacante que supervisara una comunicación cifrada que aprovechara esta vulnerabilidad podría cambiar de forma silenciosa una conexión SSL versión 3 o TLS a SSL versión 2, que admite cifrados no seguros.

**¿Cómo podría aprovechar un atacante la** **vulnerabilidad?**
En un ataque del tipo "Man in the middle", un atacante podría insertar tráfico con formato incorrecto en una sesión de exploración SSL versión 3 o TLS entre Internet Explorer y un servidor de terceros, o entre un cliente de terceros y un servidor de Microsoft, y cambiar de forma silenciosa la conexión a SSL versión 2.
...
Cualquier sistema que envíe y reciba tráfico cifrado SSL/TLS está más expuesto a esta vulnerabilidad.

**¿Cómo funciona esta actualización?**
La actualización corrige la vulnerabilidad al modificar la forma en que el componente de proveedor de SSL de Windows trata los paquetes de red cifrados.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2785220">artículo 2785220 de Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
| **Información sobre archivos**         | Vea el [artículo 2785220 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2785220).                                                                                                                |
...
-   [Kenichiro Katayama](https://twitter.com/pin_ptr), por informar de la vulnerabilidad de omisión de característica de seguridad en los protocolos SSL versión 3 y TLS de Microsoft (CVE-2013-0013)
...
-   V1.1 (12 de febrero de 2013): se ha agregado un vínculo al artículo 2785220 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.  
-   V1.2 (9 de julio de 2013): se ha revisado el boletín para anunciar un cambio de detección en los paquetes de Windows Vista para la actualización 2785220 para corregir un problema de nueva oferta de Windows Update. Se trata únicamente de un cambio de detección. Los clientes que ya han actualizado correctamente sus sistemas no necesitan realizar ninguna acción.  
-   V1.3 (16 de diciembre de 2013): se ha revisado el boletín para anunciar un cambio de detección para corregir un problema de oferta para Windows RT (2785220). Se trata únicamente de un cambio de detección. No había cambios en los archivos de la actualización. Los clientes que ya han aplicado la actualización no deben realizar ninguna acción.
