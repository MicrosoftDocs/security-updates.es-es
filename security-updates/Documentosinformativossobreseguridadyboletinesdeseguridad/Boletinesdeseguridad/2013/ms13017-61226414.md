---
TOCTitle: 'MS13-017'
Title: 'Boletín de seguridad de Microsoft MS13-017 - Importante'
ms:assetid: 'ms13-017'
ms:contentKeyID: 61226414
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-017(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS13-017 - Importante
=======================================================

Vulnerabilidades del kernel de Windows podrían permitir la elevación de privilegios (2799494)
---------------------------------------------------------------------------------------------
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7, Windows Server 2008 R2, Windows 8, Windows Server 2012 y Windows RT. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige las vulnerabilidades al modificar la forma en que el kernel de Windows trata los objetos en memoria. Para obtener más información acerca de las vulnerabilidades, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2799494 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2799494) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<td style="border:1px solid black;">
KB2724197 en [MS12-068](http://go.microsoft.com/fwlink/?linkid=257912)
</td>
</tr>
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2768387 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2768387).
...
<th style="border:1px solid black;" >
Vulnerabilidad de condición de ejecución del kernel (2013-1278)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de condición de ejecución del kernel (CVE-2013-1279)
</th>
<th style="border:1px solid black;" >
Vulnerabilidad de recuento de referencias del kernel de Windows (CVE-2013-1280)
</th>
<th style="border:1px solid black;" >
Clasificación de gravedad acumulada
</th>
...
Vulnerabilidad de condición de ejecución del kernel (CVE-2013-1278)
-------------------------------------------------------------------

Existe una vulnerabilidad de elevación de privilegios cuando el kernel de Windows trata incorrectamente los objetos en memoria. Un atacante que consiguiera aprovechar esta vulnerabilidad podría ejecutar código arbitrario en modo kernel. De esta forma, un intruso podría instalar programas; ver, cambiar o eliminar datos; o crear cuentas nuevas con todos los derechos administrativos.

Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-1278](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278).

#### Factores atenuantes para la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1278)
...
#### Soluciones provisionales para la vulnerabilidad de condición de ejecución del kernel (CVE-CVE-2013-1278)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1278)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-1279](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279).

#### Factores atenuantes para la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1279)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.

#### Soluciones provisionales para la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1279)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1279)
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-1280](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280).

#### Factores atenuantes para la vulnerabilidad de recuento de referencias en el kernel de Windows (CVE-2013-1280)

El factor atenuante hace referencia a una opción, configuración común o práctica recomendada general, existente en un estado predeterminado, que podría reducir la gravedad de una vulnerabilidad. Los siguientes factores atenuantes podrían ser útiles en su situación:

-   Para aprovechar esta vulnerabilidad, un atacante debe de tener unas credenciales de inicio de sesión válidas y ser capaz de iniciar una sesión local.

#### Soluciones provisionales para la vulnerabilidad de recuento de referencias en el kernel de Windows (CVE-2013-1280)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de recuento de referencias en el kernel de Windows (CVE-2013-1280)
...
<td style="border:1px solid black;">Use el elemento <strong>Agregar o quitar programas</strong> del Panel de control o la utilidad Spuninst.exe que se encuentra en la carpeta %Windir%\$NTUninstallKB2799494$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2799494">artículo 2799494 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
| **Informaciónsobrearchivos**                   | Vea el [artículo 2799494 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2799494)                                                                                                                 |
...
-   , por informar de la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1278)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl/)  
-   y  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   , de  
-   [Google Inc](http://www.google.com)  
-   , por informar de la vulnerabilidad de condición de ejecución del kernel (CVE-2013-1279)
...
-   V1.1 (12 de febrero de 2013): se ha agregado un vínculo al artículo 2799494 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
