---
TOCTitle: 'MS13-018'
Title: 'Boletín de seguridad de Microsoft MS13-018 - Importante'
ms:assetid: 'ms13-018'
ms:contentKeyID: 61226415
ms:mtpsurl: 'https://technet.microsoft.com/es-ES/library/ms13-018(v=Security.10)'
---

Security Bulletin

Boletín de seguridad de Microsoft MS13-018 - Importante
=======================================================

Una vulnerabilidad en TCP/IP podría permitir la denegación de servicio (2790655)
--------------------------------------------------------------------------------
...
Esta actualización de seguridad se considera importante para todas las ediciones compatibles de Windows Server 2008, Windows Server 2008 R2 y Windows Server 2012; se considera moderada para todas las ediciones compatibles de Windows Vista, Windows 7, Windows 8 y Windows RT. Para obtener más información, consulte la subsección **Software afectado y no afectado**, en esta sección.

La actualización de seguridad corrige la vulnerabilidad al modificar la forma en que la pila TCP/IP de Windows trata las secuencias de terminación de conexión. Para obtener más información acerca de la vulnerabilidad, consulte la subsección Preguntas más frecuentes (P+F) de la entrada de vulnerabilidad específica en la sección siguiente, **Información sobre la vulnerabilidad**.
...
**Problemas conocidos.** En el [artículo 2790655 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2790655) se señalan los problemas detectados que pueden experimentar los clientes al instalar esta actualización de seguridad. Se documentan asimismo las soluciones propuestas.
...
<td style="border:1px solid black;">
KB2688338 en [MS12-032](http://go.microsoft.com/fwlink/?linkid=246964)
</td>
</tr>
...
Los valores SHA1 y SHA2 de las actualizaciones de seguridad se pueden usar para comprobar la autenticidad de los paquetes de actualización de seguridad descargados. Para obtener información de hash relativa a esta actualización, vea el [artículo 2790655 de Microsoft Knowledge Base](https://support.microsoft.com/kb/2790655).
...
Para ver esta vulnerabilidad como una entrada estándar en la lista de vulnerabilidades y exposiciones comunes, vea [CVE-2013-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075).

#### Factores atenuantes para la vulnerabilidad de FIN WAIT en TCP (CVE-2013-0075)

Microsoft no ha identificado factores atenuantes para esta vulnerabilidad.

#### Soluciones provisionales para la vulnerabilidad de FIN WAIT en TCP (CVE-2013-0075)

Microsoft no ha identificado soluciones provisionales para esta vulnerabilidad.

#### Preguntas más frecuentes sobre la vulnerabilidad de FIN WAIT en TCP (CVE-2013-0075)

**¿Cuál es el alcance de esta vulnerabilidad?** 
Se trata de una vulnerabilidad de denegación de servicio.

**¿Cuál es la causa de esta vulnerabilidad?** 
La vulnerabilidad se debe a que la pila TCP/IP de Windows trata incorrectamente una secuencia de terminación de conexión.
...
La actualización corrige la vulnerabilidad al modificar la forma en que la pila TCP/IP de Windows trata las secuencias de terminación de conexión.
...
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2790655">artículo 2790655 de Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Información sobre la eliminación</strong></td>
<td style="border:1px solid black;">Para desinstalar una actualización instalada por WUSA, use el parámetro de instalación /Uninstall o haga clic en <strong>Panel</strong> <strong>de control</strong>, en <strong>Sistema y seguridad</strong>, en <strong>Windows</strong> <strong>Update</strong>, en <strong>Actualizaciones instaladas</strong> y haga su selección en la lista de actualizaciones.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informaciónsobrearchivos</strong></td>
<td style="border:1px solid black;">Vea el <a href="http://support.microsoft.com/kb/2790655">artículo 2790655 de Microsoft Knowledge Base</a></td>
...
| **Informaciónsobrearchivos**                   | Vea el [artículo 2790655 de Microsoft Knowledge Base](http://support.microsoft.com/kb/2790655)                                                                                                                 |
...
-   V1.1 (12 de febrero de 2013): se ha agregado un vínculo al artículo 2790655 de Microsoft Knowledge Base en Problemas conocidos en Resumen ejecutivo.
