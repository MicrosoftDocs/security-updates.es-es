...
<tr class="even">
<td style="border:1px solid black;"><p><strong>Valores hash SHA1/SHA2</strong></p></td>
<td style="border:1px solid black;"><p>Sí</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Problemas conocidos</strong></p></td>
...
<tbody>  
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Versión de .NET Framework</strong></p></td>
<td style="border:1px solid black;"><p><strong>Sistemas operativos</strong></p></td>
<td style="border:1px solid black;"><p><strong>Número de actualización</strong></p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p>Microsoft .NET Framework 3.5</p></td>
<td style="border:1px solid black;"><p>Windows 8.1 y Windows Server 2012 únicamente</p></td>
<td style="border:1px solid black;"><p>2894852</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p>Microsoft .NET Framework 4.0</p></td>
<td style="border:1px solid black;"><p>Windows Server 2003 Service Pack 2, Windows Vista Service Pack 2, Windows 2008 Service pack 2, Windows 7 Service Pack 1 y Windows Server 2008 R2 Service Pack 1</p></td>
<td style="border:1px solid black;"><p>2894842</p></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><p>Microsoft .NET Framework 4.5</p></td>
<td style="border:1px solid black;"><p>Windows Vista, Windows Server 2008 Service Pack 2, Windows 7 y Windows Server 2008 R2 Service Pack 1</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p>Microsoft .NET Framework 4.5.1</p></td>
<td style="border:1px solid black;"><p>Windows 8, Windows Server 2012 y Windows RT</p></td>
<td style="border:1px solid black;"><p>2894855</p></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><p>Microsoft .NET Framework 4.5.1</p></td>
<td style="border:1px solid black;"><p>Windows 8.1, Windows Server 2012 R2 y Windows RT 8.1</p></td>
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 1.1 Service Pack 1 cuando está instalado en todas las ediciones de 32 bits compatibles de Windows Server 2003 SP2:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Información sobre archivos</strong></p></td>
<td style="border:1px solid black;"><p>Vea el <a href="http://support.microsoft.com/kb/2905247">artículo 2905247 de Microsoft Knowledge Base</a></p></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones x64 y con Itanium compatibles de Windows Server 2003:<br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 cuando está instalado en todas las ediciones de 32 bits compatibles de Windows Vista:<br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 cuando está instalado en todas las ediciones x64 compatibles de Windows Vista:<br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1:<br />
KB[nnnnnnn]_*_*-Microsoft .NET Framework [versión de destino de .NET]-MSP0.txt KB[nnnnnnn]_*_*.html</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong>Requisito de reinicio</strong></p></td>
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones x64 y con Itanium compatibles de Windows Vista:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2894842v2<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</p></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 cuando está instalado en Windows Server 2008 para sistemas de 32 bits Service Pack 2:<br />
<strong>NDP45-KB2894854-V2-x86.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 cuando está instalado en Windows Server 2008 para sistemas x64 Service Pack 2:<br />
<strong>NDP45-KB2894854-V2-x64.exe</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.0 cuando está instalado en todas las ediciones x64 y con Itanium compatibles de Windows Server 2008:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2894842v2<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</p></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 cuando está instalado en Windows 7 para sistemas de 32 bits Service Pack 1:<br />
<strong>NDP45-KB2894854-V2-x86.exe</strong></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Microsoft .NET Framework [versión de destino de .NET]\KB[nnnnnnn]v2 “ThisVersionInstalled” = “Y”</p></td>
</tr>
</tbody>
</table>
<p> </p>
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 en Windows 8 para sistemas de 32 bits:<br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 en Windows 8 para sistemas de 64 bits:<br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1:</p>
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5/4.5.1 en Windows Server 2012:<br />
<strong>Windows8-RT-KB2894855-V2-x64.msu</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
...
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5 y 4.5.1 en Windows RT:<br />
La actualización 2894855 está disponible a través de Windows Update</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>Para Microsoft .NET Framework 4.5.1 en Windows RT 8.1:<br />
La actualización 2894856 está disponible a través de Windows Update</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>Requisito de reinicio</strong></p></td>
