...
<td style="border:1px solid black;"><p><strong>Actualización de seguridad acumulativa para Internet Explorer (2975687)<br />
<br />
...
<td style="border:1px solid black;"><p><strong>Una vulnerabilidad en Windows Journal podría permitir la ejecución remota de código (2975689)</strong><br />
<br />
...
<td style="border:1px solid black;"><p><strong>Una vulnerabilidad en el teclado en pantalla podría permitir la elevación de privilegios (2975685)</strong><br />
<br />
Esta actualización de seguridad crítica resuelve una vulnerabilidad de la que se ha informado de forma privada en Microsoft Windows. La vulnerabilidad podría permitir la elevación de privilegios si un atacante usa una vulnerabilidad en un proceso de integridad baja para ejecutar el texto en pantalla y carga un programa especialmente diseñado en el sistema de destino.</p></td>
...
<td style="border:1px solid black;"><p><strong>Una vulnerabilidad en el controlador de función auxiliar (AFD) podría permitir la elevación de privilegios (2975684)</strong><br />
<br />
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=402326">MS14-038</a></p></td>
<td style="border:1px solid black;"><p>Vulnerabilidad de ejecución remota de código en Windows Journal</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=402327">MS14-039</a></p></td>
<td style="border:1px solid black;"><p>Vulnerabilidad de elevación de privilegios en el teclado en pantalla</p></td>
...
<tr class="even">
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=402328">MS14-040</a></p></td>
<td style="border:1px solid black;"><p>Vulnerabilidad de elevación de privilegios en el controlador de función auxiliar</p></td>
...
<tr class="odd">
<td style="border:1px solid black;"><p><a href="http://go.microsoft.com/fwlink/?linkid=402330">MS14-041</a></p></td>
<td style="border:1px solid black;"><p>Vulnerabilidad de elevación de privilegios en DirectShow</p></td>
